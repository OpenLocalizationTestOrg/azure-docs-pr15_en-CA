#<a name="how-to-use-the-azure-command-line-tools-for-mac-and-linux"></a>How to use the Azure Command-Line Tools for Mac and Linux
...
###<a name="create-a-website"></a>Create a Website
...
###<a name="set-up-publishing-from-github"></a>Set up publishing from GitHub
...
###<a name="configure-app-settings"></a>Configure app settings
...
###<a name="list-and-show-sites"></a>List and show sites
...
###<a name="stop-start-or-restart-a-site"></a>Stop, start, or restart a site
...
###<a name="delete-a-site"></a>Delete a site
