####<a name="configuring-the-ios-project-in-xamarin-studio"></a>Configuring the iOS project in Xamarin Studio
...
####<a name="configuring-the-ios-project-in-visual-studio"></a>Configuring the iOS project in Visual Studio
