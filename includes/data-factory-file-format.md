...
#### <a name="setofobjects-file-pattern"></a>setOfObjects file pattern
...
#### <a name="arrayofobjects-file-pattern"></a>arrayOfObjects file pattern. 
...
#### <a name="supported-json-structure"></a>Supported JSON structure
Note the following points: 
