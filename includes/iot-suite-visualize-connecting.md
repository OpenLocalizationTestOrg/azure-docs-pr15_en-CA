## <a name="view-device-telemetry-in-the-dashboard"></a>View device telemetry in the dashboard
...
## <a name="send-a-command-to-your-device"></a>Send a command to your device
