# <a name="internet-of-things-security-from-the-ground-up"></a>Internet of Things security from the ground up
...
### <a name="secure-connectivity"></a>Secure connectivity 
