...
### <a name="azure-backup---storage-redundancy-options"></a>Azure Backup - Storage Redundancy Options
...
#### <a name="geo-redundant-storage-grs"></a>Geo-Redundant Storage (GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>Locally Redundant Storage (LRS)
