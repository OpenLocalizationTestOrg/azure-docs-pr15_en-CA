...
## <a name="markdown-for-azuremicrosoftcom"></a>Markdown for Azure.microsoft.com
...
## <a name="custom-markdown-extensions-used-in-our-technical-articles"></a>Custom markdown extensions used in our technical articles
...
###<a name="sample-markdown"></a>Sample markdown
...
## <a name="embedded-videos"></a>Embedded videos
...
## <a name="technology-and-platform-selectors"></a>Technology and platform selectors
...
####<a name="syntax"></a>Syntax
    ...
    > [AZURE. SELECTOR-LIST (Dropdown1 | Dropdown2 )]     - [(Dropdown1Text1 | Dropdown2Text1 )](../articles/dropdown1-text1-dropdown2-text1.md)
...
Example:
    ...
    > [AZURE. SELECTOR-LIST (Platform | Backend )]     - [(iOS | .NET)](./mobile-services-dotnet-backend-ios-get-started-push.md)
