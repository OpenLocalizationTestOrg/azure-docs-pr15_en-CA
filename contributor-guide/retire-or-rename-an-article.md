# <a name="steps-to-follow-when-you-retire-or-change-the-name-of-an-acom-technical-article"></a>Steps to follow when you retire or change the name of an ACOM technical article
...
## <a name="step-1-set-the-article-to-no-indexno-follow-and-republish-it-recommended"></a>Step 1: Set the article to no-index/no-follow and republish it (recommended)
...
## <a name="step-2-manage-inbound-links-required"></a>Step 2: Manage inbound links (required)
...
## <a name="step-3-remove-all-crosslinks-to-the-article-from-the-technical-content-repository-required"></a>Step 3: Remove all crosslinks to the article from the technical content repository (required)
...
## <a name="step-4-update-the-fwlink-tool-required"></a>Step 4: Update the FWLink tool (required)
...
## <a name="step-5-remove-all-crosslinks-to-the-article-from-other-pages-on-azuremicrosoftcom-and-create-a-redirect-for-the-retired-page-if-appropriate-required"></a>Step 5: Remove all crosslinks to the article from other pages on azure.microsoft.com and create a redirect for the retired page, if appropriate (required)
...
## <a name="step-6-retire-the-article"></a>Step 6: Retire the article
...
## <a name="step-7-remove-links-from-msdn-required"></a>Step 7: Remove links from MSDN (required)
...
## <a name="step-8-remove-cached-pages-from-search-engines-only-if-absolutely-necessary"></a>Step 8: Remove cached pages from search engines (only if absolutely necessary)
...
### <a name="contributors-guide-links"></a>Contributors' guide links
