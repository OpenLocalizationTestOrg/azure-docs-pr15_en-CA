# <a name="pull-request-etiquette-and-best-practices-for-microsoft-contributors-to-azure-documentation"></a>Pull request etiquette and best practices for Microsoft contributors to Azure documentation
...
## <a name="working-with-pull-request-reviewers"></a>Working with pull request reviewers
...
## <a name="make-the-pull-request-queue-work-better-for-everyone"></a>Make the pull request queue work better for everyone
...
## <a name="criteria-for-expedited-pull-requests"></a>Criteria for expedited pull requests
...
## <a name="in-a-hurry-submit-prs-that-can-be-accepted-automatically"></a>In a hurry? Submit PRs that can be accepted automatically
...
### <a name="need-to-make-a-lot-of-little-changes"></a>Need to make a lot of little changes?
