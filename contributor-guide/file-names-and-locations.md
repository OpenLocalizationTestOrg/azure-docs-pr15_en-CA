...
#<a name="file-names-and-locations-for-azure-technical-articles"></a>File names and locations for Azure technical articles
...
##<a name="standard-examples"></a>Standard examples
...
##<a name="marketplace-content"></a>Marketplace content
...
##<a name="file-name-approval"></a>File name approval
...
##<a name="folder-names-in-the-repo"></a>Folder names in the repo
...
##<a name="changing-case-in-file-names"></a>Changing case in file names
