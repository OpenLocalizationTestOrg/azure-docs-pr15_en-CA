...
# <a name="create-images-in-markdown"></a>Create images in markdown

## <a name="image-folder-creation-and-link-syntax"></a>Image folder creation and link syntax
...
## <a name="guidelines-specific-to-azuremicrosoftcom"></a>Guidelines specific to azure.microsoft.com
