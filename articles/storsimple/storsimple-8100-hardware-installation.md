...
# <a name="unpack-rack-mount-and-cable-your-storsimple-8100-device"></a>Unpack, rack-mount, and cable your StorSimple 8100 device
...
## <a name="unpack-your-storsimple-8100-device"></a>Unpack your StorSimple 8100 device
...
## <a name="rack-mount-your-storsimple-8100-device"></a>Rack-mount your StorSimple 8100 device
...
### <a name="prepare-the-site"></a>Prepare the site
...
#### <a name="to-install-the-device-on-the-rails"></a>To install the device on the rails
...
### <a name="mounting-the-device-in-the-rack"></a>Mounting the device in the rack

Using the rack rails that were just installed, perform the following steps to mount the device in the rack.

#### <a name="to-mount-the-device"></a>To mount the device
...
## <a name="cable-your-storsimple-8100-device"></a>Cable your StorSimple 8100 device
...
### <a name="power-cabling"></a>Power cabling
