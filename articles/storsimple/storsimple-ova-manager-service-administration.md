...
# <a name="use-the-storsimple-manager-service-to-administer-your-storsimple-virtual-array"></a>Use the StorSimple Manager service to administer your StorSimple Virtual Array
...
## <a name="connect-to-the-storsimple-manager-service"></a>Connect to the StorSimple Manager service
...
## <a name="navigate-the-storsimple-manager-service-ui"></a>Navigate the StorSimple Manager service UI
...
## <a name="use-the-storsimple-manager-service-to-perform-management-tasks"></a>Use the StorSimple Manager service to perform management tasks
