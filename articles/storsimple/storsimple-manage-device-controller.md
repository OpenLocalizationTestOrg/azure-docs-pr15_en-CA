...
# <a name="manage-your-storsimple-device-controllers"></a>Manage your StorSimple device controllers
...
## <a name="restart-or-shut-down-a-single-controller"></a>Restart or shut down a single controller
...
#### <a name="to-restart-or-shut-down-a-controller-in-classic-portal"></a>To restart or shut down a controller in classic portal
...
#### <a name="to-restart-or-shut-down-a-controller-in-windows-powershell-for-storsimple"></a>To restart or shut down a controller in Windows PowerShell for StorSimple
...
## <a name="shut-down-a-storsimple-device"></a>Shut down a StorSimple device
...
#### <a name="to-shut-down-a-storsimple-device"></a>To shut down a StorSimple device
...
## <a name="reset-the-device-to-factory-default-settings"></a>Reset the device to factory default settings
...
### <a name="to-reset-the-device-to-default-settings-in-windows-powershell-for-storsimple"></a>To reset the device to default settings in Windows PowerShell for StorSimple
...
## <a name="questions-and-answers-about-managing-device-controllers"></a>Questions and answers about managing device controllers
