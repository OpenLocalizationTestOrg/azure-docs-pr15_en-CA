...
# <a name="storsimple-8000-series-update-12-release-notes"></a>StorSimple 8000 Series Update 1.2 release notes  
...
## <a name="issues-fixed-in-update-12"></a>Issues fixed in Update 1.2
...
## <a name="known-issues-in-update-12"></a>Known issues in Update 1.2
...
## <a name="physical-device-updates-in-update-12"></a>Physical device updates in Update 1.2
...
## <a name="controller-and-firmware-updates-in-update-12"></a>Controller and firmware updates in Update 1.2
...
## <a name="virtual-device-updates-in-update-12"></a>Virtual device updates in Update 1.2
