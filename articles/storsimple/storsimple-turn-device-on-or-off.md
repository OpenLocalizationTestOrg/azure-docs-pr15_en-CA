...
### <a name="device-with-primary-enclosure-only-a-name8100"></a>Device with primary enclosure only<a name="8100">
...
### <a name="device-with-ebod-enclosure-a-name8600"></a>Device with EBOD enclosure<a name="8600">
...
### <a name="device-with-primary-enclosure-a-name8100a"></a>Device with primary enclosure<a name="8100a"> 
...
### <a name="device-with-ebod-enclosure-a-name8600a"></a>Device with EBOD enclosure<a name="8600a">
