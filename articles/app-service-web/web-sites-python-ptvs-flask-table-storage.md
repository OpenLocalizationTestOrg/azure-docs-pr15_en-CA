...
# <a name="flask-and-azure-table-storage-on-azure-with-python-tools-22-for-visual-studio"></a>Flask and Azure Table Storage on Azure with Python Tools 2.2 for Visual Studio 
