...
# <a name="enable-diagnostics-logging-for-web-apps-in-azure-app-service"></a>Enable diagnostics logging for web apps in Azure App Service
...
### <a name="download-with-azure-powershell"></a>Download with Azure PowerShell
...
### <a name="download-with-azure-command-line-interface"></a>Download with Azure Command-Line Interface
...
## <a name="how-to-view-logs-in-application-insights"></a>How to: View logs in Application Insights
...
### <a name="streaming-with-azure-powershell"></a>Streaming with Azure PowerShell
...
### <a name="streaming-with-azure-command-line-interface"></a>Streaming with Azure Command-Line Interface
...
### <a name="application-diagnostics-logs"></a>Application diagnostics logs
