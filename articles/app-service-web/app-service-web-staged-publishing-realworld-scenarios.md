...
## <a name="setting-up-a-non-production-environment-stagedevqa"></a>Setting up a non-production environment (stage,dev,QA)
...
#### <a name="the-final-wp-configphp-file"></a>The final `wp-config.php` file
...
#### <a name="set-up-a-staging-environment"></a>Set up a Staging Environment
...
#### <a name="set-up-courier2-deployment-module"></a>Set up Courier2 deployment module
