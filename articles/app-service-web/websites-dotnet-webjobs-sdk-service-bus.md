...
# <a name="how-to-use-azure-service-bus-with-the-webjobs-sdk"></a>How to use Azure Service Bus with the WebJobs SDK
...
### <a name="how-servicebustrigger-works"></a>How ServiceBusTrigger works
...
### <a name="string-queue-message"></a>String queue message
...
### <a name="poco-queue-message"></a>POCO queue message
...
### <a name="types-servicebustrigger-works-with"></a>Types ServiceBusTrigger works with
...
### <a name="create-a-single-queue-message-in-a-non-async-function"></a>Create a single queue message in a non-async function
...
### <a name="create-multiple-queue-messages-or-in-async-functions"></a>Create multiple queue messages or in async functions
...
## <a name="features-added-in-release-11"></a>Features added in release 1.1
