...
# <a name="how-to-use-azure-blob-storage-with-the-webjobs-sdk"></a>How to use Azure blob storage with the WebJobs SDK
...
## <a name="getting-the-blob-path-for-the-triggering-blob"></a>Getting the blob path for the triggering blob
