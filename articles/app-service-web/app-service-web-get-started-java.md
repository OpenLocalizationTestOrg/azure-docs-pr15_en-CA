...
6. In **Java version**, select **Java 8** and click **Save**.
    ...
    When you get the notification **Successfully updated web app settings**, navigate to http://*&lt;appname>*.azurewebsites.net  to see the default JSP servlet in action.
