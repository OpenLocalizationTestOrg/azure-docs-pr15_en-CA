...
# <a name="create-a-net-webjob-in-azure-app-service"></a>Create a .NET WebJob in Azure App Service
...
### <a name="deploy-to-web-apps"></a>Deploy to Web Apps
...
### <a name="configure-the-web-app-to-use-your-azure-sql-database-and-storage-account"></a>Configure the web app to use your Azure SQL database and storage account.
...
### <a name="create-a-visual-studio-solution-with-a-web-project-and-class-library-project"></a>Create a Visual Studio solution with a web project and class library project
...
### <a name="add-a-console-application-project-that-has-webjobs-deployment-enabled"></a>Add a Console Application project that has WebJobs deployment enabled
...
### <a name="add-nuget-packages"></a>Add NuGet packages
...
### <a name="set-project-references"></a>Set project references
...
### <a name="add-code-and-configuration-files"></a>Add code and configuration files
...
### <a name="contosoadsweb---viewsadindexcshtml-and-detailscshtml"></a>ContosoAdsWeb - Views\Ad\Index.cshtml and Details.cshtml
...
### <a name="contosoadsweb---viewsadcreatecshtml-and-editcshtml"></a>ContosoAdsWeb - Views\Ad\Create.cshtml and Edit.cshtml
...
### <a name="scaling-webjobs"></a>Scaling WebJobs
...
### <a name="avoiding-web-app-timeout-shut-downs"></a>Avoiding web app timeout shut-downs
...
### <a name="using-the-webjobs-sdk-outside-of-webjobs"></a>Using the WebJobs SDK outside of WebJobs
...
### <a name="more-webjobs-documentation"></a>More WebJobs documentation
