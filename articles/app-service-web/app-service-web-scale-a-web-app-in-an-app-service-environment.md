...
# <a name="scaling-apps-in-an-app-service-environment"></a>Scaling apps in an App Service Environment #
...
### <a name="scaling-the-number-of-instances"></a>Scaling the number of instances ###
...
### <a name="worker-pool-selection"></a>Worker Pool selection ###
