...
# <a name="bottle-and-azure-table-storage-on-azure-with-python-tools-22-for-visual-studio"></a>Bottle and Azure Table Storage on Azure with Python Tools 2.2 for Visual Studio 
...
## <a name="configure-the-web-apps-instance"></a>Configure the Web Apps instance
