...
## <a name="step-1-add-an-interceptor-class-in-the-application-to-set-the-sessioncontext"></a>Step 1: Add an Interceptor class in the application to set the SESSION_CONTEXT
