...
# <a name="set-up-staging-environments-for-web-apps-in-azure-app-service"></a>Set up staging environments for web apps in Azure App Service
<a name="Overview"></a>
...
<a name="Add"></a>
## <a name="add-a-deployment-slot-to-a-web-app"></a>Add a deployment slot to a web app ##
...
## <a name="configuration-for-deployment-slots"></a>Configuration for deployment slots ##
...
<a name="Swap"></a>
## <a name="to-swap-deployment-slots"></a>To swap deployment slots ##
...
## <a name="use-multi-phase-swap-for-your-web-app"></a>Use multi-phase swap for your web app ##
...
<a name="Rollback"></a>
## <a name="to-rollback-a-production-app-after-swap"></a>To rollback a production app after swap ##
...
<a name="Warm-up"></a>
## <a name="custom-warm-up-before-swap"></a>Custom warm-up before swap ##
...
<a name="Delete"></a>
## <a name="to-delete-a-deployment-slot"></a>To delete a deployment slot##
...
### <a name="create-a-deployment-slot-for-a-web-app"></a>Create a deployment slot for a web app
...
### <a name="initiate-multi-phase-swap-and-apply-target-slot-configuration-to-source-slot"></a>Initiate multi-phase swap and apply target slot configuration to source slot
...
### <a name="revert-the-first-phase-of-multi-phase-swap-and-restore-source-slot-configuration"></a>Revert the first phase of multi-phase swap and restore source slot configuration
...
### <a name="delete-deployment-slot"></a>Delete deployment slot
