...
# <a name="upload-a-custom-java-web-app-to-azure"></a>Upload a custom Java web app to Azure
...
## <a name="configuration-guidelines"></a>Configuration guidelines
...
## <a name="webconfig-httpplatform-configuration"></a>web.config httpPlatform configuration
...
## <a name="application-configuration-examples"></a>Application configuration Examples
