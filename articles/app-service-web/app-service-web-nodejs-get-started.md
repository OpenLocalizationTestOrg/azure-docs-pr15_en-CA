...
# <a name="get-started-with-nodejs-web-apps-in-azure-app-service"></a>Get started with Node.js web apps in Azure App Service
...
## <a name="create-and-deploy-a-simple-nodejs-web-app"></a>Create and deploy a simple Node.js web app
...
## <a name="update-your-nodejs-web-app"></a>Update your Node.js web app
...
## <a name="how-app-service-deploys-your-nodejs-app"></a>How App Service deploys your Node.js app
...
## <a name="use-a-nodejs-framework"></a>Use a Node.js framework
...
<a name="version"></a>
## <a name="use-a-specific-nodejs-engine"></a>Use a specific Node.js engine
...
>[AZURE.NOTE] It is recommended that you explicitly define the Node.js engine you want. The default Node.js version can change, and you may get errors in your Azure web app because the default Node.js version is not appropriate for your app.

<a name="iisnodelog"></a>
## <a name="get-stdout-and-stderr-logs-from-iisnode"></a>Get stdout and stderr logs from iisnode
...
## <a name="debug-your-app-with-node-inspector"></a>Debug your app with Node-Inspector
