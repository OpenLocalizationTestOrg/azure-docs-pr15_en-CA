...
# <a name="creating-web-apps-with-flask-in-azure"></a>Creating web apps with Flask in Azure
...
## <a name="web-app-create-on-the-azure-portal"></a>Web app create on the Azure Portal
