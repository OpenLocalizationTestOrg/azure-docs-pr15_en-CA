...
# <a name="secure-your-apps-custom-domain-with-https"></a>Secure your app's custom domain with HTTPS
...
### <a name="get-a-certificate-using-certreqexe"></a>Get a certificate using Certreq.exe
...
### <a name="generate-a-self-signed-certificate-using-certreqexe"></a>Generate a self-signed certificate using Certreq.exe ###
