...
# <a name="how-to-use-azure-queue-storage-with-the-webjobs-sdk"></a>How to use Azure queue storage with the WebJobs SDK
...
### <a name="poco-plain-old-clr-objecthttpenwikipediaorgwikiplainoldclrobject-queue-messages"></a>POCO [(Plain Old CLR Object](http://en.wikipedia.org/wiki/Plain_Old_CLR_Object)) queue messages
