...
# <a name="connect-to-on-premises-sql-server-from-a-web-app-in-azure-app-service-using-hybrid-connections"></a>Connect to on-premises SQL Server from a web app in Azure App Service using Hybrid Connections
...
<a name="InstallSQL"></a>
## <a name="a-install-sql-server-express-enable-tcpip-and-create-a-sql-server-database-on-premises"></a>A. Install SQL Server Express, enable TCP/IP, and create a SQL Server database on-premises ##
...
### <a name="enable-tcpip"></a>Enable TCP/IP ###
...
### <a name="create-a-sql-server-database-on-premises"></a>Create a SQL Server database on-premises ###
...
1. In SQL Server Management Studio, connect to the SQL Server you just installed. (If the **Connect to Server** dialog does not appear automatically, navigate to **Object Explorer** in the left pane, click **Connect**, and then click **Database Engine**.)  ![Connect to Server][SSMSConnectToServer]
...
<a name="CreateSite"></a>
## <a name="b-create-a-web-app-in-the-azure-portal"></a>B. Create a web app in the Azure Portal ##
...
<a name="CreateHC"></a>
## <a name="c-create-a-hybrid-connection-and-a-biztalk-service"></a>C. Create a Hybrid Connection and a BizTalk Service ##
...
<a name="InstallHCM"></a>
## <a name="d-install-the-on-premises-hybrid-connection-manager-to-complete-the-connection"></a>D. Install the on-premises Hybrid Connection Manager to complete the connection ##
...
## <a name="e-create-a-basic-aspnet-web-project-edit-the-database-connection-string-and-run-the-project-locally"></a>E. Create a basic ASP.NET web project, edit the database connection string, and run the project locally ##
...
### <a name="edit-the-database-connection-string-for-the-application"></a>Edit the database connection string for the application ###
...
### <a name="run-the-project-locally-and-register-a-new-user"></a>Run the project locally and register a new user ###
...
<a name="PubNTest"></a>
## <a name="f-publish-the-web-application-to-azure-and-test-it"></a>F. Publish the web application to Azure and test it ##
...
### <a name="test-the-completed-web-application-on-azure"></a>Test the completed web application on Azure ###
...
[Access on-premises resources using hybrid connections in Azure App Service](../app-service-web/web-sites-hybrid-connection-get-started.md)
