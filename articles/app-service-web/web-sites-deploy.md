...
# <a name="deploy-your-app-to-azure-app-service"></a>Deploy your app to Azure App Service
...
## <a name="deploy-using-an-ide"></a>Deploy using an IDE
...
<a name="vspros"></a>Additional pros of deploying using Visual Studio with Azure SDK are:
