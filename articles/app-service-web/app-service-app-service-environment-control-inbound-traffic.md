...
# <a name="how-to-control-inbound-traffic-to-an-app-service-environment"></a>How To Control Inbound Traffic to an App Service Environment
...
## <a name="network-ports-used-in-an-app-service-environment"></a>Network Ports Used in an App Service Environment ##
...
## <a name="creating-a-network-security-group"></a>Creating a Network Security Group ##
...
## <a name="assigning-a-network-security-group-to-a-subnet"></a>Assigning a Network Security Group to a Subnet ##
...
## <a name="special-considerations-for-explicit-ip-ssl"></a>Special Considerations for Explicit IP-SSL ##
