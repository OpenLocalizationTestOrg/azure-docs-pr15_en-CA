...
# <a name="configure-a-custom-domain-name-in-azure-app-service-purchased-directly-from-godaddy"></a>Configure a custom domain name in Azure App Service (Purchased directly from GoDaddy)
...
## <a name="enable-the-domain-name-on-your-web-app"></a>Enable the domain name on your web app
