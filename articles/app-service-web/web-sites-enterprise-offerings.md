...
# <a name="azure-app-service-web-apps-offerings-for-enterprise-whitepaper"></a>Azure App Service Web Apps Offerings for Enterprise Whitepaper #
...
<a href="highlevel" />
## <a name="high-level-solution"></a>High Level Solution ##
...
Using Standard App Service Features:![](./media/web-sites-enterprise-offerings/on-premise-connectivity-solutions.png "Using Standard App Service Features")

Using an App Service Environment:![](./media/web-sites-enterprise-offerings/on-premise-connectivity-solutions-ASE.png "Using an App Service Environment")

## <a name="business-benefits"></a>Business Benefits ##
...
### <a name="ease-of-migration"></a>Ease of Migration ###
...
### <a name="enterprise-class-hosting"></a>Enterprise Class Hosting ###
...
### <a name="global-scale"></a>Global Scale ###
...
## <a name="solution-details"></a>Solution Details ##
...
### <a name="migrate-existing-application"></a>Migrate Existing Application ###
...
#### <a name="items-to-consider"></a>Items to consider ####
...
### <a name="alternatives-to-using-azure-sql-database"></a>Alternatives to using Azure SQL Database ###
...
#### <a name="connectivity-to-on-premises-resources"></a>Connectivity to On Premises Resources ####
...
#### <a name="scale-and-resiliency"></a>Scale and Resiliency ####
