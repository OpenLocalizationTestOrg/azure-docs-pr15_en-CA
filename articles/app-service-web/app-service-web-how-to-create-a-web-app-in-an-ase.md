...
5. Enter the name for your web app, and then click **Create**. 
    ...
    If your ASE uses an Internal VIP then the URL of an app in that ASE is: [*sitename*]. [*subdomain specified during ASE creation*]   
...
### <a name="selecting-a-worker-pool"></a>Selecting a worker pool
...
## <a name="after-web-app-creation"></a>After web app creation
