...
## <a name="deploy-a-python-web-app"></a>Deploy a Python web app
...
4. Deploy your sample code to your Azure app like you would push any code with Git. When prompted, use the password you configured earlier.
    ...
    If you have any requirements.txt (Python) files in your project (repository) root, the deployment script restores the required packages for you. 
