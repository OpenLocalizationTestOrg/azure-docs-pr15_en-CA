...
# <a name="create-an-aspnet-mvc-app-with-auth-and-sql-db-and-deploy-to-azure-app-service"></a>Create an ASP.NET MVC app with auth and SQL DB and deploy to Azure App Service
...
## <a name="create-an-aspnet-mvc-5-application"></a>Create an ASP.NET MVC 5 application
...
1. Replace the ActionLink in the *Layout.cshtml* file with the following code.
    ...
    @Html.ActionLink("CMDemo", "Index", "Contacts", new { area = "" }, new { @class = "navbar-brand" })
...
## <a name="add-an-oauth2-provider"></a>Add an OAuth2 Provider
...
## <a name="using-the-membership-api"></a>Using the Membership API
...
## <a name="use-temporary-code-to-add-new-social-login-users-to-the-canedit-role"></a>Use Temporary Code to Add New Social Login Users to the canEdit Role  ##
...
## <a name="deploy-the-app-to-azure"></a>Deploy the app to Azure
...
### <a name="stop-the-web-app-to-prevent-other-people-from-registering"></a>Stop the web app to prevent other people from registering  
...
### <a name="remove-addtoroleasync-publish-and-test"></a>Remove AddToRoleAsync, Publish, and Test
...
## <a name="examine-the-sql-azure-db"></a>Examine the SQL Azure DB ##
