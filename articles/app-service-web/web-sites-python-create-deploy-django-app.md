...
# <a name="creating-web-apps-with-django-in-azure"></a>Creating web apps with Django in Azure
...
## <a name="web-app-creation-on-portal"></a>Web App Creation on Portal
...
### <a name="create-a-superuser"></a>Create a superuser
