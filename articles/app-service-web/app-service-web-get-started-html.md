...
# <a name="deploy-your-first-web-app-to-azure-in-five-minutes"></a>Deploy your first web app to Azure in five minutes
...
## <a name="deploy-a-simple-html-site"></a>Deploy a simple HTML site
