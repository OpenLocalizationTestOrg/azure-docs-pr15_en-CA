...
# <a name="create-a-java-web-app-in-azure-app-service"></a>Create a Java web app in Azure App Service
...
## <a name="java-application-options"></a>Java application options
