...
# <a name="connect-virtual-networks-from-different-deployment-models-in-the-portal"></a>Connect virtual networks from different deployment models in the portal
...
### <a name="part-1---create-a-new-local-network"></a>Part 1 - Create a new local network
...
### <a name="part-2---associate-the-local-network-to-your-vnet"></a>Part 2 - Associate the local network to your VNet
...
### <a name="part-3---create-the-gateway"></a>Part 3 - Create the gateway
...
### <a name="part-1---create-a-gateway-subnet"></a>Part 1 - Create a gateway subnet
...
### <a name="part-2---create-a-virtual-network-gateway"></a>Part 2 - Create a virtual network gateway


[AZURE.INCLUDE [vpn-gateway-add-gw-rm-portal](../../includes/vpn-gateway-add-gw-rm-portal-include.md)]


### <a name="part-3---create-a-local-network-gateway"></a>Part 3 - Create a local network gateway
...
### <a name="part-4---copy-the-public-ip-address"></a>Part 4 - Copy the public IP address
