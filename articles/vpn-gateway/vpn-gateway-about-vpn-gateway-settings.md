...
# <a name="about-vpn-gateway-settings"></a>About VPN Gateway settings
...
### <a name="configuring-the-gateway-sku"></a>Configuring the gateway SKU
...
### <a name="estimated-aggregate-throughput-by-gateway-sku-and-type"></a>Estimated aggregate throughput by gateway SKU and type
