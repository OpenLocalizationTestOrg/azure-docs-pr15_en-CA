...
# <a name="configure-forced-tunneling-using-the-azure-resource-manager-deployment-model"></a>Configure forced tunneling using the Azure Resource Manager deployment model
...
## <a name="about-forced-tunneling"></a>About forced tunneling
