...
# <a name="configure-active-active-s2s-vpn-connections-with-azure-vpn-gateways-using-azure-resource-manager-and-powershell"></a>Configure active-active S2S VPN connections with Azure VPN Gateways using Azure Resource Manager and PowerShell
...
## <a name="about-highly-available-cross-premises-connections"></a>About Highly Available Cross-Premises Connections
...
### <a name="step-2---create-the-vpn-gateway-for-testvnet1-with-active-active-mode"></a>Step 2 - Create the VPN gateway for TestVNet1 with active-active mode

#### <a name="1-create-the-public-ip-addresses-and-gateway-ip-configurations"></a>1. Create the public IP addresses and gateway IP configurations
...
#### <a name="2-create-the-vpn-gateway-with-active-active-configuration"></a>2. Create the VPN gateway with active-active configuration
...
#### <a name="3-obtain-the-gateway-public-ip-addresses-and-the-bgp-peer-ip-address"></a>3. Obtain the gateway public IP addresses and the BGP Peer IP address
...
#### <a name="3-vpn-and-bgp-parameters-for-your-on-premises-vpn-device"></a>3. VPN and BGP parameters for your on-premises VPN device
...
### <a name="step-3---connect-two-on-premises-vpn-devices-to-the-active-active-vpn-gateway"></a>Step 3 - Connect two on-premises VPN devices to the active-active VPN gateway
...
#### <a name="1-create-the-second-local-network-gateway-for-site5"></a>1. Create the second local network gateway for Site5
...
#### <a name="2-connect-the-vnet-gateway-and-the-second-local-network-gateway"></a>2. Connect the VNet gateway and the second local network gateway
...
#### <a name="3-vpn-and-bgp-parameters-for-your-second-on-premises-vpn-device"></a>3. VPN and BGP parameters for your second on-premises VPN device
...
#### <a name="3-create-the-active-active-vpn-gateway-for-testvnet2"></a>3. Create the active-active VPN gateway for TestVNet2
...
### <a name="configure-an-active-standby-gateway-to-active-active-gateway"></a>Configure an active-standby gateway to active-active gateway
...
#### <a name="2-create-the-public-ip-address-then-add-the-second-gateway-ip-configuration"></a>2. Create the public IP address, then add the second gateway IP configuration

    $gwpip2     = New-AzureRmPublicIpAddress -Name $GWIPName2 -ResourceGroupName $RG -Location $location -AllocationMethod Dynamic
    Add-AzureRmVirtualNetworkGatewayIpConfig -VirtualNetworkGateway $gw -Name $GWIPconf2 -Subnet $subnet -PublicIpAddress $gwpip2 

#### <a name="3-enable-active-active-mode-and-update-the-gateway"></a>3. Enable active-active mode and update the gateway
...
### <a name="configure-an-active-active-gateway-to-active-standby-gateway"></a>Configure an active-active gateway to active-standby gateway
...
#### <a name="2-remove-the-gateway-ip-configuration-and-disable-the-active-active-mode"></a>2. Remove the gateway IP configuration and disable the active-active mode
