...
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-the-classic-portal"></a>Configure a Point-to-Site connection to a VNet using the classic portal
...
### <a name="part-2-create-a-dynamic-routing-gateway"></a>Part 2: Create a dynamic routing gateway
...
### <a name="part-1-create-the-vpn-client-configuration-package"></a>Part 1: Create the VPN client configuration package
...
### <a name="part-2-install-the-vpn-configuration-package-on-the-client"></a>Part 2: Install the VPN configuration package on the client
...
### <a name="part-3-connect-to-azure"></a>Part 3: Connect to Azure
...
### <a name="part-4-verify-the-vpn-connection"></a>Part 4: Verify the VPN connection
