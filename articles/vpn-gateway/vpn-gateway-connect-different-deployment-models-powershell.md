...
# <a name="connect-virtual-networks-from-different-deployment-models-using-powershell"></a>Connect virtual networks from different deployment models using PowerShell
...
### <a name="deployment-models-and-methods-for-connecting-vnets-in-different-deployment-models"></a>Deployment models and methods for connecting VNets in different deployment models
...
### <a name="part-1---download-your-network-configuration-file"></a>Part 1 - Download your network configuration file
...
### <a name="part-2--verify-the-gateway-subnet"></a>Part 2 -Verify the gateway subnet
...
### <a name="part-3---add-the-local-network-site"></a>Part 3 - Add the local network site
...
### <a name="part-4---associate-the-vnet-with-the-local-network-site"></a>Part 4 - Associate the VNet with the local network site
...
### <a name="part-5---save-the-file-and-upload"></a>Part 5 - Save the file and upload
...
### <a name="part-6---create-the-gateway"></a>Part 6 - Create the gateway 
...
## <a name="section-3-modify-the-local-network-for-the-classic-vnet"></a>Section 3: Modify the local network for the classic VNet
...
### <a name="to-modify-in-the-portal"></a>To modify in the portal
...
### <a name="to-modify-using-the-network-configuration-file"></a>To modify using the network configuration file
