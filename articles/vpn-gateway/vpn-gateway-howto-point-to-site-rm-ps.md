...
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-powershell"></a>Configure a Point-to-Site connection to a VNet using PowerShell
...
### <a name="add-a-trusted-root-certificate"></a>Add a trusted root certificate
...
### <a name="to-remove-a-trusted-root-certificate"></a>To remove a trusted root certificate
...
### <a name="revoke-a-client-certificate"></a>Revoke a client certificate
...
### <a name="reinstate-a-client-certificate"></a>Reinstate a client certificate
