...
# <a name="configure-forced-tunneling-using-the-classic-deployment-model"></a>Configure forced tunneling using the classic deployment model
...
## <a name="configure-forced-tunneling"></a>Configure forced tunneling
...
## <a name="additional-powershell-cmdlets"></a>Additional PowerShell cmdlets

### <a name="to-delete-a-route-table"></a>To delete a route table

    Remove-AzureRouteTable -Name <routeTableName>

### <a name="to-list-a-route-table"></a>To list a route table

    Get-AzureRouteTable [-Name <routeTableName> [-DetailLevel <detailLevel>]]

### <a name="to-delete-a-route-from-a-route-table"></a>To delete a route from a route table

    Remove-AzureRouteTable –Name <routeTableName>

### <a name="to-remove-a-route-from-a-subnet"></a>To remove a route from a subnet

    Remove-AzureSubnetRouteTable –VirtualNetworkName <virtualNetworkName> -SubnetName <subnetName>

### <a name="to-list-the-route-table-associated-with-a-subnet"></a>To list the route table associated with a subnet
    
    Get-AzureSubnetRouteTable -VirtualNetworkName <virtualNetworkName> -SubnetName <subnetName>

### <a name="to-remove-a-default-site-from-a-vnet-vpn-gateway"></a>To remove a default site from a VNet VPN gateway
