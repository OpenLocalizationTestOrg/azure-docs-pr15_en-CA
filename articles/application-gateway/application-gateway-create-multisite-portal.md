...
# <a name="configure-an-existing-application-gateway-for-hosting-multiple-web-applications"></a>Configure an existing application gateway for hosting multiple web applications
...
## <a name="create-back-end-pools-for-each-site"></a>Create back-end pools for each site
...
### <a name="create-listeners-for-each-back-end"></a>Create listeners for each back-end
...
### <a name="create-rules-to-map-listeners-to-backend-pools"></a>Create rules to map listeners to backend pools
