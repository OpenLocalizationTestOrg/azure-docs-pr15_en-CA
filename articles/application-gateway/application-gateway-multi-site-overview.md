...
# <a name="application-gateway-multiple-site-hosting"></a>Application Gateway multiple site hosting
...
## <a name="host-headers-and-server-name-indication-sni"></a>Host headers and Server Name Indication (SNI)
...
## <a name="routing-rule"></a>Routing rule
