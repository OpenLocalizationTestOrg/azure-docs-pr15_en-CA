...
# <a name="create-an-application-gateway-for-hosting-multiple-web-applications"></a>Create an application gateway for hosting multiple web applications
...
## <a name="create-a-virtual-network-and-subnets"></a>Create a virtual network and subnets
