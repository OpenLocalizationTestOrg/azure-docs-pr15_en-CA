...
# <a name="configure-ssl-policy-and-end-to-end-ssl-with-application-gateway-using-powershell"></a>Configure SSL Policy and end to end SSL with Application Gateway using PowerShell
...
## <a name="disable-ssl-protocol-versions-on-an-existing-application-gateway"></a>Disable SSL protocol versions on an existing Application Gateway
