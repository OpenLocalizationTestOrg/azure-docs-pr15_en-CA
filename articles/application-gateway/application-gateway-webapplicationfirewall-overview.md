...
## <a name="application-gateway-waf-reports"></a>Application Gateway WAF reports
...
## <a name="application-gateway-waf-sku-pricing"></a>Application Gateway WAF SKU pricing
