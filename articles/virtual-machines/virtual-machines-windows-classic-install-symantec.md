...
# <a name="how-to-install-and-configure-symantec-endpoint-protection-on-a-windows-vm"></a>How to install and configure Symantec Endpoint Protection on a Windows VM
...
## <a name="install-symantec-endpoint-protection-on-an-existing-vm"></a>Install Symantec Endpoint Protection on an existing VM
