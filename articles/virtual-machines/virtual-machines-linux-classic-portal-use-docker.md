...
# <a name="using-the-docker-vm-extension-with-the-azure-classic-portal"></a>Using the Docker VM Extension with the Azure classic portal
...
## <a name="create-a-new-vm-from-the-image-gallery"></a>Create a new VM from the Image Gallery
...
## <a name="create-docker-certificates"></a>Create Docker Certificates
...
## <a name="add-the-docker-vm-extension"></a>Add the Docker VM Extension
...
### <a name="add-an-extension"></a>Add an Extension
...
### <a name="select-the-docker-vm-extension"></a>Select the Docker VM Extension
...
### <a name="add-your-certificate-and-key-files"></a>Add your Certificate and Key Files:
...
## <a name="add-the-docker-communication-endpoint"></a>Add the Docker Communication Endpoint
...
## <a name="test-your-docker-client-and-azure-docker-host"></a>Test your Docker Client and Azure Docker Host
