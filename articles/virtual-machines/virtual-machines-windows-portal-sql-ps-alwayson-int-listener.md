...
## <a name="example-script-add-an-ip-address-to-an-existing-load-balancer-with-powershell"></a>Example script: Add an IP address to an existing load balancer with PowerShell
...
## <a name="1-create-the-availability-group-listener-on-the-failover-cluster"></a>1. Create the availability group listener on the failover cluster
