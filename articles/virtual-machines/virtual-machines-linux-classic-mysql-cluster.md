...
# <a name="using-load-balanced-sets-to-clusterize-mysql-on-linux"></a>Using load-balanced sets to clusterize MySQL on Linux
...
### <a name="tested-environment"></a>Tested environment
...
### <a name="affinity-group"></a>Affinity group
...
## <a name="setting-up-the-cluster"></a>Setting up the cluster
...
### <a name="setting-up-drbd"></a>Setting up DRBD
...
### <a name="mounting-the-drbd-resource"></a>Mounting the DRBD resource
...
## <a name="setting-up-mysql"></a>Setting up MySQL
...
### <a name="creating-the-mysql-load-balanced-set"></a>Creating the MySQL Load Balanced Set
...
### <a name="testing-the-load-balanced-set"></a>Testing the load balanced set
...
### <a name="manually-failing-over"></a>Manually failing over
...
## <a name="setting-up-corosync"></a>Setting up Corosync
...
## <a name="setting-up-pacemaker"></a>Setting up Pacemaker
