...
# <a name="create-ssh-keys-on-linux-and-mac-for-linux-vms-in-azure"></a>Create SSH keys on Linux and Mac for Linux VMs in Azure
...
## <a name="create-the-ssh-keys"></a>Create the SSH Keys
...
## <a name="using-ssh-keygen"></a>Using ssh-keygen
...
### <a name="using-pem-keys"></a>Using PEM keys
...
## <a name="example-of-ssh-keygen"></a>Example of ssh-keygen
...
## <a name="using-ssh-agent-to-store-your-private-key-password"></a>Using ssh-agent to store your private key password
...
## <a name="create-and-configure-an-ssh-config-file"></a>Create and configure an SSH config file
...
### <a name="create-the-file"></a>Create the file

```bash
touch ~/.ssh/config
```

### <a name="edit-the-file-to-add-the-new-ssh-configuration"></a>Edit the file to add the new SSH configuration:

```bash
vim ~/.ssh/config
```

### <a name="example-sshconfig-file"></a>Example `~/.ssh/config` file:
...
### <a name="config-file-explained"></a>Config file explained
...
## <a name="ssh-into-linux-without-a-password"></a>SSH into Linux without a password
...
### <a name="command-explained"></a>Command explained
