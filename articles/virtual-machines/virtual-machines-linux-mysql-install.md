...
#<a name="how-to-install-mysql-on-azure"></a>How to install MySQL on Azure
...
##<a name="install-mysql-on-your-virtual-machine"></a>Install MySQL on your virtual machine

> [AZURE.NOTE] You must already have a Microsoft Azure virtual machine running Linux in order to complete this tutorial. Please see the [Azure Linux VM tutorial](virtual-machines-linux-quick-create-cli.md) to create and set up a Linux VM with `mysqlnode` as the VM name and `azureuser` as user before proceeding.
...
###<a name="how-to-install-mysql56-on-ubuntu"></a>How to install MySQL5.6 on Ubuntu
...
###<a name="how-to-install-mysql-on-red-hat-os-family-like-centos-oracle-linux"></a>How to install MySQL on Red Hat OS family like CentOS, Oracle Linux
...
###<a name="how-to-install-mysql-on-suse-linux"></a>How to install MySQL on SUSE Linux
