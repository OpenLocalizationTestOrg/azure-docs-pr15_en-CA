...
# <a name="azure-and-linux"></a>Azure and Linux
...
## <a name="azure-virtual-machines--instances"></a>Azure Virtual Machines & Instances
...
## <a name="install-the-cli"></a>Install the CLI
...
## <a name="getting-started-with-linux-on-microsoft-azure"></a>Getting Started with Linux on Microsoft Azure
...
## <a name="create-a-vm-using-the-cli"></a>Create a VM using the CLI
...
## <a name="create-a-vm-in-the-portal"></a>Create a VM in the portal
...
## <a name="login-using-ssh-without-a-password"></a>Login using SSH without a password
...
## <a name="related-azure-components"></a>Related Azure components
