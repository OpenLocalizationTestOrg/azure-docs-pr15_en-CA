...
# <a name="resize-a-windows-vm-created-in-the-classic-deployment-model"></a>Resize a Windows VM created in the classic deployment model
...
## <a name="add-your-account"></a>Add your account
...
## <a name="resize-in-the-same-hardware-cluster"></a>Resize in the same hardware cluster
...
## <a name="resize-on-a-new-hardware-cluster"></a>Resize on a new hardware cluster
