...
## <a name="sql-server-images-available-in-azure-virtual-machine-gallery"></a>SQL Server Images Available in Azure Virtual Machine Gallery
...
### <a name="bi-features-installed-on-the-sql-server-virtual-machine-gallery-images"></a>BI Features Installed on the SQL Server Virtual Machine Gallery Images
...
## <a name="general-recommendations-and-best-practices"></a>General Recommendations and Best Practices
...
## <a name="example-deployment-topologies"></a>Example Deployment Topologies
...
### <a name="single-virtual-machine"></a>Single Virtual Machine
...
### <a name="mixed-azure--data-on-azure-sql-database"></a>Mixed Azure – data on Azure SQL database
...
### <a name="hybrid-data-on-premises"></a>Hybrid –data on-premises
...
## <a name="reporting-services-native-mode-configuration"></a>Reporting Services Native Mode Configuration
...
### <a name="browse-to-the-local-report-manager"></a>Browse to the local Report Manager
...
### <a name="to-connect-to-remote-web-portal-or-report-manager-for-2014-and-2012"></a>To Connect to Remote web portal, or Report Manager for 2014 and 2012
...
1. Browse to the web portal, or report manager, using Azure Virtual Machine **DNS Name** as the server name in the URL. For example:
    ...
    **Report server**: http://uebi.cloudapp.net/reportserver  **Web portal**: http://uebi.cloudapp.net/reports

    [Configure a Firewall for Report Server Access](https://msdn.microsoft.com/library/bb934283.aspx)

### <a name="to-create-and-publish-reports-to-the-azure-virtual-machine"></a>To Create and Publish Reports to the Azure Virtual Machine
...
## <a name="install-other-sql-server-services-and-features"></a>Install other SQL Server Services and features
...
### <a name="to-install-analysis-services-tabular-mode"></a>To Install Analysis Services Tabular Mode
...
### <a name="remote-access-to-analysis-services-server"></a>Remote Access to Analysis Services Server
...
### <a name="community-content"></a>Community Content
