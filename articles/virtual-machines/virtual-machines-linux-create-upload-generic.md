...
# <a name="information-for-non-endorsed-distributions"></a>Information for Non-Endorsed Distributions #
...
## <a name="general-linux-installation-notes"></a>General Linux Installation Notes ##
...
### <a name="installing-linux-without-hyper-v"></a>Installing Linux Without Hyper-V ###
...
### <a name="resizing-vhds"></a>Resizing VHDs ###
...
## <a name="the-azure-linux-agent"></a>The Azure Linux Agent ##
