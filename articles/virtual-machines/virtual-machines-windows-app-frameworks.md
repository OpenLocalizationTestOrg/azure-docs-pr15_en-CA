...
# <a name="deploy-popular-application-frameworks-using-azure-resource-manager-templates"></a>Deploy popular application frameworks using Azure Resource Manager templates
