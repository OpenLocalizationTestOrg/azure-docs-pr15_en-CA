...
#<a name="deploy-a-lamp-app-using-the-azure-customscript-extension-for-linux"></a>Deploy a LAMP app using the Azure CustomScript Extension for Linux#
...
## <a name="upload-a-script"></a>Upload a script
...
### <a name="script-overview"></a>Script overview
...
### <a name="upload-script"></a>Upload script
...
## <a name="deploy-the-extension"></a>Deploy the extension
