...
# <a name="configure-always-on-availability-group-in-azure-vm---classic"></a>Configure Always On availability group in Azure VM - Classic
...
## <a name="create-the-virtual-network-and-domain-controller-server"></a>Create the Virtual Network and Domain Controller Server
...
## <a name="configure-domain-accounts"></a>Configure Domain Accounts
...
## <a name="create-the-sql-server-vms"></a>Create the SQL Server VMs
...
### <a name="add-the-corpinstall-user-as-an-administrator-on-each-vm"></a>Add the Corp\Install user as an administrator on each VM:
...
### <a name="add-the-failover-clustering-feature-to-each-vm"></a>Add the **Failover Clustering** feature to each VM.
...
## <a name="create-the-wsfc-cluster"></a>Create the WSFC Cluster
...
## <a name="prepare-the-sql-server-instances-for-availability-group"></a>Prepare the SQL Server Instances for Availability Group
...
## <a name="create-the-availability-group"></a>Create the Availability Group
...
### <a name="create-the-mydb1-database-on-contososql1"></a>Create the MyDB1 database on ContosoSQL1:
...
### <a name="take-a-full-backup-of-mydb1-and-restore-it-on-contososql2"></a>Take a full backup of MyDB1 and restore it on ContosoSQL2:
