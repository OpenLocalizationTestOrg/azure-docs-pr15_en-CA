...
# <a name="options-with-hpc-pack-to-create-and-manage-a-windows-hpc-cluster-in-azure"></a>Options with HPC Pack to create and manage a Windows HPC cluster in Azure
...
### <a name="manual-deployment-with-the-azure-portal"></a>Manual deployment with the Azure portal
...
## <a name="add-worker-role-nodes-to-an-hpc-pack-cluster"></a>Add worker role nodes to an HPC Pack cluster
...
## <a name="integrate-with-azure-batch"></a>Integrate with Azure Batch 
