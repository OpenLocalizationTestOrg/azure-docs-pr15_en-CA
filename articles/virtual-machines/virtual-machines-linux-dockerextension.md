...
# <a name="create-a-docker-environment-in-azure-using-the-docker-vm-extension"></a>Create a Docker environment in Azure using the Docker VM extension
...
## <a name="azure-docker-vm-extension-overview"></a>Azure Docker VM extension overview
...
## <a name="deploy-a-template-with-the-azure-docker-vm-extension"></a>Deploy a template with the Azure Docker VM extension
...
## <a name="deploy-your-first-nginx-container"></a>Deploy your first nginx container
...
## <a name="azure-docker-vm-extension-template-reference"></a>Azure Docker VM extension template reference
