...
# <a name="linux-vm-extension-configuration-samples"></a>Linux VM extension configuration samples
...
### <a name="vm-access-extension-password-reset"></a>VM Access Extension (Password Reset)
...
### <a name="os-patching"></a>OS Patching
...
### <a name="docker-extension"></a>Docker Extension
