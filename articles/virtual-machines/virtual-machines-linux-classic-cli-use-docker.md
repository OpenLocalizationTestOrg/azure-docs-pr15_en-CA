...
# <a name="using-the-docker-vm-extension-from-the-azure-command-line-interface-azure-cli"></a>Using the Docker VM Extension from the Azure Command-line Interface (Azure CLI)
...
### <a name="install-the-azure-command-line-interface-azure-cli"></a>Install the Azure Command-Line Interface (Azure CLI)
...
### <a name="connect-the-azure-cli-to-to-your-azure-account"></a>Connect the Azure CLI to to your Azure Account
...
### <a name="install-docker-and-use-the-docker-vm-extension-for-azure"></a>Install Docker and use the Docker VM Extension for Azure
...
### <a name="using-the-azure-image-gallery"></a>Using the Azure Image Gallery
...
### <a name="docker-host-vm-authentication"></a>Docker Host VM Authentication
