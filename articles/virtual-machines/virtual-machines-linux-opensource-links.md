...
# <a name="linux-and-open-source-computing-on-azure"></a>Linux and open-source computing on Azure
...
## <a name="general-links"></a>General Links
...
- [Quickstart template: Spin up a SLURM cluster](https://github.com/Azure/azure-quickstart-templates/tree/master/slurm) (and [blog post](http://blogs.technet.com/b/windowshpc/archive/2015/06/06/deploy-a-slurm-cluster-on-azure.aspx))
...
### <a name="devops-management-and-optimization"></a>Devops, management, and optimization
