...
#<a name="miscellaneous-considerations-for-oracle-virtual-machine-images"></a>Miscellaneous considerations for Oracle virtual machine images
...
##<a name="oracle-database-virtual-machine-images"></a>Oracle Database virtual machine images
### <a name="clustering-rac-is-not-supported"></a>Clustering (RAC) is not supported
...
### <a name="no-static-internal-ip"></a>No static internal IP
...
### <a name="attached-disk-configuration-options"></a>Attached disk configuration options
...
### <a name="high-availability-and-disaster-recovery-considerations"></a>High availability and disaster recovery considerations
...
##<a name="oracle-weblogic-server-virtual-machine-images"></a>Oracle WebLogic Server virtual machine images
...
##<a name="oracle-jdk-virtual-machine-images"></a>Oracle JDK virtual machine images
