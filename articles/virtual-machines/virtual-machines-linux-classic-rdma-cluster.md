...
# <a name="set-up-a-linux-rdma-cluster-to-run-mpi-applications"></a>Set up a Linux RDMA cluster to run MPI applications
...
## <a name="cluster-deployment-options"></a>Cluster deployment options
...
## <a name="sample-deployment-steps-in-classic-model"></a>Sample deployment steps in classic model
...
### <a name="step-1-provision-a-sles-12-sp1-hpc-vm"></a>Step 1. Provision a SLES 12 SP1 HPC VM
...
### <a name="step-2-customize-the-vm"></a>Step 2. Customize the VM
...
### <a name="step-3-capture-the-image"></a>Step 3. Capture the image
...
### <a name="step-4-deploy-a-cluster-with-the-image"></a>Step 4. Deploy a cluster with the image
...
## <a name="considerations-for-a-centos-hpc-cluster"></a>Considerations for a CentOS HPC cluster
...
### <a name="set-up-passwordless-ssh-trust-on-the-cluster"></a>Set up passwordless SSH trust on the cluster
...
## <a name="configure-intel-mpi"></a>Configure Intel MPI
...
## <a name="run-mpi-on-a-basic-two-node-cluster"></a>Run MPI on a basic two-node cluster
...
### <a name="run-a-simple-mpi-command"></a>Run a simple MPI command
...
### <a name="run-an-mpi-benchmark"></a>Run an MPI benchmark
