...
# <a name="create-and-upload-a-freebsd-vhd-to-azure"></a>Create and upload a FreeBSD VHD to Azure
...
## <a name="step-1-prepare-the-image-for-upload"></a>Step 1: Prepare the image for upload
...
## <a name="step-2-create-a-storage-account-in-azure"></a>Step 2: Create a storage account in Azure ##
...
## <a name="step-3-prepare-the-connection-to-azure"></a>Step 3: Prepare the connection to Azure
...
### <a name="use-the-azure-ad-method-to-upload-a-vhd-file"></a>Use the Azure AD method to upload a .vhd file
...
### <a name="use-the-certificate-method-to-upload-a-vhd-file"></a>Use the certificate method to upload a .vhd file
...
4. Type:  `Import-AzurePublishSettingsFile <PathToFile>`, where `<PathToFile>` is the full path to the .publishsettings file.
...
## <a name="step-4-upload-the-vhd-file"></a>Step 4: Upload the .vhd file
...
## <a name="step-5-create-a-vm-with-the-uploaded-vhd-file"></a>Step 5: Create a VM with the uploaded .vhd file
