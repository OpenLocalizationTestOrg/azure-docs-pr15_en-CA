...
### <a name="example-cloud-init-script-named-cloudconfighostnametxt"></a>Example cloud-init script named `cloud_config_hostname.txt`.
...
### <a name="example-cloud-init-script-cloudconfigaptupgradetxt-for-the-debian-family"></a>Example cloud-init script `cloud_config_apt_upgrade.txt` for the Debian Family
...
### <a name="example-cloud-init-script-cloudconfigadduserstxt-for-debian-family"></a>Example cloud-init script `cloud_config_add_users.txt` for Debian Family
