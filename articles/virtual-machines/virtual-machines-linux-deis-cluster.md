...
# <a name="deploy-a-3-node-deis-cluster"></a>Deploy a 3-node Deis cluster
...
## <a name="provision-the-cluster"></a>Provision the cluster
...
## <a name="install-the-client"></a>Install the client
...
## <a name="install-and-start-the-deis-platform"></a>Install and start the Deis platform
...
## <a name="deploy-and-scale-a-hello-world-application"></a>Deploy and scale a Hello World application
