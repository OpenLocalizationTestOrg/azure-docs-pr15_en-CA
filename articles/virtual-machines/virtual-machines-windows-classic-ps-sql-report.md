...
# <a name="use-powershell-to-create-an-azure-vm-with-a-native-mode-report-server"></a>Use PowerShell to Create an Azure VM With a Native Mode Report Server
...
## <a name="prerequisites-and-assumptions"></a>Prerequisites and Assumptions
...
## <a name="step-1-provision-an-azure-virtual-machine"></a>Step 1: Provision an Azure Virtual Machine
...
## <a name="step-2-create-a-server-certificate"></a>Step 2: Create a Server Certificate
...
### <a name="to-use-a-certificate-created-by-a-trusted-certificate-authority-ca"></a>To use a certificate created by a trusted Certificate Authority (CA)
...
## <a name="step-3-configure-the-report-server"></a>Step 3: Configure the Report Server
...
### <a name="use-script-to-configure-the-report-server-and-http"></a>Use script to configure the report server and HTTP
...
### <a name="use-configuration-manager-to-configure-the-report-server"></a>Use Configuration Manager to Configure the Report Server
...
## <a name="step-4-open-windows-firewall-port"></a>Step 4: Open Windows Firewall Port
...
## <a name="create-users-and-assign-roles"></a>Create Users and Assign Roles
...
## <a name="minimize-cost-if-you-are-not-using-the-vm"></a>Minimize cost if you are not using the VM
...
### <a name="links-to-other-resources-for-sql-server-in-azure-vms"></a>Links to other resources for SQL Server in Azure VMs
