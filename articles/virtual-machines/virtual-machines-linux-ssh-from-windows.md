...
# <a name="how-to-use-ssh-keys-with-windows-on-azure"></a>How to Use SSH keys with Windows on Azure
...
## <a name="overview-of-ssh-and-keys"></a>Overview of SSH and keys
...
## <a name="windows-packages-and-ssh-clients"></a>Windows packages and SSH clients
...
## <a name="use-putty-to-ssh-to-a-linux-machine"></a>Use Putty to SSH to a Linux Machine
