...
# <a name="deploy-azure-resources-using-c"></a>Deploy Azure Resources using C# 
...
## <a name="step-1-create-a-visual-studio-project-and-install-the-libraries"></a>Step 1: Create a Visual Studio project and install the libraries
...
## <a name="step-2-create-the-credentials-that-are-used-to-authenticate-requests"></a>Step 2: Create the credentials that are used to authenticate requests
...
## <a name="step-3-register-the-resource-providers-and-create-the-resources"></a>Step 3: Register the resource providers and create the resources

### <a name="register-the-providers-and-create-a-resource-group"></a>Register the providers and create a resource group
...
##<a name="step-4-delete-the-resources"></a>Step 4: Delete the resources
...
## <a name="step-5-run-the-console-application"></a>Step 5: Run the console application
