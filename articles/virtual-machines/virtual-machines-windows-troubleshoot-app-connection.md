...
# <a name="troubleshoot-access-to-an-application-running-on-an-azure-virtual-machine"></a>Troubleshoot access to an application running on an Azure virtual machine
