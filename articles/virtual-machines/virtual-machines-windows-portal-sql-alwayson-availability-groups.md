...
# <a name="configure-always-on-availability-group-in-azure-vm-automatically---resource-manager"></a>Configure Always On availability group in Azure VM automatically - Resource Manager
...
## <a name="provision-the-cluster-from-the-gallery"></a>Provision the cluster from the gallery
...
### <a name="domain-and-network-settings"></a>Domain and network settings
...
###<a name="availability-group-settings"></a>availability group settings
...
###<a name="vm-size-storage-settings"></a>VM size, storage settings
...
####<a name="a-note-about-storage"></a>A note about storage
...
For more information about SQL Server configuration best practices, see [Performance best practices for SQL Server in Azure virtual machines](virtual-machines-windows-sql-performance.md)


###<a name="sql-server-settings"></a>SQL Server settings
