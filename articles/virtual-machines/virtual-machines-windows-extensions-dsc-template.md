...
# <a name="windows-vmss-and-desired-state-configuration-with-azure-resource-manager-templates"></a>Windows VMSS and Desired State Configuration with Azure Resource Manager templates
...
## <a name="template-example-for-a-windows-vm"></a>Template example for a Windows VM
...
## <a name="template-example-for-windows-vmss"></a>Template example for Windows VMSS
...
## <a name="detailed-settings-information"></a>Detailed Settings Information
...
This example uses Resource Manager templates instead of cmdlets to deploy the extension. Save the "IisInstall.ps1" configuration, place it in a . ZIP file, and upload the file in an accessible URL. This example uses Azure blob storage, but it is possible to download . ZIP files from any arbitrary location.
...
## <a name="updating-from-the-previous-format"></a>Updating from the Previous Format
...
## <a name="troubleshooting---error-code-1100"></a>Troubleshooting - Error Code 1100
...
### <a name="invalid-values"></a>Invalid Values
...
### <a name="invalid-url"></a>Invalid URL
...
### <a name="invalid-configurationargument-type"></a>Invalid ConfigurationArgument Type
...
### <a name="missing-properties"></a>Missing Properties
