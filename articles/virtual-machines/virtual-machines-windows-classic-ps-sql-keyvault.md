...
# <a name="configure-azure-key-vault-integration-for-sql-server-on-azure-vms-classic"></a>Configure Azure Key Vault Integration for SQL Server on Azure VMs (Classic)
...
## <a name="configure-akv-integration"></a>Configure AKV Integration
...
### <a name="install-the-sql-server-iaas-extension"></a>Install the SQL Server IaaS Extension

First, [install the SQL Server IaaS Extension](virtual-machines-windows-classic-sql-server-agent-extension.md).

### <a name="understand-the-input-parameters"></a>Understand the input parameters
...
### <a name="enable-akv-integration-with-powershell"></a>Enable AKV Integration with PowerShell
