...
# <a name="deploy-an-azure-virtual-machine-using-c-and-a-resource-manager-template"></a>Deploy an Azure Virtual Machine using C# and a Resource Manager template
...
## <a name="step-1-create-the-visual-studio-project-the-template-file-and-the-parameters-file"></a>Step 1: Create the Visual Studio project, the template file, and the parameters file

### <a name="create-the-template-file"></a>Create the template file
...
### <a name="create-the-parameters-file"></a>Create the parameters file
...
## <a name="step-2-install-the-libraries"></a>Step 2: Install the libraries
...
## <a name="step-3-create-the-credentials-that-are-used-to-authenticate-requests"></a>Step 3: Create the credentials that are used to authenticate requests
...
## <a name="step-4-deploy-the-template"></a>Step 4: Deploy the template
...
## <a name="step-5-delete-the-resources"></a>Step 5: Delete the resources
...
##<a name="step-6-run-the-console-application"></a>Step 6: Run the console application
