...
# <a name="how-to-tag-a-windows-virtual-machine-in-azure"></a>How to tag a Windows virtual machine in Azure
...
## <a name="tagging-with-powershell"></a>Tagging with PowerShell
