...
# <a name="availability-and-scale-in-azure-resource-manager-templates"></a>Availability and scale in Azure Resource Manager templates
...
## <a name="network-load-balancer"></a>Network Load Balancer
...
## <a name="load-balancer-rule"></a>Load Balancer Rule
...
## <a name="load-balancer-probe"></a>Load Balancer Probe
...
## <a name="inbound-nat-rules"></a>Inbound NAT Rules
...
## <a name="deploy-multiple-vms"></a>Deploy multiple VMs
