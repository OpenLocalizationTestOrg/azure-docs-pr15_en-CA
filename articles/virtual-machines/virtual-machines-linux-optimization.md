...
## <a name="io-scheduling-algorithm-for-premium-storage"></a>I/O scheduling algorithm for Premium Storage
...
### <a name="view-the-current-io-scheduler"></a>View the current I/O scheduler
...
###<a name="change-the-current-device-devsda-of-io-scheduling-algorithm"></a>Change the current device (/dev/sda) of I/O scheduling algorithm
...
## <a name="using-software-raid-to-achieve-higher-iops"></a>Using Software RAID to achieve higher I/Ops
