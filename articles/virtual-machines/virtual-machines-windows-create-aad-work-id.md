...
# <a name="creating-a-work-or-school-identity-in-azure-active-directory-to-use-with-windows-vms"></a>Creating a Work or School identity in Azure Active Directory to use with Windows VMs
