...
# <a name="create-a-windows-virtual-machine-with-a-resource-manager-template"></a>Create a Windows virtual machine with a Resource Manager template
...
## <a name="step-1-create-the-template-file"></a>Step 1: Create the template file
...
## <a name="step-2-create-the-parameters-file"></a>Step 2: Create the parameters file
...
## <a name="step-3-install-azure-powershell"></a>Step 3: Install Azure PowerShell
...
## <a name="step-4-create-a-resource-group"></a>Step 4: Create a resource group
...
## <a name="step-5-create-the-resources-with-the-template-and-parameters"></a>Step 5: Create the resources with the template and parameters
