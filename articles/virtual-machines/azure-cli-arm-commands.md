...
# <a name="azure-cli-commands-in-resource-manager-mode"></a>Azure CLI commands in Resource Manager mode
...
## <a name="setting-the-resource-manager-mode"></a>Setting the Resource Manager mode
...
## <a name="azure-account-manage-your-account-information"></a>azure account: Manage your account information
...
## <a name="azure-ad-commands-to-display-active-directory-objects"></a>azure ad: Commands to display Active Directory objects
...
## <a name="azure-config-commands-to-manage-your-local-settings"></a>azure config: commands to manage your local settings
...
## <a name="azure-feature-commands-to-manage-account-features"></a>azure feature: commands to manage account features
...
## <a name="azure-group-commands-to-manage-your-resource-groups"></a>azure group: Commands to manage your resource groups
...
## <a name="azure-hdinsight-commands-to-manage-your-hdinsight-clusters"></a>azure hdinsight: Commands to manage your HDInsight clusters
...
## <a name="azure-insights-commands-related-to-monitoring-insights-events-alert-rules-autoscale-settings-metrics"></a>azure insights: Commands related to monitoring Insights (events, alert rules, autoscale settings, metrics)

**Retrieve operation logs for a subscription, a correlationId, a resource group, resource, or resource provider**

    insights logs list [options]

## <a name="azure-location-commands-to-get-the-available-locations-for-all-resource-types"></a>azure location: Commands to get the available locations for all resource types
...
<br>
network public-ip list [options] <resource-group> Lists all public IP resources within a resource group.
...
## <a name="azure-provider-commands-to-manage-resource-provider-registrations"></a>azure provider: Commands to manage resource provider registrations
...
## <a name="azure-resource-commands-to-manage-your-resources"></a>azure resource: Commands to manage your resources
...
## <a name="azure-role-commands-to-manage-your-azure-roles"></a>azure role: Commands to manage your Azure roles
...
## <a name="azure-tag-commands-to-manage-your-resource-manager-tag"></a>azure tag: Commands to manage your resource manager tag
