...
# <a name="how-to-update-the-azure-linux-agent-on-a-vm-to-the-latest-version-from-github"></a>How to update the Azure Linux Agent on a VM to the latest version from GitHub
...
## <a name="install-wget"></a>Install wget
...
## <a name="download-the-latest-version"></a>Download the latest version
...
### <a name="for-version-20x-type"></a>For version 2.0.x, type:
...
### <a name="for-version-21x-or-later-type"></a>For version 2.1.x or later, type:
...
## <a name="install-the-azure-linux-agent"></a>Install the Azure Linux Agent

### <a name="for-version-20x-use"></a>For version 2.0.x, use:
...
### <a name="for-version-21x-use"></a>For version 2.1.x, use:

You may need to install the package `setuptools` first--see [here](https://pypi.python.org/pypi/setuptools). Then run:

    #sudo python setup.py install

## <a name="restart-the-waagent-service"></a>Restart the waagent service
...
## <a name="confirm-the-azure-linux-agent-version"></a>Confirm the Azure Linux Agent version
