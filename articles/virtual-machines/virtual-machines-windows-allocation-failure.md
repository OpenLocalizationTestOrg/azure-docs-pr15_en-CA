...
# <a name="troubleshoot-allocation-failures-when-you-create-restart-or-resize-windows-vms-in-azure"></a>Troubleshoot allocation failures when you create, restart, or resize Windows VMs in Azure
