...
# <a name="how-to-run-a-java-application-server-on-a-virtual-machine-created-with-the-classic-deployment-model"></a>How to run a Java application server on a virtual machine created with the classic deployment model
...
## <a name="to-remotely-sign-in-to-your-virtual-machine"></a>To remotely sign in to your virtual machine
...
## <a name="to-install-a-java-application-server-on-your-virtual-machine"></a>To install a Java application server on your virtual machine
...
## <a name="to-start-tomcat"></a>To start Tomcat
...
## <a name="to-create-an-endpoint-for-your-virtual-machine"></a>To create an endpoint for your virtual machine
1. Sign in to the [Azure classic portal](https://manage.windowsazure.com).
2. Click **Virtual machines**.
...
## <a name="to-open-a-port-in-the-firewall-for-your-virtual-machine"></a>To open a port in the firewall for your virtual machine
...
## <a name="application-lifecycle-considerations"></a>Application lifecycle considerations
