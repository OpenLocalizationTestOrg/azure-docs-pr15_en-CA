...
# <a name="creating-and-uploading-a-virtual-hard-disk-that-contains-the-linux-operating-system"></a>Creating and Uploading a Virtual Hard Disk that Contains the Linux Operating System
...
<a id="prepimage"> </a>
## <a name="step-1-prepare-the-image-to-be-uploaded"></a>Step 1: Prepare the image to be uploaded
...
<a id="connect"> </a>
## <a name="step-2-prepare-the-connection-to-azure"></a>Step 2: Prepare the connection to Azure
...
<a id="upload"> </a>
## <a name="step-3-upload-the-image-to-azure"></a>Step 3: Upload the image to Azure
...
## <a name="step-4-create-a-vm-from-the-image"></a>Step 4: Create a VM from the image
