<properties
    pageTitle="Specific RDP error messages for Azure VMs | Microsoft Azure"
...
# <a name="troubleshooting-specific-rdp-error-messages-to-a-windows-vm-in-azure"></a>Troubleshooting specific RDP error messages to a Windows VM in Azure
...
<a id="rdplicense"></a>
## <a name="the-remote-session-was-disconnected-because-there-are-no-remote-desktop-license-servers-available-to-provide-a-license"></a>The remote session was disconnected because there are no Remote Desktop License Servers available to provide a license.
...
<a id="rdpname"></a>
## <a name="remote-desktop-cant-find-the-computer-name"></a>Remote Desktop can't find the computer "name".
...
<a id="rdpauth"></a>
## <a name="an-authentication-error-has-occurred-the-local-security-authority-cannot-be-contacted"></a>An authentication error has occurred. The Local Security Authority cannot be contacted.
...
<a id="wincred"></a>
## <a name="windows-security-error-your-credentials-did-not-work"></a>Windows Security error: Your credentials did not work.
...
<a id="rdpconnect"></a>
## <a name="this-computer-cant-connect-to-the-remote-computer"></a>This computer can't connect to the remote computer.
