...
# <a name="upload-and-create-a-linux-vm-from-custom-disk-image"></a>Upload and create a Linux VM from custom disk image
...
<a id="prepimage"> </a>
## <a name="prepare-the-image-to-be-uploaded"></a>Prepare the image to be uploaded
...
## <a name="list-storage-account-keys"></a>List storage account keys
...
## <a name="create-a-storage-container"></a>Create a storage container
...
## <a name="create-vm-from-custom-image"></a>Create VM from custom image
...
### <a name="create-a-vm-using-the-azure-cli"></a>Create a VM using the Azure CLI
...
### <a name="create-a-vm-using-a-json-template"></a>Create a VM using a JSON template
