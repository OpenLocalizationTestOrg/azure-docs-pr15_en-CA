...
## <a name="change-the-drive-letters"></a>Change the drive letters 
...
## <a name="move-pagefilesys-back-to-the-temporary-storage-drive"></a>Move pagefile.sys back to the temporary storage drive 
