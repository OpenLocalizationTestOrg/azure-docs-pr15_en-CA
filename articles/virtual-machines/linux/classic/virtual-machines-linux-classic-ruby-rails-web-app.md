...
# <a name="ruby-on-rails-web-application-on-an-azure-vm"></a>Ruby on Rails Web application on an Azure VM
...
## <a name="create-an-azure-vm"></a>Create an Azure VM
...
## <a name="install-ruby-on-rails"></a>Install Ruby on Rails
...
## <a name="create-and-run-an-app"></a>Create and run an app
