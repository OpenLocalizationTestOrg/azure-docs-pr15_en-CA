...
# <a name="application-deployment-with-azure-resource-manager-templates"></a>Application deployment with Azure Resource Manager templates
...
## <a name="configuration-script"></a>Configuration script
...
## <a name="vm-script-extension"></a>VM Script Extension
