...
## <a name="install-mpi-and-openfoam"></a>Install MPI and OpenFOAM
...
### <a name="install-intel-mpi"></a>Install Intel MPI
...
### <a name="configure-mpi"></a>Configure MPI
...
### <a name="compile-and-install-openfoam"></a>Compile and install OpenFOAM
...
## <a name="prepare-to-run-an-openfoam-job"></a>Prepare to run an OpenFOAM job

Now get ready to run an MPI job called sloshingTank3D, which is one of the OpenFoam samples, on two Linux nodes. 

### <a name="set-up-the-runtime-environment"></a>Set up the runtime environment
...
### <a name="host-file-for-mpirun"></a>Host file for mpirun
...
## <a name="submit-an-openfoam-job"></a>Submit an OpenFOAM job
...
### <a name="sample-credxml-file"></a>Sample cred.xml file
...
```
### <a name="sample-silentcfg-file-to-install-mpi"></a>Sample silent.cfg file to install MPI
...
###<a name="sample-hpcimpirunsh-script"></a>Sample hpcimpirun.sh script
