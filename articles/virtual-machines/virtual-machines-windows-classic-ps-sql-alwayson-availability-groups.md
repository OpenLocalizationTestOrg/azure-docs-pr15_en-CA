...
# <a name="configure-always-on-availability-group-in-azure-vm-with-powershell"></a>Configure Always On availability group in Azure VM with PowerShell
...
## <a name="connect-to-your-azure-subscription-and-create-the-virtual-network"></a>Connect to Your Azure Subscription and Create the Virtual Network
...
## <a name="initialize-the-wsfc-cluster-vms"></a>Initialize the WSFC Cluster VMs
...
## <a name="configure-the-availability-group"></a>Configure the Availability Group
