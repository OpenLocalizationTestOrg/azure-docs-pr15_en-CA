...
#### <a name="ma-moving-averagehttpswwwotextsorgfpp62"></a>[**MA (Moving Average)**](https://www.otexts.org/fpp/6/2)
...
#### <a name="ets-exponential-smoothinghttpswwwotextsorgfpp75"></a>[**ETS (Exponential Smoothing)**](https://www.otexts.org/fpp/7/5)
