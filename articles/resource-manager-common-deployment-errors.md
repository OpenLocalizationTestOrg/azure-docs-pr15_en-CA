...
## <a name="invalid-template"></a>Invalid template
...
### <a name="copy-index-is-not-expected"></a>Copy index is not expected
...
### <a name="parameter-is-not-valid"></a>Parameter is not valid
...
## <a name="not-found-or-resource-not-found"></a>Not found (or resource not found)
...
## <a name="storage-account-already-exists-or-already-taken"></a>Storage account already exists (or already taken)
...
## <a name="account-name-invalid"></a>Account name invalid
...
## <a name="operation-not-allowed"></a>Operation not allowed
...
## <a name="invalid-content-link"></a>Invalid content link
