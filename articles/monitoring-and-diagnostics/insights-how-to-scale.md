...
# <a name="scale-instance-count-manually-or-automatically"></a>Scale instance count manually or automatically
...
## <a name="scaling-manually"></a>Scaling manually
...
## <a name="scaling-based-on-a-pre-set-metric"></a>Scaling based on a pre-set metric
...
## <a name="scale-based-on-other-metrics"></a>Scale based on other metrics
...
### <a name="adding-or-changing-a-rule"></a>Adding or changing a rule

1. Choose the **schedule and performance rules** in the **Scale by** dropdown: ![Performance rules](./media/insights-how-to-scale/Insights_PerformanceRules.png)
...
### <a name="scaling-with-multiple-steps"></a>Scaling with multiple steps
...
## <a name="scale-based-on-a-schedule"></a>Scale based on a schedule
