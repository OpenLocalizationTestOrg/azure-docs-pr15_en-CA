...
# <a name="overview-of-azure-diagnostic-logs"></a>Overview of Azure Diagnostic Logs
...
## <a name="what-you-can-do-with-diagnostic-logs"></a>What you can do with Diagnostic Logs
...
## <a name="how-to-enable-collection-of-diagnostic-logs"></a>How to enable collection of Diagnostic Logs
...
### <a name="enable-diagnostic-logs-in-the-portal"></a>Enable Diagnostic Logs in the portal
...
### <a name="enable-diagnostic-logs-via-powershell"></a>Enable Diagnostic Logs via PowerShell
...
### <a name="enable-diagnostic-logs-via-cli"></a>Enable Diagnostic Logs via CLI
...
### <a name="enable-diagnostic-logs-via-rest-api"></a>Enable Diagnostic Logs via REST API
...
## <a name="manage-diagnostic-settings-in-the-portal"></a>Manage Diagnostic Settings in the portal
...
## <a name="supported-services-and-schema-for-diagnostic-logs"></a>Supported services and schema for Diagnostic Logs
...
## <a name="supported-log-categories-per-resource-type"></a>Supported log categories per resource type
