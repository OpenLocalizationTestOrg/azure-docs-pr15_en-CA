...
## <a name="authenticating-azure-monitor-requests"></a>Authenticating Azure Monitor Requests
...
## <a name="retrieve-metric-definitions"></a>Retrieve Metric Definitions
...
## <a name="retrieve-metric-values"></a>Retrieve Metric Values
...
## <a name="retrieve-the-resource-id"></a>Retrieve the Resource ID
...
## <a name="retrieve-activity-log-data"></a>Retrieve Activity Log Data
