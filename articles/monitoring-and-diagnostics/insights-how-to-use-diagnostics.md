...
# <a name="enable-monitoring-and-diagnostics"></a>Enable monitoring and diagnostics
...
## <a name="when-you-create-a-resource"></a>When you create a resource
...
## <a name="change-settings-for-an-existing-resource"></a>Change settings for an existing resource
...
### <a name="categories-of-data-collection-for-virtual-machines"></a>Categories of data collection for virtual machines
