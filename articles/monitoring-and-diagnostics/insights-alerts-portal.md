...
# <a name="use-azure-portal-to-create-alerts-for-azure-services"></a>Use Azure portal to create alerts for Azure services
...
## <a name="create-an-alert-rule-on-a-metric-with-the-azure-portal"></a>Create an alert rule on a metric with the Azure portal
