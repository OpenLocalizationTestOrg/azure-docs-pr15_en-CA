...
# <a name="create-a-metric-alert-with-a-resource-manager-template"></a>Create a metric alert with a Resource Manager template
...
## <a name="resource-manager-template-for-a-metric-alert"></a>Resource Manager template for a metric alert
...
## <a name="resource-manager-template-for-a-resource-with-an-alert"></a>Resource Manager template for a resource with an alert
