...
# <a name="automatically-enable-diagnostic-settings-at-resource-creation-using-a-resource-manager-template"></a>Automatically enable Diagnostic Settings at resource creation using a Resource Manager template
...
## <a name="non-compute-resource-template"></a>Non-Compute resource template
...
## <a name="compute-resource-template"></a>Compute resource template
