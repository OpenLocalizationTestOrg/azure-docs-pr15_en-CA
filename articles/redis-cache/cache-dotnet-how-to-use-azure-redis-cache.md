...
# <a name="how-to-use-azure-redis-cache"></a>How to Use Azure Redis Cache
...
## <a name="get-started-with-azure-redis-cache"></a>Get Started with Azure Redis Cache
...
### <a name="to-access-your-cache-after-its-created"></a>To access your cache after it's created
...
<a name="add-object"></a>
## <a name="add-and-retrieve-objects-from-the-cache"></a>Add and retrieve objects from the cache
...
## <a name="work-with-net-objects-in-the-cache"></a>Work with .NET objects in the cache
