...
# <a name="how-to-monitor-azure-redis-cache"></a>How to monitor Azure Redis Cache
...
## <a name="enable-cache-diagnostics"></a>Enable cache diagnostics
...
## <a name="how-to-monitor-a-premium-cache-with-clustering"></a>How to monitor a premium cache with clustering
...
## <a name="metrics-on-the-redis-cache-blade"></a>Metrics on the Redis Cache blade
