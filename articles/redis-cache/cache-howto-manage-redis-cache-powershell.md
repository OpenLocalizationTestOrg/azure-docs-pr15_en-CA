...
# <a name="manage-azure-redis-cache-with-azure-powershell"></a>Manage Azure Redis Cache with Azure PowerShell
...
### <a name="how-to-connect-to-azure-government-cloud-or-azure-china-cloud"></a>How to connect to Azure Government Cloud or Azure China Cloud
...
### <a name="to-connect-to-the-azure-government-cloud"></a>To connect to the Azure Government Cloud
...
### <a name="to-connect-to-the-azure-china-cloud"></a>To connect to the Azure China Cloud
...
### <a name="properties-used-for-azure-redis-cache-powershell"></a>Properties used for Azure Redis Cache PowerShell
...
<a name="databases"></a>
## <a name="to-configure-the-databases-setting-during-cache-creation"></a>To configure the databases setting during cache creation
...
## <a name="to-update-a-redis-cache"></a>To update a Redis cache
...
<a name="scale"></a>
## <a name="to-scale-a-redis-cache"></a>To scale a Redis cache
...
## <a name="to-get-information-about-a-redis-cache"></a>To get information about a Redis cache
...
## <a name="to-retrieve-the-access-keys-for-a-redis-cache"></a>To retrieve the access keys for a Redis cache
...
## <a name="to-regenerate-access-keys-for-your-redis-cache"></a>To regenerate access keys for your Redis cache
...
## <a name="to-delete-a-redis-cache"></a>To delete a Redis cache
