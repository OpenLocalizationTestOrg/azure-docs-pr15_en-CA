...
# <a name="how-to-create-a-web-app-with-redis-cache"></a>How to create a Web App with Redis Cache
...
## <a name="create-the-visual-studio-project"></a>Create the Visual Studio project
...
## <a name="create-the-aspnet-mvc-application"></a>Create the ASP.NET MVC application
...
## <a name="delete-the-resources-when-you-are-finished-with-the-application"></a>Delete the resources when you are finished with the application
...
## <a name="run-the-sample-application-on-your-local-machine"></a>Run the sample application on your local machine
