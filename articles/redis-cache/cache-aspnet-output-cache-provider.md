...
# <a name="aspnet-output-cache-provider-for-azure-redis-cache"></a>ASP.NET Output Cache Provider for Azure Redis Cache
...
## <a name="store-aspnet-page-output-in-the-cache"></a>Store ASP.NET page output in the cache
