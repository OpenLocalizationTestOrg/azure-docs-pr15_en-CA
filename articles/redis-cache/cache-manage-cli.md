...
# <a name="how-to-create-and-manage-azure-redis-cache-using-the-azure-command-line-interface-azure-cli"></a>How to create and manage Azure Redis Cache using the Azure Command-Line Interface (Azure CLI)
...
## <a name="redis-cache-properties"></a>Redis Cache properties
...
## <a name="see-all-redis-cache-commands"></a>See all Redis Cache commands
...
## <a name="delete-an-existing-redis-cache"></a>Delete an existing Redis Cache
...
## <a name="list-all-redis-caches-within-your-subscription-or-resource-group"></a>List all Redis Caches within your Subscription or Resource Group
...
## <a name="show-properties-of-an-existing-redis-cache"></a>Show properties of an existing Redis Cache
...
<a name="scale"></a>
## <a name="change-settings-of-an-existing-redis-cache"></a>Change settings of an existing Redis Cache
...
## <a name="renew-the-authentication-key-for-an-existing-redis-cache"></a>Renew the authentication key for an existing Redis Cache
...
## <a name="list-primary-and-secondary-keys-of-an-existing-redis-cache"></a>List Primary and Secondary keys of an existing Redis Cache
