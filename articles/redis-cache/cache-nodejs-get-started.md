...
# <a name="how-to-use-azure-redis-cache-with-nodejs"></a>How to use Azure Redis Cache with Node.js
...
## <a name="connect-to-the-cache-securely-using-ssl"></a>Connect to the cache securely using SSL
