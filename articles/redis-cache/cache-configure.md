...
# <a name="how-to-configure-azure-redis-cache"></a>How to configure Azure Redis Cache
...
## <a name="support--troubleshooting-settings"></a>Support & troubleshooting settings
...
### <a name="redis-cluster-size"></a>Redis Cluster Size
...
## <a name="move-your-cache-to-a-new-subscription"></a>Move your cache to a new subscription
