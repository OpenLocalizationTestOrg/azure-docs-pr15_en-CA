...
#<a name="high-availability-for-applications-built-on-microsoft-azure"></a>High availability for applications built on Microsoft Azure
...
##<a name="azure-high-availability-features"></a>Azure high-availability features
...
###<a name="features-in-other-services"></a>Features in other services
...
###<a name="availability-sets-for-azure-virtual-machines"></a>Availability sets for Azure Virtual Machines
...
##<a name="application-strategies-for-high-availability"></a>Application strategies for high availability
...
###<a name="asynchronous-communication-and-durable-queues"></a>Asynchronous communication and durable queues
...
###<a name="fault-detection-and-retry-logic"></a>Fault detection and retry logic
...
###<a name="transactional-data-pattern-for-high-availability"></a>Transactional data pattern for high availability
...
###<a name="scalability-patterns"></a>Scalability patterns
