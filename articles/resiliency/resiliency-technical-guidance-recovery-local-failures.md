...
#<a name="azure-resiliency-technical-guidance-recovery-from-local-failures-in-azure"></a>Azure resiliency technical guidance: Recovery from local failures in Azure
...
###<a name="disk-durability"></a>Disk durability
...
###<a name="virtual-machine-disks"></a>Virtual machine disks
...
##<a name="checklists-for-local-failures"></a>Checklists for local failures
