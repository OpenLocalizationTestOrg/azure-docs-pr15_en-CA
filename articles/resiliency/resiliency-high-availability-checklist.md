...
#<a name="high-availability-checklist"></a>High availability checklist
...
###<a name="are-you-using-traffic-manager-in-front-of-your-resources"></a>Are you using Traffic Manager in front of your resources?
...
###<a name="have-you-avoided-using-a-single-virtual-machine-for-any-role"></a>Have you avoided using a single virtual machine for any role?
...
###<a name="are-you-using-a-load-balancer-in-front-of-your-applications-internet-facing-vms"></a>Are you using a load balancer in front of your application's internet-facing VMs?
...
###<a name="are-you-using-availability-sets-for-your-stateless-application-and-web-servers"></a>Are you using availability sets for your stateless application and web servers?
...
###<a name="are-you-using-virtual-machine-scale-sets-vmss-for-your-stateless-application-or-web-servers"></a>Are you using Virtual Machine Scale Sets (VMSS) for your stateless application or web servers?
...
###<a name="are-you-using-premium-storage-and-separate-storage-accounts-for-each-of-your-virtual-machines"></a>Are you using premium storage and separate storage accounts for each of your virtual machines?
...
###<a name="are-you-using-a-load-balancer-or-a-queue-between-each-tier-of-your-application"></a>Are you using a load balancer or a queue between each tier of your application?
...
###<a name="are-your-sql-databases-using-active-geo-replication"></a>Are your SQL Databases using active geo-replication? 
...
###<a name="are-you-using-a-cache-azure-redis-cache-in-front-of-your-databases"></a>Are you using a cache (Azure Redis Cache) in front of your databases?
...
###<a name="have-you-contacted-microsoft-azure-support-if-you-are-expecting-a-high-scale-event"></a>Have you contacted Microsoft Azure Support if you are expecting a high scale event?
...
###<a name="are-you-using-a-content-delivery-network-azure-cdn-in-front-of-your-web-facing-storage-blobs-and-static-assets"></a>Are you using a Content Delivery Network (Azure CDN) in front of your web-facing storage blobs and static assets?
