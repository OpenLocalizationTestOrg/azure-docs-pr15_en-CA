...
# <a name="role-assignments-template-schema"></a>Role assignments template schema

Assigns a user, group, or service principal to a role at a specified scope.

## <a name="resource-format"></a>Resource format
...
## <a name="how-to-use-the-role-assignment-resource"></a>How to use the role assignment resource
