...
# <a name="generic-sql-connector-step-by-step"></a>Generic SQL Connector step-by-step
...
## <a name="prepare-the-sample-database"></a>Prepare the sample database
...
## <a name="create-the-odbc-connection-file"></a>Create the ODBC connection file
...
## <a name="create-the-generic-sql-connector"></a>Create the Generic SQL Connector
...
## <a name="create-run-profiles"></a>Create Run Profiles
...
## <a name="add-some-test-data-and-test-the-import"></a>Add some test data and test the import
