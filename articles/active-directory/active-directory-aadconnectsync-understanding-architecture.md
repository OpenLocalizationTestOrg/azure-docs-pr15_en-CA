...
### <a name="connected-data-sources-and-connectors"></a>Connected Data Sources and Connectors
...
### <a name="internal-structure-of-the-sync-engine-namespace"></a>Internal structure of the sync engine namespace
...
### <a name="connector-space-objects"></a>Connector space objects
...
### <a name="staging-objects"></a>Staging Objects
...
### <a name="metaverse-objects"></a>Metaverse objects
...
### <a name="relationships-between-staging-objects-and-metaverse-objects"></a>Relationships between staging objects and metaverse objects
...
## <a name="sync-engine-identity-management-process"></a>Sync engine identity management process
...
### <a name="export-process"></a>Export process
