...
##<a name="enabling-the-application-integration-for-sciforma"></a>Enabling the application integration for Sciforma
  
The objective of this section is to outline how to enable the application integration for Sciforma.

###<a name="to-enable-the-application-integration-for-sciforma-perform-the-following-steps"></a>To enable the application integration for Sciforma, perform the following steps:
...
###<a name="to-assign-users-to-sciforma-perform-the-following-steps"></a>To assign users to Sciforma, perform the following steps:
