...
# <a name="plan-for-hybrid-identity-lifecycle"></a>Plan for Hybrid Identity Lifecycle 
...
## <a name="synchronization-management"></a>Synchronization Management
...
![](./media/hybrid-id-design-considerations/Directory_synchronization.png)To proper design the synchronization of your hybrid identity solution ensure that the following questions are answered: •   What are the sync solutions available for the hybrid identity solution?
