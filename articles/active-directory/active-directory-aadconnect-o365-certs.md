...
# <a name="renew-federation-certificates-for-office-365-and-azure-active-directory"></a>Renew federation certificates for Office 365 and Azure Active Directory
...
## <a name="default-configuration-of-ad-fs-for-token-signing-certificates"></a>Default configuration of AD FS for token signing certificates
...
### <a name="renewal-notification-from-the-office-365-portal-or-an-email"></a>Renewal notification from the Office 365 portal or an email
...
### <a name="step-1-check-the-autocertificaterollover-state"></a>Step 1: Check the AutoCertificateRollover state
...
### <a name="step-2-confirm-that-ad-fs-and-azure-ad-are-in-sync"></a>Step 2: Confirm that AD FS and Azure AD are in sync
...
### <a name="step-3-check-if-your-certificate-is-about-to-expire"></a>Step 3: Check if your certificate is about to expire
...
### <a name="step-1-ensure-that-ad-fs-has-new-token-signing-certificates"></a>Step 1: Ensure that AD FS has new token signing certificates
...
### <a name="step-2-update-the-new-token-signing-certificates-for-the-office-365-trust"></a>Step 2: Update the new token signing certificates for the Office 365 trust
