...
# <a name="setting-up-on-premises-conditional-access-using-azure-active-directory-device-registration"></a>Setting up on-premises conditional access using Azure Active Directory Device Registration
...
## <a name="scenario-assumptions"></a>Scenario assumptions
...
<a name="checklist-prerequisites-for-conditional-access-scenario"></a>Checklist: Prerequisites for Conditional Access scenario
--------------------------------------------------------------
Connect your Azure AD tenant with your on-premises Active Directory.

## <a name="configure-azure-active-directory-device-registration-service"></a>Configure Azure Active Directory Device Registration Service
...
## <a name="part-1-enable-azure-active-directory-device-registration"></a>Part 1: Enable Azure Active Directory Device Registration
...
##<a name="part-2-deploy-and-configure-windows-server-2012-r2-active-directory-federation-services-and-set-up-a-federation-relationship-with-azure-ad"></a>Part 2: Deploy and configure Windows Server 2012 R2 Active Directory Federation Services and set up a federation relationship with Azure AD
...
##<a name="part-3-enable-device-writeback-in-azure-ad"></a>Part 3: Enable device writeback in Azure AD
...
##<a name="optional-part-4-enable-multi-factor-authentication"></a>[Optional] Part 4: Enable multi-factor authentication
...
## <a name="part-5-verification"></a>Part 5: Verification
...
## <a name="integrate-azure-active-directory-with-on-premises-active-directory"></a>Integrate Azure Active Directory with on-premises Active Directory
...
## <a name="upgrade-your-active-directory-domain-services-schema"></a>Upgrade your Active Directory Domain Services schema
...
## <a name="prepare-your-active-directory-to-support-devices"></a>Prepare your Active Directory to support devices
...
##<a name="prepare-your-active-directory-forest-to-support-devices"></a>Prepare your Active Directory forest to support devices
...
### <a name="prepare-your-active-directory-forest"></a>Prepare your Active Directory forest
...
### <a name="enable-device-authentication-in-ad-fs"></a>Enable device authentication in AD FS
...
### <a name="disable-unused-device-cleanup"></a>Disable unused device cleanup
1. On your federation server, open a Windows PowerShell command window and type:  Set-AdfsDeviceRegistration -MaximumInactiveDays 0

### <a name="prepare-azure-ad-connect-for-device-writeback"></a>Prepare Azure AD Connect for device writeback

1.  Complete Part 1: Prepare Azure AD Connect.


## <a name="join-devices-to-your-workplace-using-azure-active-directory-device-registration"></a>Join devices to your workplace using Azure Active Directory Device Registration

### <a name="join-an-ios-device-using-azure-active-directory-device-registration"></a>Join an iOS device using Azure Active Directory Device Registration
...
###<a name="join-a-windows-81-device-using-azure-active-directory-device-registration"></a>Join a Windows 8.1 device using Azure Active Directory Device Registration
...
###<a name="join-a-windows-7-device-using-azure-active-directory-device-registration"></a>Join a Windows 7 device using Azure Active Directory Device Registration
...
### <a name="join-an-android-device-using-azure-active-directory-device-registration"></a>Join an Android device using Azure Active Directory Device Registration
...
## <a name="verify-registered-devices-are-written-back-to-active-directory"></a>Verify registered devices are written-back to Active Directory
...
## <a name="create-an-application-access-policy-and-custom-access-denied-message"></a>Create an application access policy and custom access denied message
