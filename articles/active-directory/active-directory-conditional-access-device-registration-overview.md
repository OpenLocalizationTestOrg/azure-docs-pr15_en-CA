...
# <a name="get-started-with-azure-active-directory-device-registration"></a>Get started with Azure Active Directory Device Registration
...
## <a name="scenarios-enabled-by-azure-active-directory-device-registration"></a>Scenarios enabled by Azure Active Directory Device Registration
...
##<a name="setting-up-azure-active-directory-device-registration"></a>Setting up Azure Active Directory Device Registration
...
### <a name="enable-azure-active-directory-device-registration-service"></a>Enable Azure Active Directory Device Registration Service
...
## <a name="configure-azure-active-directory-device-registration-discovery"></a>Configure Azure Active Directory Device Registration discovery
...
## <a name="view-and-manage-device-objects-in-azure-active-directory"></a>View and manage device objects in Azure Active Directory
