...
# <a name="authorize-access-to-web-applications-using-openid-connect-and-azure-active-directory"></a>Authorize access to web applications using OpenID Connect and Azure Active Directory
...
## <a name="authentication-flow-using-openid-connect"></a>Authentication flow using OpenID Connect
