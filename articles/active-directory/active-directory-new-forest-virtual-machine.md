...
# <a name="install-a-new-active-directory-forest-on-an-azure-virtual-network"></a>Install a new Active Directory forest on an Azure virtual network
...
![Active Directory forest on a virtual machines in Azure Virtual Network ][1] 7
## <a name="how-does-this-differ-from-on-premises"></a>How does this differ from on-premises?
...
## <a name="create-vms-to-run-the-domain-controller-and-dns-server-roles"></a>Create VMs to run the domain controller and DNS server roles
...
## <a name="install-windows-server-active-directory"></a>Install Windows Server Active Directory
...
## <a name="reset-the-dns-server-for-the-azure-virtual-network"></a>Reset the DNS server for the Azure virtual network
...
## <a name="create-vms-for-domain-members"></a>Create VMs for domain members
