...
# <a name="scopes-permissions--consent-in-the-v20-endpoint"></a>Scopes, permissions, & consent in the v2.0 endpoint
...
## <a name="scopes--permissions"></a>Scopes & permissions
...
## <a name="requesting-individual-user-consent"></a>Requesting individual user consent
...
## <a name="requesting-consent-for-an-entire-tenant"></a>Requesting consent for an entire tenant
...
## <a name="admin-restricted-scopes"></a>Admin-Restricted scopes
...
## <a name="using-the-admin-consent-endpoint"></a>Using the admin consent endpoint
...
## <a name="using-permissions"></a>Using permissions
