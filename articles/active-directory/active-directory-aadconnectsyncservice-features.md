...
# <a name="azure-ad-connect-sync-service-features"></a>Azure AD Connect sync service features
...
## <a name="synchronize-userprincipalname-updates"></a>Synchronize userPrincipalName updates
