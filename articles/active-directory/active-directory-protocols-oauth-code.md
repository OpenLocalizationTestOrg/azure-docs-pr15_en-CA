...
# <a name="authorize-access-to-web-applications-using-oauth-20-and-azure-active-directory"></a>Authorize access to web applications using OAuth 2.0 and Azure Active Directory
...
## <a name="oauth-20-authorization-flow"></a>OAuth 2.0 authorization flow
...
## <a name="use-the-authorization-code-to-request-an-access-token"></a>Use the authorization code to request an access token
...
## <a name="use-the-access-token-to-access-the-resource"></a>Use the access token to access the resource
...
#### <a name="error-parameters"></a>Error parameters
...
#### <a name="bearer-scheme-error-codes"></a>Bearer scheme error codes
...
## <a name="refreshing-the-access-tokens"></a>Refreshing the access tokens
