...
# <a name="guidelines-for-deploying-windows-server-active-directory-on-azure-virtual-machines"></a>Guidelines for deploying Windows Server Active Directory on Azure virtual machines
...
## <a name="scope-and-audience"></a>Scope and audience
...
### <a name="azure-virtual-machines-may-need-connectivity-to-the-on-premises-corporate-network"></a>Azure virtual machines may need connectivity to the on-premises corporate network.
...
### <a name="static-ip-addresses-must-be-configured-with-azure-powershell"></a>Static IP addresses must be configured with Azure PowerShell.
...
## <a name="is-it-safe-to-virtualize-windows-server-active-directory-domain-controllers"></a>Is it safe to virtualize Windows Server Active Directory domain controllers?
...
## <a name="why-deploy-windows-server-ad-ds-on-azure-virtual-machines"></a>Why deploy Windows Server AD DS on Azure Virtual Machines?
...
## <a name="contrasts-between-deploying-windows-server-active-directory-domain-controllers-on-azure-virtual-machines-versus-on-premises"></a>Contrasts between deploying Windows Server Active Directory domain controllers on Azure Virtual Machines versus on-premises
...
## <a name="can-you-deploy-windows-server-ad-fs-on-azure-virtual-machines"></a>Can you deploy Windows Server AD FS on Azure virtual machines?
...
### <a name="an-alternative-to-ad-fs-deployment-if-the-goal-is-office-365-sso-alone"></a>An alternative to AD FS deployment if the goal is Office 365 SSO alone
...
### <a name="additional-food-for-thought"></a>Additional food for thought
...
#### <a name="scenario-considerations-and-how-technology-areas-apply-to-the-scenario"></a>Scenario considerations and how technology areas apply to the scenario
...
## <a name="deployment-decisions-and-factors"></a>Deployment decisions and factors
