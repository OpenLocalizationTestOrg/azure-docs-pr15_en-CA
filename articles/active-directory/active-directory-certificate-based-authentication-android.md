...
# <a name="get-started-with-certificate-based-authentication-on-android---public-preview"></a>Get started with certificate based authentication on Android - Public Preview  
