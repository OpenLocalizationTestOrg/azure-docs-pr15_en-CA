...
# <a name="add-and-manage-multiple-azure-active-directory-directories"></a>Add and manage multiple Azure Active Directory directories
...
##<a name="add-an-azure-ad-directory"></a>Add an Azure AD directory
