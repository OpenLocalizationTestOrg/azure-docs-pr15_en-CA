...
# <a name="service-to-service-calls-using-client-credentials"></a>Service to service calls using client credentials
...
## <a name="client-credentials-grant-flow-diagram"></a>Client credentials grant flow diagram
...
## <a name="register-the-services-in-azure-ad"></a>Register the Services in Azure AD
