...
# <a name="add-sign-in-to-an-angularjs-single-page-app---nodejs"></a>Add sign-in to an AngularJS single page app - NodeJS
...
## <a name="install-adaljs"></a>Install adal.js
...
## <a name="set-up-the-rest-api"></a>Set up the REST API
...
## <a name="sign-users-in"></a>Sign users in
...
## <a name="display-user-info"></a>Display user info
...
## <a name="call-the-rest-api"></a>Call the REST API
