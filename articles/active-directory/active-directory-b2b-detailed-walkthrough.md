...
# <a name="azure-ad-b2b-collaboration-preview-detailed-walkthrough"></a>Azure AD B2B collaboration preview: Detailed walkthrough
...
## <a name="adding-alice-to-the-contoso-directory"></a>Adding Alice to the Contoso directory
...
## <a name="adding-bob-to-the-contoso-directory-and-granting-access-to-apps"></a>Adding Bob to the Contoso directory and granting access to apps
...
## <a name="adding-carol-to-the-contoso-directory-granting-access-to-apps-and-giving-group-membership"></a>Adding Carol to the Contoso directory, granting access to apps, and giving group membership
