...
## <a name="adding-youearnedit-from-the-gallery"></a>Adding YouEarnedIt from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](./media/active-directory-saas-youearnedit-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps: ![Creating an Azure AD test user](./media/active-directory-saas-youearnedit-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-youearnedit-test-user"></a>Creating an YouEarnedIt test user
