...
## <a name="add-additional-sync-administrators"></a>Add additional sync administrators
...
## <a name="assigning-licenses-to-azure-ad-premium-and-enterprise-mobility-users"></a>Assigning licenses to Azure AD Premium and Enterprise Mobility users
...
## <a name="verifying-the-scheduled-synchronization-task"></a>Verifying the scheduled synchronization task
...
## <a name="starting-a-scheduled-synchronization-task"></a>Starting a scheduled synchronization task
