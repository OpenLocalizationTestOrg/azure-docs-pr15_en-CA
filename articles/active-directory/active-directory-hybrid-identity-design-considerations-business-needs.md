...
# <a name="determine-identity-requirements-for-your-hybrid-identity-solution"></a>Determine identity requirements for your hybrid identity solution
...
Some components that are part of the hybrid identity architecture![](./media/hybrid-id-design-considerations/hybrid-identity-architechture.png)

## <a name="determine-business-needs"></a>Determine business needs
...
## <a name="analyze-on-premises-identity-infrastructure"></a>Analyze on-premises identity infrastructure
...
## <a name="evaluate-identity-integration-requirements"></a>Evaluate identity integration requirements
...
## <a name="evaluate-applications-that-run-in-your-environment"></a>Evaluate applications that run in your environment
...
## <a name="evaluate-user-requirements"></a>Evaluate user requirements
