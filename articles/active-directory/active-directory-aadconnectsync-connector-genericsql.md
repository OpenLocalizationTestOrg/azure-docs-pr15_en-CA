<properties
   pageTitle="Generic SQL Connector | Microsoft Azure"
...
# <a name="generic-sql-connector-technical-reference"></a>Generic SQL Connector technical reference
...
## <a name="overview-of-the-generic-sql-connector"></a>Overview of the Generic SQL Connector
...
### <a name="permissions-in-connected-data-source"></a>Permissions in connected data source
...
### <a name="schema-1-detect-object-types"></a>Schema 1 (Detect object types)
...
### <a name="schema-2-detect-attribute-types"></a>Schema 2 (Detect attribute types)
...
### <a name="schema-3-define-anchor-and-dn"></a>Schema 3 (Define anchor and DN)
...
### <a name="schema-4-define-attribute-type-reference-and-direction"></a>Schema 4 (Define attribute type, reference, and direction)
...
### <a name="schema-5-define-partition-for-reference-attributes"></a>Schema 5 (Define partition for reference attributes)
...
### <a name="configure-anchors"></a>Configure Anchors
...
## <a name="configure-run-step-parameter"></a>Configure Run Step Parameter
...
### <a name="full-and-delta-import"></a>Full and Delta Import
...
- @StartIndexand @EndIndex are replaced at execution time with respective page size value configured on **Configure Step** page. For example, when the connector retrieves first page and the page size is set 500, in such situation @StartIndex would be 1 and @EndIndex 500. These values increase when connector retrieves subsequent pages and change the @StartIndex & @EndIndex value.
