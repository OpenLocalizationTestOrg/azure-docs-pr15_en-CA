...
# <a name="tutorial-azure-active-directory-integration-with-birst-agile-business-analytics"></a>Tutorial: Azure Active Directory integration with Birst Agile Business Analytics
...
## <a name="adding-birst-agile-business-analytics-from-the-gallery"></a>Adding Birst Agile Business Analytics from the gallery
...
### <a name="creating-a-birst-agile-business-analytics-test-user"></a>Creating a Birst Agile Business Analytics test user
...
> [AZURE.NOTE]If you need to create an user manually, you need to contact the Birst Agile Business Analytics support team.
