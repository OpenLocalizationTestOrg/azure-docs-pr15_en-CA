...
# <a name="tutorial-azure-active-directory-integration-with-task"></a>Tutorial: Azure Active Directory integration with@Task
...
## <a name="adding-task-from-the-gallery"></a>Adding @Task from the gallery
...
### <a name="creating-an-task-test-user"></a>Creating an @Task test user
