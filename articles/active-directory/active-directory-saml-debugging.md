...
#<a name="how-to-debug-saml-based-single-sign-on-to-applications-in-azure-active-directory"></a>How to debug SAML-based single sign-on to applications in Azure Active Directory
