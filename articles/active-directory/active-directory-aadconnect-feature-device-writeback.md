...
# <a name="azure-ad-connect-enabling-device-writeback"></a>Azure AD Connect: Enabling device writeback
...
## <a name="part-1-install-azure-ad-connect"></a>Part 1: Install Azure AD Connect
...
## <a name="part-2-prepare-active-directory"></a>Part 2: Prepare Active Directory
...
## <a name="part-3-enable-device-writeback-in-azure-ad-connect"></a>Part 3: Enable device writeback in Azure AD Connect
...
## <a name="enable-conditional-access"></a>Enable conditional access
...
## <a name="verify-devices-are-synchronized-to-active-directory"></a>Verify Devices are synchronized to Active Directory
...
### <a name="the-writeback-checkbox-is-still-disabled"></a>The writeback checkbox is still disabled
