...
# <a name="tutorial-azure-active-directory-integration-with-userecho"></a>Tutorial: Azure Active Directory integration with UserEcho
...
## <a name="adding-userecho-from-the-gallery"></a>Adding UserEcho from the gallery
...
### <a name="creating-a-userecho-test-user"></a>Creating a UserEcho test user
