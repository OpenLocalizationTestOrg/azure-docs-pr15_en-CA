...
## <a name="adding-statuspage-from-the-gallery"></a>Adding StatusPage from the gallery
...
### <a name="creating-a-statuspage-test-user"></a>Creating a StatusPage test user
