<properties
    pageTitle="Tutorial: Azure Active Directory integration with Soonr Workplace | Microsoft Azure"
...
# <a name="tutorial-azure-active-directory-integration-with-soonr-workplace"></a>Tutorial: Azure Active Directory integration with Soonr Workplace
...
## <a name="adding-soonr-workplace-from-the-gallery"></a>Adding Soonr Workplace from the gallery
...
4. **[Creating a Soonr Workplace test user](#creating-a-soonr-workplace-test-user)** - to have a counterpart of Britta Simon in Soonr Workplace that is linked to the Azure AD representation of her.
...
### <a name="creating-a-soonr-workplace-test-user"></a>Creating a Soonr Workplace test user
