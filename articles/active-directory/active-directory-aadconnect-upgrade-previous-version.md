...
### <a name="swing-migration-steps"></a>Swing migration steps
...
### <a name="move-custom-configuration-from-active-to-staging-server"></a>Move custom configuration from active to staging server
