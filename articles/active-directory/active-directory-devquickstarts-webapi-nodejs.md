...
## <a name="3-download-nodejs-for-your-platform"></a>3. Download node.js for your platform
...
## <a name="6-install-passportjs-in-to-your-web-api"></a>6. Install Passport.js in to your Web API
...
## <a name="10-create-a-serverjs-with-your-dependencies"></a>10. Create a server.js with your dependencies
...
## <a name="12-add-configuration-to-your-serverjs-file"></a>12. Add configuration to your server.js file
...
### <a name="2-next-lets-add-some-error-handling-in-our-apis"></a>2. Next, let's add some Error handling in our APIs:
...
## <a name="17-before-we-add-oauth-support-lets-run-the-server"></a>17. Before we add OAuth support, let's run the server.
