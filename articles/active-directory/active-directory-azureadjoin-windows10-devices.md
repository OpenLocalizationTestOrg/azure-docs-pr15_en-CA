...
# <a name="using-windows-10-devices-in-your-workplace"></a>Using Windows 10 devices in your workplace
...
## <a name="use-work-owned-devices-with-azure-ad-join-and-domain-join-in-windows-10"></a>Use work-owned devices with Azure AD Join and domain join in Windows 10
...
## <a name="when-to-use-azure-active-directory-join"></a>When to use Azure Active Directory Join
...
## <a name="when-to-use-domain-join-or-keep-using-it"></a>When to use domain join (or keep using it)
...
## <a name="enable-joining-of-personally-owned-devices-for-work-or-school"></a>Enable joining of personally-owned devices for work or school
...
## <a name="enable-domain-join-or-azure-ad-join"></a>Enable domain join or Azure AD Join
...
## <a name="requirements-for-deploying-azure-ad-join"></a>Requirements for deploying Azure AD Join
...
## <a name="requirements-for-using-domain-join-with-azure-ad"></a>Requirements for using domain join with Azure AD
...
## <a name="requirements-for-using-byod-and-add-a-work-or-school-account"></a>Requirements for using BYOD and "Add a work or school account"
...
## <a name="requirements-for-using-microsoft-passport"></a>Requirements for using Microsoft Passport
...
### <a name="which-partner-mobile-device-management-products-integrate-with-azure-ad"></a>Which partner mobile device management products integrate with Azure AD?
...
### <a name="what-about-workplace-join-in-windows-10"></a>What about Workplace Join in Windows 10?
...
### <a name="can-users-connect-their-microsoft-account-to-their-domain-account-in-windows-10"></a>Can users connect their Microsoft account to their domain account in Windows 10?
