...
# <a name="should-i-use-the-v20-endpoint"></a>Should I use the v2.0 endpoint?
...
## <a name="restrictions-on-apps"></a>Restrictions on apps
...
##### <a name="web-api-on-behalf-of-flow"></a>Web API On-Behalf-Of Flow
...
## <a name="restrictions-on-app-registrations"></a>Restrictions on app registrations
...
## <a name="restrictions-on-redirect-uris"></a>Restrictions on Redirect URIs
...
## <a name="restrictions-on-services--apis"></a>Restrictions on services & APIs
...
## <a name="restrictions-on-libraries--sdks"></a>Restrictions on libraries & SDKs
...
## <a name="restrictions-on-protocols"></a>Restrictions on protocols
...
## <a name="restrictions-for-work--school-accounts"></a>Restrictions for work & school accounts
...
##### <a name="device-based-conditional-access-native-and-mobile-apps-and-the-microsoft-graph"></a>Device-based conditional access, native and mobile apps, and the Microsoft Graph
...
##### <a name="windows-integrated-authentication-for-federated-tenants"></a>Windows integrated authentication for federated tenants
