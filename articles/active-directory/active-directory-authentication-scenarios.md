...
# <a name="authentication-scenarios-for-azure-ad"></a>Authentication Scenarios for Azure AD
...
## <a name="basics-of-authentication-in-azure-ad"></a>Basics of Authentication in Azure AD
...
## <a name="claims-in-azure-ad-security-tokens"></a>Claims in Azure AD Security Tokens
...
## <a name="basics-of-registering-an-application-in-azure-ad"></a>Basics of Registering an Application in Azure AD
...
## <a name="application-types-and-scenarios"></a>Application Types and Scenarios
...
#### <a name="description-of-protocol-flow"></a>Description of Protocol Flow
...
#### <a name="registering"></a>Registering
...
#### <a name="token-expiration"></a>Token Expiration
...
#### <a name="authentication-flow-for-native-application-to-api"></a>Authentication flow for native application to API
...
##### <a name="application-identity-with-oauth-20-client-credentials-grant"></a>Application Identity with OAuth 2.0 Client Credentials Grant
...
##### <a name="delegated-user-identity-with-openid-connect"></a>Delegated User Identity with OpenID Connect
...
##### <a name="delegated-user-identity-with-oauth-20-authorization-code-grant"></a>Delegated User Identity with OAuth 2.0 Authorization Code Grant
...
### <a name="daemon-or-server-application-to-web-api"></a>Daemon or Server Application to Web API
...
##### <a name="delegated-user-identity-with-oauth-20-on-behalf-of-draft-specification"></a>Delegated User Identity with OAuth 2.0 On-Behalf-Of Draft Specification
