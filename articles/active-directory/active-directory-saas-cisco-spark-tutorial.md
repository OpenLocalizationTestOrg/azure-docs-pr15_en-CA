...
# <a name="tutorial-azure-active-directory-integration-with-cisco-spark"></a>Tutorial: Azure Active Directory integration with Cisco Spark
...
## <a name="adding-cisco-spark-from-the-gallery"></a>Adding Cisco Spark from the gallery
...
### <a name="creating-a-cisco-spark-test-user"></a>Creating a Cisco Spark test user
