...
# <a name="azure-ad-connect-health-frequently-asked-questions-faq"></a>Azure AD Connect Health Frequently Asked Questions (FAQ)
...
## <a name="installation-questions"></a>Installation Questions
...
>[AZURE.NOTE] In the event of the agent being unable to communicate to Azure, the agent stores the data locally, up to a defined maximum limit. The agent overwrites the “cached” data on a “least recently serviced” basis.
...
## <a name="operations-questions"></a>Operations Questions
