...
# <a name="tutorial-azure-active-directory-integration-with-opsgenie"></a>Tutorial: Azure Active Directory integration with OpsGenie
...
## <a name="adding-opsgenie-from-the-gallery"></a>Adding OpsGenie from the gallery
...
### <a name="creating-a-opsgenie-test-user"></a>Creating a OpsGenie test user
