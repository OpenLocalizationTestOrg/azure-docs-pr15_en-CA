...
# <a name="roles-in-azure-ad-privileged-identity-management"></a>Roles in Azure AD Privileged Identity Management
...
## <a name="roles-managed-in-pim"></a>Roles managed in PIM
...
## <a name="roles-not-managed-in-pim"></a>Roles not managed in PIM
...
## <a name="user-roles-and-signing-in"></a>User roles and signing in
...
## <a name="assign-a-license-to-a-user-in-azure-ad"></a>Assign a license to a user in Azure AD
