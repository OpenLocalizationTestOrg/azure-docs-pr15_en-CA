...
# <a name="tutorial-azure-active-directory-integration-with-novatus"></a>Tutorial: Azure Active Directory integration with Novatus
...
## <a name="adding-novatus-from-the-gallery"></a>Adding Novatus from the gallery
...
### <a name="creating-a-novatus-test-user"></a>Creating a Novatus test user
