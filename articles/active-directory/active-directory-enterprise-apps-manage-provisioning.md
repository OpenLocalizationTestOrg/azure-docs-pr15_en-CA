<properties
    pageTitle="User provisioning management for enterprise apps in the Azure Active Directory preview | Microsoft Azure"
...
#<a name="preview-managing-user-account-provisioning-for-enterprise-apps-in-the-new-azure-portal"></a>Preview: Managing user account provisioning for enterprise apps in the new Azure portal
...
##<a name="provisioning-modes"></a>Provisioning modes
...
##<a name="configuring-automatic-user-account-provisioning"></a>Configuring automatic user account provisioning

Selecting the **Automatic** option displays a screen that is divided in four sections:

###<a name="admin-credentials"></a>Admin Credentials
...
###<a name="synchronization-details"></a>Synchronization Details
