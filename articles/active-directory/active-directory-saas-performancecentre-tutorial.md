...
## <a name="adding-performancecentre-from-the-gallery"></a>Adding PerformanceCentre from the gallery
...
### <a name="creating-a-performancecentre-test-user"></a>Creating a PerformanceCentre test user
