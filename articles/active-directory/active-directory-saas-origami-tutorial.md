...
# <a name="tutorial-azure-active-directory-integration-with-origami"></a>Tutorial: Azure Active Directory integration with Origami
...
## <a name="adding-origami-from-the-gallery"></a>Adding Origami from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](./media/active-directory-saas-origami-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps: ![Creating an Azure AD test user](./media/active-directory-saas-origami-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-origami-test-user"></a>Creating an Origami test user
