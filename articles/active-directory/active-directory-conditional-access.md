...
# <a name="conditional-access-in-azure-active-directory"></a>Conditional access in Azure Active Directory   
...
## <a name="how-is-conditional-access-control-enforced"></a>How is conditional access control enforced?  
...
## <a name="device-based-conditional-access"></a>Device-based conditional access
...
### <a name="multi-factor-authentication-and-location-policies"></a>Multi-factor authentication and location policies
...
### <a name="protect-resources-based-on-sign-in-risk"></a>Protect resources based on sign-in risk
