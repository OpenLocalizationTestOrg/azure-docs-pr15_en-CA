...
# <a name="aspnet-web-app-sign-in--sign-out-with-azure-ad"></a>ASP.NET Web App Sign In & Sign Out with Azure AD
...
## <a name="2-set-up-your-app-to-use-the-owin-authentication-pipeline"></a>*2. Set up your app to use the OWIN authentication pipeline*
...
## <a name="3-use-owin-to-issue-sign-in-and-sign-out-requests-to-azure-ad"></a>*3. Use OWIN to issue sign-in and sign-out requests to Azure AD*
...
## <a name="4--display-user-information"></a>*4.  Display user information*
