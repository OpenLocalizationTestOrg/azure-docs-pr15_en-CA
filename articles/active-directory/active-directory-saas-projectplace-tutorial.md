...
###<a name="to-enable-the-application-integration-for-projectplace-perform-the-following-steps"></a>To enable the application integration for Projectplace, perform the following steps:
...
###<a name="to-assign-users-to-projectplace-perform-the-following-steps"></a>To assign users to Projectplace, perform the following steps:
