...
# <a name="cloud-app-discovery-security-and-privacy-considerations"></a>Cloud App Discovery Security and Privacy Considerations
...
## <a name="collecting-data-from-your-organization"></a>Collecting data from your organization
...
### <a name="data-collected-by-the-agent"></a>Data collected by the agent
...
<br><br>
### <a name="how-the-agent-works"></a>How the agent works
...
### <a name="respecting-user-privacy"></a>Respecting user privacy
...
### <a name="intercepting-data-from-encrypted-connections-deep-inspection"></a>Intercepting data from encrypted connections (Deep inspection)
...
#### <a name="a-word-of-caution"></a>A word of caution
...
### <a name="known-issues-and-drawbacks"></a>Known issues and drawbacks
...
## <a name="sending-data-to-cloud-app-discovery"></a>Sending data to Cloud App Discovery
...
## <a name="receiving-the-data-at-the-service-end"></a>Receiving the data at the service end
...
## <a name="accessing-the-data-using-the-azure-portal"></a>Accessing the data using the Azure portal
