...
# <a name="add-sign-in-to-an-ios-app-using-a-third-party-library-with-graph-api-using-the-v20-endpoint"></a>Add sign-in to an iOS app using a third-party library with Graph API using the v2.0 endpoint
...
## <a name="set-up-the-settingsplst-file-in-the-library"></a>Set up the settings.plst file in the library
...
### <a name="add-a-check-to-see-if-youre-logged-in"></a>Add a check to see if you're logged in
