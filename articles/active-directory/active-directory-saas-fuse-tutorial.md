...
# <a name="tutorial-azure-active-directory-integration-with-fuse"></a>Tutorial: Azure Active Directory integration with Fuse
...
## <a name="adding-fuse-from-the-gallery"></a>Adding Fuse from the gallery
...
### <a name="creating-a-fuse-test-user"></a>Creating a Fuse test user
