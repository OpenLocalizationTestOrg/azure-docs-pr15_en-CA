<properties
    pageTitle="Tutorial: Azure Active Directory integration with Yardi eLearning | Microsoft Azure"
...
# <a name="tutorial-azure-active-directory-integration-with-yardi-elearning"></a>Tutorial: Azure Active Directory integration with Yardi eLearning
...
## <a name="adding-yardi-elearning-from-the-gallery"></a>Adding Yardi eLearning from the gallery
...
### <a name="creating-a-yardi-elearning-test-user"></a>Creating a Yardi eLearning test user
...
> [AZURE.NOTE] If you need to create an user manually, you need to contact the Yardi eLearning support team.
