<properties
   pageTitle="How to get AppSource certified for Azure Active Directory| Microsoft Azure"
...
#<a name="how-to-get-appsource-certified-for-azure-active-directory-ad"></a>How to get AppSource Certified for Azure Active Directory (AD) 
