...
# <a name="integrate-azure-ad-into-an-ios-app"></a>Integrate Azure AD into an iOS App
...
## <a name="1-determine-what-your-redirect-uri-will-be-for-ios"></a>*1. Determine what your Redirect URI will be for iOS*
...
## <a name="2-register-the-directorysearcher-application"></a>*2. Register the DirectorySearcher Application*
...
## <a name="3-install--configure-adal"></a>*3. Install & Configure ADAL*
...
## <a name="4--use-adal-to-get-tokens-from-aad"></a>*4.  Use ADAL to Get Tokens from AAD*
...
## <a name="step-5-build-and-run-the-application"></a>Step 5: Build and Run the application
