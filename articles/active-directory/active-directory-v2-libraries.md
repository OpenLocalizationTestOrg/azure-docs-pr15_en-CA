...
# <a name="azure-active-directory-v20-authentication-libraries"></a>Azure Active Directory v2.0 authentication libraries
...
## <a name="compatible-server-middleware-libraries"></a>Compatible server middleware libraries
Coming soon
