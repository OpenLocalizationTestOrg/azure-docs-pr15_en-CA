...
# <a name="conceptual-overview-of-custom-domain-names-in-azure-active-directory"></a>Conceptual overview of custom domain names in Azure Active Directory
...
## <a name="initial-and-custom-domain-names"></a>Initial and custom domain names
...
## <a name="verified-and-unverified-domain-names"></a>Verified and unverified domain names
...
## <a name="federated-and-managed-domain-names"></a>Federated and managed domain names
...
## <a name="primary-domain-names"></a>Primary domain names
...
## <a name="domain-names-in-azure-ad-and-other-microsoft-online-services"></a>Domain names in Azure AD and other Microsoft Online Services
...
## <a name="managing-domain-names"></a>Managing domain names
