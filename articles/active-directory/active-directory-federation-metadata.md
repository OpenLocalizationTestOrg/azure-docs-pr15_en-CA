...
# <a name="federation-metadata"></a>Federation metadata
...
## <a name="tenant-specific-and-tenant-independent-metadata-endpoints"></a>Tenant-specific and Tenant-independent metadata endpoints
...
## <a name="federation-metadata-endpoints"></a>Federation metadata endpoints
...
## <a name="contents-of-federation-metadata"></a>Contents of federation Metadata
...
### <a name="saml-protocol-endpoint-url"></a>SAML protocol endpoint URL
