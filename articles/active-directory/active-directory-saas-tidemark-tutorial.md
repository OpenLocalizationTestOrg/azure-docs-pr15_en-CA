...
# <a name="tutorial-azure-active-directory-integration-with-tidemark"></a>Tutorial: Azure Active Directory integration with Tidemark
...
## <a name="adding-tidemark-from-the-gallery"></a>Adding Tidemark from the gallery
...
### <a name="creating-a-tidemark-test-user"></a>Creating a Tidemark test user
...
> [AZURE.NOTE]If you need to create an user manually, you need to contact the Tidemark support team.
