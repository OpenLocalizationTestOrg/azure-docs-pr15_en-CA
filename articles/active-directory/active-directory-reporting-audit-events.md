...
# <a name="azure-active-directory-audit-report-events"></a>Azure Active Directory audit report events
...
## <a name="list-of-audit-report-events"></a>List of Audit Report Events
...
## <a name="audit-report-retention"></a>Audit report retention
...
## <a name="properties-included-with-each-audit-event"></a>Properties included with each audit event
...
## <a name="update-user-attributes"></a>"Update User" attributes
...
## <a name="update-group-attributes"></a>"Update Group" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-device-attributes"></a>"Update Device" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-device-configuration-attributes"></a>"Update Device Configuration" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-service-principal-configuration-attributes"></a>"Update Service principal Configuration" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
AccountEnabled |Indicates whether a security principal can authenticate.
...
## <a name="update-app-attributes"></a>"Update App" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-role-attributes"></a>"Update Role" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
AppAddress |The set of addresses (redirect URLs) that are assigned to a service principal.
...
## <a name="update-role-definition-attributes"></a>"Update Role definition" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-administrative-unit-attributes"></a>"Update Administrative Unit" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-company-attributes"></a>"Update Company" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
...
## <a name="update-domain-attributes"></a>"Update Domain" attributes
Attribute                           | Description
-------------------------------     | -------------------------------------------------------------------------------------------------------------------------------------------------------
