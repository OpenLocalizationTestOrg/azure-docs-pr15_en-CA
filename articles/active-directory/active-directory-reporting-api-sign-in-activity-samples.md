<properties
    pageTitle="Azure Active Directory sign-in activity report API samples | Microsoft Azure"
...
# <a name="azure-active-directory-sign-in-activity-report-api-samples"></a>Azure Active Directory sign-in activity report API samples
...
## <a name="executing-the-script"></a>Executing the script
