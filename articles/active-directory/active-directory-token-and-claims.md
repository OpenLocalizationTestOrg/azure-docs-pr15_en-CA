...
#### <a name="sample-idtoken"></a>Sample id_token
...
## <a name="validating-tokens"></a>Validating tokens
...
#### <a name="validating-the-signature"></a>Validating the signature
...
#### <a name="validating-the-claims"></a>Validating the claims
...
## <a name="sample-tokens"></a>Sample Tokens
...
### <a name="jwt-token---user-impersonation"></a>JWT Token - User Impersonation
