...
# <a name="azure-active-directory-preview-cmdlets-for-group-management"></a>Azure Active Directory preview cmdlets for group management
...
## <a name="installing-the-azure-ad-powershell-module"></a>Installing the Azure AD PowerShell module
...
## <a name="connecting-to-the-directory"></a>Connecting to the directory
...
## <a name="retrieving-groups"></a>Retrieving groups
...
## <a name="creating-groups"></a>Creating groups
...
## <a name="updating-groups"></a>Updating groups
...
## <a name="deleting-groups"></a>Deleting groups
To delete groups from your directory, use the Remove-AzureADGroup cmdlet as follows:

    PS C:\Windows\system32> Remove-AzureADGroup -ObjectId b11ca53e-07cc-455d-9a89-1fe3ab24566b

## <a name="managing-members-of-groups"></a>Managing members of groups
...
## <a name="managing-owners-of-groups"></a>Managing owners of groups
