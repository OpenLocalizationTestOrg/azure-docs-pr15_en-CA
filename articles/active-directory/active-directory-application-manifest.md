...
## <a name="updating-an-applications-identity-configuration"></a>Updating an application's identity configuration
...
## <a name="using-the-application-manifest-to-update-an-applications-identity-configuration"></a>Using the application manifest to update an application's identity configuration
