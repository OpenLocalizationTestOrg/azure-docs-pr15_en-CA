...
# <a name="sharing-accounts-with-azure-ad"></a>Sharing accounts with Azure AD
...
## <a name="azure-active-directory-account-sharing"></a>Azure Active Directory account sharing
...
## <a name="sharing-an-account"></a>Sharing an account
