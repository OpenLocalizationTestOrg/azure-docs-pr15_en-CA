...
# <a name="use-role-assignments-to-manage-access-to-your-azure-subscription-resources"></a>Use role assignments to manage access to your Azure subscription resources
...
## <a name="view-access"></a>View access
...
## <a name="add-access"></a>Add Access
...
## <a name="other-tools-to-manage-access"></a>Other tools to manage access
