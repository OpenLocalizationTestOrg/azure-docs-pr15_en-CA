...
# <a name="azure-active-directory-reporting-audit-api-samples"></a>Azure Active Directory reporting audit API samples
...
### <a name="executing-the-powershell-script"></a>Executing the PowerShell script
