...
##<a name="enabling-the-application-integration-for-screensteps"></a>Enabling the application integration for ScreenSteps
  
The objective of this section is to outline how to enable the application integration for ScreenSteps.

###<a name="to-enable-the-application-integration-for-screensteps-perform-the-following-steps"></a>To enable the application integration for ScreenSteps, perform the following steps:
...
###<a name="to-provision-a-user-account-to-screensteps-perform-the-following-steps"></a>To provision a user account to ScreenSteps, perform the following steps:
...
###<a name="to-assign-users-to-screensteps-perform-the-following-steps"></a>To assign users to ScreenSteps, perform the following steps:
