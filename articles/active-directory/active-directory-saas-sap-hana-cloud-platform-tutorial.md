...
###<a name="to-enable-the-application-integration-for-sap-hana-cloud-platform-perform-the-following-steps"></a>To enable the application integration for SAP HANA Cloud Platform, perform the following steps:
...
##<a name="assigning-a-role-to-a-user"></a>Assigning a role to a user
...
###<a name="to-assign-a-role-to-a-user-perform-the-following-steps"></a>To assign a role to a user, perform the following steps:
...
###<a name="to-assign-users-to-sap-hana-cloud-platform-perform-the-following-steps"></a>To assign users to SAP HANA Cloud Platform, perform the following steps:
