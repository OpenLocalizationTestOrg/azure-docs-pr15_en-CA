...
# <a name="tutorial-azure-active-directory-integration-with-yonyx-interactive-guides"></a>Tutorial: Azure Active Directory integration with Yonyx Interactive Guides
...
## <a name="adding-yonyx-interactive-guides-from-the-gallery"></a>Adding Yonyx Interactive Guides from the gallery
...
### <a name="creating-a-yonyx-interactive-guides-test-user"></a>Creating a Yonyx Interactive Guides test user
