...
#<a name="using-scim-to-enable-automatic-provisioning-of-users-and-groups-from-azure-active-directory-to-applications"></a>Using SCIM to enable automatic provisioning of users and groups from Azure Active Directory to applications
...
##<a name="building-your-own-provisioning-solution-for-any-application"></a>Building Your Own Provisioning Solution For Any Application
...
##<a name="user-and-group-schema"></a>User and Group Schema
