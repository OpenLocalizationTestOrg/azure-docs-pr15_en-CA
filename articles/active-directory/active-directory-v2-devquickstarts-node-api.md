...
# <a name="secure-a-web-api-using-nodejs"></a>Secure a Web API using node.js
...
## <a name="2-download-nodejs-for-your-platform"></a>2: Download node.js for your platform
...
## <a name="5-install-passportjs-into-your-web-api"></a>5: Install Passport.js into your Web API
...
## <a name="9-create-a-serverjs-with-your-dependencies"></a>9: Create a server.js with your dependencies
...
## <a name="11-add-configuration-to-your-serverjs-file"></a>11: Add configuration to your server.js file
...
```
## <a name="16-before-we-add-oauth-support-lets-run-the-server"></a>16: Before we add OAuth support, let's run the server.
