...
# <a name="how-to-give-access-to-manage-azure-ad-privileged-identity-management"></a>How to give access to manage Azure AD Privileged Identity Management
...
## <a name="give-another-user-access-to-manage-pim"></a>Give another user access to manage PIM
...
## <a name="remove-another-users-access-rights-for-managing-pim"></a>Remove another user's access rights for managing PIM
