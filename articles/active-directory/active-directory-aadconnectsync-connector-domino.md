...
# <a name="lotus-domino-connector-technical-reference"></a>Lotus Domino Connector technical reference
...
## <a name="overview-of-the-lotus-domino-connector"></a>Overview of the Lotus Domino Connector
...
### <a name="connected-data-source-permissions"></a>Connected Data Source permissions
...
### <a name="direct-operations-and-adminp"></a>Direct operations and AdminP
...
### <a name="ports-and-protocols"></a>Ports and protocols
...
### <a name="not-supported"></a>Not supported
...
## <a name="create-a-new-connector"></a>Create a new Connector

### <a name="client-software-installation-and-configuration"></a>Client Software Installation and Configuration
...
#### <a name="import-settings-method"></a>Import settings, method
...
#### <a name="creation-of-virtual-contact-objects"></a>Creation of Virtual Contact Objects
...
#### <a name="import-settings-conflict-object"></a>Import settings, conflict object
...
#### <a name="multivalued-transformation"></a>Multivalued Transformation
...
### <a name="configure-provisioning-hierarchy"></a>Configure Provisioning Hierarchy
...
### <a name="select-attributes"></a>Select Attributes
...
## <a name="object-lifecycle-management"></a>Object Lifecycle Management
This section provides an overview of the different objects in Domino.

### <a name="person-objects"></a>Person Objects
...
### <a name="resources-and-rooms"></a>Resources and Rooms
...
### <a name="mail-in-databases"></a>Mail-In Databases
...
### <a name="group-management"></a>Group Management
...
### <a name="mandatory-attributes"></a>Mandatory Attributes
...
## <a name="common-issues-and-questions"></a>Common issues and questions

### <a name="schema-detection-does-not-work"></a>Schema detection does not work
...
### <a name="not-all-secondary-address-books-are-visible"></a>Not all secondary address books are visible
...
### <a name="custom-attributes-in-domino"></a>Custom attributes in Domino
