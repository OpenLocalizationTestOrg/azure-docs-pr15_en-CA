...
# <a name="tutorial-azure-active-directory-integration-with-promapp"></a>Tutorial: Azure Active Directory integration with Promapp
...
## <a name="adding-promapp-from-the-gallery"></a>Adding Promapp from the gallery
...
### <a name="creating-a-promapp-test-user"></a>Creating a Promapp test user
