...
# <a name="azure-ad-privileged-identity-management-how-to-add-or-remove-a-user-role"></a>Azure AD Privileged Identity Management: How to add or remove a user role
...
## <a name="manage-roles-with-pim-in-the-azure-portal"></a>Manage roles with PIM in the Azure portal
...
## <a name="add-a-user-to-a-role"></a>Add a user to a role
...
## <a name="remove-a-user-from-a-role"></a>Remove a user from a role
