...
# <a name="azure-cli-commands-in-azure-service-management-asm-mode"></a>Azure CLI commands in Azure Service Management (asm) mode
...
## <a name="setting-asm-mode"></a>Setting asm mode
...
## <a name="manage-your-account-information-and-publish-settings"></a>Manage your account information and publish settings
...
###<a name="commands-to-manage-your-affinity-groups"></a>Commands to manage your affinity groups
...
###<a name="commands-to-manage-your-account-environment"></a>Commands to manage your account environment
...
## <a name="commands-to-manage-your-classic-virtual-machines"></a>Commands to manage your classic virtual machines
...
##  <a name="commands-to-manage-your-azure-virtual-machine-endpoints"></a>Commands to manage your Azure virtual machine endpoints
...
## <a name="commands-to-manage-your-azure-virtual-machine-images"></a>Commands to manage your Azure virtual machine images
...
## <a name="commands-to-manage-your-azure-cloud-services"></a>Commands to manage your Azure cloud services
...
## <a name="commands-to-manage-your-azure-certificates"></a>Commands to manage your Azure certificates
...
## <a name="commands-to-manage-your-web-apps"></a>Commands to manage your web apps
...
###<a name="commands-to-manage-your-web-app-application-settings"></a>Commands to manage your web app application settings
...
###<a name="commands-to-manage-your-web-app-certificates"></a>Commands to manage your web app certificates
...
###<a name="commands-to-manage-your-web-app-connection-strings"></a>Commands to manage your web app connection strings
...
###<a name="commands-to-manage-your-web-app-default-documents"></a>Commands to manage your web app default documents
...
###<a name="commands-to-manage-your-web-app-deployments"></a>Commands to manage your web app deployments
...
###<a name="commands-to-manage-your-web-app-domains"></a>Commands to manage your web app domains
...
###<a name="commands-to-manage-your-web-app-handler-mappings"></a>Commands to manage your web app handler mappings
...
###<a name="commands-to-manage-your-web-jobs"></a>Commands to manage your Web Jobs
...
###<a name="commands-to-manage-your-web-jobs-history"></a>Commands to manage your Web Jobs History
...
###<a name="commands-to-manage-your-web-app-diagnostics"></a>Commands to manage your web app diagnostics
...
###<a name="commands-to-manage-your-web-app-repositories"></a>Commands to manage your web app repositories
...
###<a name="commands-to-manage-your-web-app-scaling"></a>Commands to manage your web app scaling
...
## <a name="commands-to-manage-azure-mobile-services"></a>Commands to manage Azure Mobile Services
...
###<a name="commands-to-enable-preview-features-for-your-mobile-service"></a>Commands to enable preview features for your Mobile Service
...
###<a name="commands-to-manage-your-mobile-service-apis"></a>Commands to manage your mobile service APIs
...
###<a name="commands-to-manage-your-mobile-application-app-settings"></a>Commands to manage your mobile application app settings
...
## <a name="manage-tool-local-settings"></a>Manage tool local settings
...
## <a name="commands-to-manage-service-bus"></a>Commands to manage Service Bus
...
## <a name="commands-to-manage-your-storage-objects"></a>Commands to manage your Storage objects

###<a name="commands-to-manage-your-storage-accounts"></a>Commands to manage your Storage accounts
...
###<a name="commands-to-manage-your-storage-account-keys"></a>Commands to manage your Storage account keys
...
###<a name="commands-to-manage-your-storage-container"></a>Commands to manage your Storage container
...
###<a name="commands-to-manage-your-storage-blob"></a>Commands to manage your Storage blob
...
## <a name="commands-to-manage-sql-databases"></a>Commands to manage SQL Databases

Use these commands to manage your Azure SQL Databases

###<a name="commands-to-manage-sql-servers"></a>Commands to manage SQL Servers.
...
###<a name="commands-to-manage-your-sql-server-firewall-rules"></a>Commands to manage your SQL Server firewall rules
...
## <a name="commands-to-manage-your-virtual-networks"></a>Commands to manage your Virtual Networks
