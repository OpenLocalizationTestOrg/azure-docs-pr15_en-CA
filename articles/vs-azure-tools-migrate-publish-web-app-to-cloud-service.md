...
## <a name="update-a-connection-string-for-aspnet-dynamic-entities"></a>Update a Connection String for ASP.NET Dynamic Entities

### <a name="to-update-a-connection-string-for-aspnet-dynamic-entities"></a>To Update a Connection String for ASP.NET Dynamic Entities
