...
# <a name="using-twilio-for-voice-voip-and-sms-messaging-in-azure"></a>Using Twilio for Voice, VoIP, and SMS Messaging in Azure

This guide demonstrates how to build apps that communicate with Twilio and node.js on Azure.

<a id="whatis"/>
## <a name="what-is-twilio"></a>What is Twilio?
...
### <a name="receiving-calls-and-text-messages"></a>Receiving Calls and Text Messages
...
### <a name="making-calls-and-sending-text-messages"></a>Making Calls and Sending Text Messages
...
### <a name="embedding-voip-capabilities-in-ui-code-javascript-ios-or-android"></a>Embedding VoIP Capabilities in UI code (JavaScript, iOS, or Android)
...
<a id="signup"/>
## <a name="sign-up-for-twilio-microsoft-discount"></a>Sign Up For Twilio (Microsoft Discount)
...
<a id="azuresite"/>
## <a name="create-and-deploy-a-nodejs-azure-website"></a>Create and Deploy a node.js Azure Website
...
<a id="twiliomodule"/>
## <a name="configure-the-twilio-module"></a>Configure the Twilio Module
...
### <a name="configuring-twilio-credentials-in-system-environment-variables"></a>Configuring Twilio Credentials in System Environment Variables
...
### <a name="declaring-the-twilio-module-in-packagejson"></a>Declaring the Twilio module in package.json
...
<a id="makecall"/>
## <a name="make-an-outbound-call"></a>Make an Outbound Call
...
<a id="sendmessage"/>
## <a name="send-an-sms-message"></a>Send an SMS Message
