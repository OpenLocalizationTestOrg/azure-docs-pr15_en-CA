...
# <a name="azure-security-center-frequently-asked-questions-faq"></a>Azure Security Center frequently asked questions (FAQ)
...
### <a name="how-do-i-get-azure-security-center"></a>How do I get Azure Security Center?
...
### <a name="how-does-billing-work-for-azure-security-center"></a>How does billing work for Azure Security Center?
...
### <a name="how-do-i-disable-data-collection"></a>How do I disable data collection?
...
### <a name="how-do-i-enable-data-collection"></a>How do I enable data collection?
...
### <a name="what-happens-when-data-collection-is-enabled"></a>What happens when data collection is enabled?
...
### <a name="does-the-monitoring-agent-or-security-monitoring-extension-impact-the-performance-of-my-servers"></a>Does the Monitoring Agent or Security Monitoring extension impact the performance of my server(s)?
The agent and extension consumes a nominal amount of system resources and should have little impact on the performance.

### <a name="where-is-my-data-stored"></a>Where is my data stored?
...
## <a name="using-azure-security-center"></a>Using Azure Security Center
...
### <a name="who-can-modify-a-security-policy"></a>Who can modify a security policy?
...
### <a name="what-is-a-security-recommendation"></a>What is a security recommendation?
...
### <a name="how-can-i-see-the-current-security-state-of-my-azure-resources"></a>How can I see the current security state of my Azure resources?
...
### <a name="what-triggers-a-security-alert"></a>What triggers a security alert?
...
### <a name="whats-the-difference-between-threats-detected-and-alerted-on-by-microsoft-security-response-center-versus-azure-security-center"></a>What's the difference between threats detected and alerted on by Microsoft Security Response Center versus Azure Security Center?
...
### <a name="how-are-permissions-handled-in-azure-security-center"></a>How are permissions handled in Azure Security Center?
...
### <a name="which-azure-resources-are-monitored-by-azure-security-center"></a>Which Azure resources are monitored by Azure Security Center?
...
### <a name="what-types-of-virtual-machines-will-be-supported"></a>What types of virtual machines will be supported?
...
### <a name="why-doesnt-azure-security-center-recognize-the-antimalware-solution-running-on-my-azure-vm"></a>Why doesn't Azure Security Center recognize the antimalware solution running on my Azure VM?
...
### <a name="why-do-i-get-the-message-missing-scan-data-for-my-vm"></a>Why do I get the message "Missing Scan Data" for my VM?
...
### <a name="why-do-i-get-the-message-vm-agent-is-missing"></a>Why do I get the message "VM Agent is Missing?"
