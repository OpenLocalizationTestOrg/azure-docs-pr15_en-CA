...
# <a name="microsoft-monitoring-product-comparison"></a>Microsoft monitoring product comparison
...
## <a name="basic-architecture"></a>Basic Architecture
...
### <a name="integrating-scom-and-log-analytics"></a>Integrating SCOM and Log Analytics
...
## <a name="monitoring-logic"></a>Monitoring Logic
...
### <a name="log-analytics"></a>Log Analytics
#### <a name="event-and-performance-collection"></a>Event and Performance Collection
