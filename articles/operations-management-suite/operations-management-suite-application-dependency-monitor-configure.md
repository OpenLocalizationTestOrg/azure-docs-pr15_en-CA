...
# <a name="configuring-application-dependency-monitor-solution-in-operations-management-suite-oms"></a>Configuring Application Dependency Monitor solution in Operations Management Suite (OMS)
...
### <a name="avoiding-duplicate-data"></a>Avoiding duplicate data
...
### <a name="migrating-from-bluestripe-factfinder"></a>Migrating from BlueStripe FactFinder
...
### <a name="download-the-dependency-agent"></a>Download the Dependency Agent
...
### <a name="uninstalling-the-dependency-agent-on-linux"></a>Uninstalling the Dependency Agent on Linux
...
### <a name="installing-from-a-command-line"></a>Installing from a Command Line
...
#### <a name="microsoft-dependency-agent-management-pack-for-mma"></a>Microsoft Dependency Agent Management Pack for MMA
...
#### <a name="microsoft-dependency-agent-fluentd-plug-in-for-linux"></a>Microsoft Dependency Agent Fluentd Plug-in for Linux
...
### <a name="red-hat-enterprise-linux-centos-linux-and-oracle-linux-with-rhel-kernel"></a>Red Hat Enterprise Linux, CentOS Linux and Oracle Linux (with RHEL Kernel)
...
#### <a name="oracle-enterprise-linux-w-unbreakable-kernel-uek"></a>Oracle Enterprise Linux w/ Unbreakable Kernel (UEK)
