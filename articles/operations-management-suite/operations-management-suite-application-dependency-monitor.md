...
# <a name="using-application-dependency-monitor-solution-in-operations-management-suite-oms"></a>Using Application Dependency Monitor solution in Operations Management Suite (OMS)
...
### <a name="list-computer-name-dns-ip-and-os-version"></a>List computer name, DNS, IP, and OS version.
...
### <a name="after-viewing-event-data-for-given-process-use-its-machine-id-to-retrieve-the-computers-name"></a>After viewing event data for given process, use its machine ID to retrieve the computer’s name
