...
# <a name="enable-offline-sync-for-your-xamarinforms-mobile-app"></a>Enable offline sync for your Xamarin.Forms mobile app
...
In the provided code, all records in the remote TodoItem table are queried, but it is also possible to filter records by passing a query id and query to **PushAsync**. For more information, see the section *Incremental Sync* in [Offline Data Sync in Azure Mobile Apps][2].
