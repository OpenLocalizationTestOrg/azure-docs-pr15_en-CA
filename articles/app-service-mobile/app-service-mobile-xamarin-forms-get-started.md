...
#<a name="create-a-xamarinforms-app"></a>Create a Xamarin.Forms app
...
##<a name="download-and-run-the-xamarinforms-solution"></a>Download and run the Xamarin.Forms solution
