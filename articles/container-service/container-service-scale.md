...
# <a name="scale-an-azure-container-service"></a>Scale an Azure Container Service
...
## <a name="about-the-command"></a>About the command
...
## <a name="use-the-command-to-scale"></a>Use the command to scale
...
#### <a name="see-current-count"></a>See current count
...
#### <a name="scale-to-new-count"></a>Scale to new count
