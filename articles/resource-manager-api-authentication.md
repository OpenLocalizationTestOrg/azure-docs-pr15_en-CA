...
# <a name="how-to-use-azure-active-directory-and-resource-manager-to-manage-a-customers-resources"></a>How to use Azure Active Directory and Resource Manager to manage a customer’s resources
...
### <a name="auth-request-oauth-20"></a>Auth request (OAuth 2.0)
...
### <a name="token-request-oauth20-code-grant-flow"></a>Token request (OAuth2.0 Code Grant Flow)
...
#### <a name="get-applications-permissions-on-subscription"></a>Get Application's Permissions on Subscription
