...
# <a name="azure-backup-for-sql-server-workloads-using-dpm"></a>Azure Backup for SQL Server workloads using DPM
...
## <a name="create-a-backup-policy-to-protect-sql-server-databases-to-azure"></a>Create a backup policy to protect SQL Server databases to Azure
...
## <a name="on-demand-backup-of-a-sql-server-database"></a>On-demand backup of a SQL Server database
...
## <a name="recover-a-sql-server-database-from-azure"></a>Recover a SQL Server database from Azure
