...
# <a name="first-look-back-up-files-and-folders-with-azure-backup-using-the-resource-manager-deployment-model"></a>First look: back up files and folders with Azure Backup using the Resource Manager deployment model
...
## <a name="step-1-get-an-azure-subscription"></a>Step 1: Get an Azure subscription
...
## <a name="step-3---download-files"></a>Step 3 - Download files
...
## <a name="step-4--install-and-register-the-agent"></a>Step 4 -Install and register the agent
...
## <a name="step-5-back-up-your-files-and-folders"></a>Step 5: Back up your files and folders
