...
# <a name="plan-your-vm-backup-infrastructure-in-azure"></a>Plan your VM backup infrastructure in Azure
...
## <a name="how-does-azure-back-up-virtual-machines"></a>How does Azure back up virtual machines?
...
## <a name="performance-and-resource-utilization"></a>Performance and resource utilization
...
### <a name="storage-account-limits"></a>Storage account limits
...
### <a name="number-of-disks"></a>Number of disks
...
### <a name="backup-schedule"></a>Backup schedule
...
### <a name="backup-throughput"></a>Backup throughput
...
## <a name="total-vm-backup-time"></a>Total VM backup time
...
## <a name="how-are-protected-instances-calculated"></a>How are protected instances calculated?
