...
# <a name="restore-key-vault-key-and-secret-for-encrypted-vms-using-azure-backup"></a>Restore Key Vault key and secret for encrypted VMs using Azure Backup
...
## <a name="setup-recovery-services-vault"></a>Setup recovery services vault 
...
### <a name="set-recovery-services-vault-context"></a>Set recovery services vault context
...
### <a name="get-recovery-point"></a>Get recovery point 
...
## <a name="restore-encrypted-virtual-machine"></a>Restore encrypted virtual machine
Use the following steps to restore encrypted VM, its key and secret.

### <a name="restore-key"></a>Restore key
...
### <a name="restore-secret"></a>Restore secret
...
### <a name="restore-virtual-machine"></a>Restore virtual machine
