...
# <a name="deploy-and-manage-backup-to-azure-for-data-protection-manager-dpm-servers-using-powershell"></a>Deploy and manage backup to Azure for Data Protection Manager (DPM) servers using PowerShell
...
## <a name="installing-the-azure-backup-agent-on-a-dpm-server"></a>Installing the Azure Backup agent on a DPM Server
...
## <a name="registering-dpm-to-a-recovery-services-vault"></a>Registering DPM to a Recovery Services Vault
...
### <a name="initial-configuration-settings"></a>Initial configuration settings
...
## <a name="configuring-the-staging-area"></a>Configuring the staging Area
...
## <a name="protect-data-to-azure-backup"></a>Protect data to Azure Backup
...
### <a name="creating-a-protection-group"></a>Creating a protection group
...
### <a name="adding-group-members-to-the-protection-group"></a>Adding group members to the Protection Group
...
### <a name="selecting-the-data-protection-method"></a>Selecting the data protection method
...
### <a name="setting-the-retention-range"></a>Setting the retention range
...
### <a name="set-the-backup-schedule"></a>Set the backup schedule
...
```
### <a name="changing-the-size-of-dpm-replica--recovery-point-volume"></a>Changing the size of DPM Replica & recovery point volume
...
### <a name="committing-the-changes-to-the-protection-group"></a>Committing the changes to the Protection Group
...
PS C:\> Set-DPMProtectionGroup -ProtectionGroup $MPG
```
## <a name="view-the-backup-points"></a>View the backup points
...
## <a name="restore-data-protected-on-azure"></a>Restore data protected on Azure
