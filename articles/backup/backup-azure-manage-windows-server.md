...
# <a name="monitor-and-manage-azure-recovery-services-vaults-and-servers-for-windows-machines"></a>Monitor and manage Azure recovery services vaults and servers for Windows machines
...
### <a name="access-your-recovery-services-vaults"></a>Access your Recovery Services vaults
...
## <a name="monitor-jobs-and-alerts"></a>Monitor jobs and alerts
...
## <a name="alerts-for-backups-using-azure-backup-agent"></a>Alerts for backups using Azure backup agent:
...
| Informational  | None  |
## <a name="manage-backup-alerts"></a>Manage Backup alerts
...
## <a name="manage-backup-items"></a>Manage Backup items
...
## <a name="manage-backup-jobs"></a>Manage Backup jobs
...
## <a name="monitor-backup-usage"></a>Monitor Backup usage
...
## <a name="production-servers"></a>Production servers
...
## <a name="open-the-backup-agent"></a>Open the backup agent
...
## <a name="manage-exclusion-settings"></a>Manage exclusion settings
...
## <a name="troubleshooting-monitoring-issues"></a>Troubleshooting Monitoring Issues
