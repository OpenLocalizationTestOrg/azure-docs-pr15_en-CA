...
### <a name="are-there-situations-where-email-isnt-sent-even-if-notifications-are-configured"></a>Are there situations where email isn't sent even if notifications are configured?
