...
## <a name="why-backup-from-dpm-to-azure"></a>Why backup from DPM to Azure?
...
### <a name="1-create-a-recovery-services-vault"></a>1. Create a recovery services vault
...
### <a name="2-download-vault-credentials"></a>2. Download vault credentials
...
### <a name="3-install-backup-agent"></a>3. Install Backup Agent
