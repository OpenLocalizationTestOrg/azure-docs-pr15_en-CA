...
# <a name="restore-virtual-machines-in-azure"></a>Restore virtual machines in Azure
...
## <a name="restore-workflow"></a>Restore workflow

### <a name="1-choose-an-item-to-restore"></a>1. Choose an item to restore
...
### <a name="2-pick-a-recovery-point"></a>2. Pick a recovery point
...
### <a name="3-specify-a-destination-location"></a>3. Specify a destination location
...
## <a name="post-restore-steps"></a>Post-Restore steps
...
## <a name="backup-for-restored-vms"></a>Backup for Restored VMs
...
## <a name="restoring-a-vm-during-azure-datacenter-disaster"></a>Restoring a VM during Azure DataCenter Disaster
...
## <a name="restoring-domain-controller-vms"></a>Restoring Domain Controller VMs
...
### <a name="restoring-from-the-ui"></a>Restoring from the UI:
...
### <a name="restoring-from-powershell"></a>Restoring from PowerShell:
