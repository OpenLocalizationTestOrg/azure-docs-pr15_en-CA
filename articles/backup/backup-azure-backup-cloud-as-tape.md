...
# <a name="use-azure-backup-to-replace-your-tape-infrastructure"></a>Use Azure Backup to replace your tape infrastructure
...
## <a name="what-is-the-backup-schedule"></a>What is the Backup Schedule?
...
## <a name="what-is-the-retention-policy"></a>What is the Retention Policy?
...
## <a name="example--putting-both-together"></a>Example – Putting both together
