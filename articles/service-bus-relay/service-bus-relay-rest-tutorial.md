...
# <a name="service-bus-relay-rest-tutorial"></a>Service Bus Relay REST tutorial
...
## <a name="step-1-create-a-service-namespace"></a>Step 1: Create a service namespace
...
## <a name="step-2-define-a-rest-based-wcf-service-contract-to-use-with-service-bus"></a>Step 2: Define a REST-based WCF service contract to use with Service Bus
...
## <a name="step-3-implement-a-rest-based-wcf-service-contract-to-use-service-bus"></a>Step 3: Implement a REST-based WCF service contract to use Service Bus
...
### <a name="to-implement-a-rest-style-service-bus-contract"></a>To implement a REST-style Service Bus contract
...
### <a name="to-define-the-configuration-for-running-the-web-service-on-service-bus"></a>To define the configuration for running the web service on Service Bus
...
## <a name="step-4-host-the-rest-based-wcf-service-to-use-service-bus"></a>Step 4: Host the REST-based WCF service to use Service Bus
...
### <a name="to-create-and-configure-the-web-service-host"></a>To create and configure the web service host
...
### <a name="to-run-the-web-service-host"></a>To run the web service host
