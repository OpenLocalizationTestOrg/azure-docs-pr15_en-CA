...
# <a name="service-bus-relay-tutorial"></a>Service Bus Relay tutorial
...
## <a name="define-a-wcf-service-contract-to-use-with-service-bus"></a>Define a WCF service contract to use with Service Bus
...
### <a name="to-create-a-service-bus-contract-with-an-interface"></a>To create a Service Bus contract with an interface
...
## <a name="implement-the-wcf-contract-to-use-service-bus"></a>Implement the WCF contract to use Service Bus
...
### <a name="to-define-the-configuration-for-the-service-host"></a>To define the configuration for the service host
...
## <a name="host-and-run-a-basic-web-service-to-register-with-service-bus"></a>Host and run a basic Web service to register with Service Bus

This step describes how to run a basic Service Bus service.

### <a name="to-create-the-service-bus-credentials"></a>To create the Service Bus credentials
...
### <a name="to-create-a-base-address-for-the-service"></a>To create a base address for the service
...
### <a name="to-create-and-configure-the-service-host"></a>To create and configure the service host
...
### <a name="to-open-the-service-host"></a>To open the service host
...
## <a name="create-a-wcf-client-for-the-service-contract"></a>Create a WCF client for the service contract
...
## <a name="implement-the-wcf-client-to-call-service-bus"></a>Implement the WCF client to call Service Bus
...
### <a name="to-implement-a-client-application"></a>To implement a client application
...
## <a name="to-run-the-applications"></a>To run the applications
