...
# <a name="how-to-use-the-azure-service-bus-relay-service"></a>How to use the Azure Service Bus relay service
...
## <a name="what-is-the-service-bus-relay"></a>What is the Service Bus relay?
...
## <a name="get-the-service-bus-nuget-package"></a>Get the Service Bus NuGet package
...
## <a name="use-service-bus-to-expose-and-consume-a-soap-web-service-with-tcp"></a>Use Service Bus to expose and consume a SOAP web service with TCP
...
### <a name="how-to-create-the-service"></a>How to create the service
...
### <a name="configure-a-service-host-in-the-appconfig-file"></a>Configure a service host in the App.config file
...
### <a name="create-the-client"></a>Create the client

#### <a name="configure-a-client-programmatically"></a>Configure a client programmatically

To consume the service, you can construct a WCF client using a [ChannelFactory](https://msdn.microsoft.com/library/system.servicemodel.channelfactory.aspx) object. Service Bus uses a token-based security model implemented using SAS. The [TokenProvider](https://msdn.microsoft.com/library/azure/microsoft.servicebus.tokenprovider.aspx) class represents a security token provider with built-in factory methods that return some well-known token providers. The following example uses the [CreateSharedAccessSignatureTokenProvider](https://msdn.microsoft.com/library/azure/microsoft.servicebus.tokenprovider.createsharedaccesssignaturetokenprovider.aspx) method to handle the acquisition of the appropriate SAS token. The name and key are those obtained from the portal as described in the previous section.
...
#### <a name="configure-a-client-in-the-appconfig-file"></a>Configure a client in the App.config file
