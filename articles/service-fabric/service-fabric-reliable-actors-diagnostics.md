...
# <a name="diagnostics-and-performance-monitoring-for-reliable-actors"></a>Diagnostics and performance monitoring for Reliable Actors
...
### <a name="performance-counter-instance-names"></a>Performance counter instance names
...
#### <a name="service-fabric-actor-category"></a>Service Fabric Actor category
...
#### <a name="service-fabric-actor-method-category"></a>Service Fabric Actor Method category
...
## <a name="list-of-events-and-performance-counters"></a>List of events and performance counters

### <a name="actor-method-events-and-performance-counters"></a>Actor method events and performance counters
...
### <a name="concurrency-events-and-performance-counters"></a>Concurrency events and performance counters
...
### <a name="actor-state-management-events-and-performance-counters"></a>Actor state management events and performance counters
...
### <a name="events-related-to-actor-replicas"></a>Events related to actor replicas
...
### <a name="actor-activation-and-deactivation-events-and-performance-counters"></a>Actor activation and deactivation events and performance counters
...
### <a name="actor-request-processing-performance-counters"></a>Actor request processing performance counters
