...
# <a name="publish-an-application-to-a-remote-cluster-by-using-visual-studio"></a>Publish an application to a remote cluster by using Visual Studio
...
## <a name="the-artifacts-required-for-publishing"></a>The artifacts required for publishing
...
### <a name="publish-profiles"></a>Publish profiles
...
### <a name="application-parameter-files"></a>Application parameter files
...
## <a name="to-publish-an-application-by-using-the-publish-service-fabric-application-dialog-box"></a>To publish an application by using the Publish Service Fabric Application dialog box
...
## <a name="publish-to-an-arbitrary-cluster-endpoint-including-party-clusters"></a>Publish to an arbitrary cluster endpoint (including party clusters)
