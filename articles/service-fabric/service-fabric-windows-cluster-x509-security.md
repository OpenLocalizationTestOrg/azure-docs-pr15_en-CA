...
# <a name="secure-a-standalone-cluster-on-windows-using-x509-certificates"></a>Secure a standalone cluster on Windows using X.509 certificates
...
## <a name="which-certificates-will-you-need"></a>Which certificates will you need?
...
## <a name="aquire-the-x509-certificates"></a>Aquire the X.509 certificates
...
## <a name="optional-create-a-self-signed-certificate"></a>Optional: Create a self-signed certificate
...
## <a name="install-the-certificates"></a>Install the certificates
