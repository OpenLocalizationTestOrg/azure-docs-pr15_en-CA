...
# <a name="add-or-remove-nodes-to-a-standalone-service-fabric-cluster-running-on-windows-server"></a>Add or remove nodes to a standalone Service Fabric cluster running on Windows Server
...
## <a name="add-nodes-to-your-cluster"></a>Add nodes to your cluster
...
## <a name="remove-nodes-from-your-cluster"></a>Remove nodes from your cluster
