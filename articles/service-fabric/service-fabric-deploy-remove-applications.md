...
# <a name="deploy-and-remove-applications-using-powershell"></a>Deploy and remove applications using PowerShell
...
## <a name="remove-an-application"></a>Remove an application
