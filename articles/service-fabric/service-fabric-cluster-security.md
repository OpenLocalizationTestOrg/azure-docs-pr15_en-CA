...
## <a name="x509-certificates-and-service-fabric"></a>X.509 certificates and Service Fabric
...
### <a name="server-x509-certificates"></a>Server X.509 certificates
...
### <a name="client-x509-certificates"></a>Client X.509 certificates
