...
## <a name="help-secure-a-service-when-youre-using-service-remoting"></a>Help secure a service when you're using service remoting
...
## <a name="help-secure-a-service-when-youre-using-a-wcf-based-communication-stack"></a>Help secure a service when you're using a WCF-based communication stack
