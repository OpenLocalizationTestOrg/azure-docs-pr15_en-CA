...
# <a name="use-system-health-reports-to-troubleshoot"></a>Use system health reports to troubleshoot
...
> [AZURE.NOTE] To understand health-related concepts, read more at [Service Fabric health model](service-fabric-health-introduction.md).
...
## <a name="cluster-system-health-reports"></a>Cluster system health reports
...
### <a name="neighborhood-loss"></a>Neighborhood loss
...
## <a name="node-system-health-reports"></a>Node system health reports
...
### <a name="node-updown"></a>Node up/down
...
### <a name="certificate-expiration"></a>Certificate expiration
...
### <a name="load-capacity-violation"></a>Load capacity violation
...
## <a name="application-system-health-reports"></a>Application system health reports
...
## <a name="service-system-health-reports"></a>Service system health reports
...
### <a name="unplaced-replicas-violation"></a>Unplaced replicas violation
...
## <a name="partition-system-health-reports"></a>Partition system health reports
...
### <a name="replica-constraint-violation"></a>Replica constraint violation
...
## <a name="replica-system-health-reports"></a>Replica system health reports
...
### <a name="slow-service-api-call"></a>Slow service API call
...
### <a name="replication-queue-full"></a>Replication queue full
...
### <a name="slow-naming-operations"></a>Slow Naming operations
...
## <a name="deployedapplication-system-health-reports"></a>DeployedApplication system health reports
...
## <a name="deployedservicepackage-system-health-reports"></a>DeployedServicePackage system health reports
**System.Hosting** is the authority on deployed entities.

### <a name="service-package-activation"></a>Service package activation
...
### <a name="code-package-activation"></a>Code package activation
...
### <a name="service-type-registration"></a>Service type registration
...
### <a name="upgrade-validation"></a>Upgrade validation
