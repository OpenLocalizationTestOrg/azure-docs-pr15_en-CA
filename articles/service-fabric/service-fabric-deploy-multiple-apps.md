...
# <a name="deploy-multiple-guest-executables"></a>Deploy multiple guest executables
...
## <a name="manually-package-the-multiple-guest-executable-application"></a>Manually package the multiple guest executable application
...
### <a name="packaging-the-nodejs-application"></a>Packaging the Node.js application
...
```
### <a name="packaging-the-mongodb-application"></a>Packaging the MongoDB application
...
### <a name="publishing-the-application"></a>Publishing the application
