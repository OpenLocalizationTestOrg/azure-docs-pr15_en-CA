...
# <a name="get-started-service-fabric-web-api-services-with-owin-self-hosting"></a>Get started: Service Fabric Web API services with OWIN self-hosting
...
## <a name="introduction-to-web-api-in-service-fabric"></a>Introduction to Web API in Service Fabric
...
## <a name="service-hosting"></a>Service hosting
...
## <a name="self-host-web-api-with-an-owin-host"></a>Self-host Web API with an OWIN host
...
## <a name="set-up-the-web-server"></a>Set up the web server
...
## <a name="implement-openasync"></a>Implement OpenAsync
...
## <a name="implement-closeasync-and-abort"></a>Implement CloseAsync and Abort
...
## <a name="start-the-web-server"></a>Start the web server
...
## <a name="run-and-connect-through-a-web-browser"></a>Run and connect through a web browser
...
## <a name="scale-it-out"></a>Scale it out
