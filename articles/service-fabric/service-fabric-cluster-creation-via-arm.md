...
# <a name="create-a-service-fabric-cluster-in-azure-using-azure-resource-manager"></a>Create a Service Fabric cluster in Azure using Azure Resource Manager
...
## <a name="set-up-key-vault"></a>Set up Key Vault
...
## <a name="add-certificates-to-key-vault"></a>Add certificates to Key Vault
...
### <a name="cluster-and-server-certificate-required"></a>Cluster and server certificate (required) 
...
### <a name="application-certificates-optional"></a>Application certificates (optional)
...
### <a name="formatting-certificates-for-azure-resource-provider-use"></a>Formatting certificates for Azure resource provider use
...
## <a name="set-up-azure-active-directory-for-client-authentication"></a>Set up Azure Active Directory for client authentication
...
## <a name="create-a-service-fabric-cluster-resource-manager-template"></a>Create a Service Fabric cluster Resource Manager template
...
### <a name="add-certificates"></a>Add certificates
...
#### <a name="add-all-certificates-to-the-vmss-osprofile"></a>Add all certificates to the VMSS osProfile
...
#### <a name="configure-service-fabric-cluster-certificate"></a>Configure Service Fabric cluster certificate
...
### <a name="insert-aad-config"></a>Insert AAD config
...
## <a name="assign-users-to-roles"></a>Assign users to roles
...
##  <a name="create-secure-clusters-on-linux"></a>Create secure clusters on Linux
...
## <a name="troubleshoot-setting-up-azure-active-directory-for-client-authentication"></a>Troubleshoot setting up Azure Active Directory for client authentication
...
### <a name="service-fabric-explorer-prompts-for-selecting-certificate"></a>Service Fabric Explorer prompts for selecting certificate
...
### <a name="connect-with-powershell-fails-with-error-the-specified-credentials-are-invalid"></a>Connect with PowerShell fails with error: The specified credentials are invalid
...
### <a name="service-fabric-explorer-signing-in-return-failure-aadsts50011"></a>Service Fabric Explorer signing in return failure: AADSTS50011
...
### <a name="can-i-reuse-the-same-aad-tenant-for-multiple-clusters"></a>Can I reuse the same AAD tenant for multiple clusters?
...
### <a name="why-do-i-still-need-server-certificate-while-aad-enabled"></a>Why do I still need server certificate while AAD enabled?
