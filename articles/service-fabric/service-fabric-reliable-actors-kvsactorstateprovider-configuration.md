...
# <a name="configuring-reliable-actors--kvsactorstateprovider"></a>Configuring Reliable Actors--KVSActorStateProvider
...
## <a name="store-configuration"></a>Store configuration
