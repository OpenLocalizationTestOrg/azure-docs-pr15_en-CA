...
# <a name="view-service-fabric-health-reports"></a>View Service Fabric health reports
...
## <a name="health-queries"></a>Health queries
...
## <a name="get-application-health"></a>Get application health
...
## <a name="get-deployed-application-health"></a>Get deployed application health
...
## <a name="health-chunk-queries"></a>Health chunk queries
...
## <a name="general-queries"></a>General queries
...
## <a name="cluster-and-application-upgrades"></a>Cluster and application upgrades
...
## <a name="use-health-evaluations-to-troubleshoot"></a>Use health evaluations to troubleshoot
