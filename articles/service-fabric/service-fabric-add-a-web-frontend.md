...
# <a name="build-a-web-service-front-end-for-your-application-using-aspnet-core"></a>Build a web service front end for your application using ASP.NET Core
...
## <a name="add-an-aspnet-core-service-to-your-application"></a>Add an ASP.NET Core service to your application
...
## <a name="connect-the-services"></a>Connect the services
...
### <a name="create-the-interface"></a>Create the interface
...
### <a name="implement-the-interface-in-your-stateful-service"></a>Implement the interface in your stateful service
...
### <a name="expose-the-stateful-service-using-a-service-remoting-listener"></a>Expose the stateful service using a service remoting listener
...
### <a name="use-the-serviceproxy-class-to-interact-with-the-service"></a>Use the ServiceProxy class to interact with the service
...
## <a name="what-about-actors"></a>What about actors?
...
## <a name="how-web-services-work-on-your-local-cluster"></a>How web services work on your local cluster
