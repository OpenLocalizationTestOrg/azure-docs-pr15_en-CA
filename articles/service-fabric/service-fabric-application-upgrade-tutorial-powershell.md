...
# <a name="service-fabric-application-upgrade-using-powershell"></a>Service Fabric application upgrade using PowerShell
...
## <a name="step-1-build-and-deploy-the-visual-objects-sample"></a>Step 1: Build and deploy the Visual Objects sample
...
## <a name="step-2-update-the-visual-objects-sample"></a>Step 2: Update the Visual Objects sample
...
## <a name="step-3--decide-on-health-policies-and-upgrade-parameters"></a>Step 3:  Decide on health policies and upgrade parameters
...
## <a name="step-4-prepare-application-for-upgrade"></a>Step 4: Prepare application for upgrade
...
## <a name="step-5-start-the-application-upgrade"></a>Step 5: Start the application upgrade
