...
# <a name="introduction-to-service-fabric-health-monitoring"></a>Introduction to Service Fabric health monitoring
...
## <a name="health-entities-and-hierarchy"></a>Health entities and hierarchy
...
## <a name="health-states"></a>Health states
...
## <a name="health-policies"></a>Health policies
...
### <a name="cluster-health-policy"></a>Cluster health policy
...
### <a name="application-health-policy"></a>Application health policy
...
- [DefaultServiceTypeHealthPolicy](https://msdn.microsoft.com/library/azure/system.fabric.health.applicationhealthpolicy.defaultservicetypehealthpolicy.aspx). Specifies the default service type health policy, which replaces the default health policy for all service types in the application.
...
### <a name="service-type-health-policy"></a>Service type health policy
...
## <a name="health-evaluation"></a>Health evaluation
...
### <a name="health-report-aggregation"></a>Health report aggregation
...
### <a name="child-health-aggregation"></a>Child health aggregation
...
## <a name="health-reporting"></a>Health reporting
...
### <a name="health-reports"></a>Health reports
...
### <a name="health-events"></a>Health events
...
## <a name="example-report-and-evaluate-application-health"></a>Example: Report and evaluate application health
...
## <a name="health-model-usage"></a>Health model usage
