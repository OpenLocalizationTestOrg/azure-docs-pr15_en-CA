...
# <a name="application-upgrade-parameters"></a>Application upgrade parameters
...
<br>
## <a name="service-health-evaluation-during-application-upgrade"></a>Service health evaluation during application upgrade
