...
### <a name="deploy-the-diagnostics-extension-as-part-of-cluster-creation-through-the-portal"></a>Deploy the Diagnostics extension as part of cluster creation through the portal
...
### <a name="deploy-the-diagnostics-extension-as-part-of-cluster-creation-by-using-azure-resource-manager"></a>Deploy the Diagnostics extension as part of cluster creation by using Azure Resource Manager
...
### <a name="deploy-the-diagnostics-extension-to-an-existing-cluster"></a>Deploy the Diagnostics extension to an existing cluster
...
## <a name="update-diagnostics-to-collect-and-upload-logs-from-new-eventsource-channels"></a>Update Diagnostics to collect and upload logs from new EventSource channels
