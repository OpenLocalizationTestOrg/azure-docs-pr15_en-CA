...
# <a name="manage-application-parameters-for-multiple-environments"></a>Manage application parameters for multiple environments
...
## <a name="specifying-environment-specific-parameters"></a>Specifying environment-specific parameters
...
### <a name="default-services"></a>Default services
...
### <a name="per-environment-service-configuration-settings"></a>Per-environment service configuration settings
...
## <a name="identifying-environment-specific-parameters-during-deployment"></a>Identifying environment-specific parameters during deployment
...
### <a name="deploy-from-powershell"></a>Deploy from PowerShell
