...
# <a name="configure-security-policies-for-your-application"></a>Configure security policies for your application
...
## <a name="configure-the-policy-for-service-setupentrypoint"></a>Configure the policy for service SetupEntryPoint
...
### <a name="configure-the-policy-using-a-local-account"></a>Configure the policy using a local account
...
###  <a name="configure-the-policy-using-local-system-accounts"></a>Configure the policy using local system accounts
...
##  <a name="launch-powershell-commands-from-a-setupentrypoint"></a>Launch PowerShell commands from a SetupEntryPoint
...
## <a name="using-console-redirection-for-local-debugging"></a>Using console redirection for local debugging
...
## <a name="configure-policy-for-service-code-packages"></a>Configure policy for service code packages 
...
### <a name="create-local-user-groups"></a>Create local user groups
...
### <a name="create-local-users"></a>Create local users
...
### <a name="assign-policies-to-the-service-code-packages"></a>Assign policies to the service code packages
...
### <a name="apply-a-default-policy-to-all-service-code-packages"></a>Apply a default policy to all service code packages
...
~~~
### <a name="using-an-active-directory-domain-group-or-user"></a>Using an Active Directory domain group or user
...
## <a name="assign-securityaccesspolicy-for-http-and-https-endpoints"></a>Assign SecurityAccessPolicy for HTTP and HTTPS endpoints
...
## <a name="a-complete-application-manifest-example"></a>A complete application manifest example
