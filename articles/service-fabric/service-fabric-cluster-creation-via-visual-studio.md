...
# <a name="set-up-a-service-fabric-cluster-by-using-visual-studio"></a>Set up a Service Fabric cluster by using Visual Studio
...
## <a name="create-a-service-fabric-cluster-template-by-using-an-azure-resource-group-project"></a>Create a Service Fabric cluster template by using an Azure resource group project
...
## <a name="prepare-the-template-for-deployment"></a>Prepare the template for deployment
...
## <a name="optional-change-the-cluster-name"></a>Optional: change the cluster name
...
## <a name="optional-add-public-application-ports"></a>Optional: add public application ports
...
## <a name="deploy-the-template-by-using-visual-studio"></a>Deploy the template by using Visual Studio
