...
# <a name="configuration-settings-for-standalone-windows-cluster"></a>Configuration settings for standalone Windows cluster
...
## <a name="general-cluster-configurations"></a>General cluster configurations
...
#### <a name="endpoints-used-to-configure-the-node-types"></a>Endpoints used to configure the node types
