...
# <a name="use-powershell-to-manage-service-bus-and-event-hubs-resources"></a>Use PowerShell to manage Service Bus and Event Hubs resources
...
- An Azure subscription. Azure is a subscription-based platform. For more information about obtaining a subscription, see [purchase options][], [member offers][], or [free account][].
...
## <a name="include-a-reference-to-the-net-assembly-for-service-bus"></a>Include a reference to the .NET assembly for Service Bus
