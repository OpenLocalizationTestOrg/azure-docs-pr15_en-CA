...
# <a name="create-applications-that-use-service-bus-queues"></a>Create applications that use Service Bus queues
...
## <a name="why-queuing"></a>Why queuing?
...
### <a name="temporal-decoupling"></a>Temporal decoupling
...
### <a name="load-leveling"></a>Load leveling
...
### <a name="loose-coupling"></a>Loose coupling
...
### <a name="sign-up-for-an-azure-account"></a>Sign up for an Azure account
...
### <a name="create-the-queue"></a>Create the queue
...
### <a name="receiving-messages-from-the-queue"></a>Receiving messages from the queue
...
### <a name="use-the-queue-client"></a>Use the queue client
