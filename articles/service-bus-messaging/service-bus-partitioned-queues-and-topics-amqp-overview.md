...
# <a name="amqp-10-support-for-service-bus-partitioned-queues-and-topics"></a>AMQP 1.0 support for Service Bus partitioned queues and topics 
...
## <a name="use-amqp-with-partitioned-queues"></a>Use AMQP with partitioned queues
...
### <a name="create-partitioned-queues"></a>Create partitioned queues
...
### <a name="send-and-receive-messages-using-amqp"></a>Send and receive messages using AMQP
...
## <a name="use-amqp-with-partitioned-topics"></a>Use AMQP with partitioned topics
...
### <a name="create-partitioned-topics"></a>Create partitioned topics
