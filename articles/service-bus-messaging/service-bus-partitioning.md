...
## <a name="enable-partitioning"></a>Enable partitioning
...
## <a name="use-of-partition-keys"></a>Use of partition keys
...
### <a name="using-a-partition-key"></a>Using a partition key
...
### <a name="not-using-a-partition-key"></a>Not using a partition key
...
## <a name="advanced-topics-use-transactions-with-partitioned-entities"></a>Advanced topics: use transactions with partitioned entities
...
## <a name="using-sessions-with-partitioned-entities"></a>Using sessions with partitioned entities
...
## <a name="automatic-message-forwarding-with-partitioned-entities"></a>Automatic message forwarding with partitioned entities
...
## <a name="considerations-and-guidelines"></a>Considerations and guidelines
...
## <a name="latest-added-features"></a>Latest added features
...
## <a name="partitioned-entities-limitations"></a>Partitioned entities limitations
