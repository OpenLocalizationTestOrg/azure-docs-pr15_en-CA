...
# <a name="amqp-10-in-azure-service-bus-and-event-hubs-protocol-guide"></a>AMQP 1.0 in Azure Service Bus and Event Hubs protocol guide
...
## <a name="what-is-amqp"></a>What is AMQP?
...
## <a name="basic-amqp-scenarios"></a>Basic AMQP scenarios
...
### <a name="connections-and-sessions"></a>Connections and sessions
...
#### <a name="create-message-receiver"></a>Create Message Receiver
...
#### <a name="create-message-sender"></a>Create Message Sender
...
#### <a name="create-message-sender-error"></a>Create Message Sender (Error)
...
#### <a name="close-message-receiversender"></a>Close Message Receiver/Sender
...
#### <a name="send-success"></a>Send (Success)
...
#### <a name="send-error"></a>Send (Error)
...
#### <a name="multi-message-receive"></a>Multi-Message Receive
...
## <a name="advanced-service-bus-capabilities"></a>Advanced Service Bus capabilities
