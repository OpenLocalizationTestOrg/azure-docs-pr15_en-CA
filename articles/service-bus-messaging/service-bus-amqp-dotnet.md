...
# <a name="using-service-bus-from-net-with-amqp-10"></a>Using Service Bus from .NET with AMQP 1.0

[AZURE.INCLUDE [service-bus-selector-amqp](../../includes/service-bus-selector-amqp.md)]

## <a name="downloading-the-service-bus-sdk"></a>Downloading the Service Bus SDK
...
## <a name="configuring-net-applications-to-use-amqp-10"></a>Configuring .NET applications to use AMQP 1.0
...
### <a name="configuration-using-appconfig"></a>Configuration using App.config
...
## <a name="message-serialization"></a>Message serialization
...
## <a name="controlling-amqp-protocol-settings"></a>Controlling AMQP protocol settings
