...
# <a name="how-to-use-amqp-10-with-the-service-bus-net-api"></a>How to use AMQP 1.0 with the Service Bus .NET API
...
## <a name="download-the-service-bus-sdk"></a>Download the Service Bus SDK
...
### <a name="configure-via-appconfig"></a>Configure via App.config
...
### <a name="configure-the-service-bus-connection-string"></a>Configure the Service Bus connection string
...
### <a name="configure-the-entity-name"></a>Configure the entity name
...
### <a name="a-simple-net-application-using-a-service-bus-queue"></a>A simple .NET application using a Service Bus queue
