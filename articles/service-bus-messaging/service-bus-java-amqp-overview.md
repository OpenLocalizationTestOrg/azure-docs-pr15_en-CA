...
# <a name="amqp-10-support-in-service-bus"></a>AMQP 1.0 support in Service Bus
...
## <a name="introduction-what-is-amqp-10-and-why-is-it-important"></a>Introduction: What is AMQP 1.0 and why is it important?
...
## <a name="amqp-10-technical-features"></a>AMQP 1.0 technical features
...
## <a name="amqp-10-is-a-standard-with-a-capital-s"></a>AMQP 1.0 is a Standard (with a capital 'S')
...
## <a name="amqp-10-and-service-bus"></a>AMQP 1.0 and Service Bus
