...
## <a name="reliability-in-service-bus"></a>Reliability in Service Bus
...
### <a name="issue-for-an-azure-dependency"></a>Issue for an Azure dependency
...
### <a name="service-bus-failure-on-a-single-subsystem"></a>Service Bus failure on a single subsystem
...
### <a name="failure-of-service-bus-within-an-azure-datacenter"></a>Failure of Service Bus within an Azure datacenter
...
## <a name="paired-namespaces"></a>Paired namespaces
