...
##  <a name="principles-for-securing-customer-data-in-azure-government"></a>Principles for Securing Customer Data in Azure Government
...
###  <a name="protecting-customer-data-using-encryption"></a>Protecting Customer Data Using Encryption
...
#### <a name="best-practices-for-encryption"></a>Best practices for Encryption
...
###  <a name="protecting-customer-data-by-managing-secrets"></a>Protecting Customer Data by Managing Secrets
...
#### <a name="best-practices-for-managing-secrets"></a>Best Practices for Managing Secrets
...
###  <a name="isolation-to-restrict-data-access"></a>Isolation to Restrict Data Access
...
#### <a name="environment-isolation"></a>Environment Isolation
...
#### <a name="per-customer-isolation"></a>Per-Customer Isolation
