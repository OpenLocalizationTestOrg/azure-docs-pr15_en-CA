...
### <a name="21-update-the-offer-description-and-logos"></a>2.1 Update the offer description and logos
...
### <a name="22-update-the-sku-description"></a>2.2. Update the SKU description
...
### <a name="23-change-the-existing-links-or-add-new-links"></a>2.3 Change the existing links or add new links
...
### <a name="24-change-an-existing-sample-image-or-add-a-new-sample-image"></a>2.4 Change an existing sample image or add a new sample image
...
### <a name="25-update-the-legal-content"></a>2.5 Update the legal content
...
### <a name="26-update-the-support-information"></a>2.6 Update the support information
...
### <a name="27-update-the-categories"></a>2.7 Update the categories
