...
# <a name="general-prerequisites-for-creating-an-offer-for-the-azure-marketplace"></a>General prerequisites for creating an offer for the Azure Marketplace
...
## <a name="ensure-that-you-are-registered-as-a-seller-with-microsoft"></a>Ensure that you are registered as a seller with Microsoft
...
## <a name="steps-to-add-a-co-admin-in-the-publishing-portal"></a>Steps to add a co-admin in the Publishing Portal
...
## <a name="steps-to-delete-a-co-admin-in-the-publishing-portal"></a>Steps to delete a co-admin in the Publishing portal
...
## <a name="acquire-an-azure-pay-as-you-go-subscription"></a>Acquire an Azure "pay-as-you-go" subscription
...
## <a name="sell-from-countries"></a>"Sell-from" countries
> [AZURE.WARNING]
