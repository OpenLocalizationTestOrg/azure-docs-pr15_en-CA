...
#### <a name="functionjson-for-mobile-apps-input-binding"></a>function.json for Mobile Apps input binding
...
#### <a name="azure-mobile-apps-code-example-for-a-nodejs-queue-trigger"></a>Azure Mobile Apps code example for a Node.js queue trigger
...
#### <a name="functionjson-for-mobile-apps-output-binding"></a>function.json for Mobile Apps output binding
