...
#### <a name="functionjson-for-storage-queue-trigger"></a>function.json for storage queue trigger
...
#### <a name="functionjson-for-storage-queue-output-binding"></a>function.json for storage queue output binding
...
#### <a name="functionjson-for-storage-blob-trigger"></a>function.json for storage blob trigger
...
#### <a name="functionjson-for-a-storage-blob-input-or-output-binding"></a>function.json for a storage blob input or output binding
...
#### <a name="functionjson-for-storage-tables"></a>function.json for storage tables
