...
## <a name="functionjson-for-http-and-webhook-bindings"></a>function.json for HTTP and webhook bindings
...
## <a name="example-nodejs-code-for-an-http-trigger-function"></a>Example Node.js code for an HTTP trigger function 
...
## <a name="example-nodejs-code-for-a-github-webhook-function"></a>Example Node.js code for a GitHub WebHook function 
