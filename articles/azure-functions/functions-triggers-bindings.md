...
## <a name="dynamic-parameter-binding"></a>Dynamic parameter binding 
...
## <a name="random-guids"></a>Random GUIDs
...
## <a name="returning-a-single-output"></a>Returning a single output
...
## <a name="route-support"></a>Route support
