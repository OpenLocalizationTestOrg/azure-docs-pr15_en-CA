...
# <a name="get-started-with-the-http-listener-and-http-action-and-add-it-to-your-logic-app"></a>Get started with the HTTP listener and HTTP action and add it to your Logic App
...
## <a name="creating-an-http-listener-for-your-logic-app"></a>Creating an HTTP listener for your Logic App
...
7. Lastly, set the security settings of the API App to Public (Anonymous) to allow external clients to access the end point. This setting is available under "All settings > Application Settings" of the HTTP Listener API App:![][10]

Once that’s done, you can now create a logic app to use the HTTP listener.

## <a name="using-the-http-listener-in-your-logic-app"></a>Using the HTTP listener in your Logic App
...
## <a name="using-the-http-action"></a>Using the HTTP action
