...
# <a name="connect-to-on-premises-connectors-using-the-hybrid-connection-manager"></a>Connect to on-premises connectors using the Hybrid Connection Manager
...
## <a name="get-the-service-bus-connection-string"></a>Get the Service Bus Connection String
...
## <a name="install-the-hybrid-connection-manager"></a>Install the Hybrid Connection Manager
...
## <a name="tcp-ports-and-security"></a>TCP Ports and Security
...
### <a name="on-premises-troubleshooting"></a>On-premises troubleshooting
...
### <a name="in-the-azure-classic-portal"></a>In the Azure classic portal
