...
# <a name="logic-apps-error-and-exception-handling"></a>Logic Apps Error and Exception Handling
...
## <a name="runafter-property-to-catch-failures"></a>RunAfter property to catch failures
...
## <a name="scopes-and-results-to-evaluate-actions"></a>Scopes and results to evaluate actions
...
### <a name="getting-the-context-of-failures-with-results"></a>Getting the context of failures with results
...
## <a name="azure-diagnostics-and-telemetry"></a>Azure Diagnostics and telemetry
