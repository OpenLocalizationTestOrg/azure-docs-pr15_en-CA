...
#<a name="biztalk-rules"></a>BizTalk Rules
...
##<a name="rules-concepts"></a>Rules Concepts
...
###<a name="policy-composition"></a>Policy composition
...
###<a name="policy-testing"></a>Policy testing
...
##<a name="sample-scenario---insurance-claims"></a>Sample Scenario - Insurance Claims
...
##<a name="creation-of-rules-api-app"></a>Creation of Rules Api App
...
4. Select the *Create* button ![Alt text][3]
...
##<a name="vocabulary-creation"></a>Vocabulary Creation
...
2.Select “Vocabulary definitions”. This would show you the Vocabulary Authoring Screen 3.Select “Add” to begin adding new vocabulary definitions.
There are 2 types of vocabulary definitions currently supported – Literal and XML.

##<a name="literal-definition"></a>Literal Definition
1.  After clicking on “Add”, a new “Add Definition” Blade Opens up. Enter the following values
  ...
  4.    Data type – this allows users to select the data type of the definition. Currently 4 data types are supported: i.  String – these values must be entered in double quotes (“Example String”)  
...
##<a name="policy-creation"></a>Policy Creation
...
##<a name="rule-creation"></a>Rule Creation
...
##<a name="explicit-forward-chaining"></a>Explicit Forward Chaining
...
##<a name="enabledisable-rules"></a>Enable\Disable Rules
...
##<a name="rule-priority"></a>Rule Priority
...
##<a name="test-policy"></a>Test Policy
...
## <a name="using-rules-in-logic-apps"></a>Using Rules in Logic Apps
...
## <a name="using-rules-via-apis"></a>Using Rules via APIs
...
## <a name="editing-vocabulary-and-policy"></a>Editing Vocabulary and Policy
