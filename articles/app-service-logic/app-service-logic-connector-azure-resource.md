...
# <a name="get-started-with-the-azure-resource-connector-and-add-it-to-your-logic-app"></a>Get started with the Azure Resource Connector and add it to your Logic app
>[AZURE.NOTE] This version of the article applies to Logic apps 2014-12-01-preview schema version.

Use the Azure Resource Connector to easily manage Azure Resources inside of your Logic app.

## <a name="create-the-azure-resource-connector"></a>Create the Azure Resource Connector
...
## <a name="using-the-azure-resource-connector-in-logic-apps-designer"></a>Using the Azure Resource Connector in Logic apps designer
