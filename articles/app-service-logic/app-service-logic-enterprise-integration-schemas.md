...
### <a name="add-a-schema-file-less-than-2-mb"></a>Add a schema file less than 2 MB  
...
### <a name="add-a-schema-file-larger-than-2-mb-up-to-a-maximum-of-8-mb"></a>Add a schema file larger than 2 MB (up to a maximum of 8 MB)  
