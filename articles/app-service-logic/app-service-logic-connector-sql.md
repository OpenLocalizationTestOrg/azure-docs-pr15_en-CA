...
# <a name="get-started-with-the-microsoft-sql-connector-and-add-it-to-your-logic-app"></a>Get started with the Microsoft SQL Connector and add it to your Logic App
...
## <a name="create-the-sql-connector"></a>Create the SQL Connector
...
## <a name="use-the-connector-as-a-trigger"></a>Use the Connector as a Trigger
...
#### <a name="data-available-query-example"></a>Data Available Query Example

    SELECT COUNT(*) FROM [Order] WHERE OrderStatus = 'ProcessedForCollection'

#### <a name="poll-data-query-example"></a>Poll Data Query Example
...
### <a name="add-the-trigger"></a>Add the Trigger
...
## <a name="use-the-connector-as-an-action"></a>Use the Connector as an Action
...
## <a name="what-you-can-and-cannot-do"></a>What you can and cannot do
