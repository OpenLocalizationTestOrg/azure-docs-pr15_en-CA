...
##<a name="create-a-new-android-studio-project"></a>Create a new Android Studio Project
...
### <a name="updating-the-androidmanifestxml"></a>Updating the AndroidManifest.xml.
