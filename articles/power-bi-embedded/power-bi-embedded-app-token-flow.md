...
# <a name="authenticating-and-authorizing-with-power-bi-embedded"></a>Authenticating and authorizing with Power BI Embedded
...
## <a name="two-ways-to-authenticate"></a>Two ways to authenticate
...
## <a name="heres-how-the-flow-works"></a>Here's how the flow works
