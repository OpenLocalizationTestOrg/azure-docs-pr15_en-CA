...
# <a name="connect-to-a-data-source"></a>Connect to a data source
...
## <a name="benefits-of-using-directquery"></a>Benefits of using DirectQuery
...
<a name="measures"/>
## <a name="directquery-and-measures"></a>DirectQuery and measures
