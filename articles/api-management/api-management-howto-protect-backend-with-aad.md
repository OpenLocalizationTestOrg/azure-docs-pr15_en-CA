...
## <a name="configure-an-api-management-oauth-20-authorization-server"></a>Configure an API Management OAuth 2.0 authorization server
...
## <a name="enable-oauth-20-user-authorization-for-the-calculator-api"></a>Enable OAuth 2.0 user authorization for the Calculator API
