...
# <a name="using-external-services-from-the-azure-api-management-service"></a>Using external services from the Azure API Management service
...
### <a name="alerting-with-slack"></a>Alerting with Slack
...
### <a name="is-fire-and-forget-good-enough"></a>Is fire and forget good enough?
...
### <a name="authorizing-reference-tokens"></a>Authorizing reference tokens
...
### <a name="standardized-introspection"></a>Standardized introspection
...
### <a name="extracting-the-token"></a>Extracting the token
...
### <a name="making-the-validation-request"></a>Making the validation request
...
### <a name="checking-the-response"></a>Checking the response
...
### <a name="reporting-failure"></a>Reporting failure
...
### <a name="final-solution"></a>Final solution
...
## <a name="response-composition"></a>Response Composition
...
### <a name="building-a-dashboard"></a>Building a dashboard   
...
### <a name="faking-the-resource"></a>Faking the resource
...
### <a name="making-the-requests"></a>Making the requests
