...
# <a name="how-to-secure-back-end-services-using-client-certificate-authentication-in-azure-api-management"></a>How to secure back-end services using client certificate authentication in Azure API Management
