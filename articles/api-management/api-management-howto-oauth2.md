...
# <a name="how-to-authorize-developer-accounts-using-oauth-20-in-azure-api-management"></a>How to authorize developer accounts using OAuth 2.0 in Azure API Management
