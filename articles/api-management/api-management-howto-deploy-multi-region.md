...
# <a name="how-to-deploy-an-azure-api-management-service-instance-to-multiple-azure-regions"></a>How to deploy an Azure API Management service instance to multiple Azure regions
