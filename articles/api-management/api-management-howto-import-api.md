...
# <a name="how-to-import-the-definition-of-an-api-with-operations-in-azure-api-management"></a>How to import the definition of an API with operations in Azure API Management
