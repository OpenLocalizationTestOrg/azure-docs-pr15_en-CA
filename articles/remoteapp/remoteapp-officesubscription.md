...
# <a name="how-to-use-your-office-365-subscription-with-azure-remoteapp"></a>How to use your Office 365 subscription with Azure RemoteApp
...
## <a name="how-do-i-use-office-365-accounts-for-azure-remoteapp"></a>How do I use Office 365 accounts for Azure RemoteApp?
...
## <a name="can-i-use-my-office-365-subscription-to-run-office-applications-in-azure-remoteapp"></a>Can I use my Office 365 subscription to run Office applications in Azure RemoteApp?
...
## <a name="ok-so-how-are-my-office-365-proplus-licenses-used-with-azure-remoteapp"></a>Ok, so how are my Office 365 ProPlus licenses used with Azure RemoteApp?
...
## <a name="which-office-applications-can-i-use-with-office-365-and-azure-remoteapp"></a>Which Office applications can I use with Office 365 and Azure RemoteApp?

You can use your Office 365 subscription to activate and share Office 2013 in Azure RemoteApp deployments. We currently do not support the use of other versions of Office with Azure RemoteApp. This includes Office 2003, Office 2007, Office 2010 and Office 2016.

## <a name="what-about-visio-pro-or-project-pro"></a>What about Visio Pro or Project Pro?
...
## <a name="how-do-i-get-started-with-office-365-and-azure-remoteapp"></a>How do I get started with Office 365 and Azure RemoteApp?
...
## <a name="can-i-create-a-custom-image-with-office-365-proplus"></a>Can I create a custom image with Office 365 ProPlus?
...
### <a name="use-the-azure-gallery-image"></a>Use the Azure gallery image
...
### <a name="use-a-custom-image"></a>Use a custom image
...
### <a name="disable-automatic-updates-for-office-365-proplus-in-your-custom-image---important"></a>Disable automatic updates for Office 365 ProPlus in your custom image - IMPORTANT
...
## <a name="so-how-can-i-update-an-image-with-office-365-proplus"></a>So how can I update an image with Office 365 ProPlus?
...
### <a name="replace-your-image-with-the-latest-azure-gallery-image--add-customizations"></a>Replace your image with the latest Azure gallery image + add customizations
...
### <a name="manually-update-your-existing-image"></a>Manually update your existing image
