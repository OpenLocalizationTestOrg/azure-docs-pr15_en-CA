...
# <a name="get-started-with-azure-data-lake-store-using-the-azure-portal"></a>Get started with Azure Data Lake Store using the Azure Portal
...
## <a name="delete-azure-data-lake-store-account"></a>Delete Azure Data Lake Store account
