...
# <a name="integrating-data-lake-store-with-other-azure-services"></a>Integrating Data Lake Store with other Azure Services
...
## <a name="use-data-lake-store-with-azure-hdinsight"></a>Use Data Lake Store with Azure HDInsight
...
## <a name="use-data-lake-store-with-azure-data-lake-analytics"></a>Use Data Lake Store with Azure Data Lake Analytics
...
## <a name="use-data-lake-store-with-azure-data-factory"></a>Use Data Lake Store with Azure Data Factory
...
## <a name="copy-data-from-azure-storage-blobs-into-data-lake-store"></a>Copy data from Azure Storage Blobs into Data Lake Store
...
## <a name="copy-data-between-azure-sql-database-and-data-lake-store"></a>Copy data between Azure SQL Database and Data Lake Store
...
## <a name="use-data-lake-store-with-stream-analytics"></a>Use Data Lake Store with Stream Analytics
...
## <a name="use-data-lake-store-with-power-bi"></a>Use Data Lake Store with Power BI
...
## <a name="use-data-lake-store-with-data-catalog"></a>Use Data Lake Store with Data Catalog
