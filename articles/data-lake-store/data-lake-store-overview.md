...
# <a name="overview-of-azure-data-lake-store"></a>Overview of Azure Data Lake Store
...
### <a name="built-for-hadoop"></a>Built for Hadoop
...
### <a name="unlimited-storage-petabyte-files"></a>Unlimited storage, petabyte files
...
### <a name="performance-tuned-for-big-data-analytics"></a>Performance-tuned for big data analytics
...
### <a name="enterprise-ready-highly-available-and-secure"></a>Enterprise-ready: Highly-available and secure
...
## <a name="applications-compatible-with-azure-data-lake-store"></a>Applications compatible with Azure Data Lake Store
...
## <a name="what-is-azure-data-lake-store-file-system-adl"></a>What is Azure Data Lake Store file system (adl://)?
...
## <a name="how-do-i-start-using-azure-data-lake-store"></a>How do I start using Azure Data Lake Store?
...
## <a name="data-lake-store-videos"></a>Data Lake Store videos
