...
#<a name="azure-disk-encryption-for-windows-and-linux-iaas-vms"></a>Azure Disk Encryption for Windows and Linux IaaS VMs
...
### <a name="encryption-scenarios"></a>Encryption Scenarios
...
### <a name="encryption-features"></a>Encryption Features
...
### <a name="encryption-workflow"></a>Encryption Workflow
...
### <a name="decryption-workflow"></a>Decryption Workflow
...
- Azure disk encryption does not support port numbers being specified as part of Key Vault secret and KEK URLs. See below examples for supported Key Vault URL:
    - Unaccepted Key Vault URL   *https://contosovault.vault.azure.net:443/secrets/contososecret/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx*
...
#### <a name="setup-the-azure-ad-application-in-azure-active-directory"></a>Setup the Azure AD Application in Azure Active Directory
...
##### <a name="client-secret-based-authentication-for-azure-ad"></a>Client secret based authentication for Azure AD

The sections that follow have the necessary steps to configure a client secret based authentication for Azure AD.

##### <a name="create-a-new-azure-ad-app-using-azure-powershell"></a>Create a new Azure AD app using Azure PowerShell
...
##### <a name="provisioning-the-azure-ad-client-id-and-secret-from-the-azure-classic-deployment-model-portal"></a>Provisioning the Azure AD client ID and secret from the Azure Classic deployment model Portal
...
##### <a name="use-an-existing-app"></a>Use an existing app
...
#### <a name="certificate-based-authentication-for-azure-ad"></a>Certificate based authentication for Azure AD
...
##### <a name="create-a-new-azure-ad-app"></a>Create a new Azure AD app
...
##### <a name="use-an-existing-azure-ad-app"></a>Use an existing Azure AD app
...
##### <a name="upload-a-pfx-file-to-key-vault"></a>Upload a PFX file to Key Vault
...
##### <a name="deploy-a-certificate-in-key-vault-to-an-existing-vm"></a>Deploy a certificate in Key Vault to an existing VM
...
#### <a name="setting-key-vault-access-policy-for-the-azure-ad-application"></a>Setting Key Vault Access policy for the Azure AD Application
...
### <a name="setting-and-configuring-azure-key-vault-for-azure-disk-encryption-usage"></a>Setting and Configuring Azure Key Vault for Azure disk encryption usage
...
#### <a name="create-a-new-key-vault"></a>Create a New Key Vault
...
#### <a name="provisioning-a-key-encryption-key-optional"></a>Provisioning a Key Encryption Key (optional)
...
#### <a name="set-key-vault-permissions-to-allow-the-azure-platform-access-to-the-keys-and-secrets"></a>Set Key Vault permissions to allow the Azure platform access to the keys and secrets
...
## <a name="disk-encryption-deployment-scenarios-and-user-experiences"></a>Disk Encryption deployment scenarios and user experiences
...
### <a name="enable-encryption-on-new-iaas-vms-created-from-the-azure-gallery"></a>Enable encryption on new IaaS VM’s created from the Azure Gallery
...
### <a name="enable-encryption-on-new-iaas-vms-created-from-customer-encrypted-vhd-and-encryption-keys"></a>Enable encryption on new IaaS VM’s created from Customer Encrypted VHD and encryption keys
...
#### <a name="using-resource-manager-template"></a>Using Resource Manager template
...
#### <a name="using-powershell-cmdlets"></a>Using PowerShell cmdlets
...
#### <a name="using-cli-commands"></a>Using CLI Commands
...
2. To enable encryption on an existing/running VM, type:  *azure vm enable-disk-encryption --resource-group <resourceGroupName> --name <vmName> --aad-client-id <aadClientId> --aad-client-secret <aadClientSecret> --disk-encryption-key-vault-url <keyVaultURL> --disk-encryption-key-vault-id <keyVaultResourceId>*
...
### <a name="enable-encryption-on-existing-or-running-iaas-windows-vm-in-azure"></a>Enable encryption on existing or running IaaS Windows VM in Azure
...
### <a name="enable-encryption-on-existing-or-running-iaas-linux-vm-in-azure"></a>Enable encryption on existing or running IaaS Linux VM in Azure
...
### <a name="get-encryption-status-of-an-encrypted-iaas-vm"></a>Get encryption status of an encrypted IaaS VM
...
#### <a name="get-encryption-status-of-an-encrypted-windows-vm-using-azure-resource-manager-portal"></a>Get encryption status of an encrypted Windows VM using Azure Resource Manager portal
...
#### <a name="get-encryption-status-of-an-encrypted-windowslinux-iaas-vm-using-disk-encryption-ps-cmdlet"></a>Get encryption status of an encrypted (Windows/Linux) IaaS VM using disk encryption PS Cmdlet
...
#### <a name="get-encryption-status-of-the-iaas-vm-from-disk-encryption-cli-command"></a>Get encryption status of the IaaS VM from disk encryption CLI command
...
#### <a name="disable-encryption-on-running-windows-iaas-vm"></a>Disable Encryption on running Windows IaaS VM
...
##### <a name="disable-encryption-on-existingrunning-iaas-vm-in-azure-using-resource-manager-template"></a>Disable encryption on existing/running IaaS VM in Azure using Resource Manager template
...
##### <a name="disable-encryption-on-existingrunning-iaas-vm-in-azure-using-ps-cmdlet"></a>Disable encryption on existing/running IaaS VM in Azure using PS cmdlet
...
### <a name="connect-to-your-subscription"></a>Connect to your subscription
...
### <a name="preparing-a-pre-encrypted-windows-vhd"></a>Preparing a pre-encrypted Windows VHD
...
#### <a name="update-group-policy-to-allow-non-tpm-for-os-protection"></a>Update group policy to allow non-TPM for OS protection
...
#### <a name="prepare-os-volume-for-bitlocker-using-bdehdcfg"></a>Prepare OS volume for BitLocker using`bdehdcfg`

Execute the command below to compress the OS partition and prepare the machine for BitLocker.

    bdehdcfg -target c: shrink -quiet

#### <a name="using-bitlocker-to-protect-the-os-volume"></a>Using BitLocker to protect the OS volume
...
#### <a name="encrypting-os-drive-on-a-running-linux-vm"></a>Encrypting OS drive on a running Linux VM
...
#### <a name="preparing-a-pre-encrypted-linux-vhd"></a>Preparing a pre-encrypted Linux VHD

##### <a name="ubuntu-16"></a>Ubuntu 16

###### <a name="configure-encryption-during-distro-install"></a>Configure encryption during distro install
...
###### <a name="configure-encryption-to-work-with-azure"></a>Configure encryption to work with Azure
...
### <a name="upload-disk-encryption-secret-for-the-pre-encrypted-vm-to-key-vault"></a>Upload disk encryption secret for the pre-encrypted VM to Key Vault
...
### <a name="specify-secret-url-when-attaching-os-disk"></a>Specify secret URL when attaching OS Disk
...
## <a name="download-this-guide"></a>Download this Guide
