...
# <a name="manage-dns-records-and-record-sets-by-using-cli"></a>Manage DNS records and record sets by using CLI
...
## <a name="configure-the-cross-platform-azure-cli"></a>Configure the cross-platform Azure CLI
...
## <a name="retrieve-a-record-set"></a>Retrieve a record set
...
### <a name="to-list-record-sets-of-a-given-type"></a>To list record sets of a given type
...
## <a name="update-a-record-in-a-record-set"></a>Update a record in a record set

### <a name="to-add-another-ip-address-1234-to-an-existing-a-record-set-www"></a>To add another IP address (1.2.3.4) to an existing "A" record set ("www"):
...
### <a name="to-remove-an-existing-value-from-a-record-set"></a>To remove an existing value from a record set
...
### <a name="remove-a-ptr-record-from-a-record-set"></a>Remove a PTR record from a record set
