...
#<a name="managing-media-services-entities-with-rest-api"></a>Managing Media Services Entities with REST API
...
##<a name="adding-entities"></a>Adding entities
...
##<a name="querying-entities"></a>Querying entities
...
##<a name="updating-entities"></a>Updating entities
...
##<a name="deleting-entities"></a>Deleting entities
