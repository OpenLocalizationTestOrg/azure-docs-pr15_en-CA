<properties 
    pageTitle="Configure Content Key Authorization Policy using Media Services REST API | Microsoft Azure" 
...
#<a name="dynamic-encryption-configure-content-key-authorization-policy"></a>Dynamic encryption: Configure Content Key Authorization Policy
...
####<a name="link-contentkeyauthorizationpolicies-with-options"></a>Link ContentKeyAuthorizationPolicies with Options

Link ContentKeyAuthorizationPolicies with Options as shown [here](#ContentKeyAuthorizationPolicies).

####<a name="add-authorization-policy-to-the-content-key"></a>Add authorization policy to the content key
