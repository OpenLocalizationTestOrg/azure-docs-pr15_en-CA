...
#<a name="managing-assets-and-related-entities-with-media-services-net-sdk"></a>Managing Assets and Related Entities with Media Services .NET SDK
...
##<a name="get-an-asset-reference"></a>Get an Asset Reference
...
##<a name="get-a-job-reference"></a>Get a Job Reference
...
WarningWarning You may need to get a job reference when starting a long-running encoding job, and need to check the job status on a thread. In cases like this, when the method returns from a thread, you need to retrieve a refreshed reference to a job.
...
##<a name="list-all-assets"></a>List All Assets
...
##<a name="list-jobs-and-assets"></a>List Jobs and Assets
...
##<a name="list-all-access-policies"></a>List All Access Policies
...
##<a name="list-all-locators"></a>List All Locators
...
## <a name="enumerating-through-large-collections-of-entities"></a>Enumerating through large collections of entities
...
##<a name="delete-an-asset"></a>Delete an Asset
...
##<a name="delete-an-access-policy"></a>Delete an Access Policy
