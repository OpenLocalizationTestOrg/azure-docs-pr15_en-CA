<properties 
    pageTitle="Managing Media Services Assets across Multiple Storage Accounts | Microsoft Azure" 
...
#<a name="managing-media-services-assets-across-multiple-storage-accounts"></a>Managing Media Services Assets across Multiple Storage Accounts
...
##<a name="to-attach-a-storage-account-with-azure-service-management-rest-api"></a>To attach a Storage Account with Azure Service Management REST API
...
##<a name="to-manage-media-services-assets-across-multiple-storage-accounts"></a>To manage Media Services assets across multiple Storage Accounts
