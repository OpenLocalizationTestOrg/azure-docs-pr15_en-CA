...
# <a name="connecting-to-media-services-account-using-media-services-sdk-for-net"></a>Connecting to Media Services Account using Media Services SDK for .NET
...
## <a name="connecting-to-media-services"></a>Connecting to Media Services
...
## <a name="creating-a-cloudmediacontext-instance"></a>Creating a CloudMediaContext Instance
...
## <a name="reusing-access-control-service-tokens"></a>Reusing Access Control Service Tokens
...
## <a name="connecting-to-a-media-services-account-located-in-the-north-china-region"></a>Connecting to a Media Services account located in the North China region
...
## <a name="storing-connection-values-in-configuration"></a>Storing Connection Values in Configuration
