...
#<a name="widevine-license-template-overview"></a>Widevine license template overview
...
##<a name="json-message"></a>JSON message
...
##<a name="content-key-specs"></a>Content Key Specs 
...
##<a name="policy-overrides"></a>Policy Overrides 
...
##<a name="session-initialization"></a>Session Initialization
...
##<a name="configure-your-widevine-licenses-using-net-types"></a>Configure your Widevine licenses using .NET types

Media Services provides .NET APIs that let you configure your Widevine licenses. 

###<a name="classes-as-defined-in-the-media-services-net-sdk"></a>Classes as defined in the Media Services .NET SDK
