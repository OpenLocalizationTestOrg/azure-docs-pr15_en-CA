...
#<a name="cenc-with-multi-drm-and-access-control-a-reference-design-and-implementation-on-azure-and-azure-media-services"></a>CENC with Multi-DRM and Access Control: A Reference Design and Implementation on Azure and Azure Media Services

##<a name="key-words"></a>Key words
...
##<a name="in-this-article"></a>In this article
...
### <a name="overview-of-this-article"></a>Overview of this article
...
## <a name="a-reference-design"></a>A reference design
...
## <a name="mapping-design-to-technology-for-implementation"></a>Mapping design to technology for implementation
...
###<a name="implementation-procedures"></a>Implementation procedures
...
### <a name="some-gotchas-in-implementation"></a>Some gotchas in implementation
...
## <a name="additional-topics-for-implementation"></a>Additional Topics for Implementation
Next we will disc uss some additional topics in our design and implementation.
...
### <a name="azure-active-directory-signing-key-rollover"></a>Azure Active Directory signing key rollover
...
### <a name="where-is-the-access-token"></a>Where is the Access Token?
...
### <a name="what-about-live-streaming"></a>What about Live Streaming?
...
### <a name="what-about-license-servers-outside-of-azure-media-services"></a>What about license servers outside of Azure Media Services?
...
### <a name="what-if-i-want-to-use-a-custom-sts"></a>What if I want to use a custom STS?
...
## <a name="the-completed-system-and-test"></a>The completed system and test
...
### <a name="using-encrypted-media-extensions-for-playready"></a>Using Encrypted Media Extensions for PlayReady
...
#### <a name="using-eme-for-widevine"></a>Using EME for Widevine
...
### <a name="not-entitled-users"></a>Not entitled users
...
### <a name="running-custom-secure-token-service"></a>Running custom Secure Token Service
