...
#<a name="detect-face-and-emotion-with-azure-media-analytics"></a>Detect Face and Emotion with Azure Media Analytics
...
##<a name="face-detector-input-files"></a>Face Detector input files

Video files. Currently, the following formats are supported: MP4, MOV, and WMV.

##<a name="face-detector-output-files"></a>Face Detector output files
...
##<a name="face-detection-input-and-output-example"></a>Face detection input and output example
...
##<a name="emotion-detection-input-and-output-example"></a>Emotion detection input and output example
...
####<a name="aggregate-defaults"></a>Aggregate defaults
