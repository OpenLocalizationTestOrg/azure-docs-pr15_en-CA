...
# <a name="deliver-content-to-customers"></a>Deliver content to customers
...
## <a name="streaming-url-formats"></a>Streaming URL formats
...
### <a name="apple-http-live-streaming-hls-format-with-audio-only-filter"></a>Apple HTTP Live Streaming (HLS) format with audio-only filter
...
### <a name="hds-for-adobe-primetimeaccess-licensees-only"></a>HDS (for Adobe PrimeTime/Access licensees only)
...
### <a name="changes-to-smooth-streaming-manifest-version"></a>Changes to Smooth Streaming manifest version
