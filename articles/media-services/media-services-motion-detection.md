...
# <a name="detect-motions-with-azure-media-analytics"></a>Detect Motions with Azure Media Analytics
...
##<a name="motion-detector-input-files"></a>Motion Detector input files
...
###<a name="json-example"></a>JSON example
...
##<a name="motion-detector-output-files"></a>Motion Detector output files
