...
#<a name="inserting-ads-on-the-client-side"></a>Inserting ads on the client side
...
###<a name="using-a-video-ad-service-template-vast-file"></a>Using a Video Ad Service Template (VAST) File
...
###<a name="using-a-digital-video-multiple-ad-playlist-vmap-file"></a>Using a Digital Video Multiple Ad Playlist (VMAP) File
...
###<a name="using-a-media-abstract-sequencing-template-mast-file"></a>Using a Media Abstract Sequencing Template (MAST) File
...
###<a name="using-video-player-ad-interface-definition-vpaid"></a>Using Video Player-Ad Interface Definition (VPAID)
...
##<a name="implementing-a-windows-or-windows-phone-8-player-with-ad-support"></a>Implementing a Windows or Windows Phone 8 Player with Ad Support
...
##<a name="implementing-an-ios-video-player-with-ad-support"></a>Implementing an iOS Video Player with Ad Support
...
###<a name="scheduling-ads-with-vmap"></a>Scheduling Ads with VMAP
...
###<a name="scheduling-ads-with-vast"></a>Scheduling Ads with VAST
