...
#<a name="how-to-build-a-smooth-streaming-windows-store-application"></a>How to Build a Smooth Streaming Windows Store Application
...
##<a name="lesson-1-create-a-basic-smooth-streaming-store-application"></a>Lesson 1: Create a Basic Smooth Streaming Store Application
...
For more information on developing Windows Store application, see [Develop Great Apps for Windows 8](http://msdn.microsoft.com/windows/apps/br229512.aspx). This lesson contains the following procedures:
...
##<a name="lesson-2-add-a-slider-bar-to-control-the-media-progress"></a>Lesson 2: Add a Slider Bar to Control the Media Progress
...
##<a name="lesson-3-select-smooth-streaming-streams"></a>Lesson 3: Select Smooth Streaming Streams
...
1. From Solution Explorer, right-click **MainPage.xaml**, and then click **View Code**.
2. Inside the SSPlayer namespace, add a new class:      #region class Stream
...
##<a name="lesson-4-select-smooth-streaming-tracks"></a>Lesson 4: Select Smooth Streaming Tracks
