...
# <a name="protect-your-hls-content-with-apple-fairplay-andor-microsoft-playready"></a>Protect your HLS content with Apple FairPlay and/or Microsoft PlayReady
...
##<a name="steps-for-configuring-fairplay-dynamic-encryption-and-license-delivery-services"></a>Steps for configuring FairPlay dynamic encryption and license delivery services
...
- restrictions (open or token), - and information specific to the key delivery type that defines how the key is delivered to the client. 
...
##<a name="using-fairplay-key-delivery-by-playerclient-apps"></a>Using FairPlay key delivery by player/client apps
...
##<a name="net-example"></a>.NET example
