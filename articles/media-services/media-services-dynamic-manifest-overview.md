...
# <a name="filters-and-dynamic-manifests"></a>Filters and dynamic manifests
...
###<a name="dynamic-manifests"></a>Dynamic manifests
...
##<a name="rendition-filtering"></a>Rendition filtering 
...
##<a name="removing-language-tracks"></a>Removing language tracks
...
##<a name="trimming-start-of-an-asset"></a>Trimming start of an asset 
...
##<a name="creating-sub-clips-views-from-a-live-archive"></a>Creating sub-clips (views) from a live archive
...
##<a name="adjusting-presentation-window-dvr"></a>Adjusting Presentation Window (DVR)
...
##<a name="adjusting-livebackoff-live-position"></a>Adjusting LiveBackoff (live position)
...
##<a name="combining-multiple-rules-in-a-single-filter"></a>Combining multiple rules in a single filter
...
##<a name="create-filters-programmatically"></a>Create filters programmatically
...
## <a name="combining-multiple-filters-filter-composition"></a>Combining multiple filters (filter composition)
...
##<a name="know-issues-and-limitations"></a>Know issues and limitations
