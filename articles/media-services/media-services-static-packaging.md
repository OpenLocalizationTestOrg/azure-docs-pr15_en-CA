...
# <a name="using-azure-media-packager-to-accomplish-static-packaging-tasks"></a>Using Azure Media Packager to accomplish static packaging tasks
...
## <a name="validating-adaptive-bitrate-mp4s-encoded-with-external-encoders"></a>Validating Adaptive Bitrate MP4s Encoded with External Encoders
...
## <a name="using-static-encryption-to-protect-your-smooth-and-mpeg-dash-with-playready"></a>Using Static Encryption to Protect your Smooth and MPEG DASH with PlayReady
...
## <a name="using-static-encryption-to-protect-hlsv3-with-aes-128"></a>Using Static Encryption to Protect HLSv3 with AES-128
...
## <a name="using-static-encryption-to-protect-hlsv3-with-playready"></a>Using Static Encryption to Protect HLSv3 with PlayReady
