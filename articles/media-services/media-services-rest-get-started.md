...
#<a name="get-started-with-delivering-content-on-demand-using-rest"></a>Get started with delivering content on demand using REST 
...
###<a name="getting-an-access-token"></a>Getting an access token
...
###<a name="connecting-to-the-media-services-uri"></a>Connecting to the Media Services URI
...
### <a name="create-an-assetfile"></a>Create an AssetFile
...
### <a name="creating-the-accesspolicy-with-write-permission"></a>Creating the AccessPolicy with write permission. 
...
### <a name="get-the-upload-url"></a>Get the Upload URL
...
### <a name="upload-a-file-into-a-blob-storage-container"></a>Upload a file into a blob storage container
...
### <a name="update-the-assetfile"></a>Update the AssetFile 
...
If successful, the following is returned: HTTP/1.1 204 No Content

## <a name="delete-the-locator-and-accesspolicy"></a>Delete the Locator and AccessPolicy 
...
### <a name="get-the-streaming-endpoint-you-want-to-update"></a>Get the streaming endpoint you want to update
...
### <a name="scale-the-streaming-endpoint"></a>Scale the streaming endpoint
...
### <a name="monitor-processing-progress"></a>Monitor Processing Progress
...
### <a name="get-the-output-asset"></a>Get the output asset 
...
###<a name="creating-the-accesspolicy-with-read-permission"></a>Creating the AccessPolicy with read permission
...
###<a name="creating-a-sas-url-for-downloading-content"></a>Creating a SAS URL for downloading content 
...
### <a name="creating-a-streaming-url-for-streaming-content"></a>Creating a streaming URL for streaming content
