<properties 
    pageTitle="Create ContentKeys with REST | Microsoft Azure" 
...
#<a name="create-contentkeys-with-rest"></a>Create ContentKeys with REST
...
##<a name="create-the-contentkey"></a>Create the ContentKey 
