<properties 
    pageTitle="Encrypting your Content with Storage Encryption using AMS REST API" 
...
#<a name="encrypting-your-content-with-storage-encryption-using-ams-rest-api"></a>Encrypting your Content with Storage Encryption using AMS REST API
...
##<a name="storage-encryption-overview"></a>Storage encryption overview 
...
###<a name="retrieve-the-protectionkeyid"></a>Retrieve the ProtectionKeyId 
...
###<a name="retrieve-the-protectionkey-for-the-protectionkeyid"></a>Retrieve the ProtectionKey for the ProtectionKeyId
...
### <a name="create-the-content-key"></a>Create the content key 
...
##<a name="associate-the-contentkey-with-an-asset"></a>Associate the ContentKey with an Asset
