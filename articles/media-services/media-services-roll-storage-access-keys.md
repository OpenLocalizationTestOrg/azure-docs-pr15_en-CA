...
#<a name="update-media-services-after-rolling-storage-access-keys"></a>Update Media Services after rolling storage access keys
...
## <a name="step-1-regenerate-secondary-storage-access-key"></a>Step 1: Regenerate secondary storage access key
...
##<a name="step-3-update-locators"></a>Step 3: Update locators
...
##<a name="step-5-regenerate--primary-storage-access-key"></a>Step 5: Regenerate  primary storage access key
...
##<a name="step-6-update-media-services-to-use-the-new-primary-storage-key"></a>Step 6: Update Media Services to use the new primary storage key
...
##<a name="step-7-update-locators"></a>Step 7: Update locators  
