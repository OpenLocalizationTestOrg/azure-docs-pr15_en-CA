...
#<a name="implementing-failover-streaming-scenario"></a>Implementing failover streaming scenario
...
##<a name="add-code-that-handles-redundancy-for-on-demand-streaming"></a>Add code that handles redundancy for On-Demand streaming.
