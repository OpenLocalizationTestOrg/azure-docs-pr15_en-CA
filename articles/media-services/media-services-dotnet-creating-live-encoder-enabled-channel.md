...
#<a name="how-to-perform-live-streaming-using-azure-media-services-to-create-multi-bitrate-streams-with-net"></a>How to perform live streaming using Azure Media Services to create multi-bitrate streams with .NET
...
## <a name="what-youll-learn"></a>What you'll learn
...
##<a name="set-up-for-development-with-media-services-sdk-for-net"></a>Set up for development with Media Services SDK for .NET
