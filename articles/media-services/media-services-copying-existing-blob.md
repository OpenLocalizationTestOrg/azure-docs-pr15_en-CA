...
#<a name="copying-an-existing-blob-into-a-media-services-asset"></a>Copying an Existing Blob into a Media Services Asset
...
##<a name="copy-blobs-from-a-storage-account-into-a-media-services-asset"></a>Copy Blobs from a Storage Account into a Media Services Asset
