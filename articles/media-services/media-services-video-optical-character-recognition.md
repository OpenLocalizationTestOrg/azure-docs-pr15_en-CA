...
#<a name="use-azure-media-analytics-to-convert-text-content-in-video-files-into-digital-text"></a>Use Azure Media Analytics to convert text content in video files into digital text 
...
##<a name="ocr-input-files"></a>OCR input files

Video files. Currently, the following formats are supported: MP4, MOV, and WMV.

##<a name="task-configuration"></a>Task configuration 
...
####<a name="json-preset-example"></a>JSON preset example
...
####<a name="xml-preset-example"></a>XML preset example
...
##<a name="ocr-output-files"></a>OCR output files

The output of the OCR media processor is a JSON file.

###<a name="elements-of-the-output-json-file"></a>Elements of the output JSON file
...
###<a name="json-output-example"></a>JSON output example
