...
# <a name="get-started-with-delivering-content-on-demand-using-java"></a>Get started with delivering content on demand using Java

[AZURE.INCLUDE [media-services-selector-get-started](../../includes/media-services-selector-get-started.md)]

##<a name="setting-up-an-azure-account-for-media-services"></a>Setting Up an Azure Account for Media Services
...
##<a name="setting-up-for-media-services-development"></a>Setting up for Media Services development
...
##<a name="how-to-use-media-services-with-java"></a>How to: Use Media Services with Java
