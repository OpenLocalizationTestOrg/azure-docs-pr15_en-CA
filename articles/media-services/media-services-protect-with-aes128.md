...
#<a name="using-aes-128-dynamic-encryption-and-key-delivery-service"></a>Using AES-128 dynamic encryption and key delivery service
...
##<a name="aes-128-dynamic-encryption-and-key-delivery-service-workflow"></a>AES-128 Dynamic Encryption and Key Delivery Service Workflow
...
###<a name="request-the-key-from-the-key-delivery-service"></a>Request the key from the key delivery service
