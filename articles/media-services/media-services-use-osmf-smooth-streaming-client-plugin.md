...
# <a name="how-to-use-the-microsoft-smooth-streaming-plugin-for-the-adobe-open-source-media-framework"></a>How to Use the Microsoft Smooth Streaming Plugin for the Adobe Open Source Media Framework
...
###<a name="smooth-streaming-plugin-for-osmf-20"></a>Smooth Streaming plugin for OSMF 2.0
...
## <a name="supported-features-and-known-issues"></a>Supported features and known issues
...
## <a name="loading-the-plugin"></a>Loading the Plugin
...
###<a name="ss-for-osmf-static-loading"></a>SS for OSMF Static Loading
...
###<a name="ss-for-osmf-dynamic-loading"></a>SS for OSMF Dynamic Loading
...
##<a name="strobe-media--playback-with-the-ss-odmf-dynamic-plugin"></a>Strobe Media  Playback with the SS ODMF Dynamic Plugin
