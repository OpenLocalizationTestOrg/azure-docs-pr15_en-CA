...
# <a name="using-multiple-input-files-and-component-properties-with-premium-encoder"></a>Using multiple input files and component properties with Premium Encoder
...
## <a name="configuration-string-syntax"></a>Configuration string syntax
...
## <a name="customizing-component-properties"></a>Customizing component properties  

### <a name="property-with-a-simple-value"></a>Property with a simple value
...
### <a name="property-with-an-xml-value"></a>Property with an XML value
...
### <a name="propertypath-value"></a>propertyPath value
...
## <a name="multiple-input-files"></a>Multiple input files
...
### <a name="clip-list-xml-customization"></a>Clip List XML customization
...
### <a name="step-by-step-workflow-creation-that-overlays-a-logo-on-top-of-the-video"></a>Step-by-step workflow creation that overlays a logo on top of the video     
