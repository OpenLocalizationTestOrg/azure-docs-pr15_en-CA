...
# <a name="build-and-deploy-the-mydriving-solution-to-your-environment"></a>Build and deploy the MyDriving solution to your environment
...
## <a name="sign-up-for-accounts"></a>Sign up for accounts
...
## <a name="install-development-tools"></a>Install development tools
...
### <a name="windows-development-machine"></a>Windows development machine
...
### <a name="mac-development-machine"></a>Mac development machine
...
## <a name="fetch-the-github-repository"></a>Fetch the GitHub repository
...
## <a name="get-a-bing-maps-api-key"></a>Get a Bing maps API key
...
## <a name="build-the-demo-app"></a>Build the demo app
...
## <a name="get-to-know-the-code"></a>Get to know the code
...
## <a name="run-the-apps-in-development-mode"></a>Run the apps in development mode
...
## <a name="upload-the-mobile-app-to-hockeyapp"></a>Upload the mobile app to HockeyApp
...
## <a name="test-the-mobile-app-on-xamarin-test-cloud"></a>Test the mobile app on Xamarin Test Cloud
...
## <a name="deploy-azure-services"></a>Deploy Azure services
...
### <a name="edit-the-template"></a>Edit the template
...
### <a name="run-the-template"></a>Run the template
...
## <a name="set-up-build-and-test-definitions-in-visual-studio-team-services"></a>Set up build and test definitions in Visual Studio Team Services
...
### <a name="build-definitions"></a>Build definitions
...
### <a name="release-definitions"></a>Release definitions
...
## <a name="explore-telemetry-by-using-application-insights"></a>Explore telemetry by using Application Insights
...
## <a name="estimate-operational-costs"></a>Estimate operational costs
...
## <a name="send-us-your-feedback"></a>Send us your feedback
