...
# <a name="migrate-your-sql-code-to-sql-data-warehouse"></a>Migrate your SQL code to SQL Data Warehouse
...
## <a name="common-t-sql-limitations"></a>Common T-SQL Limitations
...
## <a name="supported-cte-features"></a>Supported CTE features
...
## <a name="cte-limitations"></a>CTE Limitations
...
## <a name="recursive-ctes"></a>Recursive CTEs
...
## <a name="unsupported-system-functions"></a>Unsupported system functions
...
## <a name="rowcount-workaround"></a>@@ROWCOUNTworkaround
