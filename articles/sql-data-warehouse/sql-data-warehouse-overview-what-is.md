...
# <a name="what-is-azure-sql-data-warehouse"></a>What is Azure SQL Data Warehouse?
...
## <a name="optimized-for-data-warehouse-workloads"></a>Optimized for data warehouse workloads
...
## <a name="predictable-and-scalable-performance"></a>Predictable and scalable performance
...
## <a name="pause-and-scale-on-demand"></a>Pause and scale on demand
...
## <a name="built-on-sql-server"></a>Built on SQL Server
...
## <a name="integrated-with-microsoft-tools"></a>Integrated with Microsoft tools
...
## <a name="hybrid-data-sources-scenarios"></a>Hybrid data sources scenarios
