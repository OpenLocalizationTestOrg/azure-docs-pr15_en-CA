...
# <a name="system-views"></a>System views

## <a name="sql-data-warehouse-catalog-views"></a>SQL Data Warehouse catalog views
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL Data Warehouse dynamic management views (DMVs)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL Server DMVs applicable to SQL Data Warehouse
...
## <a name="sql-server-catalog-views"></a>SQL Server catalog views
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>SQL Server DMVs available in SQL Data Warehouse
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>SQL Server 2016 PolyBase DMVs available in SQL Data Warehouse
