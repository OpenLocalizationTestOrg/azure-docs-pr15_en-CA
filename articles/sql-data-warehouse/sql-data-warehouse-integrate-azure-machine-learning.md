...
# <a name="use-azure-machine-learning-with-sql-data-warehouse"></a>Use Azure Machine Learning with SQL Data Warehouse
...
## <a name="read-data-from-sql-data-warehouse"></a>Read data from SQL Data Warehouse
...
## <a name="create-train-and-score-a-model"></a>Create, train and score a model
...
## <a name="write-data-to-azure-sql-data-warehouse"></a>Write data to Azure SQL Data Warehouse
