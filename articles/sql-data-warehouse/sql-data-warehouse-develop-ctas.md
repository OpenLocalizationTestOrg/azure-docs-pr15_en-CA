...
## <a name="using-ctas-to-copy-a-table"></a>Using CTAS to copy a table
...
## <a name="using-ctas-to-work-around-unsupported-features"></a>Using CTAS to work around unsupported features
...
## <a name="ansi-join-replacement-for-update-statements"></a>ANSI join replacement for update statements
...
## <a name="ansi-join-replacement-for-delete-statements"></a>ANSI join replacement for delete statements
...
## <a name="replace-merge-statements"></a>Replace merge statements
...
## <a name="ctas-recommendation-explicitly-state-data-type-and-nullability-of-output"></a>CTAS recommendation: Explicitly state data type and nullability of output
