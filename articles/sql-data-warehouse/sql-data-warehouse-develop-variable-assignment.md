...
# <a name="assign-variables-in-sql-data-warehouse"></a>Assign variables in SQL Data Warehouse
...
## <a name="setting-variables-with-declare"></a>Setting variables with DECLARE
...
## <a name="setting-values-with-set"></a>Setting values with SET
