...
# <a name="load-data-into-azure-sql-data-warehouse"></a>Load data into Azure SQL Data Warehouse
...
## <a name="load-from-azure-blob-storage"></a>Load from Azure blob storage
...
### <a name="1-use-polybase-and-t-sql"></a>1. Use PolyBase and T-SQL
...
### <a name="2-use-azure-data-factory"></a>2. Use Azure Data Factory
...
## <a name="load-from-sql-server"></a>Load from SQL Server
...
### <a name="use-integration-services-ssis"></a>Use Integration Services (SSIS)
...
### <a name="use-azcopy-recommended-for--10-tb-data"></a>Use AZCopy (recommended for < 10 TB data)
...
### <a name="use-importexport-recommended-for--10-tb-data"></a>Use Import/Export (recommended for > 10 TB data)
...
## <a name="load-from-hdinsight"></a>Load from HDInsight
