...
# <a name="language-elements"></a>Language elements

## <a name="core-elements"></a>Core elements
...
## <a name="batches-control-of-flow-and-variables"></a>Batches, control-of-flow, and variables
...
## <a name="wildcard-characters-to-match"></a>Wildcard character(s) to match
...
## <a name="diagnostic-sessions"></a>Diagnostic sessions
...
## <a name="set-statements"></a>SET statements
