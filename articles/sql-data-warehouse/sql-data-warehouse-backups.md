...
## <a name="what-is-a-data-warehouse-backup"></a>What is a data warehouse backup?
...
## <a name="azure-storage-blob-snapshots"></a>Azure Storage Blob snapshots
...
## <a name="geo-redundant-backups"></a>Geo-redundant backups
...
## <a name="data-warehouse-backup-schedule-and-retention-period"></a>Data warehouse backup schedule and retention period
...
### <a name="what-happens-to-my-backup-retention-while-my-data-warehouse-is-paused"></a>What happens to my backup retention while my data warehouse is paused?
...
### <a name="how-long-is-the-retention-period-for-a-dropped-data-warehouse"></a>How long is the retention period for a dropped data warehouse?
...
## <a name="data-warehouse-backup-costs"></a>Data warehouse backup costs
...
## <a name="using-database-backups"></a>Using database backups
