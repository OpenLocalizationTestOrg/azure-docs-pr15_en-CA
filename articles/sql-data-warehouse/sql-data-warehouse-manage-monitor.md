...
## <a name="monitor-connections"></a>Monitor connections
...
## <a name="monitor-query-execution"></a>Monitor query execution
...
### <a name="step-1-identify-the-query-you-wish-to-investigate"></a>STEP 1: Identify the query you wish to investigate
...
### <a name="step-2-investigate-the-query-plan"></a>STEP 2: Investigate the query plan
...
### <a name="step-3a-investigate-sql-on-the-distributed-databases"></a>STEP 3a: Investigate SQL on the distributed databases
...
### <a name="step-3b-investigate-data-movement-on-the-distributed-databases"></a>STEP 3b: Investigate data movement on the distributed databases
...
<a name="waiting"></a>
## <a name="monitor-waiting-queries"></a>Monitor waiting queries
