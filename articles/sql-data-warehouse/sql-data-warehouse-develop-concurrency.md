...
# <a name="concurrency-and-workload-management-in-sql-data-warehouse"></a>Concurrency and workload management in SQL Data Warehouse
...
## <a name="concurrency-limits"></a>Concurrency limits
...
## <a name="resource-classes"></a>Resource classes
...
### <a name="memory-allocations-per-distribution-mb"></a>Memory allocations per distribution (MB)
...
### <a name="memory-allocations-system-wide-gb"></a>Memory allocations system-wide (GB)
...
## <a name="concurrency-slot-consumption"></a>Concurrency slot consumption
...
### <a name="allocation-and-consumption-of-concurrency-slots"></a>Allocation and consumption of concurrency slots
...
## <a name="query-importance"></a>Query importance
...
### <a name="workload-group-mappings-to-concurrency-slots-and-importance"></a>Workload group mappings to concurrency slots and importance
...
### <a name="dw500-mapping-of-resource-classes-to-importance"></a>DW500 mapping of resource classes to importance
...
## <a name="queries-that-honor-concurrency-limits"></a>Queries that honor concurrency limits
...
## <a name="query-exceptions-to-concurrency-limits"></a>Query exceptions to concurrency limits
...
## <a name="change-a-user-resource-class-example"></a>Change a user resource class example
...
## <a name="queued-query-detection-and-other-dmvs"></a>Queued query detection and other DMVs
