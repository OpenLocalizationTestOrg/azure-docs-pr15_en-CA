...
# <a name="transactions-in-sql-data-warehouse"></a>Transactions in SQL Data Warehouse
...
## <a name="transaction-isolation-levels"></a>Transaction isolation levels
...
## <a name="transaction-size"></a>Transaction size
...
## <a name="transaction-state"></a>Transaction state
...
## <a name="using-throw-and-raiserror"></a>Using THROW and RAISERROR
