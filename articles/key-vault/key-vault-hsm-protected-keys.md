...
<tags
    ...
    ms.date="10/24/2016"
    ms.author="cabailey"/>
#<a name="how-to-generate-and-transfer-hsm-protected-keys-for-azure-key-vault"></a>How to generate and transfer HSM-protected keys for Azure Key Vault
...
##<a name="more-information-about-thales-hsms-and-microsoft-services"></a>More information about Thales HSMs and Microsoft services
...
##<a name="implementing-bring-your-own-key-byok-for-azure-key-vault"></a>Implementing bring your own key (BYOK) for Azure Key Vault
...
##<a name="prerequisites-for-byok"></a>Prerequisites for BYOK
...
##<a name="generate-and-transfer-your-key-to-azure-key-vault-hsm"></a>Generate and transfer your key to Azure Key Vault HSM
...
## <a name="step-1-prepare-your-internet-connected-workstation"></a>Step 1: Prepare your Internet-connected workstation
For this first step, do the following procedures on your workstation that is connected to the Internet.


###<a name="step-11-install-azure-powershell"></a>Step 1.1: Install Azure PowerShell
...
###<a name="step-12-get-your-azure-subscription-id"></a>Step 1.2: Get your Azure subscription ID
...
###<a name="step-13-download-the-byok-toolset-for-azure-key-vault"></a>Step 1.3: Download the BYOK toolset for Azure Key Vault
...
##<a name="step-2-prepare-your-disconnected-workstation"></a>Step 2: Prepare your disconnected workstation
...
###<a name="step-21-prepare-the-disconnected-workstation-with-thales-hsm"></a>Step 2.1: Prepare the disconnected workstation with Thales HSM
...
###<a name="step-22-install-the-byok-toolset-on-the-disconnected-workstation"></a>Step 2.2: Install the BYOK toolset on the disconnected workstation
...
##<a name="step-3-generate-your-key"></a>Step 3: Generate your key

For this third step, do the following procedures on the disconnected workstation.

###<a name="step-31-create-a-security-world"></a>Step 3.1: Create a security world
...
###<a name="step-32-validate-the-downloaded-package"></a>Step 3.2: Validate the downloaded package
...
###<a name="step-33-create-a-new-key"></a>Step 3.3: Create a new key
...
##<a name="step-4-prepare-your-key-for-transfer"></a>Step 4: Prepare your key for transfer

For this fourth step, do the following procedures on the disconnected workstation.

###<a name="step-41-create-a-copy-of-your-key-with-reduced-permissions"></a>Step 4.1: Create a copy of your key with reduced permissions
...
###<a name="step-42-inspect-the-new-copy-of-the-key"></a>Step 4.2: Inspect the new copy of the key
...
###<a name="step-43-encrypt-your-key-by-using-microsofts-key-exchange-key"></a>Step 4.3: Encrypt your key by using Microsoft’s Key Exchange Key
...
###<a name="step-44-copy-your-key-transfer-package-to-the-internet-connected-workstation"></a>Step 4.4: Copy your key transfer package to the Internet-connected workstation
...
##<a name="step-5-transfer-your-key-to-azure-key-vault"></a>Step 5: Transfer your key to Azure Key Vault
