...
#<a name="how-to-setup-key-vault-with-end-to-end-key-rotation-and-auditing"></a>How to setup Key Vault with end to end key rotation and auditing
...
##<a name="setting-up-keyvault"></a>Setting up KeyVault
...
##<a name="setting-up-application"></a>Setting up Application
...
##<a name="key-rotation-using-azure-automation"></a>Key Rotation using Azure Automation
...
##<a name="key-vault-auditing-pipeline"></a>Key Vault Auditing pipeline
