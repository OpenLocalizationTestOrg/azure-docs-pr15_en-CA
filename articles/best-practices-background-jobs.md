...
# <a name="background-jobs-guidance"></a>Background jobs guidance
...
## <a name="types-of-background-jobs"></a>Types of background jobs
...
### <a name="event-driven-triggers"></a>Event-driven triggers
...
### <a name="schedule-driven-triggers"></a>Schedule-driven triggers
...
## <a name="returning-results"></a>Returning results
...
## <a name="hosting-environment"></a>Hosting environment
...
## <a name="azure-web-apps-and-webjobs"></a>Azure Web Apps and WebJobs
...
## <a name="azure-cloud-services-web-and-worker-roles"></a>Azure Cloud Services web and worker roles
...
### <a name="running-background-tasks-in-the-web-role"></a>Running background tasks in the web role
...
### <a name="running-background-tasks-in-a-worker-role"></a>Running background tasks in a worker role
...
## <a name="resiliency-considerations"></a>Resiliency considerations
...
## <a name="scaling-and-performance-considerations"></a>Scaling and performance considerations
