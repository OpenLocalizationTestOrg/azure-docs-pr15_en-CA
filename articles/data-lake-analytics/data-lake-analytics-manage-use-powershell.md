...
# <a name="manage-azure-data-lake-analytics-using-azure-powershell"></a>Manage Azure Data Lake Analytics using Azure PowerShell
...
##<a name="install-azure-powershell-10-or-greater"></a>Install Azure PowerShell 1.0 or greater
...
###<a name="list-account"></a>List account
...
## <a name="manage-catalog-items"></a>Manage catalog items
...
###<a name="get-catalog-item-details"></a>Get catalog item details 
...
###<a name="test-existence-of--catalog-item"></a>Test existence of  catalog item
...
##<a name="appendix-a---data-lake-analytics-arm-template"></a>Appendix A - Data Lake Analytics ARM template

The following ARM template can be used to deploy a Data Lake Analytics account and its dependent Data Lake Store account.  Save it as a json file, and then use PowerShell script to call the template. For more information, see [Deploy an application with Azure Resource Manager template](../resource-group-template-deploy.md#deploy-with-powershell) and [Authoring Azure Resource Manager templates](../resource-group-authoring-templates.md).
