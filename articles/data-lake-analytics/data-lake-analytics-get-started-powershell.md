...
# <a name="tutorial-get-started-with-azure-data-lake-analytics-using-azure-powershell"></a>Tutorial: get started with Azure Data Lake Analytics using Azure PowerShell
...
##<a name="upload-data-to-data-lake"></a>Upload data to Data Lake
