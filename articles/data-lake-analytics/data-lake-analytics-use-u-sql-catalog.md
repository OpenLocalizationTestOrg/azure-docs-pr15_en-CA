...
# <a name="use-u-sql-catalog"></a>Use U-SQL catalog
...
## <a name="manage-catalogs"></a>Manage catalogs
...
### <a name="use-azure-portal"></a>Use Azure portal

See [Manage Data Lake Analytics using portal](data-lake-analytics-manage-use-portal.md#view-u-sql-catalog)


### <a name="use-data-lake-tools-for-visual-studio"></a>Use Data Lake Tools for Visual Studio.
