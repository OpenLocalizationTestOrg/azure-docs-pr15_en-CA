...
# <a name="move-data-to-and-from-azure-table-using-azure-data-factory"></a>Move data to and from Azure Table using Azure Data Factory
...
## <a name="sample-copy-data-from-azure-table-to-azure-blob"></a>Sample: Copy data from Azure Table to Azure Blob
...
## <a name="sample-copy-data-from-azure-blob-to-azure-table"></a>Sample: Copy data from Azure Blob to Azure Table
...
## <a name="azure-table-dataset-type-properties"></a>Azure Table Dataset type properties
...
## <a name="azure-table-copy-activity-type-properties"></a>Azure Table Copy Activity type properties
...
### <a name="type-mapping-for-azure-table"></a>Type Mapping for Azure Table
