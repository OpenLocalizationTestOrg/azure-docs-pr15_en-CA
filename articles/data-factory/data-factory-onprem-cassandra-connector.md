...
# <a name="move-data-from-an-on-premises-cassandra-database-using-azure-data-factory"></a>Move data from an on-premises Cassandra database using Azure Data Factory
...
## <a name="sample-copy-data-from-cassandra-to-blob"></a>Sample: Copy data from Cassandra to Blob
...
## <a name="onpremisescassandra-linked-service-properties"></a>OnPremisesCassandra linked service properties
...
## <a name="cassandratable-properties"></a>CassandraTable properties
...
## <a name="cassandrasource-type-properties"></a>CassandraSource type properties
...
### <a name="type-mapping-for-cassandra"></a>Type mapping for Cassandra
...
## <a name="work-with-collections-using-virtual-table"></a>Work with collections using virtual table
