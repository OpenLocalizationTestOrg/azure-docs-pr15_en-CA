...
# <a name="move-data-from-a-odata-source-using-azure-data-factory"></a>Move data From a OData source using Azure Data Factory
...
## <a name="sample-copy-data-from-odata-source-to-azure-blob"></a>Sample: Copy data from OData source to Azure Blob
...
**OData linked service** This example uses the Basic authentication. See [OData linked service](#odata-linked-service-properties) section for different types of authentication you can use. 
...
## <a name="odata-linked-service-properties"></a>OData linked Service properties
...
### <a name="using-windows-authentication-accessing-on-premises-odata-source"></a>Using Windows authentication accessing on-premises OData source
...
## <a name="odata-dataset-type-properties"></a>OData dataset type properties
...
## <a name="odata-copy-activity-type-properties"></a>OData Copy Activity type properties
...
### <a name="type-mapping-for-odata"></a>Type mapping for OData
