...
# <a name="move-data-from-a-web-table-source-using-azure-data-factory"></a>Move data from a Web table source using Azure Data Factory
...
## <a name="sample-copy-data-from-web-table-to-azure-blob"></a>Sample: Copy data from Web table to Azure Blob
...
**Web linked service** This example uses the Web linked service with anonymous authentication. See [Web linked service](#web-linked-service-properties) section for different types of authentication you can use. 
...
## <a name="web-linked-service-properties"></a>Web Linked Service properties
...
## <a name="webtable-dataset-properties"></a>WebTable dataset properties
...
## <a name="websource---copy-activity-type-properties"></a>WebSource - Copy Activity type properties
