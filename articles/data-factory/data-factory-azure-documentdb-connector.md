...
# <a name="move-data-to-and-from-documentdb-using-azure-data-factory"></a>Move data to and from DocumentDB using Azure Data Factory
...
## <a name="sample-copy-data-from-documentdb-to-azure-blob"></a>Sample: Copy data from DocumentDB to Azure Blob
...
Example: SELECT Person.PersonId, Person.Name.First AS FirstName, Person.Name.Middle as MiddleName, Person.Name.Last AS LastName FROM Person
...
## <a name="sample-copy-data-from-azure-blob-to-azure-documentdb"></a>Sample: Copy data from Azure Blob to Azure DocumentDB
...
## <a name="azure-documentdb-linked-service-properties"></a>Azure DocumentDB Linked Service properties
...
## <a name="azure-documentdb-dataset-type-properties"></a>Azure DocumentDB Dataset type properties
...
## <a name="azure-documentdb-copy-activity-type-properties"></a>Azure DocumentDB Copy Activity type properties
