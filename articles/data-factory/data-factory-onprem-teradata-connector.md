...
# <a name="move-data-from-teradata-using-azure-data-factory"></a>Move data from Teradata using Azure Data Factory
...
### <a name="sample-copy-data-from-teradata-to-azure-blob"></a>Sample: Copy data from Teradata to Azure Blob
...
## <a name="teradata-linked-service-properties"></a>Teradata linked service properties
...
## <a name="teradata-dataset-type-properties"></a>Teradata dataset type properties
...
## <a name="teradata-copy-activity-type-properties"></a>Teradata copy activity type properties
...
## <a name="type-mapping-for-teradata"></a>Type mapping for Teradata
