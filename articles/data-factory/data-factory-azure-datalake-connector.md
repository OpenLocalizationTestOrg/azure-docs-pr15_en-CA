...
# <a name="move-data-to-and-from-azure-data-lake-store-using-azure-data-factory"></a>Move data to and from Azure Data Lake Store using Azure Data Factory
...
## <a name="sample-copy-data-from-azure-blob-to-azure-data-lake-store"></a>Sample: Copy data from Azure Blob to Azure Data Lake Store
...
### <a name="to-create-azure-data-lake-linked-service-using-data-factory-editor"></a>To create Azure Data Lake Linked Service using Data Factory Editor
...
## <a name="sample-copy-data-from-azure-data-lake-store-to-azure-blob"></a>Sample: Copy data from Azure Data Lake Store to Azure Blob
The following sample shows:
...
## <a name="azure-data-lake-store-linked-service-properties"></a>Azure Data Lake Store Linked Service properties
...
## <a name="azure-data-lake-dataset-type-properties"></a>Azure Data Lake Dataset type properties
...
### <a name="using-partitionedby-property"></a>Using partitionedBy property
...
## <a name="azure-data-lake-copy-activity-type-properties"></a>Azure Data Lake Copy Activity type properties  
