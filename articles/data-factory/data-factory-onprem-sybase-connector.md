...
# <a name="move-data-from-sybase-using-azure-data-factory"></a>Move data from Sybase using Azure Data Factory 
...
## <a name="sample-copy-data-from-sybase-to-azure-blob"></a>Sample: Copy data from Sybase to Azure Blob
...
## <a name="sybase-linked-service-properties"></a>Sybase linked service properties
...
## <a name="sybase-dataset-type-properties"></a>Sybase dataset type properties
...
## <a name="sybase-copy-activity-type-properties"></a>Sybase copy activity type properties 
...
## <a name="type-mapping-for-sybase"></a>Type mapping for Sybase
