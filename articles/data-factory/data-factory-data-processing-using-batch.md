...
# <a name="process-large-scale-datasets-using-data-factory-and-batch"></a>Process large-scale datasets using Data Factory and Batch
...
## <a name="why-azure-batch"></a>Why Azure Batch?
...
## <a name="why-azure-data-factory"></a>Why Azure Data Factory?
...
## <a name="data-factory-and-batch-together"></a>Data Factory and Batch together
...
## <a name="architecture-of-sample-solution"></a>Architecture of sample solution
...
## <a name="implementation-of-sample-solution"></a>Implementation of sample solution
...
#### <a name="azure-batch-pool-of-virtual-machines-vms"></a>Azure Batch pool of virtual machines (VMs)
...
### <a name="high-level-steps-to-create-the-solution"></a>High-level steps to create the solution
...
#### <a name="procedure-create-the-custom-activity"></a>Procedure: Create the custom activity
...
### <a name="create-the-data-factory"></a>Create the data factory
...
#### <a name="step-4-create-and-run-the-pipeline-with-custom-activity"></a>Step 4: Create and run the pipeline with custom activity
...
#### <a name="step-5-test-the-pipeline"></a>Step 5: Test the pipeline
...
#### <a name="extend-the-sample"></a>Extend the sample
...
### <a name="next-steps-consume-the-data"></a>Next steps: Consume the data
