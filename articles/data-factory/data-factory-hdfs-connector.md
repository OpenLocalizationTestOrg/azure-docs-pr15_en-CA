...
# <a name="move-data-from-on-premises-hdfs-using-azure-data-factory"></a>Move data From on-premises HDFS using Azure Data Factory
...
## <a name="enabling-connectivity"></a>Enabling connectivity
...
## <a name="sample-copy-data-from-on-premises-hdfs-to-azure-blob"></a>Sample: Copy data from on-premises HDFS to Azure Blob
...
**HDFS linked service** This example uses the Windows authentication. See [HDFS linked service](#hdfs-linked-service-properties) section for different types of authentication you can use. 
...
## <a name="hdfs-linked-service-properties"></a>HDFS Linked Service properties
...
### <a name="using-windows-authentication"></a>Using Windows authentication
...
## <a name="hdfs-dataset-type-properties"></a>HDFS Dataset type properties
...
## <a name="hdfs-copy-activity-type-properties"></a>HDFS Copy Activity type properties
