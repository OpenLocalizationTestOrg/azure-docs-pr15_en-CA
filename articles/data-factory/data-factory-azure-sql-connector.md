...
# <a name="move-data-to-and-from-azure-sql-database-using-azure-data-factory"></a>Move data to and from Azure SQL Database using Azure Data Factory
...
## <a name="supported-sources-and-sinks"></a>Supported sources and sinks
...
## <a name="sample-copy-data-from-azure-sql-database-to-azure-blob"></a>Sample: Copy data from Azure SQL Database to Azure Blob
...
## <a name="sample-copy-data-from-azure-blob-to-azure-sql-database"></a>Sample: Copy data from Azure Blob to Azure SQL Database
...
## <a name="azure-sql-linked-service-properties"></a>Azure SQL linked service properties
...
## <a name="azure-sql-dataset-type-properties"></a>Azure SQL dataset type properties
...
## <a name="azure-sql-copy-activity-type-properties"></a>Azure SQL copy activity type properties
...
## <a name="identity-columns-in-the-target-database"></a>Identity columns in the target database
...
### <a name="type-mapping-for-sql-server--azure-sql-database"></a>Type mapping for SQL Server & Azure SQL Database
