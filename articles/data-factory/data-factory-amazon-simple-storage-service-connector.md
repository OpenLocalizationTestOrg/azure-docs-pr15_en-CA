...
# <a name="move-data-from-amazon-simple-storage-service-using-azure-data-factory"></a>Move data From Amazon Simple Storage Service using Azure Data Factory
...
## <a name="sample-copy-data-from-amazon-s3-to-azure-blob"></a>Sample: Copy data from Amazon S3 to Azure Blob
...
## <a name="dataset-type-properties"></a>Dataset type properties
...
### <a name="sample-data-set-with-version"></a>Sample data set (with version)
...
## <a name="copy-activity-type-properties"></a>Copy activity type properties
