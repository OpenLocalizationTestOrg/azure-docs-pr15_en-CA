...
# <a name="move-data-from-amazon-redshift-using-azure-data-factory"></a>Move data From Amazon Redshift using Azure Data Factory
...
## <a name="sample-copy-data-from-amazon-redshift-to-azure-blob"></a>Sample: Copy data from Amazon Redshift to Azure Blob
...
### <a name="type-mapping-for-amazon-redshift"></a>Type mapping for Amazon Redshift
