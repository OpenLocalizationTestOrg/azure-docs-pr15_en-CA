...
# <a name="pipelines-and-activities-in-azure-data-factory"></a>Pipelines and Activities in Azure Data Factory
...
## <a name="what-is-a-data-pipeline"></a>What is a data pipeline?
...
## <a name="what-is-an-activity"></a>What is an activity?
...
## <a name="sample-copy-pipeline"></a>Sample copy pipeline
...
## <a name="sample-transformation-pipeline"></a>Sample transformation pipeline
...
## <a name="chaining-activities"></a>Chaining activities
...
## <a name="scheduling-and-execution"></a>Scheduling and Execution
...
## <a name="create-pipelines"></a>Create pipelines
...
### <a name="using-visual-studio"></a>Using Visual Studio 
...
### <a name="using-net-sdk"></a>Using .NET SDK
...
### <a name="using-rest-api"></a>Using REST API
...
## <a name="monitor-and-manage-pipelines"></a>Monitor and manage pipelines  
