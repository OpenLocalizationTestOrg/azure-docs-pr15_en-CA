...
# <a name="move-data-from-salesforce-by-using-azure-data-factory"></a>Move data from Salesforce by using Azure Data Factory
...
## <a name="salesforce-request-limits"></a>Salesforce request limits
...
## <a name="sample-copy-data-from-salesforce-to-an-azure-blob"></a>Sample: Copy data from Salesforce to an Azure blob
...
## <a name="salesforce-linked-service-properties"></a>Salesforce linked service properties
...
## <a name="salesforce-dataset-properties"></a>Salesforce dataset properties
...
## <a name="relationalsource-type-properties"></a>RelationalSource type properties
...
### <a name="retrieving-data-using-where-clause-on-datetime-column"></a>Retrieving data using where clause on DateTime column
...
### <a name="retrieving-data-from-salesforce-report"></a>Retrieving data from Salesforce Report
You can retrieve data from Salesforce reports by specifying query as `{call "<report name>"}`, e.g. `"query": "{call \"TestReport\"}"`.

### <a name="retrieving-deleted-records-from-salesforce-recycle-bin"></a>Retrieving deleted records from Salesforce Recycle Bin
...
### <a name="type-mapping-for-salesforce"></a>Type mapping for Salesforce
