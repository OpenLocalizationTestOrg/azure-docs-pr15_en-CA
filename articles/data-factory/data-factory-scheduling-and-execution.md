...
# <a name="data-factory-scheduling-and-execution"></a>Data Factory scheduling and execution
...
## <a name="schedule-an-activity"></a>Schedule an activity
...
## <a name="time-series-datasets-and-data-slices"></a>Time series datasets and data slices
...
## <a name="move-data-from-sql-database-to-blob-storage"></a>Move data from SQL Database to Blob storage
...
## <a name="active-period-for-pipeline"></a>Active period for pipeline
...
## <a name="parallel-processing-of-data-slices"></a>Parallel processing of data slices
...
## <a name="rerun-a-failed-data-slice"></a>Rerun a failed data slice 
...
## <a name="run-activities-in-a-sequence"></a>Run activities in a sequence
...
### <a name="copy-sequentially"></a>Copy sequentially
...
## <a name="model-datasets-with-different-frequencies"></a>Model datasets with different frequencies
...
### <a name="sample-1-produce-a-daily-output-report-for-input-data-that-is-available-every-hour"></a>Sample 1: Produce a daily output report for input data that is available every hour
...
### <a name="sample-2-specify-dependency-with-expressions-and-data-factory-functions"></a>Sample 2: Specify dependency with expressions and Data Factory functions
...
## <a name="data-factory-functions-and-system-variables"></a>Data Factory functions and system variables   
...
## <a name="data-dependency-deep-dive"></a>Data dependency deep dive
...
## <a name="data-dependency-and-validation"></a>Data dependency and validation
...
## <a name="external-data"></a>External data
