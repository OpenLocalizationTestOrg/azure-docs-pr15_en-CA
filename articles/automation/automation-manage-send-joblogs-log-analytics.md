...
# <a name="forward-job-status-and-job-streams-from-automation-to-log-analytics-oms"></a>Forward job status and job streams from Automation to Log Analytics (OMS)
...
## <a name="prerequisites-and-deployment-considerations"></a>Prerequisites and deployment considerations
...
## <a name="setup-integration-with-log-analytics"></a>Setup integration with Log Analytics
...
## <a name="viewing-automation-logs-in-log-analytics"></a>Viewing Automation Logs in Log Analytics 
...
### <a name="send-an-email-when-a-runbook-job-fails-or-suspends"></a>Send an email when a runbook job fails or suspends 
...
### <a name="find-all-jobs-that-have-completed-with-errors"></a>Find all jobs that have completed with errors 
...
### <a name="view-job-streams-for-a-job"></a>View job streams for a job  
...
### <a name="view-historical-job-status"></a>View historical job status 
