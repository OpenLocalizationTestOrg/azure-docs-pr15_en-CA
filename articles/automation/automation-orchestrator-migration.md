...
# <a name="migrating-from-orchestrator-to-azure-automation-beta"></a>Migrating from Orchestrator to Azure Automation (Beta)
...
### <a name="monitor-activities"></a>Monitor activities
...
### <a name="integration-packs-that-cannot-be-converted"></a>Integration packs that cannot be converted
...
### <a name="using-runbook-converter"></a>Using Runbook Converter
...
### <a name="exporting-runbooks-from-orchestrator"></a>Exporting runbooks from Orchestrator
...
### <a name="invoke-runbook-activity"></a>Invoke Runbook activity
