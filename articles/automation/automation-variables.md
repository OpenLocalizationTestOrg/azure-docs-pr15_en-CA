...
# <a name="variable-assets-in-azure-automation"></a>Variable assets in Azure Automation
...
## <a name="cmdlets-and-workflow-activities"></a>Cmdlets and workflow activities
...
## <a name="creating-a-new-automation-variable"></a>Creating a new Automation variable

### <a name="to-create-a-new-variable-with-the-azure-portal"></a>To create a new variable with the Azure portal
...
### <a name="to-create-a-new-variable-with-windows-powershell"></a>To create a new variable with Windows PowerShell
...
## <a name="using-a-variable-in-a-runbook-or-dsc-configuration"></a>Using a variable in a runbook or DSC configuration
...
### <a name="textual-runbook-samples"></a>Textual runbook samples

#### <a name="setting-and-retrieving-a-simple-value-from-a-variable"></a>Setting and retrieving a simple value from a variable
...
#### <a name="setting-and-retrieving-a-complex-object-in-a-variable"></a>Setting and retrieving a complex object in a variable
...
#### <a name="setting-and-retrieving-a-collection-in-a-variable"></a>Setting and retrieving a collection in a variable
...
### <a name="graphical-runbook-samples"></a>Graphical runbook samples
...
#### <a name="setting-values-in-a-variable"></a>Setting values in a variable
...
#### <a name="retrieving-values-from-a-variable"></a>Retrieving values from a variable
