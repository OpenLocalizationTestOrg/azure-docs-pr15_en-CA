...
# <a name="connection-assets-in-azure-automation"></a>Connection assets in Azure Automation
...
## <a name="creating-a-new-connection"></a>Creating a New Connection

### <a name="to-create-a-new-connection-with-the-azure-classic-portal"></a>To create a new connection with the Azure classic portal
...
### <a name="to-create-a-new-connection-with-the-azure-portal"></a>To create a new connection with the Azure portal
...
### <a name="to-create-a-new-connection-with-windows-powershell"></a>To create a new connection with Windows PowerShell
...
## <a name="using-a-connection-in-a-runbook-or-dsc-configuration"></a>Using a connection in a runbook or DSC configuration
