...
## <a name="assign-values-to-input-parameters-in-runbooks"></a>Assign values to input parameters in runbooks
...
### <a name="test-a-runbook-and-assign-parameters"></a>Test a runbook and assign parameters
