...
# <a name="certificate-assets-in-azure-automation"></a>Certificate assets in Azure Automation
...
## <a name="activities-to-access-certificates"></a>Activities to access certificates
...
## <a name="creating-a-new-certificate"></a>Creating a new certificate
...
### <a name="to-create-a-new-certificate-with-the-azure-classic-portal"></a>To create a new certificate with the Azure classic portal
...
### <a name="to-create-a-new-certificate-with-the-azure-portal"></a>To create a new certificate with the Azure portal
...
### <a name="to-create-a-new-certificate-with-windows-powershell"></a>To create a new certificate with Windows PowerShell
...
## <a name="using-a-certificate"></a>Using a certificate
