...
# <a name="azure-automation-hybrid-runbook-workers"></a>Azure Automation Hybrid Runbook Workers
...
## <a name="hybrid-runbook-worker-groups"></a>Hybrid Runbook Worker groups
...
## <a name="hybrid-runbook-worker-requirements"></a>Hybrid Runbook Worker requirements
...
### <a name="configure-proxy-and-firewall-settings"></a>Configure proxy and firewall settings
...
## <a name="installing-hybrid-runbook-worker"></a>Installing Hybrid Runbook Worker
...
### <a name="1-create-operations-management-suite-workspace"></a>1. Create Operations Management Suite workspace
...
### <a name="2-add-automation-solution-to-operations-management-suite-workspace"></a>2. Add Automation solution to Operations Management Suite workspace
...
## <a name="removing-hybrid-runbook-worker"></a>Removing Hybrid Runbook Worker
...
## <a name="starting-runbooks-on-hybrid-runbook-worker"></a>Starting runbooks on Hybrid Runbook Worker
...
## <a name="creating-runbooks-for-hybrid-runbook-worker"></a>Creating runbooks for Hybrid Runbook Worker
...
## <a name="troubleshooting-runbooks-on-hybrid-runbook-worker"></a>Troubleshooting runbooks on Hybrid Runbook Worker
...
## <a name="relationship-to-service-management-automation"></a>Relationship to Service Management Automation
