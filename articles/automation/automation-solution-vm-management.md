...
# <a name="startstop-vms-during-off-hours-preview-solution-in-automation"></a>Start/Stop VMs during off-hours [Preview] solution in Automation
...
### <a name="configuring-e-mail-notifications"></a>Configuring e-mail notifications
...
### <a name="modifying-the-startup-and-shutdown-schedule"></a>Modifying the startup and shutdown schedule
