...
# <a name="import-data-to-documentdb-with-the-database-migration-tool"></a>Import data to DocumentDB with the Database Migration tool
...
## <a name="export-to-json-file"></a>Export to JSON file
...
## <a name="confirm-import-settings-and-view-command-line"></a>Confirm import settings and view command line
