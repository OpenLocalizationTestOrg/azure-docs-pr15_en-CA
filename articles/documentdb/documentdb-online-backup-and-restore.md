...
# <a name="automatic-online-backup-and-restore-with-documentdb"></a>Automatic online backup and restore with DocumentDB 
...
## <a name="high-availability-with-documentdb---a-recap"></a>High availability with DocumentDB - a recap
...
## <a name="full-automatic-online-backups"></a>Full, automatic, online backups
...
## <a name="retention-period-for-a-given-snapshot"></a>Retention period for a given snapshot
...
## <a name="restore-database-from-the-online-backup"></a>Restore database from the online backup
