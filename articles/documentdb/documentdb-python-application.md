...
### <a name="add-the-required-imports-to-viewspy"></a>Add the required imports to views.py
...
### <a name="add-a-configuration-file-and-change-the-initpy"></a>Add a configuration file and change the \_\_init\_\_.py
