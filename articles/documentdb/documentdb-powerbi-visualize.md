...
# <a name="power-bi-tutorial-for-documentdb-visualize-data-using-the-power-bi-connector"></a>Power BI tutorial for DocumentDB: Visualize data using the Power BI connector
...
## <a name="lets-get-started"></a>Let's get started
...
## <a name="flattening-and-transforming-json-documents"></a>Flattening and transforming JSON documents
...
## <a name="build-the-reports"></a>Build the reports
...
## <a name="publish-and-share-your-report"></a>Publish and share your report
...
## <a name="create-a-dashboard-in-powerbicom"></a>Create a dashboard in PowerBI.com
...
## <a name="refresh-data-in-powerbicom"></a>Refresh data in PowerBI.com
