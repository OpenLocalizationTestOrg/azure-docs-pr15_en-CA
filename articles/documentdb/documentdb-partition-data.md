...
# <a name="partitioning-and-scaling-in-azure-documentdb"></a>Partitioning and scaling in Azure DocumentDB
...
## <a name="working-with-the-sdks"></a>Working with the SDKs
...
### <a name="migrating-from-single-partition-to-partitioned-collections"></a>Migrating from single-partition to partitioned collections
