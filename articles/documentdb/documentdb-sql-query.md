...
# <a name="sql-query-and-sql-syntax-in-documentdb"></a>SQL query and SQL syntax in DocumentDB
...
## <a name="getting-started-with-sql-commands-in-documentdb"></a>Getting started with SQL commands in DocumentDB
...
## <a name="documentdb-indexing"></a>DocumentDB indexing
...
## <a name="basics-of-a-documentdb-sql-query"></a>Basics of a DocumentDB SQL query
...
### <a name="sub-documents"></a>Sub-documents
...
### <a name="equality-and-comparison-operators"></a>Equality and comparison operators
...
### <a name="between-keyword"></a>BETWEEN keyword
...
### <a name="logical-and-or-and-not-operators"></a>Logical (AND, OR and NOT) operators
...
### <a name="in-keyword"></a>IN keyword
...
### <a name="ternary--and-coalesce--operators"></a>Ternary (?) and Coalesce (??) operators
...
### <a name="quoted-property-accessor"></a>Quoted property accessor
...
### <a name="nested-properties"></a>Nested properties
...
### <a name="scalar-expressions"></a>Scalar expressions
...
### <a name="object-and-array-creation"></a>Object and array creation
...
### <a name="value-keyword"></a>VALUE keyword
...
## <a name="advanced-database-concepts-and-sql-queries"></a>Advanced database concepts and SQL queries
...
### <a name="operator-evaluation"></a>Operator evaluation
...
## <a name="parameterized-sql-queries"></a>Parameterized SQL queries
...
### <a name="spatial-functions"></a>Spatial functions
...
### <a name="net-and-json-mapping"></a>.NET and JSON mapping
...
### <a name="list-of-supported-linq-operators"></a>List of supported LINQ operators
...
### <a name="composite-sql-queries"></a>Composite SQL queries
...
## <a name="executing-sql-queries"></a>Executing SQL queries
...
### <a name="javascript-server-side-api"></a>JavaScript server-side API 
...
## <a name="aggregate-functions"></a>Aggregate functions
