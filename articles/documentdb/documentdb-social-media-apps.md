...
# <a name="going-social-with-documentdb"></a>Going social with DocumentDB
...
## <a name="the-nosql-road"></a>The NoSQL road
...
## <a name="the-ladder-pattern-and-data-duplication"></a>The “Ladder” pattern and data duplication
...
## <a name="the-search-box"></a>The search box
...
## <a name="the-underlying-knowledge"></a>The underlying knowledge
