...
# <a name="performance-levels-in-documentdb"></a>Performance levels in DocumentDB
...
## <a name="introduction-to-performance-levels"></a>Introduction to performance levels
...
## <a name="setting-performance-levels-for-collections"></a>Setting performance levels for collections
...
## <a name="working-with-performance-levels"></a>Working with performance levels
...
## <a name="changing-performance-levels-using-the-net-sdk"></a>Changing performance levels using the .NET SDK
