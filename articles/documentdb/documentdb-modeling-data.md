...
#<a name="modeling-data-in-documentdb"></a>Modeling data in DocumentDB#
...
##<a name="embedding-data"></a>Embedding data##
...
###<a name="when-to-embed"></a>When to embed
...
###<a name="when-not-to-embed"></a>When not to embed
...
### <a name="what-about-foreign-keys"></a>What about foreign keys?
...
###<a name="when-to-reference"></a>When to reference
...
###<a name="where-do-i-put-the-relationship"></a>Where do I put the relationship?
...
###<a name="how-do-i-model-manymany-relationships"></a>How do I model many:many relationships?
