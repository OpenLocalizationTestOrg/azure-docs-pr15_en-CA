...
# <a name="deploy-documentdb-and-azure-app-service-web-apps-using-an-azure-resource-manager-template"></a>Deploy DocumentDB and Azure App Service Web Apps using an Azure Resource Manager Template
...
<a id="Build"></a>
##<a name="step-2-deploy-the-documentdb-account-app-service-web-app-and-demo-application-sample"></a>Step 2: Deploy the DocumentDB account, App Service web app and demo application sample
...
<a id="Build"></a> 
## <a name="step-3-deploy-the-document-account-and-web-app-sample"></a>Step 3: Deploy the Document account and web app sample
