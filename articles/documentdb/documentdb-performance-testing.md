...
# <a name="performance-and-scale-testing-with-azure-documentdb"></a>Performance and scale testing with Azure DocumentDB
...
## <a name="run-the-performance-testing-application"></a>Run the performance testing application
