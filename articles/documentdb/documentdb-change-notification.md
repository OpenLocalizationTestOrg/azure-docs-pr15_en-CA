...
# <a name="notifications-for-new-or-changed-documentdb-resources-using-logic-apps"></a>Notifications for new or changed DocumentDB resources using Logic Apps
...
## <a name="how-the-it-department-solved-the-problem"></a>How the IT department solved the problem
...
## <a name="high-level-view-of-notification-process"></a>High-Level view of notification process
...
### <a name="lets-take-a-look-at-what-this-logic-app-does"></a>Let's take a look at what this Logic App does
...
### <a name="lets-start-with-the-main-logic-app"></a>Let's start with the main Logic App
...
### <a name="design-view-of-your-completed-logic-app"></a>Design View of your completed Logic App
...
##### <a name="designer-view"></a>Designer View

![Conversion](./media/documentdb-change-notification/conversion.png)

##### <a name="code-view"></a>Code View
...
## <a name="viewing-the-patient-data-in-the-azure-blob-service"></a>Viewing the patient data in the Azure Blob service
