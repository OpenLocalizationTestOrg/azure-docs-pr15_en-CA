...
# <a name="working-with-geospatial-data-in-azure-documentdb"></a>Working with Geospatial data in Azure DocumentDB
...
## <a name="introduction-to-spatial-data"></a>Introduction to spatial data
...
### <a name="points-linestrings-and-polygons"></a>Points, linestrings and polygons
...
### <a name="coordinate-reference-systems"></a>Coordinate reference systems
...
## <a name="creating-documents-with-spatial-data"></a>Creating documents with spatial data
...
## <a name="querying-spatial-types"></a>Querying spatial types
...
### <a name="spatial-sql-built-in-functions"></a>Spatial SQL built-in functions
...
### <a name="linq-querying-in-the-net-sdk"></a>LINQ Querying in the .NET SDK
