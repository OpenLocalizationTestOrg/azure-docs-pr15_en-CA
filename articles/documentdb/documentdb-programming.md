...
# <a name="documentdb-server-side-programming-stored-procedures-database-triggers-and-udfs"></a>DocumentDB server-side programming: Stored procedures, database triggers, and UDFs
...
## <a name="introduction-to-stored-procedure-and-udf-programming"></a>Introduction to Stored Procedure and UDF Programming
...
## <a name="stored-procedures"></a>Stored procedures

### <a name="example-write-a-simple-stored-procedure"></a>Example: Write a simple stored procedure 
...
### <a name="example-write-a-stored-procedure-to-create-a-document"></a>Example: Write a stored procedure to create a document 
...
## <a name="database-program-transactions"></a>Database program transactions
...
### <a name="commit-and-rollback"></a>Commit and rollback
...
## <a name="bounded-execution"></a>Bounded execution
...
### <a name="example-bulk-importing-data-into-a-database-program"></a>Example: Bulk importing data into a database program
...
### <a name="database-pre-triggers"></a>Database pre-triggers
...
### <a name="database-post-triggers"></a>Database post-triggers
...
### <a name="example-write-a-stored-procedure-using-the-javascript-query-api"></a>Example: Write a stored procedure using the JavaScript query API
...
## <a name="sql-to-javascript-cheat-sheet"></a>SQL to Javascript cheat sheet
...
### <a name="pre-compilation"></a>Pre-compilation
...
## <a name="client-sdk-support"></a>Client SDK support
