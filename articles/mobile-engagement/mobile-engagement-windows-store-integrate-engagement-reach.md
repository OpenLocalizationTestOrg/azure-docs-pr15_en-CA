...
## <a name="embed-the-engagement-reach-sdk-into-your-windows-universal-project"></a>Embed the Engagement Reach SDK into your Windows Universal project
...
## <a name="enable-the-windows-notification-service"></a>Enable the Windows Notification Service

### <a name="windows-8x-and-windows-phone-81-only"></a>Windows 8.x and Windows Phone 8.1 only
...
### <a name="web-views-manual-integration"></a>Web views manual integration
...
## <a name="handle-datapush-optional"></a>Handle datapush (optional)
...
## <a name="custom-scheme-tip"></a>Custom scheme tip
