...
#<a name="how-to-integrate-engagement-on-android"></a>How to Integrate Engagement on Android
...
##<a name="embed-the-engagement-sdk-and-service-into-your-android-project"></a>Embed the Engagement SDK and service into your Android project

Download the Android SDK from [here](https://aka.ms/vq9mfn) Get `mobile-engagement-VERSION.jar` and put them into the `libs` folder of your Android project (create the libs folder if it does not exist yet).
...
### <a name="recommended-method-overload-your-activity-classes"></a>Recommended method: overload your `Activity` classes
...
##<a name="advanced-configuration-in-androidmanifestxml"></a>Advanced configuration (in AndroidManifest.xml)

### <a name="wake-locks"></a>Wake locks
