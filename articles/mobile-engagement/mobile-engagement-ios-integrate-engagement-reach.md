<properties
    pageTitle="Azure Mobile Engagement iOS SDK Reach Integration | Microsoft Azure"
...
#<a name="how-to-integrate-engagement-reach-on-ios"></a>How to Integrate Engagement Reach on iOS
...
### <a name="embed-the-engagement-reach-sdk-into-your-ios-project"></a>Embed the Engagement Reach SDK into your iOS project
...
##<a name="how-to-receive-announcements-and-polls-at-any-time"></a>How to receive announcements and polls at any time
...
### <a name="prepare-your-application-for-apple-push-notifications"></a>Prepare your application for Apple push notifications
...
### <a name="add-the-necessary-client-code"></a>Add the necessary client code
...
### <a name="if-you-have-your-own-unusernotificationcenterdelegate-implementation"></a>If you have your own UNUserNotificationCenterDelegate implementation
...
##### <a name="notification-handling"></a>Notification handling
...
#### <a name="include-notification-as-part-of-an-existing-view"></a>Include notification as part of an existing view
...
##### <a name="implementation-example"></a>Implementation example
