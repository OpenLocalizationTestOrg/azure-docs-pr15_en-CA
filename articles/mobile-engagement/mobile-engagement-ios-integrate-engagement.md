...
#<a name="how-to-integrate-engagement-on-ios"></a>How to Integrate Engagement on iOS
...
##<a name="embed-the-engagement-sdk-into-your-ios-project"></a>Embed the Engagement SDK into your iOS project
...
### <a name="recommended-method-overload-your-uiviewcontroller-classes"></a>Recommended method: overload your `UIViewController` classes
...
The Engagement API allows to use all of Engagement's advanced capabilities and is detailed in the How to Use the Engagement API on iOS (as well as in the technical documentation of the `EngagementAgent` class).

##<a name="disable-idfa-collection"></a>Disable IDFA collection
...
### <a name="integration-in-your-settings-bundle"></a>Integration in your settings bundle
