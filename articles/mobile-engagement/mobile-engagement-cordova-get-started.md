...
# <a name="get-started-with-azure-mobile-engagement-for-cordovaphonegap"></a>Get Started with Azure Mobile Engagement for Cordova/Phonegap
...
###<a name="create-a-new-cordova-project"></a>Create a new Cordova project
...
###<a name="configure-push-credentials-for-mobile-engagement"></a>Configure Push credentials for Mobile Engagement
...
###<a name="enable-push-notifications-in-the-cordova-app"></a>Enable push notifications in the Cordova app
