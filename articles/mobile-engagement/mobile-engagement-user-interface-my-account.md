...
# <a name="how-to-manage-your-account-profile-and-test-devices"></a>How to manage your account profile and test devices
...
Here is my device identifier: {deviceid} will be replaced by: Here is my device identifier: XXXXXXXXXXXXXXXX
