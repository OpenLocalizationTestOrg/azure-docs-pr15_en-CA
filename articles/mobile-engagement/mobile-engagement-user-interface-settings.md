...
# <a name="how-to-manage-the-global-settings-of-your-application"></a>How to manage the global settings of your application
...
To enable Native Push using Windows Notification Service, you must provide your application's credentials. You will need your Package security identifier (SID) and your Secret key.
 
![settings5][50]
 
### <a name="google-cloud-messaging-for-android-gcm"></a>Google Cloud Messaging for Android (GCM)

To enable Native Push using GCM, you need to follow the instructions from Google. Then you must paste a server simple API key, configured without IP restrictions. Requires integration with the SDK for Android v1.12.0+.
...
## <a name="commercial-pressure"></a>Commercial Pressure
