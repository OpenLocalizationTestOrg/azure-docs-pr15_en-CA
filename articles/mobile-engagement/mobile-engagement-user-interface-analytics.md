...
# <a name="how-to-analyze-historical-data-about-your-application"></a>How to analyze historical data about your application
...
## <a name="standard-and-custom-analytics"></a>Standard and Custom Analytics
...
## <a name="accessing-the-retention-overview"></a>Accessing the Retention Overview
![Analytics3][12]
...
## <a name="understanding-the-retention-overview-cards"></a>Understanding the Retention Overview cards
![Analytics4][13]

### <a name="each-card-is-composed-of-3-main-parts"></a>Each card is composed of 3 main parts:
1. 1: The cohort and the period considered
2. 2-4: The retention for the current period
3. 5: A Sparkline of the history

### <a name="here-is-detailed-information-about-each-element"></a>Here is detailed information about each element:
