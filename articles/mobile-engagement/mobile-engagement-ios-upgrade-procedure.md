...
##<a name="from-300-to-400"></a>From 3.0.0 to 4.0.0
...
### <a name="application-push-capability"></a>Application push capability
XCode 8 may reset your app push capability, please double check it in the `capability` tab of your selected target.

### <a name="add-the-new-ios-10-notification-registration-code"></a>Add the new iOS 10 notification registration code
...
### <a name="if-you-already-have-your-own-unusernotificationcenterdelegate-implementation"></a>If you already have your own UNUserNotificationCenterDelegate implementation
...
##<a name="from-200-to-300"></a>From 2.0.0 to 3.0.0
...
##<a name="from-1160-to-200"></a>From 1.16.0 to 2.0.0
...
### <a name="class-name-changes"></a>Class Name Changes
