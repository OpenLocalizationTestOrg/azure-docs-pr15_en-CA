...
# <a name="get-started-with-azure-mobile-engagement-for-windows-phone-silverlight-apps"></a>Get started with Azure Mobile Engagement for Windows Phone Silverlight apps
...
###<a name="create-a-new-windows-phone-silverlight-project"></a>Create a new Windows Phone Silverlight project
...
###<a name="enable-your-app-to-receive-mpns-push-notifications"></a>Enable your app to receive MPNS Push Notifications
