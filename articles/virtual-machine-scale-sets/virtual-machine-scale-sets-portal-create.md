...
# <a name="create-a-virtual-machine-scale-set-using-the-azure-portal"></a>Create a Virtual Machine Scale Set using the Azure portal
...
## <a name="create-the-linux-virtual-machine"></a>Create the Linux virtual machine
...
## <a name="connect-to-a-vm-in-the-scale-set"></a>Connect to a VM in the scale set
