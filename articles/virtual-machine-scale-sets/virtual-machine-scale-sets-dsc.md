...
# <a name="using-virtual-machine-scale-sets-with-the-azure-dsc-extension"></a>Using Virtual Machine Scale Sets with the Azure DSC Extension
...
## <a name="differences-between-deploying-to-vm-and-vmss"></a>Differences between deploying to VM and VMSS
...
## <a name="behavior-for-vmss"></a>Behavior for VMSS
