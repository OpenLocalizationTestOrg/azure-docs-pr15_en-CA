...
# <a name="automatically-scale-machines-in-a-virtual-machine-scale-set"></a>Automatically scale machines in a virtual machine scale set
...
See [How to install and configure Azure PowerShell](../powershell-install-configure.md) for information about installing the latest version of Azure PowerShell, selecting your subscription, and signing in to Azure.

## <a name="step-2-create-a-resource-group-and-a-storage-account"></a>Step 2: Create a resource group and a storage account
...
## <a name="step-3-create-the-template"></a>Step 3: Create the template
...
## <a name="step-4-upload-the-template-to-storage"></a>Step 4: Upload the template to storage
...
## <a name="step-5-deploy-the-template"></a>Step 5: Deploy the template
...
>[AZURE.NOTE] You can also use the portal’s ability to deploy the resources. Use this link: "https://portal.azure.com/#create/Microsoft.Template/uri/<link to VM Scale Set JSON template>"

## <a name="step-6-monitor-resources"></a>Step 6: Monitor resources
...
## <a name="step-7-remove-the-resources"></a>Step 7: Remove the resources
