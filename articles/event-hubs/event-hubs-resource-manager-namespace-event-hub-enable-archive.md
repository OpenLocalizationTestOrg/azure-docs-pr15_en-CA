...
# <a name="create-an-event-hubs-namespace-with-event-hub-and-enable-archive-using-an-azure-resource-manager-template"></a>Create an Event Hubs namespace with Event Hub and enable Archive using an Azure Resource Manager template
