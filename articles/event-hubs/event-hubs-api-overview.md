...
# <a name="event-hubs-api-overview"></a>Event Hubs API overview
...
## <a name="run-time-apis"></a>Run-time APIs

### <a name="create-publisher"></a>Create publisher
...
### <a name="publish-message"></a>Publish message
...
### <a name="create-consumer"></a>Create consumer
...
### <a name="consume-message"></a>Consume message
