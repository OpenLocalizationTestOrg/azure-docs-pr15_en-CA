...
## <a name="event-publisher"></a>Event publisher
...
### <a name="common-publisher-tasks"></a>Common publisher tasks

This section describes common tasks for event publishers.

#### <a name="acquire-a-sas-token"></a>Acquire a SAS token
...
### <a name="event-consumer"></a>Event consumer
...
## <a name="capacity-and-security"></a>Capacity and security
