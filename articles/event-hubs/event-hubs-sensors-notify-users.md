...
# <a name="notify-users-of-data-received-from-sensors-or-other-systems"></a>Notify users of data received from sensors or other systems
...
## <a name="applicability"></a>Applicability
