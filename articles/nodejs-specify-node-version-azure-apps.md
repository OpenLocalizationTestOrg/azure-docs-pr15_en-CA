...
# <a name="specifying-a-nodejs-version-in-an-azure-application"></a>Specifying a Node.js version in an Azure application
...
##<a name="default-versions"></a>Default versions
...
##<a name="versioning-with-packagejson"></a>Versioning with package.json
...
##<a name="versioning-websites-with-app-settings"></a>Versioning Websites with App Settings
...
##<a name="versioning-cloud-services-with-powershell"></a>Versioning Cloud Services with PowerShell
...
##<a name="using-a-custom-version-with-azure-websites"></a>Using a custom version with Azure Websites
