...
# <a name="send-and-receive-messages-with-iot-hub"></a>Send and receive messages with IoT Hub
...
## <a name="device-to-cloud-messages"></a>Device-to-cloud messages
...
### <a name="non-telemetry-traffic"></a>Non-telemetry traffic
...
### <a name="device-to-cloud-configuration-options"></a>Device-to-cloud configuration options
...
### <a name="anti-spoofing-properties"></a>Anti-spoofing properties
...
## <a name="cloud-to-device-messages"></a>Cloud-to-device messages
...
### <a name="message-lifecycle"></a>Message lifecycle
...
### <a name="message-expiration-time-to-live"></a>Message expiration (time to live)
...
### <a name="message-feedback"></a>Message feedback
...
### <a name="cloud-to-device-configuration-options"></a>Cloud-to-device configuration options
...
## <a name="read-device-to-cloud-messages"></a>Read device-to-cloud messages

IoT Hub exposes an endpoint for your back-end services to read the device-to-cloud messages received by your hub. The endpoint is Event Hub-compatible, which enables you to use any of the mechanisms the Event Hubs service supports for reading messages.
...
## <a name="port-numbers"></a>Port numbers
...
## <a name="notes-on-mqtt-support"></a>Notes on MQTT support
