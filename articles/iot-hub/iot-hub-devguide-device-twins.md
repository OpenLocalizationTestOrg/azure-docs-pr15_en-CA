...
# <a name="understand-device-twins---preview"></a>Understand device twins - preview
...
### <a name="desired-configuration-example"></a>Desired configuration example
...
## <a name="twin-metadata"></a>Twin metadata
...
## <a name="optimistic-concurrency"></a>Optimistic concurrency
