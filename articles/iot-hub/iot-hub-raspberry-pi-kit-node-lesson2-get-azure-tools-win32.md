...
# <a name="21-get-azure-tools-windows-7-"></a>2.1 Get Azure tools (Windows 7 +)
...
## <a name="214-install-python"></a>2.1.4 Install Python
...
## <a name="215-install-the-azure-cli"></a>2.1.5 Install the Azure CLI
...
## <a name="216-summary"></a>2.1.6 Summary
