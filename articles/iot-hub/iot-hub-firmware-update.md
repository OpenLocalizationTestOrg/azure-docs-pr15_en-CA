...
# <a name="tutorial-how-to-do-a-firmware-update-preview"></a>Tutorial: How to do a firmware update (preview)
...
## <a name="trigger-a-remote-firmware-update-on-the-device-using-a-direct-method"></a>Trigger a remote firmware update on the device using a direct method 
