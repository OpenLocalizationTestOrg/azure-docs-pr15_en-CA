...
# <a name="12-get-the-tools-macos-1010"></a>1.2 Get the tools (macOS 10.10)
...
## <a name="123-what-you-need"></a>1.2.3 What you need

- An Internet connection to download the development tools and the software
- A Mac that is running macOS Yosemite (10.10) or later

## <a name="124-install-git-and-nodejs"></a>1.2.4 Install Git and Node.js
