...
# <a name="31-create-an-azure-function-app-and-azure-storage-account"></a>3.1 Create an Azure function app and Azure Storage account
...
## <a name="311-what-will-you-do"></a>3.1.1 What will you do
...
## <a name="312-what-will-you-learn"></a>3.1.2 What will you learn
...
## <a name="313-what-do-you-need"></a>3.1.3 What do you need
...
## <a name="314-open-the-sample-app"></a>3.1.4 Open the sample app
...
## <a name="315-configure-azure-resource-manager-templates-and-create-resources-in-azure"></a>3.1.5 Configure Azure Resource Manager templates and create resources in Azure
...
## <a name="316-summary"></a>3.1.6 Summary
