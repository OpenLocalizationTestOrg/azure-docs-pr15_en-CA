...
# <a name="tutorial-how-to-process-iot-hub-device-to-cloud-messages-using-java"></a>Tutorial: How to process IoT Hub device-to-cloud messages using Java
...
## <a name="send-interactive-messages-from-a-simulated-device"></a>Send interactive messages from a simulated device
...
## <a name="process-device-to-cloud-messages"></a>Process device-to-cloud messages
...
### <a name="provision-an-azure-storage-account-and-a-service-bus-queue"></a>Provision an Azure Storage account and a Service Bus queue
...
### <a name="create-the-event-processor"></a>Create the event processor
...
## <a name="receive-interactive-messages"></a>Receive interactive messages
