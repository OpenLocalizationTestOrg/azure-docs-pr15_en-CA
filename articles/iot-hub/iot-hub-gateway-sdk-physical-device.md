...
# <a name="azure-iot-gateway-sdk-beta--send-device-to-cloud-messages-with-a-real-device-using-linux"></a>Azure IoT Gateway SDK (beta) – send device-to-cloud messages with a real device using Linux
...
### <a name="how-data-flows-through-the-gateway"></a>How data flows through the Gateway
...
## <a name="prepare-your-hardware"></a>Prepare your hardware
...
### <a name="set-up-the-edison-board"></a>Set up the Edison board
...
### <a name="enable-connectivity-to-the-sensortag-device-from-your-edison-board"></a>Enable connectivity to the SensorTag device from your Edison board
...
## <a name="run-the-ble-gateway-sample"></a>Run the BLE Gateway sample
...
### <a name="configure-two-sample-devices-in-your-iot-hub"></a>Configure two sample devices in your IoT Hub
...
### <a name="build-the-iot-gateway-sdk-on-your-edison-device"></a>Build the IoT Gateway SDK on your Edison device
...
### <a name="configure-and-run-the-ble-sample-on-your-edison-device"></a>Configure and run the BLE sample on your Edison device
...
#### <a name="logger-configuration"></a>Logger configuration
...
#### <a name="ble-module-configuration"></a>BLE module configuration
...
#### <a name="identity-mapping-module-configuration"></a>Identity mapping module configuration
...
#### <a name="ble-printer-module-configuration"></a>BLE Printer module configuration
...
#### <a name="routing-configuration"></a>Routing configuration
