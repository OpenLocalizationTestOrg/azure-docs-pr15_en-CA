...
# <a name="create-an-iot-hub-using-a-c-program-with-an-azure-resource-manager-template"></a>Create an IoT hub using a C# program with an Azure Resource Manager template
