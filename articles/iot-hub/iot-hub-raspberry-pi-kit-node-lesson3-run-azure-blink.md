...
# <a name="32-run-sample-application-to-send-device-to-cloud-messages"></a>3.2 Run sample application to send device-to-cloud messages

## <a name="321-what-you-will-do"></a>3.2.1 What you will do
...
## <a name="322-what-you-will-learn"></a>3.2.2 What you will learn

- How to use the gulp tool to deploy and run the sample Node.js application on your Pi.

## <a name="323-what-you-need"></a>3.2.3 What you need
...
## <a name="324-get-your-iot-hub-and-device-connection-strings"></a>3.2.4 Get your IoT hub and device connection strings
...
## <a name="325-configure-the-device-connection"></a>3.2.5 Configure the device connection
...
## <a name="326-deploy-and-run-the-sample-application"></a>3.2.6 Deploy and run the sample application
...
## <a name="327-verify-the-sample-application-works"></a>3.2.7 Verify the sample application works
...
## <a name="328-summary"></a>3.2.8 Summary
