...
# <a name="control-access-to-iot-hub"></a>Control access to IoT Hub
...
## <a name="access-control-and-permissions"></a>Access control and permissions
...
### <a name="protocol-specifics"></a>Protocol specifics
...
### <a name="special-considerations-for-sasl-plain"></a>Special considerations for SASL PLAIN
...
## <a name="scope-hub-level-credentials"></a>Scope hub-level credentials
...
## <a name="security-tokens"></a>Security tokens
...
### <a name="security-token-structure"></a>Security token structure
...
### <a name="use-sas-tokens-in-a-device-client"></a>Use SAS tokens in a device client
...
### <a name="use-a-symmetric-key-in-the-identity-registry"></a>Use a symmetric key in the identity registry
...
### <a name="use-a-shared-access-policy"></a>Use a shared access policy
...
### <a name="use-security-tokens-from-service-components"></a>Use security tokens from service components
...
## <a name="supported-x509-certificates"></a>Supported X.509 certificates
...
### <a name="register-an-x509-client-certificate-for-a-device"></a>Register an X.509 client certificate for a device
...
### <a name="use-an-x509-client-certificate-during-runtime-operations"></a>Use an X.509 client certificate during runtime operations

The [Azure IoT device SDK for .NET][lnk-client-sdk] (version 1.0.11+) supports the use of X.509 client certificates.

### <a name="c-support"></a>C\# Support

The class **DeviceAuthenticationWithX509Certificate** supports the creation of  **DeviceClient** instances using an X.509 client certificate.
...
## <a name="custom-device-authentication"></a>Custom device authentication
...
### <a name="comparison-with-a-custom-gateway"></a>Comparison with a custom gateway
...
## <a name="iot-hub-permissions"></a>IoT Hub permissions
