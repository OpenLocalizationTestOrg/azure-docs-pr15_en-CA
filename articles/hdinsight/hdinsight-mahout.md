...
#<a name="generate-movie-recommendations-by-using-apache-mahout-with-hadoop-in-hdinsight"></a>Generate movie recommendations by using Apache Mahout with Hadoop in HDInsight
...
###<a name="cannot-find-the-jar-file"></a>Cannot find the JAR file
