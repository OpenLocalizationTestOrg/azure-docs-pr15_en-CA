...
#<a name="use-ssh-with-linux-based-hadoop-on-hdinsight-from-linux-unix-or-os-x"></a>Use SSH with Linux-based Hadoop on HDInsight from Linux, Unix, or OS X
...
## <a name="connect-to-a-domain-joined-hdinsight-cluster"></a>Connect to a Domain-joined HDInsight cluster
