...
# <a name="process-events-from-azure-event-hubs-with-storm-on-hdinsight-c"></a>Process events from Azure Event Hubs with Storm on HDInsight (C#)
...
## <a name="completed-project"></a>Completed project
...
## <a name="event-hubs-spout-and-bolt"></a>Event Hubs spout and bolt
...
### <a name="download-the-jar-file"></a>Download the .jar file
...
## <a name="configure-the-eventhubwriter"></a>Configure the EventHubWriter
...
## <a name="configure-the-eventhubreader"></a>Configure the EventHubReader
...
## <a name="deploy-the-topologies"></a>Deploy the topologies
...
## <a name="stop-the-topologies"></a>Stop the topologies
