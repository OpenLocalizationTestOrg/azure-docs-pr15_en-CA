...
#<a name="understand-and-resolve-errors-received-from-webhcat-templeton-on-hdinsight"></a>Understand and resolve errors received from WebHCat (Templeton,) on HDInsight
...
##<a name="what-is-webhcat"></a>What is WebHCat?
...
##<a name="too-many-requests"></a>Too many requests
