...
#<a name="extend-hdinsight-capabilities-by-using-azure-virtual-network"></a>Extend HDInsight capabilities by using Azure Virtual Network
...
## <a name="virtual-network-requirements"></a>Virtual Network requirements
...
###<a name="location-based-virtual-networks"></a>Location-based Virtual networks
...
###<a name="classic-or-v2-virtual-network"></a>Classic or v2 Virtual Network
...
###<a name="secured-virtual-networks"></a>Secured Virtual Networks
...
###<a name="determine-the-fqdn"></a>Determine the FQDN
...
###<a name="connecting-to-hbase"></a>Connecting to HBase
...
###<a name="verify-network-connectivity"></a>Verify network connectivity
