...
# <a name="information-about-using-hdinsight-on-linux"></a>Information about using HDInsight on Linux
...
## <a name="remote-access-to-services"></a>Remote access to services
...
## <a name="file-locations"></a>File locations
...
## <a name="hdfs-azure-blob-storage-and-storage-best-practices"></a>HDFS, Azure Blob storage, and storage best practices
...
### <a name="what-blob-storage-is-the-cluster-using"></a>What Blob storage is the cluster using?
...
### <a name="how-do-i-access-blob-storage"></a>How do I access Blob storage?
...
## <a name="how-do-i-install-hue-or-other-hadoop-component"></a>How do I install Hue (or other Hadoop component)?
