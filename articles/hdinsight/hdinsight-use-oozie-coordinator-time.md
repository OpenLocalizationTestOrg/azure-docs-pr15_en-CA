...
# <a name="use-time-based-oozie-coordinator-with-hadoop-in-hdinsight-to-define-workflows-and-coordinate-jobs"></a>Use time-based Oozie coordinator with Hadoop in HDInsight to define workflows and coordinate jobs
...
##<a name="what-is-oozie"></a>What is Oozie
...
##<a name="define-oozie-workflow-and-the-related-hiveql-script"></a>Define Oozie workflow and the related HiveQL script
...
##<a name="deploy-the-oozie-project-and-prepare-the-tutorial"></a>Deploy the Oozie project and prepare the tutorial
...
##<a name="run-the-oozie-project"></a>Run the Oozie project
