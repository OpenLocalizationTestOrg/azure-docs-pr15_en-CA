...
##<a name="download-the-flight-data"></a>Download the flight data
...
##<a name="upload-the-data"></a>Upload the data
...
##<a name="create-and-run-the-hiveql"></a>Create and run the HiveQL
...
##<a name="create-a-sql-database-table"></a>Create a SQL Database table
...
##<a name="export-data-with-sqoop"></a>Export data with Sqoop
