...
# <a name="use-oozie-with-hadoop-to-define-and-run-a-workflow-in-hdinsight"></a>Use Oozie with Hadoop to define and run a workflow in HDInsight
...
##<a name="submit-oozie-jobs-using-powershell"></a>Submit Oozie jobs using PowerShell
