...
# <a name="configure-domain-joined-hdinsight-clusters-preview"></a>Configure Domain-joined HDInsight clusters (Preview)
...
## <a name="create-an-azure-classic-vnet"></a>Create an Azure classic VNet
...
## <a name="create-and-configure-azure-ad-ds-for-your-azure-ad"></a>Create and configure Azure AD DS for your Azure AD
...
## <a name="configure-an-organizational-unit-and-reverse-dns"></a>Configure an organizational unit and reverse DNS
...
## <a name="create-a-resource-manager-vnet-for-hdinsight-cluster"></a>Create a Resource Manager VNet for HDInsight cluster
...
## <a name="peer-the-azure-ad-vnet-and-the-hdinsight-vnet"></a>Peer the Azure AD VNet and the HDInsight VNet
...
## <a name="create-hdinsight-cluster"></a>Create HDInsight cluster
