...
# <a name="use-ssh-tunneling-to-access-ambari-web-ui-jobhistory-namenode-oozie-and-other-web-uis"></a>Use SSH Tunneling to access Ambari web UI, JobHistory, NameNode, Oozie, and other web UI's
...
## <a name="what-requires-an-ssh-tunnel"></a>What requires an SSH tunnel?
...
## <a name="what-is-an-ssh-tunnel"></a>What is an SSH tunnel?
...
##<a name="verify-with-ambari-web-ui"></a>Verify with Ambari web UI
