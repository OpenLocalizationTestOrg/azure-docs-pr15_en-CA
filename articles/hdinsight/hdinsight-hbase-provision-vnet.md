...
# <a name="create-hbase-clusters-in-azure-virtual-network"></a>Create HBase clusters in Azure Virtual Network 
...
## <a name="create-hbase-cluster-into-virtual-network"></a>Create HBase cluster into virtual network
...
## <a name="connect-to-the-hbase-cluster-using-hbase-java-rpc-apis"></a>Connect to the HBase cluster using HBase Java RPC APIs
