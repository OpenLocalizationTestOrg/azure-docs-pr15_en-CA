...
#<a name="manage-hdinsight-clusters-by-using-the-ambari-rest-api"></a>Manage HDInsight clusters by using the Ambari REST API
...
##<a name="example-get-the-default-storage-account-and-container"></a>Example: Get the default storage account and container
...
##<a name="example-update-ambari-configuration"></a>Example: Update Ambari configuration
...
###<a name="example-restart-a-service-component"></a>Example: Restart a service component
