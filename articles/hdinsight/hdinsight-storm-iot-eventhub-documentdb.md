...
#<a name="process-vehicle-sensor-data-from-azure-event-hubs-using-apache-storm-on-hdinsight"></a>Process vehicle sensor data from Azure Event Hubs using Apache Storm on HDInsight
