...
# <a name="analyze-sensor-data-with-apache-storm-event-hub-and-hbase-in-hdinsight-hadoop"></a>Analyze sensor data with Apache Storm, Event Hub, and HBase in HDInsight (Hadoop) 
...
### <a name="topology-components"></a>Topology components
...
### <a name="configure-event-hub"></a>Configure Event Hub
...
## <a name="download-and-configure-the-project"></a>Download and configure the project
...
## <a name="compile-and-test-locally"></a>Compile and test locally
...
### <a name="start-the-web-application"></a>Start the web application
...
### <a name="start-generating-data"></a>Start generating data
...
### <a name="start-the-topology"></a>Start the topology
...
## <a name="create-a-storm-and-hbase-cluster"></a>Create a Storm and HBase cluster
...
## <a name="configure-the-dashboard-bolt"></a>Configure the Dashboard bolt
...
## <a name="create-the-hbase-table"></a>Create the HBase table
...
## <a name="configure-the-hbase-bolt"></a>Configure the HBase bolt
...
### <a name="download-the-hbase-sitexml"></a>Download the hbase-site.xml
...
### <a name="download-and-install-the-storm-hbase-component"></a>Download and install the storm-hbase component
...
### <a name="enable-the-storm-hbase-component-in-the-project"></a>Enable the storm-hbase component in the project
...
## <a name="build-package-and-deploy-the-solution-to-hdinsight"></a>Build, package and deploy the solution to HDInsight
...
## <a name="view-hbase-data"></a>View HBase data
...
## <a name="delete-your-clusters"></a>Delete your clusters
