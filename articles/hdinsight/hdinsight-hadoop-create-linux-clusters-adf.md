...
# <a name="create-on-demand-linux-based-hadoop-clusters-in-hdinsight-using-azure-data-factory"></a>Create on-demand Linux-based Hadoop clusters in HDInsight using Azure Data Factory
...
##<a name="prepare-storage-account"></a>Prepare storage account
