...
# <a name="monitor-hadoop-clusters-in-hdinsight-using-the-ambari-api"></a>Monitor Hadoop clusters in HDInsight using the Ambari API
...
## <a name="what-is-ambari"></a>What is Ambari?
...
## <a name="ambari-monitoring-apis"></a>Ambari monitoring APIs
