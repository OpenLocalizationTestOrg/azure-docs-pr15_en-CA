...
#<a name="use-c-user-defined-functions-with-hive-and-pig-streaming-on-hadoop-in-hdinsight"></a>Use C# user-defined functions with Hive and Pig streaming on Hadoop in HDInsight
...
##<a name="net-and-streaming"></a>.NET and streaming
...
###<a name="create-the-c-project"></a>Create the C# project
...
###<a name="upload-to-storage"></a>Upload to storage
...
###<a name="hive-query"></a>Hive query
...
##<a name="pig-and-c35"></a>Pig and C&#35;
...
###<a name="upload-the-application"></a>Upload the application
...
###<a name="use-the-application-from-pig-latin"></a>Use the application from Pig Latin
