...
# <a name="develop-scalding-mapreduce-jobs-with-apache-hadoop-on-hdinsight"></a>Develop Scalding MapReduce jobs with Apache Hadoop on HDInsight
...
## <a name="create-and-build-the-project"></a>Create and build the project
...
## <a name="run-the-job-on-a-linux-based-cluster"></a>Run the job on a Linux-based cluster
...
## <a name="run-the-job-on-a-windows-based-cluster"></a>Run the job on a Windows-based cluster
