...
# <a name="use-power-bi-to-visualize-data-from-an-apache-storm-topology"></a>Use Power BI to visualize data from an Apache Storm topology
...
## <a name="download-the-example"></a>Download the example
...
## <a name="create-a-database"></a>Create a database
...
## <a name="deploy-the-sample"></a>Deploy the sample
...
## <a name="create-a-report"></a>Create a report
