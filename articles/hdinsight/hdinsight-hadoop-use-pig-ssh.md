...
#<a name="run-pig-jobs-on-a-linux-based-cluster-with-the-pig-command-ssh"></a>Run Pig jobs on a Linux-based cluster with the Pig command (SSH)
...
###<a name="pig-latin-batch-files"></a>Pig Latin batch files
