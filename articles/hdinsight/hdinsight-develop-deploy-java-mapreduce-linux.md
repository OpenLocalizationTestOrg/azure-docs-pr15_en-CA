...
# <a name="develop-java-mapreduce-programs-for-hadoop-on-hdinsight-linux"></a>Develop Java MapReduce programs for Hadoop on HDInsight Linux
...
##<a name="create-a-new-maven-project"></a>Create a new Maven project
...
##<a name="create-the-mapreduce-application"></a>Create the MapReduce application
