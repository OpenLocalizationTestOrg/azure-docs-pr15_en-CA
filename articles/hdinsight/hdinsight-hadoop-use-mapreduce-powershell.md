...
# <a name="run-mapreduce-jobs-with-hadoop-on-hdinsight-using-powershell"></a>Run MapReduce jobs with Hadoop on HDInsight using PowerShell
...
###<a name="view-output"></a>View output
