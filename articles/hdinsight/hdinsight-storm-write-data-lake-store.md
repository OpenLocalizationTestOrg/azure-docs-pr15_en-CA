...
#<a name="use-azure-data-lake-store-with-apache-storm-with-hdinsight"></a>Use Azure Data Lake Store with Apache Storm with HDInsight
...
###<a name="understanding-adlstorebolt"></a>Understanding ADLStoreBolt
...
1. Download the example project from [https://github.com/Azure-Samples/hdinsight-storm-azure-data-lake-store ](https://github.com/Azure-Samples/hdinsight-storm-azure-data-lake-store
...
##<a name="deploy-and-run-on-linux-based-hdinsight"></a>Deploy and run on Linux-based HDInsight
...
##<a name="deploy-and-run-on-windows-based-hdinsight"></a>Deploy and run on Windows-based HDInsight
