...
#<a name="create-linux-based-clusters-in-hdinsight-using-curl-and-the-azure-rest-api"></a>Create Linux-based clusters in HDInsight using cURL and the Azure REST API
...
##<a name="get-an-authentication-token"></a>Get an authentication token
...
##<a name="check-the-status-of-a-deployment"></a>Check the status of a deployment
