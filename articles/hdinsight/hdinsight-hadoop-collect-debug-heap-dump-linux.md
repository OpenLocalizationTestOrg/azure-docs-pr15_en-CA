...
#<a name="enable-heap-dumps-for-hadoop-services-on-linux-based-hdinsight-preview"></a>Enable heap dumps for Hadoop services on Linux-based HDInsight (Preview)
...
###<a name="enable-heap-dumps"></a>Enable heap dumps
...
###<a name="dump-location"></a>Dump location
