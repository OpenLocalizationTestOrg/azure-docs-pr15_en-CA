...
# <a name="install-jupyter-notebook-on-your-computer-and-connect-to-apache-spark-cluster-on-hdinsight-linux"></a>Install Jupyter notebook on your computer and connect to Apache Spark cluster on HDInsight Linux
...
## <a name="install-jupyter-notebook-on-your-computer"></a>Install Jupyter notebook on your computer
...
## <a name="install-the-kernels-and-spark-magic"></a>Install the kernels and Spark magic
...
## <a name="configure-spark-magic-to-access-the-hdinsight-spark-cluster"></a>Configure Spark magic to access the HDInsight Spark cluster
