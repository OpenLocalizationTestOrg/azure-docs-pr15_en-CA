...
#<a name="develop-python-streaming-programs-for-hdinsight"></a>Develop Python streaming programs for HDInsight
...
##<a name="create-the-mapper-and-reducer"></a>Create the mapper and reducer
...
##<a name="run-mapreduce"></a>Run MapReduce
