...
#<a name="develop-apache-storm-topologies-using-python-on-hdinsight"></a>Develop Apache Storm topologies using Python on HDInsight
...
##<a name="storm-multi-language-support"></a>Storm multi-language support
...
###<a name="the-storm-module"></a>The Storm module
...
###<a name="java-vs-clojure-topology-definition"></a>Java vs. Clojure topology definition
...
##<a name="python-components-with-a-java-topology"></a>Python components with a Java topology
...
###<a name="build-and-run-the-project"></a>Build and run the project
...
##<a name="python-components-with-a-clojure-topology"></a>Python components with a Clojure topology
