...
# <a name="log-analytics-data-security"></a>Log Analytics data security
...
## <a name="data-segregation"></a>Data segregation
...
## <a name="security-standards-certifications"></a>Security standards certifications
...
## <a name="1-sign-up-for-log-analytics-and-collect-data"></a>1. Sign up for Log Analytics and collect data
...
## <a name="2-send-data-from-agents"></a>2. Send data from agents
...
## <a name="3-the-log-analytics-service-receives-and-processes-data"></a>3. The Log Analytics service receives and processes data
...
## <a name="4-use-log-analytics-to-access-the-data"></a>4. Use Log Analytics to access the data
