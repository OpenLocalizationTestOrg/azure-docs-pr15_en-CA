...
## <a name="configure-proxy-and-firewall-settings-with-the-microsoft-monitoring-agent"></a>Configure proxy and firewall settings with the Microsoft Monitoring Agent
...
## <a name="configure-proxy-and-firewall-settings-with-operations-manager"></a>Configure proxy and firewall settings with Operations Manager
