...
## <a name="creating-a-custom-field"></a>Creating a custom field
...
### <a name="step-2---perform-initial-extract"></a>Step 2 - Perform initial extract.
...
### <a name="step-3--verify-accuracy-of-the-extract-and-create-custom-field"></a>Step 3 – Verify accuracy of the extract and create custom field
