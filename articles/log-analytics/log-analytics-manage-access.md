...
# <a name="manage-access-to-log-analytics"></a>Manage access to Log Analytics
...
## <a name="determine-the-number-of-workspaces-you-need"></a>Determine the number of workspaces you need
...
### <a name="workspace-information"></a>Workspace information
...
#### <a name="view-workspace-information"></a>View workspace information
...
## <a name="manage-accounts-and-users"></a>Manage accounts and users
...
### <a name="managing-access-to-log-analytics-using-the-azure-portal"></a>Managing access to Log Analytics using the Azure portal
...
- If you want to navigate directly to a portal that you have access to using Azure permissions, then you need to specify the resource as part of the URL. It is possible to get this URL using PowerShell.
  ...
  The URL will look like:`https://eus.mms.microsoft.com/?tenant=contoso.com&resource=%2fsubscriptions%2faaa5159e-dcf6-890a-a702-2d2fee51c102%2fresourcegroups%2fdb-resgroup%2fproviders%2fmicrosoft.operationalinsights%2fworkspaces%2fmydemo12`


### <a name="managing-users-in-the-oms-portal"></a>Managing users in the OMS portal
...
#### <a name="add-a-user-to-an-existing-workspace"></a>Add a user to an existing workspace
...
#### <a name="edit-an-existing-user-type"></a>Edit an existing user type
...
#### <a name="to-edit-an-account"></a>To edit an account
...
### <a name="remove-a-user-from-a-oms-workspace"></a>Remove a user from a OMS workspace
...
### <a name="add-a-group-to-an-existing-workspace"></a>Add a group to an existing workspace
...
## <a name="link-an-existing-workspace-to-an-azure-subscription"></a>Link an existing workspace to an Azure subscription
...
### <a name="to-link-a-workspace-to-an-azure-subscription-in-the-oms-portal"></a>To link a workspace to an Azure subscription in the OMS portal
...
### <a name="to-link-a-workspace-to-an-azure-subscription-in-the-azure-portal"></a>To link a workspace to an Azure subscription in the Azure portal
...
## <a name="upgrade-a-workspace-to-a-paid-data-plan"></a>Upgrade a workspace to a paid data plan
...
### <a name="using-entitlements-from-the-oms-add-on-for-system-center"></a>Using entitlements from the OMS Add-On for System Center
...
### <a name="using-azure-commitment-from-an-enterprise-agreement"></a>Using Azure Commitment from an Enterprise Agreement
...
### <a name="to-change-a-workspace-to-a-paid-data-plan"></a>To change a workspace to a paid data plan
...
## <a name="add-an-azure-active-directory-organization-to-an-existing-workspace"></a>Add an Azure Active Directory Organization to an existing workspace
...
### <a name="to-add-an-azure-active-directory-organization-to-an-existing-workspace"></a>To add an Azure Active Directory Organization to an existing workspace
...
## <a name="close-your-oms-workspace"></a>Close your OMS workspace
...
### <a name="to-close-an-oms-workspace"></a>To close an OMS workspace
