...
# <a name="syslog-data-sources-in-log-analytics"></a>Syslog data sources in Log Analytics
...
## <a name="configuring-syslog"></a>Configuring Syslog
...
### <a name="configure-syslog-in-the-oms-portal"></a>Configure Syslog in the OMS portal
...
### <a name="configure-syslog-on-linux-agent"></a>Configure Syslog on Linux agent
...
### <a name="changing-the-syslog-port"></a>Changing the Syslog port
...
## <a name="syslog-record-properties"></a>Syslog record properties
...
## <a name="log-queries-with-syslog-records"></a>Log queries with Syslog records
