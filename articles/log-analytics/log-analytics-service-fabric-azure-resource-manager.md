...
##<a name="deploy-a-service-fabric-cluster-connected-to-a-log-analytics-workspace"></a>Deploy a Service Fabric Cluster connected to a Log Analytics workspace.
...
Once you select the deploy button above, you will arrive on the Azure portal with parameters for you to edit. Be sure to create a new resource group if you input a new Log Analytics workspace name: ![Service Fabric](./media/log-analytics-service-fabric/2.png)
...
##<a name="deploy-a-service-fabric-cluster-connected-to-an-oms-workspace-with-vm-extension-installed"></a>Deploy a Service Fabric Cluster connected to an OMS workspace with VM Extension installed.
This template does the following:
...
- Go to Settings on the left pane, and select Data >> Windows Performance Counters >> "Add the selected performance counters": ![Service Fabric](./media/log-analytics-service-fabric/7.png)
...
##<a name="adding-an-existing-storage-account-to-log-analytics"></a>Adding an existing storage account to Log Analytics
