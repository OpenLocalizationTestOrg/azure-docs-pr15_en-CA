...
# <a name="azure-networking-analytics-preview-solution-in-log-analytics"></a>Azure Networking Analytics (Preview) solution in Log Analytics
...
## <a name="review-azure-networking-analytics-data-collection-details"></a>Review Azure Networking Analytics data collection details
...
## <a name="use-azure-networking-analytics"></a>Use Azure Networking Analytics
...
### <a name="to-view-details-for-any-log-summary"></a>To view details for any log summary
