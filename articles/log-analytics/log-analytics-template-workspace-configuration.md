...
# <a name="manage-log-analytics-using-azure-resource-manager-templates"></a>Manage Log Analytics using Azure Resource Manager templates
...
## <a name="create-and-configure-a-log-analytics-workspace"></a>Create and configure a Log Analytics Workspace
...
```
### <a name="deploying-the-sample-template"></a>Deploying the sample template
...
## <a name="example-resource-manager-templates"></a>Example Resource Manager templates
