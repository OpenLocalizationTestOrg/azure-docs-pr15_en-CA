...
# <a name="custom-logs-in-log-analytics"></a>Custom logs in Log Analytics
...
## <a name="defining-a-custom-log"></a>Defining a custom log
...
### <a name="step-1-open-the-custom-log-wizard"></a>Step 1. Open the Custom Log Wizard
...
### <a name="step-2-upload-and-parse-a-sample-log"></a>Step 2. Upload and parse a sample log
...
### <a name="step-3-add-log-collection-paths"></a>Step 3. Add log collection paths
...
### <a name="step-4-provide-a-name-and-description-for-the-log"></a>Step 4. Provide a name and description for the log
...
### <a name="step-5-validate-that-the-custom-logs-are-being-collected"></a>Step 5. Validate that the custom logs are being collected
...
### <a name="step-6-parse-the-custom-log-entries"></a>Step 6. Parse the custom log entries
...
## <a name="disabling-a-custom-log"></a>Disabling a custom log
...
## <a name="custom-log-record-properties"></a>Custom log record properties
...
## <a name="log-searches-with-custom-log-records"></a>Log searches with custom log records
...
## <a name="sample-walkthrough-of-adding-a-custom-log"></a>Sample walkthrough of adding a custom log
...
### <a name="upload-and-parse-a-sample-log"></a>Upload and parse a sample log
...
### <a name="add-log-collection-paths"></a>Add log collection paths
...
### <a name="provide-a-name-and-description-for-the-log"></a>Provide a name and description for the log
...
### <a name="validate-that-the-custom-logs-are-being-collected"></a>Validate that the custom logs are being collected
...
### <a name="parse-the-custom-log-entries"></a>Parse the custom log entries
