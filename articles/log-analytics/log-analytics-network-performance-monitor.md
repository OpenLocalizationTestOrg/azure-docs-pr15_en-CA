...
# <a name="network-performance-monitor-preview-solution-in-oms"></a>Network Performance Monitor (Preview) solution in OMS
...
### <a name="using-the-solution-standalone"></a>Using the solution standalone
...
### <a name="using-the-solution-with-other-networking-tools"></a>Using the solution with other networking tools
...
## <a name="installing-and-configuring-agents-for-the-solution"></a>Installing and configuring agents for the solution
...
### <a name="where-to-install-the-agents"></a>Where to install the agents
...
### <a name="configure-agents"></a>Configure agents
...
## <a name="configuring-the-solution"></a>Configuring the solution
...
### <a name="configure-the-solution-with-a-default-network"></a>Configure the solution with a default network
...
### <a name="create-new-networks"></a>Create new networks
...
#### <a name="to-create-a-new-network"></a>To create a new network
...
### <a name="wait-for-data-aggregation"></a>Wait for data aggregation
...
### <a name="edit-monitoring-settings-for-subnets"></a>Edit monitoring settings for subnets

All subnets where at least one agent was installed are listed on the **Subnetworks** tab in the configuration page.

#### <a name="to-enable-or-disable-monitoring-for-particular-subnetworks"></a>To enable or disable monitoring for particular subnetworks
...
### <a name="choose-nodes-to-monitor"></a>Choose nodes to monitor

All the nodes that have an agent installed on them are listed in the **Nodes** tab.

#### <a name="to-enable-or-disable-monitoring-for-nodes"></a>To enable or disable monitoring for nodes
...
### <a name="set-monitoring-rules"></a>Set monitoring rules
...
#### <a name="to-create-custom-monitoring-rules"></a>To create custom monitoring rules
...
## <a name="data-collection-details"></a>Data collection details
...
### <a name="solution-overview-tile"></a>Solution Overview tile
...
### <a name="network-performance-monitor-solution-dashboard"></a>Network Performance Monitor solution dashboard
...
### <a name="drill-down-for-depth"></a>Drill-down for depth
...
#### <a name="trend-charts"></a>Trend charts
...
#### <a name="hop-by-hop-topology-map"></a>Hop-by-hop topology map
...
#### <a name="fault-localization"></a>Fault localization
...
## <a name="investigate-the-root-cause-of-a-health-alert"></a>Investigate the root cause of a health alert
