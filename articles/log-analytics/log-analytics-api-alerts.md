...
# <a name="log-analytics-alert-rest-api"></a>Log Analytics alert REST API
...
### <a name="retrieving-schedules"></a>Retrieving schedules
...
### <a name="editing-a-schedule"></a>Editing a schedule
...
### <a name="deleting-schedules"></a>Deleting schedules
...
### <a name="retrieving-actions"></a>Retrieving actions
...
### <a name="creating-or-editing-actions"></a>Creating or editing actions
...
### <a name="deleting-actions"></a>Deleting actions
...
#### <a name="remediation-actions"></a>Remediation actions
...
#### <a name="create-or-edit-a-webhook-action"></a>Create or edit a webhook action
