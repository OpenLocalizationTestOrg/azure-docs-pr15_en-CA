...
# <a name="log-searches-in-log-analytics"></a>Log searches in Log Analytics
...
## <a name="use-basic-filters"></a>Use basic filters
...
### <a name="to-conduct-a-simple-search"></a>To conduct a simple search
...
### <a name="to-search-for-processor-time-performance-data"></a>To search for processor time performance data
...
## <a name="use-additional-filters"></a>Use additional filters
...
#### <a name="to-search-using-a-boolean-operator"></a>To search using a boolean operator
...
## <a name="manipulate-search-results"></a>Manipulate search results
...
### <a name="limit-and-top"></a>Limit and top
...
#### <a name="to-search-using-top"></a>To search using top
...
#### <a name="to-run-a-search-using-the-select-command"></a>To run a search using the select command
...
## <a name="use-the-measure-command"></a>Use the measure command
...
#### <a name="to-search-using-measure-count"></a>To search using measure count
...
## <a name="use-the-max-and-min-functions-with-the-measure-command"></a>Use the max and min functions with the measure command
...
## <a name="use-the-avg-function-with-the-measure-command"></a>Use the avg function with the measure command
...
### <a name="to-search-using-the-avg-function-with-the-measure-command"></a>To search using the avg function with the measure command
...
### <a name="use-the-sum-function-with-the-measure-command"></a>Use the sum function with the measure command
...
### <a name="use-the-percentile-function-with-the-measure-command"></a>Use the percentile function with the measure command
...
## <a name="use-the-where-command"></a>Use the where command
...
## <a name="use-the-in-operator"></a>Use the in operator
...
## <a name="use-the-distinct-command"></a>Use the distinct command
...
## <a name="use-the-countdistinct-function-with-the-measure-command"></a>Use the countdistinct function with the measure command
...
## <a name="use-the-measure-interval-command"></a>Use the measure interval command
...
### <a name="use-multiple-aggregates-in-one-query"></a>Use multiple aggregates in one query
