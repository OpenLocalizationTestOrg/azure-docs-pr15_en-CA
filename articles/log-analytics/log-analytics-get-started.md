...
# <a name="get-started-with-log-analytics"></a>Get started with Log Analytics
...
## <a name="log-analytics-prerequisites-and-deployment-considerations"></a>Log Analytics prerequisites and deployment considerations
...
## <a name="sign-up-in-3-steps-using-the-operations-management-suite"></a>Sign up in 3 steps using the Operations Management Suite
...
## <a name="sign-up-quickly-using-microsoft-azure"></a>Sign up quickly using Microsoft Azure
...
## <a name="get-started-with-the-operations-management-suite-portal"></a>Get started with the Operations Management Suite portal
...
## <a name="optionally-connect-servers-directly-to-the-operations-management-suite-by-installing-an-agent"></a>Optionally, connect servers directly to the Operations Management Suite by installing an agent
...
## <a name="optionally-connect-servers-using-system-center-operations-manager"></a>Optionally, connect servers using System Center Operations Manager
...
## <a name="optionally-analyze-data-from-cloud-services-in-microsoft-azure"></a>Optionally, analyze data from cloud services in Microsoft Azure
