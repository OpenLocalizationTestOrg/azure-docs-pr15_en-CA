...
# <a name="connect-windows-computers-to-log-analytics"></a>Connect Windows computers to Log Analytics
...
## <a name="system-requirements-and-required-configuration"></a>System requirements and required configuration
...
## <a name="download-the-agent-setup-file-from-oms"></a>Download the agent setup file from OMS
...
## <a name="install-the-agent-using-setup"></a>Install the agent using setup
...
## <a name="upgrade-the-agent-and-add-a-workspace-using-a-script"></a>Upgrade the agent and add a workspace using a script
...
## <a name="configure-an-agent-manually-or-add-additional-workspaces"></a>Configure an agent manually or add additional workspaces
...
## <a name="to-disable-an-agent"></a>To disable an agent
...
## <a name="optionally-configure-agents-to-report-to-an-operations-manager-management-group"></a>Optionally, configure agents to report to an Operations Manager management group

If you use Operations Manager in your IT infrastructure, you can also use the MMA agent as an Operations Manager agent.

### <a name="to-configure-mma-agents-to-report-to-an-operations-manager-management-group"></a>To configure MMA agents to report to an Operations Manager management group
...
## <a name="optionally-configure-agents-to-use-the-oms-log-analytics-forwarder"></a>Optionally, configure agents to use the OMS Log Analytics Forwarder
...
## <a name="optionally-configure-proxy-and-firewall-settings"></a>Optionally, configure proxy and firewall settings
