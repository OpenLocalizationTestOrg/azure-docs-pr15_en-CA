...
# <a name="capacity-management-solution-in-log-analytics"></a>Capacity Management solution in Log Analytics
...
## <a name="capacity-management-data-collection-details"></a>Capacity Management data collection details
...
## <a name="capacity-management-page"></a>Capacity Management page
...
### <a name="to-view-a-capacity-page"></a>To view a capacity page

- On the **Overview** page, click **Capacity Management**, and then click **Compute** or **Storage**.

## <a name="compute-page"></a>Compute page
...
### <a name="to-work-with-items-on-the-compute-page"></a>To work with items on the Compute page
...
## <a name="direct-attached-storage-page"></a>Direct Attached Storage page
...
### <a name="to-work-with-items-on-the-direct-attached-storage-page"></a>To work with items on the Direct Attached Storage page
