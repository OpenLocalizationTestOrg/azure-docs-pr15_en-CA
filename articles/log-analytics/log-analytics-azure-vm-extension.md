...
# <a name="connect-azure-virtual-machines-to-log-analytics"></a>Connect Azure virtual machines to Log Analytics
...
## <a name="enable-the-vm-extension-in-the-azure-portal"></a>Enable the VM extension in the Azure portal
...
### <a name="to-install-the-log-analytics-agent-and-connect-the-virtual-machine-to-a-log-analytics-workspace"></a>To install the Log Analytics agent and connect the virtual machine to a Log Analytics workspace
...
## <a name="enable-the-vm-extension-using-powershell"></a>Enable the VM extension using PowerShell
...
## <a name="deploy-the-vm-extension-using-a-template"></a>Deploy the VM extension using a template
...
## <a name="troubleshooting-windows-virtual-machines"></a>Troubleshooting Windows Virtual Machines
...
## <a name="troubleshooting-linux-virtual-machines"></a>Troubleshooting Linux Virtual Machines
