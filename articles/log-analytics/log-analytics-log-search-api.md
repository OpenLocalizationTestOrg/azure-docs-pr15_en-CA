...
## <a name="overview-of-the-log-search-rest-api"></a>Overview of the Log Search REST API
...
## <a name="basic-log-analytics-search-rest-api-tutorial"></a>Basic Log Analytics Search REST API tutorial

### <a name="to-use-the-arm-client"></a>To use the ARM Client
...
### <a name="to-perform-a-simple-search-using-the-armclient"></a>To perform a simple search using the ARMClient
...
## <a name="log-analytics-search-rest-api-reference-examples"></a>Log Analytics Search REST API reference examples
...
### <a name="saved-searches---rest-only"></a>Saved searches - REST only
...
### <a name="create-saved-searches"></a>Create saved searches
...
### <a name="delete-saved-searches"></a>Delete saved searches
...
### <a name="update-saved-searches"></a>Update saved searches
...
### <a name="metadata---json-only"></a>Metadata - JSON only
...
## <a name="computer-groups"></a>Computer groups
...
### <a name="retrieving-computer-groups"></a>Retrieving computer groups
...
### <a name="creating-or-updating-a-computer-group"></a>Creating or updating a computer group
...
### <a name="deleting-computer-groups"></a>Deleting computer groups
