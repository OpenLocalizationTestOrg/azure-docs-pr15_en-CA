...
# <a name="active-directory-replication-status-solution-in-log-analytics"></a>Active Directory Replication Status solution in Log Analytics
...
## <a name="ad-replication-status-data-collection-details"></a>AD Replication Status data collection details
...
## <a name="optionally-enable-a-non-domain-controller-to-send-ad-data-to-oms"></a>Optionally, enable a non-domain controller to send AD data to OMS
...
### <a name="to-enable-a-non-domain-controller-to-send-ad-data-to-oms"></a>To enable a non-domain controller to send AD data to OMS
...
## <a name="understanding-replication-errors"></a>Understanding replication errors
...
### <a name="destination-server-status-and-source-server-status"></a>Destination Server Status and Source Server Status
...
### <a name="replication-error-types"></a>Replication Error Types
...
### <a name="ad-replication-status-details"></a>AD Replication status details
...
## <a name="ad-replication-status-faq"></a>AD Replication Status FAQ
...
## <a name="troubleshoot-data-collection-problems"></a>Troubleshoot data collection problems
