...
# <a name="monitor-and-manage-stream-analytics-jobs-with-azure-powershell-cmdlets"></a>Monitor and manage Stream Analytics jobs with Azure PowerShell cmdlets
...
## <a name="prerequisites-for-running-azure-powershell-cmdlets-for-stream-analytics"></a>Prerequisites for running Azure PowerShell cmdlets for Stream Analytics
...
## <a name="azure-powershell-cmdlets-for-stream-analytics"></a>Azure PowerShell cmdlets for Stream Analytics
