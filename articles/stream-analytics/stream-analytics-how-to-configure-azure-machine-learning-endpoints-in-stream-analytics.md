...
## <a name="overview-azure-machine-learning-terminology"></a>Overview: Azure Machine Learning terminology
...
## <a name="machine-learning-resources-needed-for-stream-analytics-jobs"></a>Machine Learning resources needed for Stream Analytics jobs
...
## <a name="configure-a-stream-analytics-and-machine-learning-udf-via-rest-api"></a>Configure a Stream Analytics and Machine Learning UDF via REST API
...
## <a name="creating-a-udf-with-basic-properties"></a>Creating a UDF with basic properties
...
## <a name="call-retrievedefaultdefinition-endpoint-for-default-udf"></a>Call RetrieveDefaultDefinition endpoint for default UDF
...
## <a name="patch-udf-with-the-response"></a>Patch UDF with the response 
...
## <a name="implement-stream-analytics-transformation-to-call-the-udf"></a>Implement Stream Analytics transformation to call the UDF
