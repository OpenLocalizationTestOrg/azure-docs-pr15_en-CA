...
# <a name="query-examples-for-common-stream-analytics-usage-patterns"></a>Query examples for common Stream Analytics usage patterns
...
## <a name="query-example-data-type-conversions"></a>Query example: Data type conversions
...
**Explanation**: Use a CAST statement on the Weight field to specify its type (see the list of supported Data Types [here](https://msdn.microsoft.com/library/azure/dn835065.aspx)).


## <a name="query-example-using-likenot-like-to-do-pattern-matching"></a>Query example: Using Like/Not like to do pattern matching
...
## <a name="query-example-specify-logic-for-different-casesvalues-case-statements"></a>Query example: Specify logic for different cases/values (CASE statements)
...
## <a name="query-example-send-data-to-multiple-outputs"></a>Query example: Send data to multiple outputs
...
**Explanation**: The INTO clause tells Stream Analytics which of the outputs to write the data from this statement.
...
## <a name="query-example-counting-unique-values"></a>Query example: Counting unique values
...
**Explanation:** We do an initial aggregation to get unique makes with their count over the window.
...
## <a name="query-example-determine-if-a-value-has-changed"></a>Query example: Determine if a value has changed#
...
## <a name="query-example-find-first-event-in-a-window"></a>Query example: Find first event in a window
...
## <a name="query-example-find-last-event-in-a-window"></a>Query example: Find last event in a window
...
## <a name="query-example-detect-the-absence-of-events"></a>Query example: Detect the absence of events
...
## <a name="query-example-detect-duration-between-events"></a>Query example: Detect duration between events
...
## <a name="query-example-detect-duration-of-a-condition"></a>Query example: Detect duration of a condition
...
## <a name="query-example-fill-missing-values"></a>Query example: Fill missing values
