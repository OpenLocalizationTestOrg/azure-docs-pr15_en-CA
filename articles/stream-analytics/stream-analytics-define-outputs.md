...
# <a name="stream-analytics-outputs-options-for-storage-analysis"></a>Stream Analytics outputs: Options for storage, analysis
...
### <a name="authorize-an-azure-data-lake-store"></a>Authorize an Azure Data Lake Store
...
### <a name="authorize-a-power-bi-account"></a>Authorize a Power BI account
...
### <a name="configure-the-power-bi-output-properties"></a>Configure the Power BI output properties
...
### <a name="renew-power-bi-authorization"></a>Renew Power BI Authorization
