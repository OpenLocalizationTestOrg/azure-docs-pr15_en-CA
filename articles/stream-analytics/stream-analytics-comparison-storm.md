...
# <a name="help-choosing-a-streaming-analytics-platform-apache-storm-comparison-to-azure-stream-analytics"></a>Help choosing a streaming analytics platform: Apache Storm comparison to Azure Stream Analytics
...
## <a name="storm-comparison-to-stream-analytics-general-features"></a>Storm comparison to Stream Analytics: General features ##
...
Automatic patching with no downtime.
        ...
        <tr>
            ...
            <td width="204" valign="top">
                <p>
SLA of 99.9% uptime </p>
                <p>
Auto-recovery from failures </p>
                <p>
