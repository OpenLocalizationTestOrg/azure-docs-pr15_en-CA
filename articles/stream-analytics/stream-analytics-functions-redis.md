...
# <a name="how-to-store-data-from-azure-stream-analytics-in-an-azure-redis-cache-using-azure-functions"></a>How to store data from Azure Stream Analytics in an Azure Redis Cache using Azure Functions
...
## <a name="create-and-connect-a-service-bus-queue-output"></a>Create and connect a Service Bus Queue output
...
## <a name="run-solution-and-check-results"></a>Run solution and check results
