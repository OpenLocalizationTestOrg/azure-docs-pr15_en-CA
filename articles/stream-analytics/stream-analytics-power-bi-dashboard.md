...
#  <a name="stream-analytics--power-bi-a-real-time-analytics-dashboard-for-streaming-data"></a>Stream Analytics & Power BI: A real-time analytics dashboard for streaming data
...
## <a name="create-azure-stream-analytics-job"></a>Create Azure Stream Analytics job
...
## <a name="add-power-bi-output"></a>Add Power BI output
...
## <a name="write-query"></a>Write query
...
## <a name="create-the-dashboard-in-power-bi"></a>Create the dashboard in Power BI
...
## <a name="limitations-and-best-practices"></a>Limitations and best practices
...
### <a name="powerbi-view-refresh"></a>PowerBI view refresh
...
### <a name="renew-authorization"></a>Renew authorization
