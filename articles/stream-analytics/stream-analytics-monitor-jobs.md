...
# <a name="programmatically-create-a-stream-analytics-job-monitor"></a>Programmatically create a Stream Analytics job monitor
...
## <a name="setup-a-project"></a>Setup a project
...
## <a name="create-management-clients"></a>Create Management Clients
...
## <a name="enable-monitoring-for-an-existing-stream-analytics-job"></a>Enable Monitoring For an Existing Stream Analytics Job
