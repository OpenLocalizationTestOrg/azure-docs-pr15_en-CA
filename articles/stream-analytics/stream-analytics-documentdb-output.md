...
# <a name="target-azure-documentdb-for-json-output-from-stream-analytics"></a>Target Azure DocumentDB for JSON output from Stream Analytics
...
## <a name="basics-of-documentdb-as-an-output-target"></a>Basics of DocumentDB as an output target
...
## <a name="tune-consistency-availability-and-latency"></a>Tune consistency, availability, and latency
...
## <a name="choose-a-performance-level"></a>Choose a performance level
...
## <a name="upserts-from-stream-analytics"></a>Upserts from Stream Analytics
...
## <a name="data-partitioning-in-documentdb"></a>Data partitioning in DocumentDB
...
## <a name="documentdb-settings-for-json-output"></a>DocumentDB settings for JSON output
