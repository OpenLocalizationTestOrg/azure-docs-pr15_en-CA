...
# <a name="scale-your-stream-analytics-job-with-azure-machine-learning-functions"></a>Scale your Stream Analytics job with Azure Machine Learning functions
...
## <a name="what-is-an-azure-machine-learning-function-in-stream-analytics"></a>What is an Azure Machine Learning function in Stream Analytics?
...
## <a name="configure-a-stream-analytics-job-with-machine-learning-functions"></a>Configure a Stream Analytics job with Machine Learning functions
...
## <a name="example--sentiment-analysis"></a>Example – Sentiment Analysis
...
## <a name="new-function-related-monitoring-metrics"></a>New function-related monitoring metrics
