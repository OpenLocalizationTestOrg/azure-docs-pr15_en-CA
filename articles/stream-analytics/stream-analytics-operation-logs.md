...
# <a name="debug-stream-analytics-jobs-using-service-and-operation-logs"></a>Debug Stream Analytics jobs using service and operation logs
...
## <a name="find-operation-logs-in-the-azure-management-portal"></a>Find operation logs in the Azure Management portal
...
## <a name="dashboard-of-the-stream-analytics-job"></a>Dashboard of the Stream Analytics job
...
## <a name="find-audit-logs-in-the-azure-portal"></a>Find audit logs in the Azure portal ##
...
## <a name="get-log-details"></a>Get log details
...
## <a name="debug-a-failed-job"></a>Debug a failed job
