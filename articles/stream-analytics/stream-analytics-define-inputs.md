...
# <a name="data-connection-learn-about-data-stream-inputs-from-events-to-stream-analytics"></a>Data connection: Learn about data stream inputs from events to Stream Analytics
...
## <a name="data-input-types-data-stream-and-reference-data"></a>Data input types: Data stream and reference data
...
### <a name="data-stream-inputs"></a>Data stream inputs
...
### <a name="reference-data"></a>Reference data
...
## <a name="create-a-data-stream-input-with-an-event-hub"></a>Create a data stream input with an Event Hub
...
### <a name="configure-event-hub-as-an-input-data-stream"></a>Configure Event Hub as an input data stream
...
## <a name="create-an-iot-hub-data-stream-input"></a>Create an IoT Hub data stream input
...
### <a name="configure-iot-hub-as-an-data-stream-input"></a>Configure IoT Hub as an data stream input
...
## <a name="create-a-blob-storage-data-stream-input"></a>Create a Blob storage data stream input
