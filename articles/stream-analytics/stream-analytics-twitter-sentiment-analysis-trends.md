...
## <a name="create-an-event-hub-input-and-a-consumer-group"></a>Create an event hub input and a consumer group
...
## <a name="view-output-for-sentiment-analysis"></a>View output for sentiment analysis
