...
# <a name="scale-azure-stream-analytics-jobs-to-increase-stream-data-processing-throughput"></a>Scale Azure Stream Analytics jobs to increase stream data processing throughput
...
## <a name="what-are-the-parts-of-a-stream-analytics-job"></a>What are the parts of a Stream Analytics job?
...
## <a name="configuring-streaming-units"></a>Configuring streaming units
...
## <a name="embarrassingly-parallel-job"></a>Embarrassingly parallel job
...
### <a name="query-with-grouping-key"></a>Query with grouping key
...
### <a name="multi-step-query-with-grouping-key"></a>Multi Step Query with Grouping Key ###
...
## <a name="example-scenarios-that-are-not-embarrassingly-parallel"></a>Example scenarios that are NOT embarrassingly parallel

### <a name="mismatched-partition-count"></a>Mismatched Partition Count ###
...
### <a name="not-using-event-hubs-or-blobs-as-output"></a>Not using Event Hubs or Blobs as output
Input – Event Hubs with 8 partitions Output – PowerBI

PowerBI output doesn’t currently support partitioning.

### <a name="multi-step-query-with-different-partition-by-values"></a>Multi Step Query with different Partition By values
Input – Event Hub with 8 partitions Output – Event Hub with 8 partitions
...
## <a name="calculate-the-maximum-streaming-units-of-a-job"></a>Calculate the maximum streaming units of a job
...
### <a name="steps-in-a-query"></a>Steps in a query
...
### <a name="partition-a-step"></a>Partition a step
...
### <a name="calculate-the-max-streaming-units-for-a-job"></a>Calculate the max streaming units for a job
...
### <a name="examples-of-scale"></a>Examples of scale
...
## <a name="configure-stream-analytics-job-partition"></a>Configure Stream Analytics job partition
...
## <a name="monitor-job-performance"></a>Monitor job performance
...
## <a name="stream-analytics-throughput-at-scale---raspberry-pi-scenario"></a>Stream Analytics Throughput at scale - Raspberry Pi scenario
