...
# <a name="logs-exceptions-and-custom-diagnostics-for-aspnet-in-application-insights"></a>Logs, exceptions and custom diagnostics for ASP.NET in Application Insights
...
### <a name="run-your-app-and-view-the-results"></a>Run your app and view the results.
...
####  <a name="install-an-adapter-for-your-logging-framework"></a>Install an adapter for your logging framework
...
#### <a name="viewing-exceptions"></a>Viewing exceptions
...
### <a name="reporting-unhandled-exceptions"></a>Reporting unhandled exceptions
...
### <a name="correlating-with-a-build"></a>Correlating with a build
...
### <a name="some-of-my-events-or-traces-dont-appear"></a>Some of my events or traces don't appear
