...
# <a name="using-analytics-in-application-insights"></a>Using Analytics in Application Insights
...
## <a name="query-your-telemetry"></a>Query your telemetry

### <a name="write-a-query"></a>Write a query
...
### <a name="run-a-query"></a>Run a query
...
### <a name="save-a-query"></a>Save a query
...
## <a name="see-the-details"></a>See the details
...
## <a name="arrange-the-results"></a>Arrange the results
...
### <a name="sort-and-filter-items"></a>Sort and filter items
...
### <a name="group-items"></a>Group items
...
### <a name="missing-some-results"></a>Missing some results?
...
## <a name="export-to-power-bi"></a>Export to Power BI
