...
# <a name="explore-net-trace-logs-in-application-insights"></a>Explore .NET trace logs in Application Insights  
...
## <a name="install-logging-on-your-app"></a>Install logging on your app
...
## <a name="configure-application-insights-to-collect-logs"></a>Configure Application Insights to collect logs
...
## <a name="insert-diagnostic-log-calls"></a>Insert diagnostic log calls
...
## <a name="using-the-trace-api-directly"></a>Using the Trace API directly
...
## <a name="explore-your-logs"></a>Explore your logs
...
### <a name="how-do-i-do-this-for-java"></a>How do I do this for Java?

Use the [Java log adapters](app-insights-java-trace-logs.md).

### <a name="theres-no-application-insights-option-on-the-project-context-menu"></a>There's no Application Insights option on the project context menu
...
### <a name="no-log-adapter-option-in-the-configuration-tool"></a>No log adapter option in the configuration tool
...
### <a name="i-can-see-traces-in-diagnostic-search-but-not-the-other-events"></a>I can see traces in diagnostic search, but not the other events
...
### <a name="im-not-seeing-some-of-the-log-entries-that-i-expect"></a>I'm not seeing some of the log entries that I expect
