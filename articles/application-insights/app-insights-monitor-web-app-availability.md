...
# <a name="monitor-availability-and-responsiveness-of-any-web-site"></a>Monitor availability and responsiveness of any web site
...
### <a name="test-more-urls"></a>Test more URLs
...
## <a name="multi-step-web-tests"></a>Multi-step web tests
...
#### <a name="1-record-a-scenario"></a>1. Record a scenario
...
#### <a name="2-upload-the-web-test-to-application-insights"></a>2. Upload the web test to Application Insights
...
### <a name="plugging-time-and-random-numbers-into-your-multi-step-test"></a>Plugging time and random numbers into your multi-step test
...
## <a name="dealing-with-sign-in"></a>Dealing with sign-in
...
### <a name="simple-username-and-password"></a>Simple username and password
...
### <a name="open-authentication"></a>Open Authentication
