...
# <a name="create-application-insights-resources-using-powershell"></a>Create Application Insights resources using PowerShell
...
## <a name="copy-the-json-for-existing-resources"></a>Copy the JSON for existing resources
...
## <a name="parameterize-the-template"></a>Parameterize the template
...
## <a name="set-dependencies-between-the-resources"></a>Set dependencies between the resources
...
## <a name="create-application-insights-resources"></a>Create Application Insights resources
...
## <a name="define-metric-alerts"></a>Define metric alerts
