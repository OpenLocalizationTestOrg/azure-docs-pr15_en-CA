...
# <a name="troubleshooting-and-q-and-a-for-application-insights-for-java"></a>Troubleshooting and Q and A for Application Insights for Java

Questions or problems with [Visual Studio Application Insights in Java][java]? Here are some tips.


## <a name="build-errors"></a>Build errors
...
## <a name="no-usage-data"></a>No usage data
...
## <a name="changing-the-target"></a>Changing the target
...
## <a name="the-azure-start-screen"></a>The Azure start screen
