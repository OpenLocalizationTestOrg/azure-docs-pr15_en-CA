...
# <a name="system-performance-counters-in-application-insights"></a>System performance counters in Application Insights
...
## <a name="view-counters"></a>View counters
...
## <a name="add-counters"></a>Add counters
...
### <a name="collecting-performance-counters-in-code"></a>Collecting performance counters in code
...
## <a name="performance-counters-in-analytics"></a>Performance counters in Analytics
...
## <a name="aspnet-and-application-insights-counts"></a>ASP.NET and Application Insights counts
