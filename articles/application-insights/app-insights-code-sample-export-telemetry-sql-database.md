...
# <a name="code-sample-parse-data-exported-from-application-insights"></a>Code sample: Parse data exported from Application Insights
...
## <a name="add-application-insights-sdk"></a>Add Application Insights SDK
...
## <a name="create-a-worker-role"></a>Create a worker role 
...
#### <a name="create-worker-role-project"></a>Create worker role project
...
#### <a name="connect-to-the-storage-account"></a>Connect to the storage account
...
#### <a name="retrieve-the-storage-connection-string"></a>Retrieve the storage connection string
...
#### <a name="run-the-worker-at-regular-intervals"></a>Run the worker at regular intervals
...
#### <a name="insert-each-json-object-as-a-table-row"></a>Insert each JSON object as a table row
...
#### <a name="parse-each-blob"></a>Parse each blob
...
#### <a name="prepare-a-dictionary-for-each-json-document"></a>Prepare a dictionary for each JSON document
...
#### <a name="cast-the-json-document-into-c-class-telemetry-object-properties"></a>Cast the JSON document into C# class telemetry object properties
...
#### <a name="pageviewperformance-class-file-generated-out-of-json-document"></a>PageViewPerformance class file generated out of JSON document
...
## <a name="schema-information-only"></a>Schema (information only)
