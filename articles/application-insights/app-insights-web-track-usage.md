...
# <a name="usage-analysis-for-web-applications-with-application-insights"></a>Usage analysis for web applications with Application Insights
...
## <a name="how-popular-is-my-web-application"></a>How popular is my web application?
...
### <a name="where-do-my-users-live"></a>Where do my users live?
...
### <a name="what-browsers-or-operating-systems-do-they-use"></a>What browsers or operating systems do they use?
...
#### <a name="whats-a-session"></a>What's a session?
...
## <a name="users-and-user-counts"></a>Users and user counts
...
## <a name="synthetic-traffic"></a>Synthetic traffic
...
## <a name="page-usage"></a>Page usage
...
## <a name="custom-tracking"></a>Custom tracking
...
## <a name="view-counts-of-custom-events"></a>View counts of custom events
...
## <a name="drill-into-specific-events"></a>Drill into specific events
...
## <a name="filter-search-and-segment-your-data-with-properties"></a>Filter, search and segment your data with properties
