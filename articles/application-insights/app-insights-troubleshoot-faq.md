...
# <a name="questions---application-insights-for-aspnet"></a>Questions - Application Insights for ASP.NET

## <a name="configuration-problems"></a>Configuration problems
...
## <a name="can-i-use-application-insights-with-"></a>Can I use Application Insights with ...?

[See Platforms][platforms]


## <a name="is-it-free"></a>Is it free?
...
#### <a name="what-do-i-get-if-i-pay"></a>What do I get if I pay?
...
#### <a name="is-my-data-secure-in-the-portal-how-long-is-it-retained"></a>Is my data secure in the portal? How long is it retained?
...
## <a name="more-answers"></a>More answers
