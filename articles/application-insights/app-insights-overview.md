...
# <a name="application-insights---introduction"></a>Application Insights - introduction
...
## <a name="how-do-i-use-it"></a>How do I use it?
...
## <a name="explore-metrics"></a>Explore Metrics
...
#### <a name="get-more-detail"></a>Get more detail
...
#### <a name="customize-a-chart"></a>Customize a chart
...
## <a name="search-instance-data"></a>Search instance data
...
### <a name="log-traces"></a>Log traces
...
## <a name="development-in-visual-studio"></a>Development in Visual Studio
...
## <a name="releasing-a-new-build"></a>Releasing a new build
...
### <a name="proactive-diagnostics"></a>Proactive diagnostics 
...
### <a name="metric-alerts"></a>Metric alerts
