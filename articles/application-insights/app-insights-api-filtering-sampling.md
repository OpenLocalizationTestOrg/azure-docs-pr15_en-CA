...
# <a name="filtering-and-preprocessing-telemetry-in-the-application-insights-sdk"></a>Filtering and preprocessing telemetry in the Application Insights SDK
...
### <a name="create-a-telemetry-processor"></a>Create a telemetry processor
...
### <a name="example-filters"></a>Example filters

#### <a name="synthetic-requests"></a>Synthetic requests
...
#### <a name="failed-authentication"></a>Failed authentication
...
#### <a name="filter-out-fast-remote-dependency-calls"></a>Filter out fast remote dependency calls
...
#### <a name="diagnose-dependency-issues"></a>Diagnose dependency issues
...
## <a name="add-properties-itelemetryinitializer"></a>Add properties: ITelemetryInitializer
...
### <a name="javascript-telemetry-initializers"></a>JavaScript telemetry initializers
...
## <a name="itelemetryprocessor-and-itelemetryinitializer"></a>ITelemetryProcessor and ITelemetryInitializer
...
### <a name="to-use-the-persistence-channel"></a>To use the persistence channel
...
#### <a name="test-example"></a>Test example
