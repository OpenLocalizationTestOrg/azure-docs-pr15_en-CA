...
# <a name="proactive-failure-rate-diagnostics"></a>Proactive Failure Rate Diagnostics
...
## <a name="if-you-receive-an-proactive-failure-rate-diagnostics-alert"></a>If you receive an Proactive failure rate diagnostics alert
