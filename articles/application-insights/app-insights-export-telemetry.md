...
# <a name="export-telemetry-from-application-insights"></a>Export telemetry from Application Insights
...
#### <a name="cant-add-or-change-an-export"></a>Can't add or change an export?
...
## <a name="processing-the-data"></a>Processing the data
...
## <a name="if-you-regenerate-your-storage-key"></a>If you regenerate your storage key...
...
## <a name="export-samples"></a>Export samples
