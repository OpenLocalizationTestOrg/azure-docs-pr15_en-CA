...
#  <a name="sampling-in-application-insights"></a>Sampling in Application Insights
...
## <a name="types-of-sampling"></a>Types of sampling
...
## <a name="ingestion-sampling"></a>Ingestion sampling
...
## <a name="adaptive-sampling-at-your-web-server"></a>Adaptive sampling at your web server
...
### <a name="alternative-configure-adaptive-sampling-in-code"></a>Alternative: configure adaptive sampling in code
...
## <a name="sampling-for-web-pages-with-javascript"></a>Sampling for web pages with JavaScript
...
## <a name="fixed-rate-sampling-for-aspnet-web-sites"></a>Fixed-rate sampling for ASP.NET web sites
...
### <a name="alternative-enable-fixed-rate-sampling-in-your-server-code"></a>Alternative: enable fixed-rate sampling in your server code
...
## <a name="when-to-use-sampling"></a>When to use sampling?
...
### <a name="which-type-of-sampling-should-i-use"></a>Which type of sampling should I use?
...
## <a name="how-do-i-know-whether-sampling-is-in-operation"></a>How do I know whether sampling is in operation?
...
## <a name="how-does-sampling-work"></a>How does sampling work?
...
## <a name="sampling-and-the-javascript-sdk"></a>Sampling and the JavaScript SDK
