...
# <a name="usage-analysis-with-application-insights"></a>Usage analysis with Application Insights
...
### <a name="run-your-project-and-see-first-results"></a>Run your project and see first results
...
## <a name="analytics-out-of-the-box"></a>Analytics out of the box
