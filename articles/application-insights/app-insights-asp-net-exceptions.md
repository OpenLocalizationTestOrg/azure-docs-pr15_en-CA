...
# <a name="set-up-application-insights-diagnose-exceptions"></a>Set up Application Insights: Diagnose exceptions
...
## <a name="dependency-failures"></a>Dependency failures
...
## <a name="custom-tracing-and-log-data"></a>Custom tracing and log data
...
### <a name="how-to-see-request-post-data"></a>How to see request POST data
...
## <a name="exception-performance-counters"></a>Exception performance counters
