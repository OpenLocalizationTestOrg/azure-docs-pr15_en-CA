...
# <a name="moving-from-azure-endpoint-monitoring-to-application-insights-availability-tests"></a>Moving from Azure Endpoint Monitoring to Application Insights Availability Tests
...
## <a name="what-are-availability-tests"></a>What are Availability tests?
...
## <a name="so-whats-happening-to-my-endpoint-tests"></a>So what's happening to my endpoint tests?
...
## <a name="what-do-i-need-to-do"></a>What do I need to do?
...
### <a name="option-a-do-nothing-leave-it-to-us"></a>Option A: Do nothing. Leave it to us.
...
### <a name="option-b-you-manage-andor-enable-the-new-tests"></a>Option B: You manage and/or enable the new tests.
...
## <a name="how-do-i-edit-the-new-tests"></a>How do I edit the new tests?
...
## <a name="why-is-this-happening"></a>Why is this happening?
...
## <a name="am-i-paying-for-the-new-tests"></a>Am I paying for the new tests?
...
## <a name="what-is-and-isnt-migrated"></a>What is and isn't migrated?
...
## <a name="how-do-i-find-the-new-tests"></a>How do I find the new tests?
...
## <a name="what-happens-if-i-do-nothing"></a>What happens if I do nothing?
...
## <a name="where-can-i-provide-feedback-on-this"></a>Where can I provide feedback on this? 
