...
# <a name="application-insights-api-for-custom-events-and-metrics"></a>Application Insights API for custom events and metrics 
...
## <a name="construct-a-telemetryclient"></a>Construct a TelemetryClient
...
## <a name="track-event"></a>Track Event
...
### <a name="view-your-events-in-the-azure-portal"></a>View your events in the Azure portal
...
## <a name="track-metric"></a>Track Metric
...
#### <a name="custom-page-views"></a>Custom page views
...
#### <a name="timing-page-views"></a>Timing page views
...
## <a name="track-request"></a>Track Request
...
## <a name="operation-context"></a>Operation context
...
## <a name="track-exception"></a>Track Exception
...
## <a name="track-trace"></a>Track Trace 
...
## <a name="track-dependency"></a>Track Dependency
...
## <a name="flushing-data"></a>Flushing data
...
#### <a name="alternative-way-to-set-properties-and-metrics"></a>Alternative way to set properties and metrics
...
## <a name="sampling-filtering-and-processing-telemetry"></a>Sampling, filtering and processing telemetry 
...
## <a name="disabling-telemetry"></a>Disabling telemetry
...
## <a name="reference-docs"></a>Reference docs
