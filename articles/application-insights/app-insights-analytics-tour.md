...
# <a name="a-tour-of-analytics-in-application-insights"></a>A tour of Analytics in Application Insights
...
## <a name="takeapp-insights-analytics-referencemdtake-operator-show-me-n-rows"></a>[Take](app-insights-analytics-reference.md#take-operator): show me n rows
...
## <a name="topapp-insights-analytics-referencemdtop-operator-and-sortapp-insights-analytics-referencemdsort-operator"></a>[Top](app-insights-analytics-reference.md#top-operator) and [sort](app-insights-analytics-reference.md#sort-operator)
...
## <a name="projectapp-insights-analytics-referencemdproject-operator-select-rename-and-compute-columns"></a>[Project](app-insights-analytics-reference.md#project-operator): select, rename and compute columns
...
## <a name="extendapp-insights-analytics-referencemdextend-operator-compute-columns"></a>[Extend](app-insights-analytics-reference.md#extend-operator): compute columns
...
## <a name="summarizeapp-insights-analytics-referencemdsummarize-operator-aggregate-groups-of-rows"></a>[Summarize](app-insights-analytics-reference.md#summarize-operator): aggregate groups of rows
...
## <a name="counting-sampled-data"></a>Counting sampled data
...
## <a name="charting-the-results"></a>Charting the results
...
## <a name="whereapp-insights-analytics-referencemdwhere-operator-filtering-on-a-condition"></a>[Where](app-insights-analytics-reference.md#where-operator): filtering on a condition
...
### <a name="filtering-events"></a>Filtering events
...
## <a name="multiple-series"></a>Multiple series 
...
### <a name="segment-a-chart-by-dimensions"></a>Segment a chart by dimensions
...
### <a name="display-multiple-metrics"></a>Display multiple metrics
...
## <a name="daily-average-cycle"></a>Daily average cycle
...
## <a name="compare-multiple-daily-series"></a>Compare multiple daily series
...
## <a name="plot-a-distribution"></a>Plot a distribution
...
## <a name="letapp-insights-analytics-referencemdlet-clause-assign-a-result-to-a-variable"></a>[Let](app-insights-analytics-reference.md#let-clause): Assign a result to a variable
...
## <a name="accessing-nested-objects"></a>Accessing nested objects
...
## <a name="custom-properties-and-measurements"></a>Custom properties and measurements
...
### <a name="requests-table"></a>Requests table
...
### <a name="custom-events-table"></a>Custom events table
...
### <a name="custom-metrics-table"></a>Custom metrics table
...
### <a name="performance-counters-table"></a>Performance counters table
...
### <a name="exceptions-table"></a>Exceptions table
...
### <a name="browser-timings-table"></a>Browser timings table
...
### <a name="availbility-results-table"></a>Availbility results table
