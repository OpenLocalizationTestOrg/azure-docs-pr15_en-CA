...
# <a name="get-started-with-application-insights-in-a-java-web-project"></a>Get started with Application Insights in a Java web project
...
## <a name="2-add-the-application-insights-sdk-for-java-to-your-project"></a>2. Add the Application Insights SDK for Java to your project

*Choose the appropriate way for your project.*

#### <a name="if-youre-using-eclipse-to-create-a-maven-or-dynamic-web-project-"></a>If you're using Eclipse to create a Maven or Dynamic Web project ...

Use the [Application Insights SDK for Java plug-in][eclipse].

#### <a name="if-youre-using-maven"></a>If you're using Maven...
...
#### <a name="if-youre-using-gradle"></a>If you're using Gradle...
...
### <a name="alternative-ways-to-set-the-instrumentation-key"></a>Alternative ways to set the instrumentation key
...
#### <a name="if-youre-using-spring-web-mvc-31-or-later"></a>If you're using Spring Web MVC 3.1 or later
...
#### <a name="if-youre-using-struts-2"></a>If you're using Struts 2
...
## <a name="5-run-your-application"></a>5. Run your application

Either run it in debug mode on your development machine, or publish to your server.

## <a name="6-view-your-telemetry-in-application-insights"></a>6. View your telemetry in Application Insights
...
### <a name="analytics-powerful-query-language"></a>Analytics: Powerful query language
...
## <a name="7-install-your-app-on-the-server"></a>7. Install your app on the server
...
## <a name="exceptions-and-request-failures"></a>Exceptions and request failures
...
## <a name="get-user-and-session-data"></a>Get user and session data
...
## <a name="capture-log-traces"></a>Capture log traces
...
## <a name="send-your-own-telemetry"></a>Send your own telemetry
...
## <a name="questions-problems"></a>Questions? Problems?
