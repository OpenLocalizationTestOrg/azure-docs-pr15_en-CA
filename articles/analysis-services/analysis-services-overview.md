...
# <a name="what-is-azure-analysis-services"></a>What is Azure Analysis Services?
...
## <a name="built-on-sql-server-analysis-services"></a>Built on SQL Server Analysis Services
...
## <a name="use-the-tools-you-already-know"></a>Use the tools you already know
...
## <a name="connect-to-data-sources"></a>Connect to data sources
...
## <a name="explore-your-data-from-anywhere"></a>Explore your data from anywhere
...
#### <a name="on-premises-data-sources"></a>On-premises data sources
