...
## <a name="server-administrators"></a>Server administrators
...
## <a name="database-users"></a>Database users
...
## <a name="enable-azure-active-directory-authentication"></a>Enable Azure Active Directory authentication
