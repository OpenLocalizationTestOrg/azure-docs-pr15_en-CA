...
# <a name="secure-your-cloud-and-on-premises-resources-using-azure-multi-factor-authentication-server-with-ad-fs-in-windows-server-2012-r2"></a>Secure your cloud and on-premises resources using Azure Multi-Factor Authentication Server with AD FS in Windows Server 2012 R2
...
## <a name="edit-the-multifactorauthenticationadfsadapterconfig-file"></a>Edit the MultiFactorAuthenticationAdfsAdapter.config file
