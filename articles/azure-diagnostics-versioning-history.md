...
## <a name="azure-26-diagnostics-changes"></a>Azure 2.6 diagnostics changes
...
### <a name="migrating-projects-to-azure-sdk-26-and-later"></a>Migrating projects to Azure SDK 2.6 and later
...
## <a name="diagnostics-functionality-differences-between-azure-sdk-24-and-earlier-and-azure-sdk-25-and-later"></a>Diagnostics functionality differences between Azure SDK 2.4 and earlier and Azure SDK 2.5 and later
