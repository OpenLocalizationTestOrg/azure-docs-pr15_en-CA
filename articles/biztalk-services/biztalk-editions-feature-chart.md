...
# <a name="biztalk-services-editions-chart"></a>BizTalk Services: Editions chart
...
## <a name="compare-the-editions"></a>Compare the editions
...
## <a name="editions-chart"></a>Editions chart
...
#### <a name="what-is-a-biztalk-unit"></a>What is a BizTalk unit?
...
#### <a name="what-is-the-difference-between-biztalk-services-and-azure-biztalk-vm"></a>What is the difference between BizTalk Services and Azure BizTalk VM?
...
#### <a name="what-is-the-difference-between-biztalk-adapter-service-and-hybrid-connections"></a>What is the difference between BizTalk Adapter Service and Hybrid Connections?
...
#### <a name="what-does-hybrid-connection-data-transfer-gb-per-unit-mean-is-this-per-minutehourdayweekmonth-what-happens-when-the-limit-is-reached"></a>What does "Hybrid Connection Data Transfer (GB) per unit" mean? Is this per minute/hour/day/week/month? What happens when the limit is reached?
...
#### <a name="when-i-create-an-agreement-in-biztalk-services-why-does-the-number-of-bridges-go-up-by-two-instead-of-just-one"></a>When I create an agreement in BizTalk Services, why does the number of bridges go up by two instead of just one?
...
####  <a name="what-happens-when-i-hit-the-quota-limit-on-the-number-of-bridges-or-agreements"></a>What happens when I hit the quota limit on the number of bridges or agreements?
...
#### <a name="how-do-i-migrate-from-one-tier-of-biztalk-services-to-another"></a>How do I migrate from one tier of BizTalk Services to another?
...
#### <a name="is-the-biztalk-adapter-service-included-in-the-service-how-do-i-receive-the-software"></a>Is the BizTalk Adapter Service included in the service? How do I receive the software?
