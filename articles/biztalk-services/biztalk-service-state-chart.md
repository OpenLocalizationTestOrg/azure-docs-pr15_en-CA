...
# <a name="biztalk-services-service-state-chart"></a>BizTalk Services: Service state chart
...
## <a name="start-stop-restart-suspend-resume-and-delete-operations"></a>Start, Stop, Restart, Suspend, Resume, and Delete Operations
<table border="1">
<tr>
...
## <a name="scale-update-configuration-and-backup-operations"></a>Scale, Update Configuration, and Backup Operations
<table border="1">
<tr>
        <th colspan="15">Operation or Action</th>
</tr>
