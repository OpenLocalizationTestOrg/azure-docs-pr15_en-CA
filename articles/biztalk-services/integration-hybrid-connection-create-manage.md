...
# <a name="create-and-manage-hybrid-connections"></a>Create and Manage Hybrid Connections


## <a name="overview-of-the-steps"></a>Overview of the Steps
...
#### <a name="copyregenerate-the-hybrid-connection-strings"></a>Copy/regenerate the Hybrid Connection Strings
...
#### <a name="use-group-policy-to-control-the-on-premises-resources-used-by-a-hybrid-connection"></a>Use Group Policy to control the on-premises resources used by a Hybrid Connection
