...
# <a name="tutorial-process-edifact-invoices-using-azure-biztalk-services"></a>Tutorial: Process EDIFACT invoices using Azure BizTalk Services
...
## <a name="sample-based-on-this-tutorial"></a>Sample based on this tutorial
...
## <a name="what-does-the-solution-do"></a>What does the solution do?
...
## <a name="step-1-create-the-service-bus-queues"></a>Step 1: Create the Service Bus queues  
...
## <a name="step-2-create-and-deploy-trading-partner-agreement"></a>Step 2: Create and deploy trading partner agreement
...
### <a name="create-the-trading-partners"></a>Create the trading partners
...
### <a name="create-the-agreement"></a>Create the agreement
...
## <a name="step-3-create-and-deploy-the-biztalk-services-project"></a>Step 3: Create and deploy the BizTalk Services project
...
### <a name="create-the-biztalk-services-project"></a>Create the BizTalk Services project
...
## <a name="step-4-test-the-solution"></a>Step 4: Test the solution
...
## <a name="step-5-optional-send-edifact-invoice-in-batches"></a>Step 5 (optional): Send EDIFACT invoice in batches 
