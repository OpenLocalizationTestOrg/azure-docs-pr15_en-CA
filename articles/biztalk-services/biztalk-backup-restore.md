...
# <a name="biztalk-services-backup-and-restore"></a>BizTalk Services: Backup and Restore
...
#### <a name="before-restoring-a-backup"></a>Before restoring a backup
...
#### <a name="restore-a-backup"></a>Restore a backup
