...
# <a name="migrating-biztalk-server-edi-solutions-to-biztalk-services-technical-guide"></a>Migrating BizTalk Server EDI Solutions to BizTalk Services: Technical Guide
...
## <a name="which-version-of-biztalk-server-edi-artifacts-can-be-migrated-to-biztalk-services"></a>Which version of BizTalk Server EDI artifacts can be migrated to BizTalk Services?
...
## <a name="scenariosmessage-flow"></a>Scenarios/Message Flow
...
## <a name="sendreceive-ports-to-trading-partners"></a>Send/Receive Ports to Trading Partners
...
### <a name="new-transform-operations"></a>New Transform Operations
...
### <a name="migrating-biztalk-server-maps"></a>Migrating BizTalk Server Maps
...
### <a name="fallback-agreements"></a>Fallback Agreements
...
### <a name="routing-to-multiple-destinations"></a>Routing to multiple destinations
