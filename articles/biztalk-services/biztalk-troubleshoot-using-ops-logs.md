...
# <a name="biztalk-services-troubleshoot-using-operation-logs"></a>BizTalk Services: Troubleshoot using operation logs

## <a name="what-are-the-operation-logs"></a>What are the Operation Logs
...
## <a name="view-biztalk-services-operation-logs"></a>View BizTalk Services Operation Logs
...
3. Select the checkmark to view the filtered list. The following image shows activities related to testbiztalkservice:  ![View operation logs][ViewLogs] 
