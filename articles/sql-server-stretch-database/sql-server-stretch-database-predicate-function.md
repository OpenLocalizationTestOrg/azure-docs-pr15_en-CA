...
## <a name="examples-of-filter-functions-that-arent-valid"></a>Examples of filter functions that aren't valid
...
### <a name="examples-of-replacements-that-arent-valid"></a>Examples of replacements that aren't valid
