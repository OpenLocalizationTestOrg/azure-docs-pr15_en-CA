...
# <a name="running-the-automated-elasticsearch-performance-tests"></a>Running the automated Elasticsearch performance tests
...
## <a name="how-the-tests-work"></a>How the tests work
...
## <a name="building-and-deploying-the-junit-jar-and-dependencies"></a>Building and deploying the JUnit JAR and dependencies
...
Copy the appropriate Java archive (JAR) file along with the rest of the dependencies to your JMeter machines. The process is described in [Deploying a JMeter JUnit sampler for testing Elasticsearch performance][]. 
...
## <a name="creating-the-test-indexes"></a>Creating the test indexes
...
## <a name="configuring-the-test-script-parameters"></a>Configuring the test script parameters
