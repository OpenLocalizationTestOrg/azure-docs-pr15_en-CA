...
# <a name="azure-resiliency-guidance-resiliency-checklist"></a>Azure resiliency guidance: Resiliency checklist
...
## <a name="failure-mode-analysis"></a>Failure Mode Analysis
...
###  <a name="sql-server-running-in-a-vm"></a>SQL Server (running in a VM)
