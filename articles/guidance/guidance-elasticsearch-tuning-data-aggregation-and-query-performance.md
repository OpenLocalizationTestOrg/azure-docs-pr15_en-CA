...
# <a name="tuning-data-aggregation-and-query-performance-with-elasticsearch-on-azure"></a>Tuning data aggregation and query performance with Elasticsearch on Azure
...
## <a name="index-and-query-performance-considerations"></a>Index and query performance considerations
...
### <a name="storing-multiple-types-in-an-index"></a>Storing multiple types in an index
...
### <a name="optimizing-index-types"></a>Optimizing index types
...
### <a name="reindexing-data"></a>Reindexing data
...
### <a name="managing-mappings"></a>Managing mappings
...
### <a name="using-doc-values"></a>Using doc values
...
### <a name="using-replicas-to-reduce-query-contention"></a>Using replicas to reduce query contention
...
### <a name="using-the-shard-request-cache"></a>Using the shard request cache
...
### <a name="using-client-nodes"></a>Using client nodes
...
### <a name="tuning-queries"></a>Tuning queries
...
## <a name="testing-and-analyzing-aggregation-and-search-performance"></a>Testing and analyzing aggregation and search performance
...
## <a name="performance-results---disk-type"></a>Performance results - disk type
...
## <a name="performance-results---scaling-up"></a>Performance results - scaling up
...
## <a name="performance-results---scaling-out"></a>Performance results - scaling out
...
## <a name="performance-results---number-of-replicas"></a>Performance results - number of replicas
...
## <a name="performance-results---doc-values"></a>Performance results - doc values
...
## <a name="performance-results---shard-request-cache"></a>Performance results - shard request cache
...
## <a name="performance-results---number-of-shards"></a>Performance results - number of shards
...
## <a name="appendix-the-query-and-aggregation-performance-test"></a>Appendix: the query and aggregation performance test
