...
# <a name="implementing-active-directory-federation-services-adfs-in-azure"></a>Implementing Active Directory Federation Services (ADFS) in Azure
...
### <a name="availability-recommendations"></a>Availability recommendations
...
### <a name="adfs-installation-recommendations"></a>ADFS installation recommendations
...
### <a name="adfs-trust-recommendations"></a>ADFS Trust recommendations
