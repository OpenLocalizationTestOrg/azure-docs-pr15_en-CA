...
# <a name="running-linux-vms-in-multiple-regions-for-high-availability"></a>Running Linux VMs in multiple regions for high availability
...
### <a name="cassandra-deployment-across-multiple-regions"></a>Cassandra deployment across multiple regions
