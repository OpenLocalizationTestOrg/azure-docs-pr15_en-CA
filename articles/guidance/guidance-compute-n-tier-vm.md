...
# <a name="running-windows-vms-for-an-n-tier-architecture-on-azure"></a>Running Windows VMs for an N-tier architecture on Azure
...
### <a name="sql-server-always-on-availability-groups"></a>SQL Server Always On Availability Groups
