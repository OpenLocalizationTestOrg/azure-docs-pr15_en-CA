...
# <a name="sign-up-and-tenant-onboarding-in-a-multitenant-application"></a>Sign-up and tenant onboarding in a multitenant application
...
## <a name="admin-consent-and-azure-ad-permissions"></a>Admin consent and Azure AD permissions
...
## <a name="implementing-tenant-sign-up"></a>Implementing tenant sign-up
...
## <a name="adding-the-admin-consent-prompt"></a>Adding the admin consent prompt
...
## <a name="registering-a-tenant"></a>Registering a Tenant
