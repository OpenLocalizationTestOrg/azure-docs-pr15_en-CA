...
# <a name="authentication-in-multitenant-apps-using-azure-ad-and-openid-connect"></a>Authentication in multitenant apps, using Azure AD and OpenID Connect
...
## <a name="register-the-app-with-azure-ad"></a>Register the app with Azure AD
...
## <a name="configure-the-auth-middleware"></a>Configure the auth middleware
...
## <a name="initiate-the-authentication-flow"></a>Initiate the authentication flow
...
## <a name="user-login-sessions"></a>User login sessions
...
## <a name="about-the-openid-connect-middleware"></a>About the OpenID Connect middleware
...
### <a name="authentication-ticket"></a>Authentication ticket
...
### <a name="openid-connect-endpoints"></a>OpenID connect endpoints
...
### <a name="openid-connect-flows"></a>OpenID connect flows
