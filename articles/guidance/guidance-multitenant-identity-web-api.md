...
# <a name="securing-a-backend-web-api-in-a-multitenant-application"></a>Securing a backend web API in a multitenant application
...
## <a name="register-the-web-api-in-azure-ad"></a>Register the web API in Azure AD
...
## <a name="using-the-access-token-to-call-the-web-api"></a>Using the access token to call the web API
...
## <a name="authenticating-in-the-web-api"></a>Authenticating in the web API
...
### <a name="issuer-validation"></a>Issuer validation
