...
# <a name="caching-access-tokens-in-a-multitenant-application"></a>Caching access tokens in a multitenant application
...
## <a name="encrypting-cached-tokens"></a>Encrypting cached tokens
...
## <a name="distributedtokencache-implementation"></a>DistributedTokenCache implementation
