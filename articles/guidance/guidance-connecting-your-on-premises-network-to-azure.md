...
## <a name="connecting-over-the-public-internet"></a>Connecting over the public Internet
...
## <a name="connecting-with-a-point-to-site-connection"></a>Connecting with a point-to-site connection
...
## <a name="connecting-with-a-site-to-site-connection"></a>Connecting with a site-to-site connection
...
## <a name="connecting-with-a-dedicated-private-connection"></a>Connecting with a dedicated private connection
