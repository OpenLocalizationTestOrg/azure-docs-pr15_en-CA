...
# <a name="implementing-a-highly-available-hybrid-network-architecture"></a>Implementing a highly available hybrid network architecture
...
### <a name="vnet-and-gatewaysubnet"></a>VNet and GatewaySubnet
...
### <a name="vpn-and-expressroute-gateways"></a>VPN and ExpressRoute gateways
