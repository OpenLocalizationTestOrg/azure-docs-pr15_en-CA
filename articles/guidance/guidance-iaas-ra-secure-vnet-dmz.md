...
# <a name="implementing-a-dmz-between-azure-and-the-internet"></a>Implementing a DMZ between Azure and the Internet
...
### <a name="public-load-balancer-recommendations"></a>Public load balancer recommendations ###
