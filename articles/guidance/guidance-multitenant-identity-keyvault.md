...
# <a name="using-azure-key-vault-to-protect-application-secrets"></a>Using Azure Key Vault to protect application secrets
...
## <a name="setting-up-key-vault-in-the-surveys-app"></a>Setting up Key Vault in the Surveys app
...
### <a name="set-up-an-admin-user"></a>Set up an admin user
...
### <a name="set-up-a-client-certificate"></a>Set up a client certificate
...
### <a name="add-configuration-settings-to-your-key-vault"></a>Add configuration settings to your key vault
...
### <a name="uncomment-the-code-that-enables-key-vault"></a>Uncomment the code that enables Key Vault
...
### <a name="update-the-user-secrets"></a>Update the user secrets
