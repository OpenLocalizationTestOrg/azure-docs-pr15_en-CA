...
# <a name="implementing-a-dmz-between-azure-and-your-on-premises-datacenter"></a>Implementing a DMZ between Azure and your on-premises datacenter
...
### <a name="rbac-recommendations"></a>RBAC recommendations
...
### <a name="resource-group-recommendations"></a>Resource group recommendations
...
### <a name="virtual-network-gateway-recommendations"></a>Virtual network gateway recommendations
...
### <a name="nva-recommendations"></a>NVA recommendations
...
### <a name="management-subnet-recommendations"></a>Management subnet recommendations
...
### <a name="routing-all-on-premises-user-requests-through-the-nva"></a>Routing all on-premises user requests through the NVA
...
### <a name="using-nsgs-to-blockpass-traffic-between-application-tiers"></a>Using NSGs to block/pass traffic between application tiers
