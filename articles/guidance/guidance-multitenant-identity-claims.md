...
# <a name="working-with-claims-based-identities-in-multitenant-applications"></a>Working with claims-based identities in multitenant applications

[AZURE.INCLUDE [pnp-header](../../includes/guidance-pnp-header-include.md)]

This article is [part of a series]. There is also a complete [sample application] that accompanies this series.

## <a name="claims-in-azure-ad"></a>Claims in Azure AD
...
## <a name="claims-transformations"></a>Claims transformations
...
## <a name="using-claims-for-authorization"></a>Using claims for authorization
