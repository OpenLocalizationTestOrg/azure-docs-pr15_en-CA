...
# <a name="configuring-resilience-and-recovery-on-elasticsearch-on-azure"></a>Configuring resilience and recovery on Elasticsearch on Azure
...
## <a name="using-dedicated-master-nodes"></a>Using dedicated master nodes
...
## <a name="controlling-high-availability-with-azure--update-domains-and-fault-domains"></a>Controlling high availability with Azure – update domains and fault domains 
...
## <a name="handling-intermittent-connectivity-between-nodes"></a>Handling intermittent connectivity between nodes
...
## <a name="controlling-recovery"></a>Controlling recovery
...
## <a name="preventing-split-brain"></a>Preventing split brain 
...
## <a name="handling-rolling-updates"></a>Handling rolling updates
...
## <a name="testing-and-analyzing-elasticsearch-resilience-and-recovery"></a>Testing and analyzing Elasticsearch resilience and recovery
...
## <a name="node-failure-and-restart-with-no-data-loss-results"></a>Node failure and restart with no data loss: results
...
## <a name="node-failure-with-catastrophic-data-loss-results"></a>Node failure with catastrophic data loss: results
...
## <a name="node-failure-and-restart-with-shard-reallocation-results"></a>Node failure and restart with shard reallocation: results
...
## <a name="rolling-updates-results"></a>Rolling updates: results
