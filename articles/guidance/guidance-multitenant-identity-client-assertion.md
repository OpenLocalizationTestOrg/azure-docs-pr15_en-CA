...
# <a name="using-client-assertion-to-get-access-tokens-from-azure-ad"></a>Using client assertion to get access tokens from Azure AD
...
## <a name="using-client-assertion-in-the-surveys-application"></a>Using client assertion in the Surveys application
