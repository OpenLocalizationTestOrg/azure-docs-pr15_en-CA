...
# <a name="designing-resilient-applications-for-azure"></a>Designing resilient applications for Azure
...
## <a name="process-to-achieve-resiliency"></a>Process to achieve resiliency
...
## <a name="defining-your-resiliency-requirements"></a>Defining your resiliency requirements
...
### <a name="decompose-by-workload"></a>Decompose by workload
...
### <a name="rto-and-rpo"></a>RTO and RPO
...
### <a name="composite-slas"></a>Composite SLAs
...
## <a name="designing-for-resiliency"></a>Designing for resiliency
...
### <a name="example-of-identifying-failure-modes-and-detection-strategy"></a>Example of identifying failure modes and detection strategy
...
## <a name="resiliency-strategies"></a>Resiliency strategies
...
### <a name="retry-transient-failures"></a>Retry transient failures
...
### <a name="load-balance-across-instances"></a>Load balance across instances
...
### <a name="replicate-data"></a>Replicate data
...
### <a name="degrade-gracefully"></a>Degrade gracefully
...
### <a name="throttle-high-volume-users"></a>Throttle high-volume users
...
### <a name="use-a-circuit-breaker"></a>Use a circuit breaker  
...
### <a name="use-load-leveling-to-smooth-out-spikes-in-traffic"></a>Use load leveling to smooth out spikes in traffic
...
### <a name="isolate-critical-resources"></a>Isolate critical resources 
...
### <a name="apply-compensating-transactions"></a>Apply compensating transactions 
...
## <a name="testing-for-resiliency"></a>Testing for resiliency
...
## <a name="resilient-deployment"></a>Resilient deployment
...
## <a name="manual-failure-responses"></a>Manual failure responses
