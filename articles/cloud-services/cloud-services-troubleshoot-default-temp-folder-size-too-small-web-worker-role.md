...
# <a name="default-temp-folder-size-is-too-small-on-a-cloud-service-webworker-role"></a>Default TEMP folder size is too small on a cloud service web/worker role
