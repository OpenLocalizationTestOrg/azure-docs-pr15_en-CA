...
# <a name="configuring-ssl-for-an-application-in-azure"></a>Configuring SSL for an application in Azure
...
## <a name="step-2-modify-the-service-definition-and-configuration-files"></a>Step 2: Modify the service definition and configuration files
...
3.  In your service definition file, add a **Binding** element within the **Sites** section. This section adds an HTTPS binding to map the endpoint to your site:
...
## <a name="step-3-upload-a-certificate"></a>Step 3: Upload a certificate
...
## <a name="step-4-connect-to-the-role-instance-by-using-https"></a>Step 4: Connect to the role instance by using HTTPS
