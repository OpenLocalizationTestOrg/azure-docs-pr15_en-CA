...
## <a name="manual-scale"></a>Manual scale
...
## <a name="automatic-scale---cpu"></a>Automatic scale - CPU
...
## <a name="automatic-scale---queue"></a>Automatic scale - Queue
...
## <a name="scale-linked-resources"></a>Scale linked resources
