...
# <a name="configuring-a-custom-domain-name-for-an-azure-cloud-service"></a>Configuring a custom domain name for an Azure cloud service
...
## <a name="understand-cname-and-a-records"></a>Understand CNAME and A records
...
## <a name="add-an-a-record-for-your-custom-domain"></a>Add an A record for your custom domain
