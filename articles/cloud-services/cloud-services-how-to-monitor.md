...
# <a name="how-to-monitor-cloud-services"></a>How to Monitor Cloud Services
...
## <a name="how-to-configure-monitoring-for-cloud-services"></a>How to: Configure monitoring for cloud services
...
### <a name="to-change-the-monitoring-level-to-verbose-or-minimal"></a>To change the monitoring level to verbose or minimal
...
## <a name="how-to-receive-alerts-for-cloud-service-metrics"></a>How to: Receive alerts for cloud service metrics
...
## <a name="how-to-add-metrics-to-the-metrics-table"></a>How to: Add metrics to the metrics table
...
### <a name="to-add-custom-metrics-to-the-metrics-table"></a>To add custom metrics to the metrics table
...
## <a name="how-to-customize-the-metrics-chart"></a>How to: Customize the metrics chart
...
### <a name="to-customize-the-metrics-chart-on-the-dashboard"></a>To customize the metrics chart on the dashboard
...
## <a name="how-to-access-verbose-monitoring-data-outside-the-azure-classic-portal"></a>How to: Access verbose monitoring data outside the Azure classic portal
