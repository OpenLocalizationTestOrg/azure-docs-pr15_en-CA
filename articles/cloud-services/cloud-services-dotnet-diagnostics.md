...
# <a name="enabling-azure-diagnostics-in-azure-cloud-services"></a>Enabling Azure Diagnostics in Azure Cloud Services

See [Azure Diagnostics Overview](../azure-diagnostics.md) for a background on Azure Diagnostics.


## <a name="how-to-enable-diagnostics-in-a-worker-role"></a>How to Enable Diagnostics in a Worker Role
...
### <a name="step-1-create-a-worker-role"></a>Step 1: Create a Worker Role
...
### <a name="step-2-instrument-your-code"></a>Step 2: Instrument your code
...
### <a name="step-3-deploy-your-worker-role"></a>Step 3: Deploy your Worker Role
...
### <a name="step-4-create-your-diagnostics-configuration-file-and-install-the-extension"></a>Step 4: Create your Diagnostics configuration file and install the extension
...
### <a name="step-5-install-diagnostics-on-your-worker-role"></a>Step 5: Install Diagnostics on your Worker Role
