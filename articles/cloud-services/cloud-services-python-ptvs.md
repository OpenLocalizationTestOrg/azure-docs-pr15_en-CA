...
# <a name="python-web-and-worker-roles-with-python-tools-for-visual-studio"></a>Python web and worker roles with Python Tools for Visual Studio
...
## <a name="install-python-on-the-cloud-service"></a>Install Python on the cloud service
...
#### <a name="sample-servicedefinitioncsdef"></a>Sample ServiceDefinition.csdef
...
#### <a name="modify-launchworkerps1"></a>Modify LaunchWorker.ps1
...
### <a name="investigate-logs"></a>Investigate logs
