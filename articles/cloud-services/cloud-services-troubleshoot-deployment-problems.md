...
# <a name="troubleshoot-cloud-service-deployment-problems"></a>Troubleshoot cloud service deployment problems
...
## <a name="problem-i-cannot-access-my-website-but-my-deployment-is-started-and-all-role-instances-are-ready"></a>Problem: I cannot access my website, but my deployment is started and all role instances are ready
...
## <a name="problem-my-role-instances-recycled-without-me-doing-anything"></a>Problem: My role instances recycled without me doing anything
...
## <a name="problem-i-cannot-do-a-vip-swap-and-receive-an-error"></a>Problem: I cannot do a VIP swap and receive an error
...
## <a name="problem-a-role-instance-is-looping-between-started-initializing-busy-and-stopped"></a>Problem: A role instance is looping between Started, Initializing, Busy, and Stopped
...
## <a name="problem-my-application-stopped-working"></a>Problem: My application stopped working
