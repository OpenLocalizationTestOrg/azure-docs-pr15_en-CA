...
# <a name="creating-an-internal-load-balancer-using-the-azure-cli"></a>Creating an internal load balancer using the Azure CLI
...
## <a name="set-up-cli-to-use-resource-manager"></a>Set up CLI to use Resource Manager
...
## <a name="create-a-front-end-ip-pool-and-a-backend-address-pool"></a>Create a front-end IP pool and a backend address pool
...
## <a name="create-lb-rules-nat-rules-and-probe"></a>Create LB rules, NAT rules, and probe
...
## <a name="delete-a-load-balancer"></a>Delete a load balancer
