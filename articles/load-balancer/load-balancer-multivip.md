...
# <a name="configure-multiple-vips-for-a-cloud-service"></a>Configure multiple VIPs for a cloud service
...
## <a name="how-to-add-a-vip-to-a-cloud-service"></a>How to add a VIP to a cloud service
...
## <a name="how-to-remove-a-vip-from-a-cloud-service"></a>How to remove a VIP from a cloud service
...
## <a name="how-to-retrieve-vip-information-from-a-cloud-service"></a>How to retrieve VIP information from a Cloud Service
...
## <a name="how-to-associate-a-vip-to-an-endpoint"></a>How to associate a VIP to an endpoint
...
## <a name="how-to-enable-load-balancing-on-a-specific-vip"></a>How to enable load balancing on a specific VIP
