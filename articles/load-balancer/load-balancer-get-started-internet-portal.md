...
# <a name="creating-an-internet-facing-load-balancer-using-the-azure-portal"></a>Creating an Internet-facing load balancer using the Azure portal
...
## <a name="what-is-required-to-create-an-internet-facing-load-balancer"></a>What is required to create an Internet-facing load balancer?
...
## <a name="set-up-a-load-balancer-in-azure-portal"></a>Set up a load balancer in Azure portal
...
## <a name="create-a-back-end-address-pool"></a>Create a back-end address pool
...
## <a name="create-a-probe-lb-rule-and-nat-rules"></a>Create a probe, LB rule, and NAT rules
