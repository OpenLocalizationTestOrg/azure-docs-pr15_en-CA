...
# <a name="get-started-creating-an-internet-facing-load-balancer-classic-in-the-azure-cli"></a>Get started creating an Internet facing load balancer (classic) in the Azure CLI
...
## <a name="step-by-step-creating-an-internet-facing-load-balancer-using-cli"></a>Step by step creating an Internet facing load balancer using CLI
