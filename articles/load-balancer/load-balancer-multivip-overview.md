...
# <a name="multiple-vips-for-azure-load-balancer"></a>Multiple VIPs for Azure Load Balancer
...
## <a name="rule-type-1-no-backend-port-reuse"></a>Rule type #1: No backend port reuse
...
## <a name="rule-type-2-backend-port-reuse-by-using-floating-ip"></a>Rule type #2: backend port reuse by using Floating IP
