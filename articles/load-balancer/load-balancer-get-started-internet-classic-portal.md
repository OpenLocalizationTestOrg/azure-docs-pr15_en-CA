...
# <a name="get-started-creating-an-internet-facing-load-balancer-classic-in-the-azure-classic-portal"></a>Get started creating an Internet facing load balancer (classic) in the Azure classic portal
...
## <a name="set-up-an-internet-facing-load-balancer-for-virtual-machines"></a>Set up an Internet-facing load balancer for virtual machines
