...
# <a name="create-an-internet-facing-load-balancer-with-ipv6-in-azure-resource-manager-using-the-azure-cli"></a>Create an Internet facing load balancer with IPv6 in Azure Resource Manager using the Azure CLI
...
## <a name="deploying-the-solution-using-the-azure-cli"></a>Deploying the solution using the Azure CLI
...
## <a name="set-up-your-cli-environment-to-use-azure-resource-manager"></a>Set up your CLI environment to use Azure Resource Manager
...
## <a name="create-a-resource-group-a-load-balancer-a-virtual-network-and-subnets"></a>Create a resource group, a load balancer, a virtual network, and subnets
...
## <a name="create-public-ip-addresses-for-the-front-end-pool"></a>Create public IP addresses for the front-end pool
...
## <a name="create-front-end-and-back-end-pools"></a>Create front-end and back-end pools
...
## <a name="create-the-probe-nat-rules-and-lb-rules"></a>Create the probe, NAT rules, and LB rules
...
## <a name="create-nics"></a>Create NICs
...
## <a name="create-the-back-end-vm-resources-and-attach-each-nic"></a>Create the back-end VM resources and attach each NIC
...
1. Set up the PowerShell variables
    ...
    >[AZURE.WARNING] This example uses the username and password for the VMs in clear text. Appropriate care must be taken when using credentials in the clear. For a more secure method of handling credentials in PowerShell, see the [Get-Credential](https://technet.microsoft.com/library/hh849815.aspx) cmdlet.
