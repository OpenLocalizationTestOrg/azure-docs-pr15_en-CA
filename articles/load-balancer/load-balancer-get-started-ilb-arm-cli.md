...
# <a name="create-an-internal-load-balancer-by-using-the-azure-cli"></a>Create an internal load balancer by using the Azure CLI
...
## <a name="deploy-the-solution-by-using-the-azure-cli"></a>Deploy the solution by using the Azure CLI
...
## <a name="create-an-internal-load-balancer-step-by-step"></a>Create an internal load balancer step by step
...
## <a name="create-an-internal-load-balancer-set"></a>Create an internal load balancer set
