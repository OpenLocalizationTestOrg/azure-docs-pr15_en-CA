...
## <a name="deploying-the-solution-by-using-azure-powershell"></a>Deploying the solution by using Azure PowerShell
...
## <a name="create-a-front-end-ip-pool-and-a-back-end-address-pool"></a>Create a front-end IP pool and a back-end address pool
...
## <a name="create-nat-rules-a-load-balancer-rule-a-probe-and-a-load-balancer"></a>Create NAT rules, a load balancer rule, a probe, and a load balancer
...
## <a name="add-the-network-interface-to-the-load-balancer"></a>Add the network interface to the load balancer
