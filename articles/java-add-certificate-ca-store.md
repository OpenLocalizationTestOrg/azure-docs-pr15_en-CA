...
# <a name="adding-a-certificate-to-the-java-ca-certificates-store"></a>Adding a Certificate to the Java CA Certificates Store
...
## <a name="to-add-a-certificate-to-the-cacerts-store"></a>To add a certificate to the cacerts store
