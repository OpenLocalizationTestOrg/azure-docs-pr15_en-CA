...
# <a name="understand-your-azure-external-service-charges"></a>Understand your Azure external service charges
...
## <a name="what-are-azure-external-services"></a>What are Azure external services?
...
### <a name="identify-external-services"></a>Identify external services
...
### <a name="external-services-are-billed-separately"></a>External services are billed separately
...
### <a name="each-external-service-has-a-different-billing-model"></a>Each external service has a different billing model
...
### <a name="you-cant-use-monthly-free-credits-for-external-services"></a>You can't use monthly free credits for external services
...
## <a name="view-external-service-spending-and-history"></a>View external service spending and history
