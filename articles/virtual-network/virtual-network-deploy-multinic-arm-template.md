...
# <a name="deploy-multi-nic-vms-using-a-template"></a>Deploy multi NIC VMs using a template
...
## <a name="understand-the-deployment-template"></a>Understand the deployment template
