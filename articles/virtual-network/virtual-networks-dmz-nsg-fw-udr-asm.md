...
# <a name="example-3--build-a-dmz-to-protect-networks-with-a-firewall-udr-and-nsg"></a>Example 3 – Build a DMZ to Protect Networks with a Firewall, UDR, and NSG
...
#### <a name="creating-the-local-routes"></a>Creating the local routes
...
## <a name="network-security-groups-nsg"></a>Network Security Groups (NSG)
...
### <a name="logical-rule-description"></a>Logical Rule Description
...
### <a name="rule-prerequisites"></a>Rule Prerequisites
...
### <a name="firewall-rules-creation"></a>Firewall Rules Creation
...
## <a name="rule-activation"></a>Rule Activation
...
## <a name="traffic-scenarios"></a>Traffic Scenarios
...
#### <a name="allowed-internet-rdp-to-backend"></a>(Allowed) Internet RDP to Backend
...
#### <a name="allowed-web-server-dns-lookup-on-dns-server"></a>(Allowed) Web Server DNS lookup on DNS server
...
#### <a name="allowed-backend-server-to-frontend-server"></a>(Allowed) Backend server to Frontend server
...
#### <a name="denied-internet-to-backend-server"></a>(Denied) Internet to Backend Server
...
#### <a name="denied-frontend-server-to-backend-server"></a>(Denied) Frontend server to Backend Server
...
#### <a name="denied-internet-dns-lookup-on-dns-server"></a>(Denied) Internet DNS lookup on DNS server
...
#### <a name="denied-internet-to-sql-access-through-firewall"></a>(Denied) Internet to SQL access through Firewall
...
### <a name="main-script-and-network-config"></a>Main Script and Network Config
...
#### <a name="full-script"></a>Full Script
...
#### <a name="network-config-file"></a>Network Config File
...
#### <a name="sample-application-scripts"></a>Sample Application Scripts
