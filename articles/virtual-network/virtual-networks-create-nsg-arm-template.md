...
# <a name="how-to-create-nsgs-using-a-template"></a>How to create NSGs using a template
...
## <a name="nsg-resources-in-a-template-file"></a>NSG resources in a template file
