<properties 
   pageTitle="Troubleshoot Network Security Groups - Portal | Microsoft Azure"
...
# <a name="troubleshoot-network-security-groups-using-the-azure-portal"></a>Troubleshoot Network Security Groups using the Azure Portal
...
### <a name="view-effective-security-rules-for-a-virtual-machine"></a>View effective security rules for a virtual machine
...
### <a name="view-effective-security-rules-for-a-network-interface"></a>View effective security rules for a network interface
...
## <a name="view-effective-security-rules-for-a-network-security-group-nsg"></a>View effective security rules for a network security group (NSG)
