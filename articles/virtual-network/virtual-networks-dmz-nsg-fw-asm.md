...
# <a name="example-2--build-a-dmz-to-protect-applications-with-a-firewall-and-nsgs"></a>Example 2 – Build a DMZ to protect applications with a Firewall and NSGs
...
#### <a name="allowed-web-to-web-server-through-firewall"></a>(Allowed) Web to Web Server through Firewall
...
#### <a name="allowed-rdp-to-backend"></a>(Allowed) RDP to Backend
...
#### <a name="allowed-web-server-access-file-on-appvm01"></a>(Allowed) Web Server access file on AppVM01
...
#### <a name="denied-web-direct-to-web-server"></a>(Denied) Web direct to Web Server
...
#### <a name="denied-web-to-backend-server"></a>(Denied) Web to Backend Server
...
#### <a name="denied-web-dns-lookup-on-dns-server"></a>(Denied) Web DNS lookup on DNS server
...
#### <a name="denied-web-to-sql-access-through-firewall"></a>(Denied) Web to SQL access through Firewall
