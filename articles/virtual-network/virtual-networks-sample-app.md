...
# <a name="sample-application-for-use-with-security-boundary-environments"></a>Sample Application for Use with Security Boundary Environments
...
## <a name="firewall-rule-to-allow-icmp"></a>Firewall Rule to Allow ICMP
...
## <a name="iis01---web-application-installation-script"></a>IIS01 - Web Application Installation Script
This script will:
...
## <a name="appvm01---file-server-installation-script"></a>AppVM01 - File Server Installation Script
...
## <a name="dns01---dns-server-installation-script"></a>DNS01 - DNS Server Installation Script
