...
#<a name="create-user-defined-routes-udr-in-resource-manager-by-using-powershell"></a>Create User Defined Routes (UDR) in Resource Manager by using PowerShell
