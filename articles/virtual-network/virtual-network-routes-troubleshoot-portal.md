...
# <a name="troubleshoot-routes-using-the-azure-portal"></a>Troubleshoot routes using the Azure Portal
...
## <a name="using-effective-routes-to-troubleshoot-vm-traffic-flow"></a>Using Effective Routes to troubleshoot VM traffic flow
...
### <a name="view-effective-routes-for-a-virtual-machine"></a>View effective routes for a virtual machine
...
### <a name="view-effective-routes-for-a-network-interface"></a>View effective routes for a network interface
...
### <a name="view-effective-routes-for-a-route-table"></a>View effective routes for a route table
