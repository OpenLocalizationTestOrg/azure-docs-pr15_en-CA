...
# <a name="create-a-vm-with-multiple-nics"></a>Create a VM with multiple NICs
...
## <a name="how-to-configure-a-multi-nic-vm-in-a-classic-deployment"></a>How to Configure a multi NIC VM in a classic deployment
...
## <a name="secondary-nics-access-to-other-subnets"></a>Secondary NICs access to other subnets
...
### <a name="configure-windows-vms"></a>Configure Windows VMs
...
### <a name="configure-linux-vms"></a>Configure Linux VMs
