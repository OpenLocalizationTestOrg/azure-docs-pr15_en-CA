...
# <a name="how-to-create-nsgs-in-resource-manager-by-using-powershell"></a>How to create NSGs in Resource Manager by using PowerShell
...
## <a name="how-to-remove-an-nsg"></a>How to remove an NSG
