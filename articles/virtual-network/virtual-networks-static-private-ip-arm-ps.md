...
# <a name="how-to-set-a-static-private-ip-address-in-resource-manager-by-using-powershell"></a>How to set a static private IP address in Resource Manager by using PowerShell
