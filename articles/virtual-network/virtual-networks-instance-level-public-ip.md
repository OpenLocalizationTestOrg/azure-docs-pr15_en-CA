...
# <a name="instance-level-public-ip-overview"></a>Instance level public IP overview
...
## <a name="why-should-i-request-an-ilpip"></a>Why should I request an ILPIP?
...
## <a name="how-to-request-an-ilpip-during-vm-creation"></a>How to request an ILPIP during VM creation
...
## <a name="how-to-retrieve-ilpip-information-for-a-vm"></a>How to retrieve ILPIP information for a VM
...
## <a name="how-to-remove-an-ilpip-from-a-vm"></a>How to remove an ILPIP from a VM
...
## <a name="how-to-add-an-ilpip-to-an-existing-vm"></a>How to add an ILPIP to an existing VM
...
## <a name="how-to-associate-an-ilpip-to-a-vm-by-using-a-service-configuration-file"></a>How to associate an ILPIP to a VM by using a service configuration file
