...
# <a name="how-to-decide-if-azure-ad-domain-services-is-right-for-your-use-case"></a>How to decide if Azure AD Domain Services is right for your use-case
...
## <a name="compare-azure-ad-domain-services-to-diy-ad-domain-in-azure"></a>Compare Azure AD Domain Services to DIY AD domain in Azure
...
#### <a name="managed-service"></a>Managed service
...
#### <a name="secure-deployments"></a>Secure deployments
...
#### <a name="domain-or-enterprise-administrator-privileges"></a>Domain or Enterprise Administrator privileges
...
#### <a name="domain-authentication-using-ntlm-and-kerberos"></a>Domain authentication using NTLM and Kerberos
...
#### <a name="custom-ou-structure"></a>Custom OU structure
...
#### <a name="ad-domain-or-forest-trusts"></a>AD Domain or Forest Trusts
...
#### <a name="geo-dispersed-deployments"></a>Geo-dispersed deployments
