...
# <a name="azure-ad-domain-services---troubleshooting-guide"></a>Azure AD Domain Services - Troubleshooting guide
...
## <a name="you-cannot-enable-azure-ad-domain-services-for-your-azure-ad-directory"></a>You cannot enable Azure AD Domain Services for your Azure AD directory
...
### <a name="domain-name-conflict"></a>Domain Name conflict
**Error message:**
...
### <a name="inadequate-permissions"></a>Inadequate permissions
**Error message:**
...
### <a name="invalid-configuration"></a>Invalid configuration
**Error message:**
...
## <a name="users-are-unable-to-sign-in-to-the-azure-ad-domain-services-managed-domain"></a>Users are unable to sign in to the Azure AD Domain Services managed domain
...
## <a name="users-removed-from-your-azure-ad-tenant-are-not-removed-from-your-managed-domain"></a>Users removed from your Azure AD tenant are not removed from your managed domain
