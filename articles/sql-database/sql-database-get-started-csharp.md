...
# <a name="try-sql-database-use-c-to-create-a-sql-database-with-the-sql-database-library-for-net"></a>Try SQL Database: Use C# to create a SQL database with the SQL Database Library for .NET
...
## <a name="create-a-sql-database-server-firewall-rule-and-sql-database---c-example"></a>Create a SQL Database server, firewall rule, and SQL database - C# example
...
## <a name="create-a-service-principal-to-access-resources"></a>Create a service principal to access resources
