...
# <a name="upgrade-an-app-to-use-the-latest-elastic-database-client-library"></a>Upgrade an app to use the latest elastic database client library
...
## <a name="upgrade-steps"></a>Upgrade steps
...
2. Open a Command Prompt, navigate to the same folder, and issue the command:`nuget install Microsoft.Azure.SqlDatabase.ElasticScale.Client`

3. Navigate to the subfolder containing the new client DLL version you have just downloaded, for example:`cd .\Microsoft.Azure.SqlDatabase.ElasticScale.Client.1.0.0\lib\net45`
...
## <a name="elastic-database-client-version-history"></a>Elastic database client version history 
