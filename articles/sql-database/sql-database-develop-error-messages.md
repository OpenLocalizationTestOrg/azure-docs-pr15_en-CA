...
# <a name="sql-error-codes-for-sql-database-client-applications-database-connection-error-and-other-issues"></a>SQL error codes for SQL Database client applications: Database connection error and other issues
...
## <a name="database-connection-errors-transient-errors-and-other-temporary-errors"></a>Database connection errors, transient errors, and other temporary errors
...
### <a name="most-common-database-connection-errors-and-transient-fault-errors"></a>Most common database connection errors and transient fault errors
...
### <a name="transient-fault-error-codes"></a>Transient fault error codes
...
## <a name="resource-governance-errors"></a>Resource governance errors
...
## <a name="elastic-pool-errors"></a>Elastic pool errors
