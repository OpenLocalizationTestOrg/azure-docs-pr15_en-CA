...
# <a name="connecting-to-sql-database-or-sql-data-warehouse-by-using-azure-active-directory-authentication"></a>Connecting to SQL Database or SQL Data Warehouse By Using Azure Active Directory Authentication
...
## <a name="trust-architecture"></a>Trust architecture
...
## <a name="administrator-structure"></a>Administrator structure
...
## <a name="1-create-and-populate-an-azure-ad"></a>1. Create and populate an Azure AD
...
## <a name="2-ensure-your-sql-database-is-version-12"></a>2. Ensure your SQL Database is version 12
...
## <a name="3-optional-associate-or-change-the-active-directory-that-is-currently-associated-with-your-azure-subscription"></a>3. Optional: Associate or change the active directory that is currently associated with your Azure Subscription
...
## <a name="4-create-an-azure-ad-administrator-for-azure-sql-server"></a>4. Create an Azure AD administrator for Azure SQL Server
...
### <a name="provision-an-azure-active-directory-administrator-for-your-azure-sql-server-by-using-the-azure-portal"></a>Provision an Azure Active Directory administrator for your Azure SQL Server by using the Azure portal
...
### <a name="provision-an-azure-ad-administrator-for-azure-sql-server-by-using-powershell"></a>Provision an Azure AD administrator for Azure SQL Server by using PowerShell
...
## <a name="5-configure-your-client-computers"></a>5. Configure your client computers
...
## <a name="6-create-contained-database-users-in-your-database-mapped-to-azure-ad-identities"></a>6. Create contained database users in your database mapped to Azure AD identities

### <a name="about-contained-database-users"></a>About contained database users
...
### <a name="connect-to-the-user-database-or-data-warehouse-by-using-sql-server-management-studio-or-sql-server-data-tools"></a>Connect to the user database or data warehouse by using SQL Server Management Studio or SQL Server Data Tools
...
#### <a name="connect-using-active-directory-integrated-authentication"></a>Connect using Active Directory integrated authentication
...
#### <a name="connect-using-active-directory-password-authentication"></a>Connect using Active Directory password authentication
...
### <a name="create-an-azure-ad-contained-database-user-in-a-user-database"></a>Create an Azure AD contained database user in a user database
...
## <a name="7-connect-by-using-azure-ad-identities"></a>7. Connect by using Azure AD identities
...
### <a name="71-connecting-using-integrated-windows-authentication"></a>7.1. Connecting using integrated (Windows) authentication
...
### <a name="72-connecting-with-an-azure-ad-principal-name-and-a-password"></a>7.2. Connecting with an Azure AD principal name and a password
...
### <a name="73-connecting-with-an-azure-ad-token"></a>7.3 Connecting with an Azure AD token
...
### <a name="connecting-with-sqlcmd"></a>Connecting with sqlcmd  
