...
# <a name="configure-azure-sql-database-firewall-rules---overview"></a>Configure Azure SQL Database firewall rules \- overview
...
## <a name="creating-the-first-server-level-firewall-rule"></a>Creating the first server-level firewall rule
...
## <a name="creating-database-level-firewall-rules"></a>Creating database-level firewall rules
