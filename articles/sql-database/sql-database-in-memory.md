...
### <a name="script-for-ostressexe"></a>Script for ostress.exe
...
### <a name="run-the-inmem-stress-workload-first"></a>Run the _inmem stress workload first
...
#### <a name="reset-edit-for-ondisk-then-rerun"></a>Reset, edit for _ondisk, then rerun
