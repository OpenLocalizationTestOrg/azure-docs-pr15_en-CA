...
# <a name="azure-sql-database-general-limitations-and-guidelines"></a>Azure SQL Database General Limitations and Guidelines
...
## <a name="connectivity-and-authentication"></a>Connectivity and authentication
...
## <a name="sql-server-agentjobs"></a>SQL Server Agent/Jobs
...
## <a name="sql-server-collation-support"></a>SQL Server Collation Support
...
## <a name="naming-requirements"></a>Naming Requirements
...
## <a name="additional-guidelines"></a>Additional Guidelines
