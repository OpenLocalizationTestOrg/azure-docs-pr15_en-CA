...
# <a name="connect-to-sql-database-by-using-python"></a>Connect to SQL Database by using Python
...
## <a name="step-1-create-a-sql-database"></a>Step 1: Create a SQL database
...
## <a name="step-2-configure-development-environment"></a>Step 2: Configure Development Environment

### <a name="mac-os"></a>**Mac OS**   
### <a name="install-the-required-modules"></a>Install the required modules
...
## <a name="step-3-run-sample-code"></a>Step 3: Run sample code
...
### <a name="connect-to-your-sql-database"></a>Connect to your SQL Database
...
### <a name="execute-an-sql-select-statement"></a>Execute an SQL SELECT statement
...
### <a name="insert-a-row-pass-parameters-and-retrieve-the-generated-primary-key"></a>Insert a row, pass parameters, and retrieve the generated primary key
