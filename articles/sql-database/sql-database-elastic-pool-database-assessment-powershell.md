...
# <a name="powershell-script-for-identifying-databases-suitable-for-an-elastic-database-pool"></a>PowerShell script for identifying databases suitable for an elastic database pool
...
## <a name="script-details"></a>Script details
