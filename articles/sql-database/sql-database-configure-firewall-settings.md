...
# <a name="configure-an-azure-sql-database-server-level-firewall-rule-using-the-azure-portal"></a>Configure an Azure SQL Database server-level firewall rule using the Azure Portal
...
## <a name="manage-existing-server-level-firewall-rules-through-the-azure-portal"></a>Manage existing server-level firewall rules through the Azure portal
