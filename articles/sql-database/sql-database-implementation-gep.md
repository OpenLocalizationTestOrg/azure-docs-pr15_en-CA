...
## <a name="expanding-services-and-growth-by-using-azure"></a>Expanding services and growth by using Azure
...
## <a name="the-limitations-of-a-do-it-yourself-datacenter"></a>The limitations of a do-it-yourself datacenter
...
## <a name="finding-smooth-skies-in-the-cloud"></a>Finding smooth skies in the cloud
...
## <a name="unstructured-and-semi-structured-data"></a>Unstructured and semi-structured data
...
## <a name="authentication-and-routing"></a>Authentication and routing
...
## <a name="other-azure-services"></a>Other Azure services
...
## <a name="expand-customer-satisfaction-without-expanding-it"></a>Expand customer satisfaction without expanding IT
...
##<a name="gep-contributors"></a>GEP contributors
