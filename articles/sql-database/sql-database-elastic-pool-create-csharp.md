...
# <a name="create-an-elastic-database-pool-with-cx23"></a>Create an elastic database pool with C&#x23;
...
## <a name="create-a-sql-elastic-database-pool---c-example"></a>Create a SQL elastic database pool - C# example
