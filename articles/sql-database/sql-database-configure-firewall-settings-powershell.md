...
# <a name="configure-azure-sql-database-server-level-firewall-rules-by-using-powershell"></a>Configure Azure SQL Database server-level firewall rules by using PowerShell
...
## <a name="create-server-firewall-rules"></a>Create server firewall rules
...
## <a name="manage-firewall-rules-by-using-powershell"></a>Manage firewall rules by using PowerShell
