...
# <a name="troubleshoot-diagnose-and-prevent-sql-connection-errors-and-transient-errors-for-sql-database"></a>Troubleshoot, diagnose, and prevent SQL connection errors and transient errors for SQL Database
...
## <a name="transient-errors-transient-faults"></a>Transient errors (transient faults)
...
If your client program is using ADO.NET, your program is told about the transient error by the throw of an **SqlException**. The **Number** property can be compared against the list of transient errors near the top of the topic: [SQL error codes for SQL Database client applications](sql-database-develop-error-messages.md).

<a id="connection-versus-command" name="connection-versus-command"></a>

### <a name="connection-versus-command"></a>Connection versus command
...
### <a name="retry-logic-for-transient-errors"></a>Retry logic for transient errors
...
#### <a name="principles-for-retry"></a>Principles for retry
...
#### <a name="other-considerations-for-retry"></a>Other considerations for retry
...
#### <a name="interval-increase-between-retries"></a>Interval increase between retries
...
#### <a name="code-samples-with-retry-logic"></a>Code samples with retry logic
...
#### <a name="test-your-retry-logic"></a>Test your retry logic


To test your retry logic, you must simulate or cause an error than can be corrected while your program is still running.


##### <a name="test-by-disconnecting-from-the-network"></a>Test by disconnecting from the network
...
##### <a name="test-by-misspelling-the-database-name-when-connecting"></a>Test by misspelling the database name when connecting
...
### <a name="net-sqlconnection-parameters-for-connection-retry"></a>.NET SqlConnection parameters for connection retry
...
#### <a name="should-connectretrycount-be-combined-with-application-retry-logic"></a>Should ConnectRetryCount be combined with application retry logic?
...
## <a name="connections-to-azure-sql-database"></a>Connections to Azure SQL Database

<a id="c-connection-string" name="c-connection-string"></a>

### <a name="connection-connection-string"></a>Connection: Connection string
...
### <a name="connection-ip-address"></a>Connection: IP address
...
For more information, see: [How to: Configure firewall settings on SQL Database](sql-database-configure-firewall-settings.md)


<a id="c-connection-ports" name="c-connection-ports"></a>

### <a name="connection-ports"></a>Connection: Ports
...
For background information about cofiguration of ports and IP address, see: [Azure SQL Database firewall](sql-database-firewall-configure.md)


<a id="d-connection-ado-net-4-5" name="d-connection-ado-net-4-5"></a>

### <a name="connection-adonet-461"></a>Connection: ADO.NET 4.6.1
...
### <a name="diagnostics-test-whether-utilities-can-connect"></a>Diagnostics: Test whether utilities can connect
...
### <a name="diagnostics-check-the-open-ports"></a>Diagnostics: Check the open ports
...
### <a name="diagnostics-log-your-errors"></a>Diagnostics: Log your errors
...
### <a name="diagnostics-examine-system-logs-for-errors"></a>Diagnostics: Examine system logs for errors
...
### <a name="diagnostics-search-for-problem-events-in-the-sql-database-log"></a>Diagnostics: Search for problem events in the SQL Database log
...
#### <a name="a-few-returned-rows-from-sysfnxetelemetryblobtargetreadfile"></a>A few returned rows from sys.fn_xe_telemetry_blob_target_read_file
...
### <a name="entlib60-classes-for-transient-errors-and-retry"></a>EntLib60 classes for transient errors and retry
...
### <a name="entlib60-the-logging-block"></a>EntLib60: The logging block
...
For details see: [5 - As Easy As Falling Off a Log: Using the Logging Application Block](https://msdn.microsoft.com/library/dn440731%28v=pandp.60%29.aspx)

<a id="entlib60-istransient-method-source-code" name="entlib60-istransient-method-source-code"></a>

### <a name="entlib60-istransient-method-source-code"></a>EntLib60 IsTransient method source code
