...
# <a name="plan-and-prepare-to-upgrade-to-sql-database-v12"></a>Plan and prepare to upgrade to SQL Database V12
...
## <a name="plan-ahead"></a>Plan ahead
...
### <a name="version-clarification"></a>Version clarification
...
### <a name="service-tier-planning"></a>Service tier planning
...
### <a name="review-the-geo-replication-configuration"></a>Review the Geo-Replication configuration
...
## <a name="preparation-actions"></a>Preparation actions
...
### <a name="service-tier-actions"></a>Service tier actions
...
### <a name="suspend-geo-replication-during-upgrade"></a>Suspend Geo-Replication during upgrade
...
### <a name="open-ports-on-an-azure-vm-for-client-connectivity"></a>Open ports on an Azure VM for client connectivity
...
### <a name="portals-for-v12"></a>Portals for V12
...
### <a name="limitation-during-upgrade-to-v12"></a>Limitation *during* upgrade to V12
...
### <a name="limitation-after-upgrade-to-v12"></a>Limitation *after* upgrade to V12
...
### <a name="export-and-import-after-upgrade-to-v12"></a>Export and import *after* upgrade to V12
...
#### <a name="automated-export"></a>Automated Export
...
### <a name="restore-to-v12-of-a-deleted-v11-database"></a>Restore to V12 of a deleted V11 database
...
## <a name="failure-resolution"></a>Failure resolution
