...
# <a name="configure-azure-sql-database-server-level-and-database-level-firewall-rules-using-t-sql"></a>Configure Azure SQL Database server-level and database-level firewall rules using T-SQL
