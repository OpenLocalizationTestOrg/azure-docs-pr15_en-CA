...
# <a name="sql-server-database-migration-to-sql-database-in-the-cloud"></a>SQL Server database migration to SQL Database in the cloud
...
## <a name="database-migration-tools-test-sql-server-database-compatibility-with-sql-database"></a>Database migration tools test SQL Server database compatibility with SQL Database
...
## <a name="fix-database-migration-compatibility-issues"></a>Fix database migration compatibility issues
...
## <a name="migrate-a-compatible-sql-server-database-to-sql-database"></a>Migrate a compatible SQL Server database to SQL Database
