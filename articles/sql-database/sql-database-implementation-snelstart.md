...
##<a name="why-snelstart-extended-services-from-the-desktop-to-the-cloud"></a>Why SnelStart extended services from the desktop to the cloud
...
##<a name="a-modern-company-with-traditional-roots"></a>A modern company with traditional roots
...
##<a name="optimizing-performance-and-cost-with-elastic-pools"></a>Optimizing performance and cost with elastic pools
...
##<a name="azure-sql-databases-help-containerize-data-for-isolation-and-security"></a>Azure SQL Databases help containerize data for isolation and security 
...
##<a name="azure-removes-overhead-so-that-developers-can-spend-more-time-delivering-value"></a>Azure removes overhead so that developers can spend more time delivering value 
...
##<a name="how-azure-services-enable-saas-for-snelstart"></a>How Azure services enable SaaS for SnelStart
...
##<a name="simplicity-from-the-cloud"></a>Simplicity from the cloud
