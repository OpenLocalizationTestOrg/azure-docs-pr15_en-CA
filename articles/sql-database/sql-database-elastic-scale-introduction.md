...
# <a name="scaling-out-with-azure-sql-database"></a>Scaling out with Azure SQL Database
...
## <a name="why-use-the-tools"></a>Why use the tools?
...
## <a name="horizontal-and-vertical-scaling"></a>Horizontal and vertical scaling
...
## <a name="multi-tenant-and-single-tenant"></a>Multi-tenant and single-tenant
...
### <a name="move-data-from-multiple-to-single-tenancy-databases"></a>Move data from multiple to single-tenancy databases
