...
# <a name="import-a-bacpac-file-to-create-an-azure-sql-database-by-using-powershell"></a>Import a BACPAC file to create an Azure SQL database by using PowerShell
...
## <a name="set-up-the-variables-for-your-environment"></a>Set up the variables for your environment
...
## <a name="import-the-database"></a>Import the database
...
## <a name="monitor-the-progress-of-the-operation"></a>Monitor the progress of the operation
...
## <a name="sql-database-powershell-import-script"></a>SQL Database PowerShell import script
