...
# <a name="expressroute-circuits-and-routing-domains"></a>ExpressRoute circuits and routing domains
...
### <a name="quotas-limits-and-limitations"></a>Quotas, limits, and limitations
...
## <a name="routing-domain-comparison"></a>Routing domain comparison
