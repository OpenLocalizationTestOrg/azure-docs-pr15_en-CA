...
# <a name="create-a-virtual-network-for-expressroute-in-the-classic-portal"></a>Create a Virtual Network for ExpressRoute in the classic portal
...
## <a name="create-a-classic-vnet-and-gateway"></a>Create a classic VNet and gateway
