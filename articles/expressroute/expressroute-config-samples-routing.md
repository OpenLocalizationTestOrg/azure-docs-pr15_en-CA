...
# <a name="router-configuration-samples-to-setup-and-manage-routing"></a>Router configuration samples to setup and manage routing
...
### <a name="1-configuring-interfaces-and-sub-interfaces"></a>1. Configuring interfaces and sub-interfaces
...
#### <a name="dot1q-interface-definition"></a>Dot1Q interface definition
...
#### <a name="qinq-interface-definition"></a>QinQ interface definition
...
### <a name="2-setting-up-ebgp-sessions"></a>2. Setting up eBGP sessions
...
### <a name="3-setting-up-prefixes-to-be-advertised-over-the-bgp-session"></a>3. Setting up prefixes to be advertised over the BGP session
...
## <a name="juniper-mx-series-routers"></a>Juniper MX series routers 
