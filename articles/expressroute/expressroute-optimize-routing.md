...
# <a name="optimize-expressroute-routing"></a>Optimize ExpressRoute Routing
...
## <a name="suboptimal-routing-case-1"></a>Suboptimal routing case 1
...
### <a name="solution-use-bgp-communities"></a>Solution: use BGP Communities
...
## <a name="suboptimal-routing-case-2"></a>Suboptimal routing case 2
...
### <a name="solution-use-as-path-prepending"></a>Solution: use AS PATH prepending
