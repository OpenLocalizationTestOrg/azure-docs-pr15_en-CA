...
# <a name="expressroute-troubleshooting-guide-getting-arp-tables-in-the-classic-deployment-model"></a>ExpressRoute troubleshooting guide: Getting ARP tables in the classic deployment model
...
## <a name="prerequisites-for-using-arp-tables"></a>Prerequisites for using ARP tables
...
## <a name="arp-tables-for-your-expressroute-circuit"></a>ARP tables for your ExpressRoute circuit
...
### <a name="arp-table-when-a-circuit-is-in-an-operational-expected-state"></a>ARP table when a circuit is in an operational (expected) state
...
### <a name="arp-table-when-its-on-premises-or-when-the-connectivity-provider-side-has-problems"></a>ARP table when it's on-premises or when the connectivity-provider side has problems
...
### <a name="arp-table-when-the-microsoft-side-has-problems"></a>ARP table when the Microsoft side has problems
