...
#<a name="expressroute-troubleshooting-guide---getting-arp-tables-in-the-resource-manager-deployment-model"></a>ExpressRoute Troubleshooting guide - Getting ARP tables in the Resource Manager deployment model
...
## <a name="address-resolution-protocol-arp-and-arp-tables"></a>Address Resolution Protocol (ARP) and ARP tables
...
## <a name="prerequisites-for-learning-arp-tables"></a>Prerequisites for learning ARP tables
...
## <a name="getting-the-arp-tables-for-your-expressroute-circuit"></a>Getting the ARP tables for your ExpressRoute circuit
...
### <a name="arp-tables-for-azure-private-peering"></a>ARP tables for Azure private peering
...
### <a name="arp-tables-for-azure-public-peering"></a>ARP tables for Azure public peering
...
### <a name="arp-tables-for-microsoft-peering"></a>ARP tables for Microsoft peering
...
## <a name="how-to-use-this-information"></a>How to use this information
...
### <a name="arp-table-when-a-circuit-is-in-operational-state-expected-state"></a>ARP table when a circuit is in operational state (expected state)
...
### <a name="arp-table-when-on-premises--connectivity-provider-side-has-problems"></a>ARP table when on-premises / connectivity provider side has problems
...
### <a name="arp-table-when-microsoft-side-has-problems"></a>ARP table when Microsoft side has problems
