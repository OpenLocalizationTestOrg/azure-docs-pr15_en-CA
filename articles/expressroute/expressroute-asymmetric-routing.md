...
# <a name="asymmetric-routing-with-multiple-network-paths"></a>Asymmetric routing with multiple network paths
...
## <a name="multiple-network-paths"></a>Multiple network paths
...
## <a name="stateful-devices"></a>Stateful devices
...
## <a name="asymmetric-routing-with-expressroute"></a>Asymmetric routing with ExpressRoute
...
## <a name="asymmetric-routing-solutions"></a>Asymmetric routing solutions
...
### <a name="source-based-nat"></a>Source-based NAT
...
## <a name="asymmetric-routing-detection"></a>Asymmetric routing detection
