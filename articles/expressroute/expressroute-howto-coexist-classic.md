...
# <a name="configure-expressroute-and-site-to-site-coexisting-connections-for-the-classic-deployment-model"></a>Configure ExpressRoute and Site-to-Site coexisting connections for the classic deployment model
