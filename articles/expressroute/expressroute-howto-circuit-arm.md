...
### <a name="1-sign-in-to-your-azure-account-and-select-your-subscription"></a>1. Sign in to your Azure account and select your subscription
...
### <a name="3-create-an-expressroute-circuit"></a>3. Create an ExpressRoute circuit
...
### <a name="4-list-all-expressroute-circuits"></a>4. List all ExpressRoute circuits
...
### <a name="7-create-your-routing-configuration"></a>7. Create your routing configuration
...
### <a name="to-move-the-sku-from-metered-to-unlimited"></a>To move the SKU from metered to unlimited
...
### <a name="to-control-access-to-the-classic-and-resource-manager-environments"></a>To control access to the classic and Resource Manager environments  
