...
# <a name="convert-a-machine-learning-training-experiment-to-a-predictive-experiment"></a>Convert a Machine Learning training experiment to a predictive experiment
...
## <a name="set-up-web-service-button"></a>Set Up Web Service button
...
### <a name="adjust-input-and-output-modules"></a>Adjust input and output modules
...
### <a name="add-or-remove-additional-data-processing-modules"></a>Add or remove additional data processing modules
...
### <a name="add-optional-web-service-parameters"></a>Add optional Web Service Parameters
...
For more information about Web Service Parameters, see [Using Azure Machine Learning Web Service Parameters ][webserviceparameters].

[webserviceparameters]: machine-learning-web-service-parameters.md


## <a name="deploy-the-predictive-experiment-as-a-web-service"></a>Deploy the predictive experiment as a web service
