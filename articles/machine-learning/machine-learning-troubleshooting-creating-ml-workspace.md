...
# <a name="troubleshooting-guide-create-and-connect-to-an-machine-learning-workspace"></a>Troubleshooting guide: Create and connect to an Machine Learning workspace
...
## <a name="workspace-owner"></a>Workspace owner
...
## <a name="allowed-regions"></a>Allowed regions
