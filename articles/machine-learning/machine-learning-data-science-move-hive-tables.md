...
#<a name="create-and-load-data-into-hive-tables-from-azure-blob-storage"></a>Create and load data into Hive tables from Azure blob storage
...
#### <a name="submit-hive-queries-directly-in-hadoop-command-line"></a>Submit Hive queries directly in Hadoop Command Line.
...
#### <a name="submit-hive-queries-in-hql-files"></a>Submit Hive queries in .hql files
...
#### <a name="submit-hive-queries-in-hive-command-console"></a>Submit Hive queries in Hive command console.
...
### <a name="partitioned-table"></a>Partitioned table
