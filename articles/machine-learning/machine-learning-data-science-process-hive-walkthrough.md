...
# <a name="the-team-data-science-process-in-action-using-hdinsight-hadoop-clusters"></a>The Team Data Science Process in action: using HDInsight Hadoop clusters
...
### <a name="exploration-assessing-data-quality-by-checking-for-invalid-longitudelatitude-records"></a>Exploration: Assessing data quality by checking for invalid longitude/latitude records
...
### <a name="exploration-compute-direct-distance-between-two-longitude-latitude-locations"></a>Exploration: Compute Direct Distance Between Two Longitude-Latitude Locations
...
### <a name="use-the-import-data-module-in-azure-machine-learning-to-access-the-down-sampled-data"></a>Use the Import Data module in Azure Machine Learning to access the down sampled data
