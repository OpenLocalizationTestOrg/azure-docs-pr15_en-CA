...
# <a name="quick-start-guide-for-the-machine-learning-recommendations-api"></a>Quick start guide for the Machine Learning Recommendations API
...
###<a name="ids-are-case-sensitive"></a>IDs are case sensitive
...
###<a name="import-catalog-data"></a>Import catalog data
...
###<a name="import-usage-data"></a>Import usage data

####<a name="uploading-a-file"></a>Uploading a file
...
####<a name="using-data-acquisition"></a>Using data acquisition
...
###<a name="build-a-recommendation-model"></a>Build a recommendation model
...
###<a name="get-build-status-of-a-model"></a>Get build status of a model
...
###<a name="update-model"></a>Update model
