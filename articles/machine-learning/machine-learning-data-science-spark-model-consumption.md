...
# <a name="score-spark-built-machine-learning-models"></a>Score Spark-built machine learning models 
...
## <a name="ingest-data-and-create-a-cleaned-data-frame"></a>Ingest data and create a cleaned data frame
...
## <a name="prepare-data-for-scoring-in-spark"></a>Prepare data for scoring in Spark 
...
### <a name="feature-transformation-index-and-encode-categorical-features-for-input-into-models-for-scoring"></a>Feature transformation: index and encode categorical features for input into models for scoring 
...
### <a name="create-rdd-objects-with-feature-arrays-for-input-into-models"></a>Create RDD objects with feature arrays for input into models
...
## <a name="score-with-the-logistic-regression-model-and-save-output-to-blob"></a>Score with the Logistic Regression Model and save output to blob
...
## <a name="score-a-linear-regression-model"></a>Score a Linear Regression Model
...
## <a name="score-classification-and-regression-random-forest-models"></a>Score classification and regression Random Forest Models
...
## <a name="score-classification-and-regression-gradient-boosting-tree-models"></a>Score classification and regression Gradient Boosting Tree Models
...
## <a name="clean-up-objects-from-memory-and-print-scored-file-locations"></a>Clean up objects from memory and print scored file locations
...
## <a name="consume-spark-models-through-a-web-interface"></a>Consume Spark Models through a web interface
