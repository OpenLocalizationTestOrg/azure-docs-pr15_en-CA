...
# <a name="copy-sample-experiments-to-create-new-machine-learning-experiments"></a>Copy sample experiments to create new machine learning experiments
...
## <a name="find-an-experiment-to-copy-in-cortana-intelligence-gallery"></a>Find an experiment to copy in Cortana Intelligence Gallery
...
### <a name="find-the-newest-or-most-popular-experiments"></a>Find the newest or most popular experiments
...
### <a name="look-for-an-experiment-that-meets-specific-requirements"></a>Look for an experiment that meets specific requirements
...
3. You can find experiments that meet your requirements a couple different ways:
    ...
    *  **Use the search box.** For example, to find experiments contributed by Microsoft related to digit recognition that use a two-class support vector machine algorithm, enter "digit recognition" in the search box. Then, select the filters **Experiment**, **Microsoft content only**, and **Two-Class Support Vector Machine**:![](./media/machine-learning-sample-experiments/search-for-experiments.png) 
...
## <a name="use-a-template-in-machine-learning-studio"></a>Use a template in Machine Learning Studio
