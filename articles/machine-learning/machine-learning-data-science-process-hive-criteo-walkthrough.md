...
# <a name="the-team-data-science-process-in-action---using-azure-hdinsight-hadoop-clusters-on-a-1-tb-dataset"></a>The Team Data Science Process in action - Using Azure HDInsight Hadoop Clusters on a 1 TB dataset
...
### <a name="confirm-database-and-table-creation"></a>Confirm database and table creation
...
### <a name="number-of-train-examples"></a>Number of train examples
...
### <a name="number-of-test-examples-in-the-two-test-datasets"></a>Number of test examples in the two test datasets
...
### <a name="label-distribution-in-the-train-dataset"></a>Label distribution in the train dataset
...
### <a name="histogram-distributions-of-some-numeric-variables-in-the-train-dataset"></a>Histogram distributions of some numeric variables in the train dataset
...
### <a name="approximate-percentiles-of-some-numeric-variables-in-the-train-dataset"></a>Approximate percentiles of some numeric variables in the train dataset
...
### <a name="find-number-of-unique-values-for-some-categorical-columns-in-the-train-dataset"></a>Find number of unique values for some categorical columns in the train dataset
...
### <a name="co-occurence-counts-of-pairs-of-categorical-variables-in-the-train-dataset"></a>Co-occurence counts of pairs of categorical variables in the train dataset
...
#### <a name="feature-engineering-on-the-data"></a>Feature engineering on the data
...
##### <a name="building-counting-transforms"></a>Building counting transforms
...
##### <a name="choosing-what-count-features-to-include-as-part-of-the-train-and-test-datasets"></a>Choosing what count features to include as part of the train and test datasets
...
##### <a name="data-transformation-before-generating-the-count-features"></a>Data transformation before generating the count features
...
##### <a name="applying-the-count-transformation-on-our-data"></a>Applying the count transformation on our data
...
##### <a name="an-excerpt-of-what-the-count-features-look-like"></a>An excerpt of what the count features look like
...
#### <a name="azure-machine-learning-model-building"></a>Azure Machine Learning model building

##### <a name="choice-of-learner"></a>Choice of learner
...
#### <a name="score-the-model"></a>Score the model
...
#### <a name="select-a-few-rows-of-data-for-the-input-port"></a>Select a few rows of data for the input port
...
#### <a name="generate-input-data-for-webservice"></a>Generate input data for webservice
...
#### <a name="scoring-experiment-for-publishing-webservice"></a>Scoring experiment for publishing webservice
