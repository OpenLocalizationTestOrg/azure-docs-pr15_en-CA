...
# <a name="the-team-data-science-process-in-action-using-sql-server"></a>The Team Data Science Process in action: using SQL Server
...
#### <a name="feature-engineering-in-sql-queries"></a>Feature Engineering in SQL Queries
...
#### <a name="preparing-data-for-model-building"></a>Preparing Data for Model Building
...
#### <a name="read-in-a-small-data-sample-from-the-sql-server-database"></a>Read-in a small data sample from the SQL Server Database
...
#### <a name="visualization-scatterplot-example"></a>Visualization: Scatterplot Example
...
### <a name="sub-sampling-the-data-in-sql"></a>Sub-Sampling the Data in SQL
...
#### <a name="create-a-sample-table-and-populate-with-1-of-the-joined-tables-drop-table-first-if-it-exists"></a>Create a Sample Table and Populate with 1% of the Joined Tables. Drop Table First if it Exists.
...
### <a name="data-exploration-using-sql-queries-in-ipython-notebook"></a>Data Exploration using SQL Queries in IPython Notebook
...
### <a name="feature-generation-using-sql-queries-in-ipython-notebook"></a>Feature Generation Using SQL Queries in IPython Notebook
...
#### <a name="label-generation-generate-class-labels"></a>Label Generation: Generate Class Labels
...
#### <a name="feature-engineering-count-features-for-categorical-columns"></a>Feature Engineering: Count Features for Categorical Columns
...
#### <a name="feature-engineering-bin-features-for-numerical-columns"></a>Feature Engineering: Bin features for Numerical Columns
...
#### <a name="feature-engineering-extract-location-features-from-decimal-latitudelongitude"></a>Feature Engineering: Extract Location Features from Decimal Latitude/Longitude
