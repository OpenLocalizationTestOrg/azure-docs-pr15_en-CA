...
### <a name="define-a-convolutional-network-for-multiclass-classification-digit-recognition-example"></a>Define a convolutional network for multiclass classification: digit recognition example
