...
# <a name="how-to-evaluate-model-performance-in-azure-machine-learning"></a>How to evaluate model performance in Azure Machine Learning
...
##<a name="evaluation-vs-cross-validation"></a>Evaluation vs. Cross Validation##
...
##<a name="evaluating-a-regression-model"></a>Evaluating a Regression Model##
...
###<a name="inspecting-the-evaluation-results"></a>Inspecting the Evaluation Results###
...
###<a name="using-cross-validation"></a>Using Cross Validation###
...
##<a name="evaluating-a-binary-classification-model"></a>Evaluating a Binary Classification Model##
...
![Binary Classification Evaluation Results](media/machine-learning-evaluate-model-performance/7.png) Figure 7. Binary Classification Evaluation Results.
