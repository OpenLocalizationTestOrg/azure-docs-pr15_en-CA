...
# <a name="scenarios-for-advanced-analytics-in-azure-machine-learning"></a>Scenarios for advanced analytics in Azure Machine Learning
...
#### <a name="additional-azure-resources-none"></a>Additional Azure resources: None
...
#### <a name="additional-azure-resources-azure-virtual-machine-ipython-notebook-server"></a>Additional Azure resources: Azure Virtual Machine (IPython Notebook server)
...
#### <a name="additional-azure-resources-azure-virtual-machine-sql-server--ipython-notebook-server"></a>Additional Azure resources: Azure Virtual Machine (SQL Server / IPython Notebook server)
...
2.  Use one of the data export methods to export the data from SQL Server to dump files.
    ...
    > [AZURE.NOTE] If you decide to move all data from the on-prem database, an alternate (faster) method to move the full database to the SQL Server instance in Azure. Skip the steps to export data, create database, and load/import data to the target database and follow the alternate method.
...
### <a name="alternate-method-to-copy-a-full-database-from-an-on-premises--sql-server-to-azure-sql-database"></a>Alternate method to copy a full database from an on-premises  SQL Server to Azure SQL Database
...
#### <a name="additional-azure-resources-azure-hdinsight-hadoop-cluster-and-azure-virtual-machine-ipython-notebook-server"></a>Additional Azure resources: Azure HDInsight Hadoop Cluster and Azure Virtual Machine (IPython Notebook server)
...
### <a name="advanced-analytics-in-action-examples"></a>Advanced Analytics in action Examples
