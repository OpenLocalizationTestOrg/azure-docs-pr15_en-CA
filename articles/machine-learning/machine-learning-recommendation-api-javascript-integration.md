...
###<a name="31-limitations-and-browser-support"></a>3.1. Limitations and Browser Support
This is a reference implementation and it is given as is. It should support all major browsers.

###<a name="32-type-of-events"></a>3.2. Type of Events
...
####<a name="321-click-event"></a>3.2.1. Click Event
...
####<a name="322-recommendation-click-event"></a>3.2.2. Recommendation Click Event
...
####<a name="323-add-shopping-cart-event"></a>3.2.3. Add Shopping Cart Event
...
####<a name="324-remove-shopping-cart-event"></a>3.2.4. Remove Shopping Cart Event
...
####<a name="325-purchase-event"></a>3.2.5. Purchase Event
...
####<a name="326-user-login-event"></a>3.2.6. User Login Event
...
###<a name="41-consume-recommendations"></a>4.1 Consume Recommendations
