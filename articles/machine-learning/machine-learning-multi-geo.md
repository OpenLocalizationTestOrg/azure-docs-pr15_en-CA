...
# <a name="multi-geo-help-documentation"></a>Multi-Geo Help documentation

This article describes how you can create a workspace and publish a web service in other Azure regions.

## <a name="create-a-workspace"></a>Create a workspace
...
## <a name="open-an-experiment-from-gallery"></a>Open an experiment from Gallery
