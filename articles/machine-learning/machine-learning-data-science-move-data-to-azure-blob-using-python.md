...
# <a name="move-data-to-and-from-azure-blob-storage-using-python"></a>Move Data to and from Azure Blob Storage using Python
...
## <a name="upload-data-to-blob"></a>Upload Data to Blob
...
## <a name="download-data-from-blob"></a>Download Data from Blob
