...
# <a name="walkthrough-step-3-create-a-new-azure-machine-learning-experiment"></a>Walkthrough Step 3: Create a new Azure Machine Learning experiment
...
The dialog should look like this: ![Column Selector with all columns selected][4]
...
##<a name="create-training-and-test-datasets"></a>Create training and test datasets
