...
# <a name="the-team-data-science-process-in-action-using-sql-data-warehouse"></a>The Team Data Science Process in action: using SQL Data Warehouse
...
### <a name="data-import-verification"></a>Data import verification
...
### <a name="exploration-trip-distribution-by-medallion-and-hacklicense"></a>Exploration: Trip distribution by medallion and hack_license
...
### <a name="data-quality-assessment-verify-records-with-incorrect-longitude-andor-latitude"></a>Data quality assessment: Verify records with incorrect longitude and/or latitude
...
### <a name="exploration-tipped-vs-not-tipped-trips-distribution"></a>Exploration: Tipped vs. not tipped trips distribution
...
### <a name="exploration-tip-classrange-distribution"></a>Exploration: Tip class/range distribution
...
### <a name="exploration-compute-and-compare-trip-distance"></a>Exploration: Compute and compare trip distance
...
### <a name="feature-engineering-using-sql-functions"></a>Feature engineering using SQL functions
...
### <a name="prepare-data-for-model-building"></a>Prepare data for model building
...
### <a name="initialize-database-credentials"></a>Initialize database credentials
...
### <a name="report-number-of-rows-and-columns-in-table-nyctaxitrip"></a>Report number of rows and columns in table <nyctaxi_trip>
...
### <a name="report-number-of-rows-and-columns-in-table-nyctaxifare"></a>Report number of rows and columns in table <nyctaxi_fare>
...
### <a name="read-in-a-small-data-sample-from-the-sql-data-warehouse-database"></a>Read-in a small data sample from the SQL Data Warehouse Database
...
### <a name="visualization-box-plot-example"></a>Visualization: Box plot example
...
### <a name="visualization-distribution-plot-example"></a>Visualization: Distribution plot example
...
### <a name="visualization-bar-and-line-plots"></a>Visualization: Bar and line plots
...
### <a name="visualization-scatterplot-examples"></a>Visualization: Scatterplot examples
...
### <a name="data-exploration-on-sampled-data-using-sql-queries-in-ipython-notebook"></a>Data exploration on sampled data using SQL queries in IPython notebook
...
#### <a name="exploration-report-number-of-rows-and-columns-in-the-sampled-table"></a>Exploration: Report number of rows and columns in the sampled table
...
#### <a name="exploration-tippednot-tripped-distribution"></a>Exploration: Tipped/not tripped Distribution
...
#### <a name="exploration-tip-class-distribution"></a>Exploration: Tip class distribution
...
#### <a name="exploration-plot-the-tip-distribution-by-class"></a>Exploration: Plot the tip distribution by class
...
#### <a name="exploration-daily-distribution-of-trips"></a>Exploration: Daily distribution of trips
...
#### <a name="exploration-trip-distribution-per-medallion"></a>Exploration: Trip distribution per medallion
...
#### <a name="exploration-trip-time-distribution"></a>Exploration: Trip time distribution

    query = '''select trip_time_in_secs, count(*) from <schemaname>.<nyctaxi_sample> group by trip_time_in_secs order by count(*) desc'''
    pd.read_sql(query,conn)

#### <a name="exploration-trip-distance-distribution"></a>Exploration: Trip distance distribution

    query = '''select floor(trip_distance/5)*5 as tripbin, count(*) from <schemaname>.<nyctaxi_sample> group by floor(trip_distance/5)*5 order by count(*) desc'''
    pd.read_sql(query,conn)

#### <a name="exploration-payment-type-distribution"></a>Exploration: Payment type distribution

    query = '''select payment_type,count(*) from <schemaname>.<nyctaxi_sample> group by payment_type'''
    pd.read_sql(query,conn)

#### <a name="verify-the-final-form-of-the-featurized-table"></a>Verify the final form of the featurized table
