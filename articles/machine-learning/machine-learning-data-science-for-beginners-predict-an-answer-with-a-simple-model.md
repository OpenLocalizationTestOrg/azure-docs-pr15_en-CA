...
# <a name="predict-an-answer-with-a-simple-model"></a>Predict an answer with a simple model

## <a name="video-4-data-science-for-beginners-series"></a>Video 4: Data Science for Beginners series
...
## <a name="transcript-predict-an-answer-with-a-simple-model"></a>Transcript: Predict an answer with a simple model
...
## <a name="collect-relevant-accurate-connected-enough-data"></a>Collect relevant, accurate, connected, enough data
...
## <a name="ask-a-sharp-question"></a>Ask a sharp question
...
## <a name="plot-the-existing-data"></a>Plot the existing data
...
## <a name="draw-the-model-through-the-data-points"></a>Draw the model through the data points
...
## <a name="use-the-model-to-find-the-answer"></a>Use the model to find the answer
...
## <a name="create-a-confidence-interval"></a>Create a confidence interval
...
## <a name="were-done-with-no-math-or-computers"></a>We're done, with no math or computers
