...
## <a name="preparation-steps"></a>Preparation Steps 

## <a name="p1-plan-the-analytics-project"></a>P1. Plan the analytics project 
...
## <a name="p2-setup-analytics-environment"></a>P2. Setup analytics environment 
...
## <a name="1-ingest-data-into-the-analytical-environment"></a>1. Ingest Data into the analytical environment 
...
## <a name="2-explore-and-pre-process-data"></a>2. Explore and pre-process data 
...
## <a name="3-develop-features"></a>3. Develop Features 
...
## <a name="4-create-predictive-models"></a>4. Create predictive models 
...
## <a name="5-deploy-and-consume-models"></a>5. Deploy and Consume models 
