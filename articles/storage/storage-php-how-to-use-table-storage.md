...
# <a name="how-to-use-table-storage-from-php"></a>How to use table storage from PHP
...
## <a name="create-a-php-application"></a>Create a PHP application
...
## <a name="get-the-azure-client-libraries"></a>Get the Azure Client Libraries

[AZURE.INCLUDE [get-client-libraries](../../includes/get-client-libraries.md)]

## <a name="configure-your-application-to-access-the-table-service"></a>Configure your application to access the Table service
...
> [AZURE.NOTE] This example (and other examples in this article) assume you have installed the PHP Client Libraries for Azure via Composer. If you installed the libraries manually, you need to reference the <code>WindowsAzure.php</code> autoloader file.
...
## <a name="retrieve-a-subset-of-entities-in-a-partition"></a>Retrieve a subset of entities in a partition
...
## <a name="retrieve-a-subset-of-entity-properties"></a>Retrieve a subset of entity properties
...
## <a name="batch-table-operations"></a>Batch table operations
