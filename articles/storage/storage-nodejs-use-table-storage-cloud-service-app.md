...
# <a name="nodejs-web-application-using-storage"></a>Node.js Web Application using Storage
...
## <a name="setting-storage-credentials-in-webconfig"></a>Setting Storage Credentials in Web.Config
...
### <a name="modify-appjs"></a>Modify app.js
