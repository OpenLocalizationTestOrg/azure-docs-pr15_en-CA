...
# <a name="manage-anonymous-read-access-to-containers-and-blobs"></a>Manage anonymous read access to containers and blobs
...
## <a name="grant-anonymous-users-permissions-to-containers-and-blobs"></a>Grant anonymous users permissions to containers and blobs
...
### <a name="setting-container-permissions-from-the-azure-portal"></a>Setting container permissions from the Azure Portal
...
### <a name="setting-container-permissions-programmatically-using-net"></a>Setting container permissions programmatically using .NET
...
## <a name="access-containers-and-blobs-anonymously"></a>Access containers and blobs anonymously
...
### <a name="create-an-anonymous-client-object"></a>Create an anonymous client object
...
### <a name="reference-a-container-anonymously"></a>Reference a container anonymously
...
### <a name="reference-a-blob-anonymously"></a>Reference a blob anonymously
...
## <a name="features-available-to-anonymous-users"></a>Features available to anonymous users
