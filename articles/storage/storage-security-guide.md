...
####<a name="how-the-shared-access-signature-is-authenticated-by-the-azure-storage-service"></a>How the Shared Access Signature is authenticated by the Azure Storage Service
...
####<a name="creating-an-sas-uri"></a>Creating an SAS URI
...
####<a name="how-are-my-blobs-being-authenticated"></a>How are my blobs being authenticated?
