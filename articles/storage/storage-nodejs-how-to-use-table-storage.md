...
# <a name="how-to-use-azure-table-storage-from-nodejs"></a>How to use Azure Table storage from Node.js
...
### <a name="use-node-package-manager-npm-to-install-the-package"></a>Use Node Package Manager (NPM) to install the package
...
### <a name="work-with-batched-operations"></a>Work with batched operations
...
## <a name="retrieve-an-entity-by-key"></a>Retrieve an entity by key
...
## <a name="use-continuation-tokens"></a>Use continuation tokens
...
## <a name="work-with-shared-access-signatures"></a>Work with shared access signatures
