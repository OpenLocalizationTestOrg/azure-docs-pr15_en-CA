...
###<a name="step-1-create-a-new-storage-accountstorage-create-storage-accountmd"></a>Step 1: [Create a new storage account](storage-create-storage-account.md).

###<a name="step-2-enable-encryption"></a>Step 2: Enable encryption.
...
###<a name="step-3-copy-data-to-storage-account"></a>Step 3: Copy data to storage account
...
#### <a name="using-azcopy"></a>Using AzCopy
...
#### <a name="using-the-storage-client-libraries"></a>Using the Storage Client Libraries
...
#### <a name="using-a-storage-explorer"></a>Using a Storage Explorer
...
###<a name="step-4-query-the-status-of-the-encrypted-data"></a>Step 4: Query the status of the encrypted data
...
##<a name="encryption-and-decryption-workflow"></a>Encryption and Decryption Workflow
...
##<a name="frequently-asked-questions-about-storage-service-encryption-for-data-at-rest"></a>Frequently asked questions about Storage Service Encryption for Data at Rest
