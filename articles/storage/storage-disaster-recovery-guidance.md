...
# <a name="what-to-do-if-an-azure-storage-outage-occurs"></a>What to do if an Azure Storage outage occurs
...
## <a name="how-to-detect"></a>How to detect 
...
## <a name="what-to-do-if-a-storage-outage-occurs"></a>What to do if a Storage outage occurs
...
### <a name="option-2-copy-data-from-secondary"></a>Option 2: Copy data from secondary
...
## <a name="what-to-expect-if-a-storage-failover-occurs"></a>What to expect if a Storage failover occurs
...
##<a name="best-practices-for-protecting-your-data"></a>Best Practices for protecting your data
