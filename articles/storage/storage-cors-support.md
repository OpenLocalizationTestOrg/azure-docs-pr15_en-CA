...
# <a name="cross-origin-resource-sharing-cors-support-for-the-azure-storage-services"></a>Cross-Origin Resource Sharing (CORS) Support for the Azure Storage Services
...
## <a name="understanding-cors-requests"></a>Understanding CORS requests
...
### <a name="preflight-request"></a>Preflight request
...
### <a name="actual-request"></a>Actual request
...
## <a name="enabling-cors-for-the-azure-storage-services"></a>Enabling CORS for the Azure Storage services
...
## <a name="understanding-cors-rule-evaluation-logic"></a>Understanding CORS rule evaluation logic
...
### <a name="example--cors-rules-evaluation"></a>Example – CORS rules evaluation
...
## <a name="understanding-how-the-vary-header-is-set"></a>Understanding how the Vary header is set
...
## <a name="billing-for-cors-requests"></a>Billing for CORS requests
