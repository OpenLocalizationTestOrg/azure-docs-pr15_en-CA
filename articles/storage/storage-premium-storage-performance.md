...
# <a name="azure-premium-storage-design-for-high-performance"></a>Azure Premium Storage: Design for High Performance
...
## <a name="application-performance-indicators"></a>Application Performance Indicators  
...
## <a name="gather-application-performance-requirements"></a>Gather Application Performance Requirements  
...
### <a name="counters-to-measure-application-performance-requirements"></a>Counters to measure application performance requirements  
...
## <a name="optimizing-application-performance"></a>Optimizing Application Performance  
...
### <a name="optimizing-iops-throughput-and-latency-at-a-glance"></a>Optimizing IOPS, Throughput and Latency at a glance  
...
## <a name="nature-of-io-requests"></a>Nature of IO Requests  
...
## <a name="high-scale-vm-sizes"></a>High Scale VM Sizes  
...
## <a name="premium-storage-disk-sizes"></a>Premium Storage Disk Sizes  
...
## <a name="queue-depth"></a>Queue Depth  
