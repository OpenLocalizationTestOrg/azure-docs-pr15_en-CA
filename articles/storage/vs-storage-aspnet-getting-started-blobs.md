...
# <a name="get-started-with-blob-storage-and-visual-studio-connected-services-aspnet"></a>Get started with blob storage and Visual Studio connected services (ASP.NET)
