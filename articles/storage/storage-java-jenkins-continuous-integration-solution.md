...
# <a name="using-azure-storage-with-a-jenkins-continuous-integration-solution"></a>Using Azure Storage with a Jenkins Continuous Integration solution
...
## <a name="overview-of-jenkins"></a>Overview of Jenkins ##
...
## <a name="how-to-use-the-blob-service-with-jenkins-ci"></a>How to use the Blob service with Jenkins CI ##
