...
## <a name="about-storage-analytics-logging"></a>About Storage Analytics logging
...
### <a name="logging-authenticated-requests"></a>Logging authenticated requests
...
### <a name="logging-anonymous-requests"></a>Logging anonymous requests
...
### <a name="how-logs-are-stored"></a>How logs are stored
...
### <a name="log-naming-conventions"></a>Log naming conventions
...
### <a name="accessing-logging-data"></a>Accessing logging data
...
## <a name="about-storage-analytics-metrics"></a>About Storage Analytics metrics
...
### <a name="how-metrics-are-stored"></a>How metrics are stored
...
### <a name="accessing-metrics-data"></a>Accessing metrics data
...
## <a name="billing-for-storage-analytics"></a>Billing for Storage Analytics
...
### <a name="understanding-billable-requests"></a>Understanding billable requests
...
### <a name="setting-up-storage-analytics"></a>Setting up Storage Analytics
