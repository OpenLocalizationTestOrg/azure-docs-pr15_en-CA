...
# <a name="transfer-data-with-the-azcopy-command-line-utility"></a>Transfer data with the AzCopy Command-Line Utility
...
## <a name="writing-your-first-azcopy-command"></a>Writing your first AzCopy command
...
### <a name="download-single-blob"></a>Download single blob
...
### <a name="download-single-blob-from-secondary-region"></a>Download single blob from secondary region

    AzCopy /Source:https://myaccount-secondary.blob.core.windows.net/mynewcontainer /Dest:C:\myfolder /SourceKey:key /Pattern:abc.txt

Note that you must have read-access geo-redundant storage enabled.

### <a name="download-all-blobs"></a>Download all blobs
...
### <a name="download-blobs-with-specified-prefix"></a>Download blobs with specified prefix
...
### <a name="set-the-last-modified-time-of-exported-files-to-be-same-as-the-source-blobs"></a>Set the last-modified time of exported files to be same as the source blobs
...
### <a name="upload-single-file"></a>Upload single file
...
### <a name="upload-files-matching-specified-pattern"></a>Upload files matching specified pattern
...
### <a name="specify-the-mime-content-type-of-a-destination-blob"></a>Specify the MIME content type of a destination blob
...
### <a name="copy-single-blob-within-storage-account"></a>Copy single blob within Storage account
...
### <a name="copy-single-blob-across-storage-accounts"></a>Copy single blob across Storage accounts
...
### <a name="copy-single-blob-from-secondary-region-to-primary-region"></a>Copy single blob from secondary region to primary region

    AzCopy /Source:https://myaccount1-secondary.blob.core.windows.net/mynewcontainer1 /Dest:https://myaccount2.blob.core.windows.net/mynewcontainer2 /SourceKey:key1 /DestKey:key2 /Pattern:abc.txt

Note that you must have read-access geo-redundant storage enabled.

### <a name="copy-single-blob-and-its-snapshots-across-storage-accounts"></a>Copy single blob and its snapshots across Storage accounts
...
### <a name="synchronously-copy-blobs-across-storage-accounts"></a>Synchronously copy blobs across Storage accounts
...
### <a name="download-single-file"></a>Download single file
...
### <a name="download-all-files"></a>Download all files
...
### <a name="copy-across-file-shares"></a>Copy across file shares

    AzCopy /Source:https://myaccount1.file.core.windows.net/myfileshare1/ /Dest:https://myaccount2.file.core.windows.net/myfileshare2/ /SourceKey:key1 /DestKey:key2 /S

### <a name="copy-from-file-share-to-blob"></a>Copy from file share to blob

    AzCopy /Source:https://myaccount1.file.core.windows.net/myfileshare/ /Dest:https://myaccount2.blob.core.windows.net/mycontainer/ /SourceKey:key1 /DestKey:key2 /S

Note that asynchronous copying from File Storage to Page Blob is not supported.

### <a name="copy-from-blob-to-file-share"></a>Copy from blob to file share

    AzCopy /Source:https://myaccount1.blob.core.windows.net/mycontainer/ /Dest:https://myaccount2.file.core.windows.net/myfileshare/ /SourceKey:key1 /DestKey:key2 /S

### <a name="synchronously-copy-files"></a>Synchronously copy files
...
## <a name="table-export"></a>Table: Export

### <a name="export-table"></a>Export table
...
### <a name="split-export-into-multiple-files"></a>Split export into multiple files
...
### <a name="export-table-to-json-or-csv-data-file-format"></a>Export table to JSON or CSV data file format
...
### <a name="export-table-entities-concurrently"></a>Export table entities concurrently
...
### <a name="export-table-to-blob"></a>Export table to blob
...
### <a name="import-table"></a>Import table
...
### <a name="import-entities-to-table-using-blobs"></a>Import entities to table using blobs
...
### <a name="only-copy-data-that-doesnt-exist-in-the-destination"></a>Only copy data that doesn't exist in the destination
...
### <a name="use-a-response-file-to-specify-command-line-parameters"></a>Use a response file to specify command-line parameters
...
### <a name="use-multiple-response-files-to-specify-command-line-parameters"></a>Use multiple response files to specify command-line parameters
...
### <a name="specify-a-shared-access-signature-sas"></a>Specify a shared access signature (SAS)
...
### <a name="journal-file-folder"></a>Journal file folder
...
### <a name="generate-a-log-file"></a>Generate a log file
...
### <a name="specify-the-number-of-concurrent-operations-to-start"></a>Specify the number of concurrent operations to start
...
### <a name="run-azcopy-against-azure-storage-emulator"></a>Run AzCopy against Azure Storage Emulator
...
## <a name="known-issues-and-best-practices"></a>Known Issues and Best Practices

### <a name="limit-concurrent-writes-while-copying-data"></a>Limit concurrent writes while copying data
...
### <a name="run-one-azcopy-instance-on-one-machine"></a>Run one AzCopy instance on one machine.
...
### <a name="enable-fips-compliant-md5-algorithms-for-azcopy-when-you-use-fips-compliant-algorithms-for-encryption-hashing-and-signing"></a>Enable FIPS compliant MD5 algorithms for AzCopy when you "Use FIPS compliant algorithms for encryption, hashing and signing".
...
For property “AzureStorageUseV1MD5” • True - The default value, AzCopy will use .NET MD5 implementation.
...
### <a name="azure-storage-documentation"></a>Azure Storage documentation:
...
### <a name="azure-storage-blog-posts"></a>Azure Storage blog posts:
