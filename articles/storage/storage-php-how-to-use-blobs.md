...
# <a name="how-to-use-blob-storage-from-php"></a>How to use blob storage from PHP
...
## <a name="configure-your-application-to-access-the-blob-service"></a>Configure your application to access the blob service
