...
# <a name="enabling-azure-storage-metrics-and-viewing-metrics-data"></a>Enabling Azure Storage metrics and viewing metrics data
...
## <a name="how-to-enable-metrics-using-the-azure-portal"></a>How to enable metrics using the Azure Portal
...
## <a name="how-to-enable-metrics-using-powershell"></a>How to enable metrics using PowerShell
