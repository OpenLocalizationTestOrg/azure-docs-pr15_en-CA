...
# <a name="how-to-use-queue-storage-from-java"></a>How to use Queue storage from Java
...
## <a name="how-to-add-a-message-to-a-queue"></a>How to: Add a message to a queue
...
## <a name="additional-options-for-dequeuing-messages"></a>Additional options for dequeuing messages
...
## <a name="how-to-list-the-queues"></a>How to: List the queues
