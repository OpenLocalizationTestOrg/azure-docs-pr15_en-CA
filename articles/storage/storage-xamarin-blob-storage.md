...
# <a name="how-to-use-blob-storage-from-xamarin"></a>How to use Blob Storage from Xamarin
...
## <a name="create-a-new-xamarin-application"></a>Create a new Xamarin Application
...
## <a name="create-container-and-upload-blob"></a>Create container and upload blob
