...
# <a name="create-a-blob-snapshot"></a>Create a blob snapshot
...
## <a name="create-a-snapshot"></a>Create a snapshot
...
## <a name="copy-snapshots"></a>Copy snapshots
...
## <a name="specify-an-access-condition"></a>Specify an access condition
...
## <a name="delete-snapshots"></a>Delete snapshots
...
## <a name="snapshots-with-azure-premium-storage"></a>Snapshots with Azure Premium Storage
...
## <a name="return-the-absolute-uri-to-a-snapshot"></a>Return the absolute URI to a snapshot
...
## <a name="understand-how-snapshots-accrue-charges"></a>Understand how snapshots accrue charges
...
### <a name="important-billing-considerations"></a>Important billing considerations
...
### <a name="snapshot-billing-scenarios"></a>Snapshot billing scenarios
