...
# <a name="how-to-use-blob-storage-from-java"></a>How to use Blob storage from Java
...
### <a name="optional-configure-a-container-for-public-access"></a>Optional: Configure a container for public access
