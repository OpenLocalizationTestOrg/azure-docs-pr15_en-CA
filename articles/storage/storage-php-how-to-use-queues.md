...
# <a name="how-to-use-queue-storage-from-php"></a>How to use Queue storage from PHP
...
## <a name="additional-options-for-de-queuing-messages"></a>Additional options for de-queuing messages
...
## <a name="get-queue-length"></a>Get queue length
