...
#  <a name="replicate-hyper-v-virtual-machines-on-a-single-vmm-server"></a>Replicate Hyper-V virtual machines on a single VMM server
...
## <a name="replicate-across-sites-with-a-single-standalone-vmm-server"></a>Replicate across sites with a single standalone VMM server
...
### <a name="what-to-do-in-an-outage"></a>What to do in an outage
...
## <a name="replicate-across-sites-with-a-single-vmm-server-in-a-stretched-cluster"></a>Replicate across sites with a single VMM server in a stretched cluster
