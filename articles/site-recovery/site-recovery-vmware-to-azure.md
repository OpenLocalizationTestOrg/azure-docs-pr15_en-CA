...
# <a name="replicate-vmware-virtual-machines-and-physical-machines-to-azure-with-azure-site-recovery-using-the-azure-portal"></a>Replicate VMware virtual machines and physical machines to Azure with Azure Site Recovery using the Azure portal
...
## <a name="business-advantages"></a>Business advantages
...
### <a name="windows64-bit-only"></a>Windows(64 bit only)
- Windows Server 2008 R2 SP1+
- Windows Server 2012
- Windows Server 2012 R2

### <a name="linux-64-bit-only"></a>Linux (64 bit only)
...
## <a name="scenario-architecture"></a>Scenario architecture
...
## <a name="configuration-server--scale-out-process-prerequisites"></a>Configuration server / Scale out Process prerequisites
...
## <a name="vmware-vcentervsphere-host-prerequisites"></a>VMware vCenter/vSphere host prerequisites
...
## <a name="protected-machine-prerequisites"></a>Protected machine prerequisites
...
## <a name="prepare-for-deployment"></a>Prepare for deployment
...
### <a name="prepare-the-configuration-server"></a>Prepare the configuration server
...
## <a name="step-1-choose-your-protection-goals"></a>Step 1: Choose your protection goals
...
## <a name="step-2-set-up-the-source-environment"></a>Step 2: Set up the source environment
...
### <a name="run-site-recovery-unified-setup"></a>Run Site Recovery Unified Setup
...
#### <a name="run-setup-from-the-command-line"></a>Run setup from the command line
...
### <a name="add-the-vmware-account-used-for-automatic-discovery"></a>Add the VMware account used for automatic discovery
...
### <a name="connect-to-vsphere-hosts-and-vcenter-servers"></a>Connect to vSphere hosts and vCenter servers
...
## <a name="step-3-set-up-the-target-environment"></a>Step 3: Set up the target environment
...
## <a name="step-4-set-up-replication-settings"></a>Step 4: Set up replication settings
...
## <a name="step-5-capacity-planning"></a>Step 5: Capacity planning
...
### <a name="size-recommendations-for-the-configuration-server"></a>Size recommendations for the configuration server
...
### <a name="size-recommendations-for-the-process-server"></a>Size recommendations for the process server
...
### <a name="network-bandwidth-considerations"></a>Network bandwidth considerations
...
#### <a name="throttle-bandwidth"></a>Throttle bandwidth
...
#### <a name="influence-network-bandwidth"></a>Influence network bandwidth
...
## <a name="step-6-replicate-applications"></a>Step 6: Replicate applications

Make sure that machines you want to replicate are prepared for Mobility service installation, and then enable replication.

### <a name="install-the-mobility-service"></a>Install the Mobility service
...
#### <a name="prepare-for-automatic-push-on-windows-machines"></a>Prepare for automatic push on Windows machines
...
#### <a name="prepare-for-automatic-push-on-linux-servers"></a>Prepare for automatic push on Linux servers
...
#### <a name="install-mobility-service-on-a-windows-server"></a>Install Mobility Service on a Windows Server
...
#### <a name="install-mobility-service-on-a-windows-server-using-the-command-prompt"></a>Install Mobility Service on a Windows server using the Command prompt
...
#####<a name="full-command-line-syntax"></a>Full Command-line Syntax
...
#### <a name="uninstall-mobility-service-manually"></a>Uninstall Mobility service manually
...
#### <a name="install-mobility-service-on-a-linux-server-using-command-line"></a>Install Mobility Service on a Linux server using command-line
...
#### <a name="exclude-disks-from-replication"></a>Exclude disks from replication
...
### <a name="view-and-manage-vm-properties"></a>View and manage VM properties
...
## <a name="step-7-test-the-deployment"></a>Step 7: Test the deployment
...
### <a name="prepare-for-failover"></a>Prepare for failover
...
## <a name="monitor-your-deployment"></a>Monitor your deployment
...
## <a name="deploy-additional-process-servers"></a>Deploy additional process servers
...
### <a name="install-an-additional-process-server"></a>Install an additional process server
...
### <a name="migrate-machines-to-use-the-new-process-server"></a>Migrate machines to use the new process server
...
## <a name="vmware-account-permissions"></a>VMware account permissions
