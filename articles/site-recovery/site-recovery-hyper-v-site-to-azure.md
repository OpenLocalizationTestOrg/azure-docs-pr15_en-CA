...
# <a name="replicate-hyper-v-virtual-machines-without-vmm-to-azure-using-azure-site-recovery-with-the-azure-portal"></a>Replicate Hyper-V virtual machines (without VMM) to Azure using Azure Site Recovery with the Azure portal
...
### <a name="prepare-the-hyper-v-hosts"></a>Prepare the Hyper-V hosts
...
### <a name="install-the-provider-and-agent"></a>Install the Provider and agent
...
4. Then run these commands to register the server in the vault: CD C:\Program Files\Microsoft Azure Site Recovery Provider\
...
### <a name="prepare-for-test-failover"></a>Prepare for test failover
...
## <a name="complete-migration-of-your-virtual-machines-to-azure"></a>Complete migration of your virtual machines to Azure
