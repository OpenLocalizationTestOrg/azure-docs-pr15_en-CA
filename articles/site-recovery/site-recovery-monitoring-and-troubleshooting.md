...
# <a name="monitor-and-troubleshoot-protection-for-virtual-machines-and-physical-servers"></a>Monitor and troubleshoot protection for virtual machines and physical servers
...
## <a name="understanding-the-components"></a>Understanding the components

### <a name="vmwarephysical-site-deployment-for-replication-between-on-premises-and-azure"></a>VMware/Physical Site Deployment for replication between on-premises and Azure.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises-site"></a>VMM Site Deployment for replication between on-premises site.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises--azure"></a>VMM Site Deployment for replication between on-premises & Azure.
...
### <a name="hyper-v-site-deployment-for-replication-between-on-premises--azure"></a>Hyper-V Site Deployment for replication between on-premises & Azure
...
## <a name="monitor-configuration-protection-and-recovery-operations"></a>Monitor configuration, protection and recovery operations
...
## <a name="monitor-replication-health-for-virtual-machine"></a>Monitor replication health for virtual machine
...
## <a name="troubleshoot-on-premises-hyper-v-issues"></a>Troubleshoot on-premises Hyper-V issues
...
In this case *Replication Health* is being indicated as Critical – *View Replication Health* to see the details.
...
### <a name="hyper-v-replication-logging-options"></a>Hyper-V Replication Logging Options
...
In the **Actions** pane, click on **Enable Log**. Once enabled, it appears in **Performance Monitor** as an Event Trace Session located under **Data Collector Sets.**
...
## <a name="reaching-out-for-microsoft-support"></a>Reaching out for Microsoft Support

### <a name="log-collection"></a>Log collection

For VMM Site protection, refer [ASR Log Collection using Support Diagnostics Platform (SDP) Tool](http://social.technet.microsoft.com/wiki/contents/articles/28198.asr-data-collection-and-analysis-using-the-vmm-support-diagnostics-platform-sdp-tool.aspx) to collect the required logs.

For Hyper-V Site protection, download the [tool](https://dcupload.microsoft.com/tools/win7files/DIAG_ASRHyperV_global.DiagCab) & execute it on the Hyper-V host to collect the logs.

For VMware/Physical scenarios, refer [Azure Site Recovery Log Collection for VMware and Physical site protection](http://social.technet.microsoft.com/wiki/contents/articles/30677.azure-site-recovery-log-collection-for-vmware-and-physical-site-protection.aspx) to collect the required logs.
...
To raise support ticket for ASR, reach out to Azure Support using the URL at <http://aka.ms/getazuresupport>

## <a name="kb-articles"></a>KB Articles
...
## <a name="common-asr-errors-and-their-resolutions"></a>Common ASR errors and their resolutions
...
### <a name="configuration-server-process-server-master-target"></a>Configuration Server, Process Server, Master Target
...
### <a name="remote-desktop-troubleshooting-after-failover"></a>Remote desktop troubleshooting after failover
...
#### <a name="adding-a-public-ip-on-a-resource-manager-virtual-machine"></a>Adding a public IP on a resource manager virtual machine
