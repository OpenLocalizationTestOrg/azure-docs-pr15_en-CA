...
# <a name="prepare-for-azure-site-recovery-deployment"></a>Prepare for Azure Site Recovery deployment
...
## <a name="select-your-deployment-model"></a>Select your deployment model
...
## <a name="select-your-deployment-scenario"></a>Select your deployment scenario
...
## <a name="check-what-you-need-for-deployment"></a>Check what you need for deployment
...
## <a name="verify-url-access"></a>Verify URL access
