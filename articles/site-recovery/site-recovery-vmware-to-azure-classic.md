...
# <a name="replicate-vmware-virtual-machines-and-physical-servers-to-azure-with-azure-site-recovery"></a>Replicate VMware virtual machines and physical servers to Azure with Azure Site Recovery
...
## <a name="enhanced-deployment"></a>Enhanced deployment
...
## <a name="how-does-site-recovery-help-protect-virtual-machines-and-physical-servers"></a>How does Site Recovery help protect virtual machines and physical servers?
...
### <a name="source-environment-considerations"></a>Source environment considerations
...
### <a name="management-server-considerations"></a>Management server considerations
...
### <a name="network-bandwidth-from-source-to-target"></a>Network bandwidth from source to target
...
#### <a name="throttling-bandwidth-used-for-replication"></a>Throttling bandwidth used for replication
...
#### <a name="maximizing-bandwidth-usage"></a>Maximizing bandwidth usage
...
### <a name="additional-process-servers"></a>Additional process servers
...
## <a name="before-you-start-deployment"></a>Before you start deployment
...
## <a name="step-2-set-up-an-azure-network"></a>Step 2: Set up an Azure network
...
## <a name="step-3-install-the-vmware-components"></a>Step 3: Install the VMware components
...
## <a name="step-4-download-a-vault-registration-key"></a>Step 4: Download a vault registration key
...
## <a name="step-5-install-the-management-server"></a>Step 5: Install the management server
...
## <a name="step-6-set-up-credentials-for-the-vcenter-server"></a>Step 6: Set up credentials for the vCenter server
...
## <a name="step-7-add-vcenter-servers-and-esxi-hosts"></a>Step 7: Add vCenter servers and ESXi hosts
...
## <a name="step-8-create-a-protection-group"></a>Step 8: Create a protection group
...
## <a name="step-9-install-the-mobility-service"></a>Step 9: Install the Mobility service
...
### <a name="install-the-mobility-service-with-push-installation"></a>Install the Mobility service with push installation
...
#### <a name="install-manually-on-a-windows-server"></a>Install manually on a Windows server
...
#### <a name="modify-the-ip-address-of-the-management-server"></a>Modify the IP address of the management server
...
#### <a name="install-manually-on-a-linux-server"></a>Install manually on a Linux server:
...
## <a name="step-10-enable-protection-for-a-machine"></a>Step 10: Enable protection for a machine
...
## <a name="step-11-set-protected-machine-properties"></a>Step 11: Set protected machine properties
...
## <a name="step-12-create-a-recovery-plan-and-run-a-failover"></a>Step 12: Create a recovery plan and run a failover
...
### <a name="connect-to-replicated-azure-virtual-machines-after-failover"></a>Connect to replicated Azure virtual machines after failover
...
### <a name="set-up-an-additional-process-server"></a>Set up an additional process server
...
### <a name="install-the-process-server"></a>Install the process server
...
## <a name="vmware-permissions-for-vcenter-access"></a>VMware permissions for vCenter access
