...
# <a name="replicate-hyper-v-virtual-machines-in-vmm-clouds-to-a-secondary-vmm-site-using-the-azure-portal"></a>Replicate Hyper-V virtual machines in VMM clouds to a secondary VMM site using the Azure portal
...
### <a name="data-privacy-overview"></a>Data privacy overview
...
## <a name="prepare-for-deployment-with-a-single-vmm-server"></a>Prepare for deployment with a single VMM server
...
## <a name="step-1-choose-your-protection-goal"></a>Step 1: Choose your protection goal
...
### <a name="configure-storage-mapping"></a>Configure Storage mapping
...
### <a name="control-bandwidth"></a>Control bandwidth
...
### <a name="onboard-existing-virtual-machines"></a>Onboard existing virtual machines
...
### <a name="update-dns-with-the-replica-vm-ip-address"></a>Update DNS with the replica VM IP address
...
#### <a name="retrieve-the-ip-address"></a>Retrieve the IP address
