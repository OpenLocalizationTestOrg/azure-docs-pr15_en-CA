...
# <a name="remove-servers-and-disable-protection"></a>Remove servers and disable protection
...
## <a name="unregister-a-vmm-server"></a>Unregister a VMM server
...
### <a name="unregister-an-unconnected-vmm-server"></a>Unregister an unconnected VMM server
...
## <a name="unregister-a-hyper-v-server-in-a-hyper-v-site"></a>Unregister a Hyper-V server in a Hyper-V site
...
## <a name="stop-protecting-a-hyper-v-virtual-machine"></a>Stop protecting a Hyper-V virtual machine
...
### <a name="remove-protection"></a>Remove protection
...
### <a name="clean-up-protection-settings-manually-between-vmm-sites"></a>Clean up protection settings manually (between VMM sites)
...
### <a name="clean-up-protection-settings-manually-between-on-premises-vmm-sites-and-azure"></a>Clean up protection settings manually (between on-premises VMM sites and Azure)
...
### <a name="clean-up-protection-settings-manually-between-hyper-v-sites-and-azure"></a>Clean up protection settings manually (between Hyper-V sites and Azure)
...
## <a name="stop-protecting-a-vmware-virtual-machine-or-a-physical-server"></a>Stop protecting a VMware virtual machine or a physical server
