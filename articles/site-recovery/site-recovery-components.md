...
## <a name="replicate-to-azure-vmware-virtual-machines-or-physical-windowslinux-servers"></a>Replicate to Azure: VMware virtual machines or physical Windows/Linux servers
...
## <a name="replicate-to-azure-hyper-v-vms-not-managed-by-vmm"></a>Replicate to Azure: Hyper-V VMs not managed by VMM
...
## <a name="replicate-to-azure-hyper-v-vms-managed-by-vmm"></a>Replicate to Azure: Hyper-V VMs managed by VMM
...
## <a name="replicate-to-a-secondary-site-vmware-virtual-machines-or-physical-servers"></a>Replicate to a secondary site: VMware virtual machines or physical servers 
...
## <a name="replicate-to-a-secondary-site-hyper-v-vms-managed-by-vmm"></a>Replicate to a secondary site: Hyper-V VMs managed by VMM
...
## <a name="replicate-to-a-secondary-site-with-san-replication-hyper-v-vms-managed-by-vmm"></a>Replicate to a secondary site with SAN replication: Hyper-V VMs managed by VMM
...
## <a name="hyper-v-protection-lifecycle"></a>Hyper-V protection lifecycle
