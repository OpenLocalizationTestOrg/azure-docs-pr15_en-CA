...
## <a name="types-of-failover"></a>Types of failover
...
### <a name="failback-from-secondary-site"></a>Failback from secondary site
...
### <a name="failback-from-azure"></a>Failback from Azure
...
### <a name="failover-considerations"></a>Failover considerations
...
### <a name="run-a-test-failover-from-on-premises-to-azure"></a>Run a test failover from on-premises to Azure
...
### <a name="run-a-test-failover-from-a-primary-on-premises-site-to-a-secondary-on-premises-site"></a>Run a test failover from a primary on-premises site to a secondary on-premises site
...
## <a name="run-a-planned-failover-primary-to-secondary"></a>Run a planned failover (primary to secondary)
...
## <a name="failback-from-secondary-to-primary"></a>Failback from secondary to primary
...
## <a name="failback-to-an-alternate-location"></a>Failback to an alternate location
