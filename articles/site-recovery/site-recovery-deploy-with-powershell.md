...
# <a name="replicate-hyper-v-virtual-machines-in-vmm-clouds-to-azure-using-powershell---classic"></a>Replicate Hyper-V virtual machines in VMM clouds to Azure using Powershell - Classic
...
## <a name="step-2-create-a-site-recovery-vault"></a>Step 2: Create a Site Recovery vault
...
## <a name="step-3-generate-a-vault-registration-key"></a>Step 3: Generate a vault registration key
