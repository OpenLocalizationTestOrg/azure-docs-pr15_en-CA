...
# <a name="run-job-preparation-and-completion-tasks-on-azure-batch-compute-nodes"></a>Run job preparation and completion tasks on Azure Batch compute nodes
...
## <a name="what-are-job-preparation-and-release-tasks"></a>What are job preparation and release tasks?
...
## <a name="when-to-use-job-preparation-and-release-tasks"></a>When to use job preparation and release tasks
...
## <a name="job-preparation-task"></a>Job preparation task
...
## <a name="job-release-task"></a>Job release task
...
## <a name="job-prep-and-release-tasks-with-batch-net"></a>Job prep and release tasks with Batch .NET
...
## <a name="code-sample-on-github"></a>Code sample on GitHub
...
### <a name="inspect-job-preparation-and-release-tasks-in-the-azure-portal"></a>Inspect job preparation and release tasks in the Azure portal
