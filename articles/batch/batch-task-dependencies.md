...
# <a name="task-dependencies-in-azure-batch"></a>Task dependencies in Azure Batch
...
## <a name="task-dependencies-with-batch-net"></a>Task dependencies with Batch .NET
...
## <a name="enable-task-dependencies"></a>Enable task dependencies
...
## <a name="create-dependent-tasks"></a>Create dependent tasks
...
## <a name="dependency-scenarios"></a>Dependency scenarios
...
### <a name="one-to-many"></a>One-to-many
...
### <a name="task-id-range"></a>Task ID range
