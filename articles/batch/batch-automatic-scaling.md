...
# <a name="automatically-scale-compute-nodes-in-an-azure-batch-pool"></a>Automatically scale compute nodes in an Azure Batch pool
...
## <a name="automatic-scaling-formulas"></a>Automatic scaling formulas
...
### <a name="samples-sample-percentage-and-the-getsample-method"></a>Samples, sample percentage, and the *GetSample()* method
...
## <a name="write-an-autoscale-formula"></a>Write an autoscale formula
...
## <a name="create-an-autoscale-enabled-pool"></a>Create an autoscale-enabled pool
...
1. Set the [CloudPool.AutoScaleEnabled](https://msdn.microsoft.com/library/azure/microsoft.azure.batch.cloudpool.autoscaleenabled.aspx) property to `true`.
1. Set the [CloudPool.AutoScaleFormula](https://msdn.microsoft.com/library/azure/microsoft.azure.batch.cloudpool.autoscaleformula.aspx) property with your autoscale formula.
1. (Optional) Set the [CloudPool.AutoScaleEvaluationInterval](https://msdn.microsoft.com/library/azure/microsoft.azure.batch.cloudpool.autoScaleevaluationinterval.aspx) property (default is 15 minutes).
1. Commit the pool with [CloudPool.Commit](https://msdn.microsoft.com/library/azure/microsoft.azure.batch.cloudpool.commit.aspx) or [CommitAsync](https://msdn.microsoft.com/library/azure/microsoft.azure.batch.cloudpool.commitasync.aspx).
...
### <a name="automatic-scaling-interval"></a>Automatic scaling interval
...
## <a name="enable-autoscaling-on-an-existing-pool"></a>Enable autoscaling on an existing pool
...
### <a name="update-an-autoscale-formula"></a>Update an autoscale formula
...
### <a name="update-the-autoscale-interval"></a>Update the autoscale interval
...
## <a name="evaluate-an-autoscale-formula"></a>Evaluate an autoscale formula
...
## <a name="get-information-about-autoscale-runs"></a>Get information about autoscale runs
...
## <a name="example-autoscale-formulas"></a>Example autoscale formulas

Let's take a look at a few formulas that show different ways to adjust the amount of compute resources in a pool.

### <a name="example-1-time-based-adjustment"></a>Example 1: Time-based adjustment
...
### <a name="example-2-task-based-adjustment"></a>Example 2: Task-based adjustment
...
### <a name="example-3-accounting-for-parallel-tasks"></a>Example 3: Accounting for parallel tasks
...
### <a name="example-4-setting-an-initial-pool-size"></a>Example 4: Setting an initial pool size
