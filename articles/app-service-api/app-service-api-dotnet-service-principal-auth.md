...
# <a name="service-principal-authentication-for-api-apps-in-azure-app-service"></a>Service principal authentication for API Apps in Azure App Service
...
#### <a name="how-to-consume-the-protected-api-app"></a>How to consume the protected API app
...
#### <a name="how-to-protect-the-api-app-from-access-by-users-in-the-same-tenant"></a>How to protect the API app from access by users in the same tenant
...
### <a name="how-to-protect-the-api-app-from-browser-access"></a>How to protect the API app from browser access
...
## <a name="set-up-authentication-in-azure"></a>Set up authentication in Azure
...
### <a name="verify-that-the-api-app-is-protected"></a>Verify that the API app is protected
...
## <a name="configure-the-todolistapi-project-to-acquire-and-send-the-azure-ad-token"></a>Configure the ToDoListAPI project to acquire and send the Azure AD token
...
### <a name="get-azure-ad-configuration-values"></a>Get Azure AD configuration values
...
### <a name="configure-azure-ad-settings-in-the-middle-tier-api-apps-runtime-environment"></a>Configure Azure AD settings in the middle tier API app's runtime environment
...
## <a name="protect-the-api-app-from-browser-access"></a>Protect the API app from browser access
...
### <a name="disable-browser-access"></a>Disable browser access
...
### <a name="verify-browser-access-no-longer-works"></a>Verify browser access no longer works
...
## <a name="restrict-access-to-a-particular-service-principal"></a>Restrict access to a particular service principal  
...
## <a name="building-the-projects-from-scratch"></a>Building the projects from scratch
