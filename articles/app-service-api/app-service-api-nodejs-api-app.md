...
# <a name="build-a-nodejs-restful-api-and-deploy-it-to-an-api-app-in-azure"></a>Build a Node.js RESTful API and deploy it to an API app in Azure
...
## <a name="get-the-sample-code"></a>Get the sample code
...
## <a name="scaffold-auto-generate-nodejs-code-based-on-swagger-metadata"></a>Scaffold (auto-generate) Node.js code based on Swagger metadata
...
### <a name="install-and-execute-swaggerize"></a>Install and execute Swaggerize
...
### <a name="customize-the-scaffolded-code"></a>Customize the scaffolded code
...
### <a name="test-with-the-api-running-locally"></a>Test with the API running locally
...
## <a name="set-up-your-new-api-app-for-git-deployment"></a>Set up your new API app for Git deployment
...
## <a name="deploy-your-api-code-to-azure"></a>Deploy your API code to Azure
...
## <a name="test-with-the-api-running-in-azure"></a>Test with the API running in Azure
