...
# <a name="app-service-api-apps-metadata-for-api-discovery-and-code-generation"></a>App Service API Apps metadata for API discovery and code generation 
...
## <a name="swagger-endpoint"></a>Swagger endpoint
...
### <a name="azure-resource-manager-property"></a>Azure Resource Manager property
