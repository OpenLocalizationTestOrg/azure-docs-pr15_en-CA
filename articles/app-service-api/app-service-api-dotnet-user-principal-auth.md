...
# <a name="user-authentication-for-api-apps-in-azure-app-service"></a>User authentication for API Apps in Azure App Service
...
### <a name="configure-authentication-for-the-middle-tier-api-app"></a>Configure authentication for the middle tier API app
...
### <a name="optional-test-the-api-app"></a>Optional: Test the API app
...
### <a name="configure-the-azure-ad-application"></a>Configure the Azure AD application
...
## <a name="configure-the-todolistangular-project-to-use-authentication"></a>Configure the ToDoListAngular project to use authentication
...
### <a name="deploy-the-todolistangular-project-to-azure"></a>Deploy the ToDoListAngular project to Azure
...
## <a name="configure-the-todolistapi-project-to-use-authentication"></a>Configure the ToDoListAPI project to use authentication
...
### <a name="deploy-the-todolistapi-project-to-azure"></a>Deploy the ToDoListAPI project to Azure
