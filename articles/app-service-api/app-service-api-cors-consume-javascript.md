...
# <a name="consume-an-api-app-from-javascript-using-cors"></a>Consume an API app from JavaScript using CORS
...
#### <a name="configure-cors-in-the-azure-portal"></a>Configure CORS in the Azure portal
...
#### <a name="configure-cors-by-using-azure-resource-manager-tools"></a>Configure CORS by using Azure Resource Manager tools
...
## <a name="deploy-the-todolistangular-project-to-a-new-web-app"></a>Deploy the ToDoListAngular project to a new web app
...
### <a name="create-a-new-web-app-for-the-todolistangular-project"></a>Create a new web app for the ToDoListAngular project
...
### <a name="set-the-middle-tier-url-in-web-app-settings"></a>Set the middle tier URL in web app settings
...
### <a name="deploy-the-todolistangular-web-project-to-the-new-web-app"></a>Deploy the ToDoListAngular web project to the new web app
...
### <a name="test-the-application-without-cors-enabled"></a>Test the application without CORS enabled 
...
## <a name="configure-cors-for-the-middle-tier-api-app"></a>Configure CORS for the middle tier API app
...
### <a name="test-the-application-with-cors-enabled"></a>Test the application with CORS enabled
...
### <a name="how-to-enable-cors-in-web-api-code"></a>How to enable CORS in Web API code
...
## <a name="using-azure-api-management-with-api-apps"></a>Using Azure API Management with API Apps
