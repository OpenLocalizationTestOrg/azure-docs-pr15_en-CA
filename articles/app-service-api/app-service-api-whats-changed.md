...
# <a name="app-service-api-apps---whats-changed"></a>App Service API Apps - What's changed
...
## <a name="feature-changes"></a>Feature changes
...
### <a name="hosting-and-redeployment"></a>Hosting and redeployment
...
### <a name="internal-access"></a>Internal access
...
## <a name="using-api-apps-with-logic-apps"></a>Using API Apps with Logic Apps
