...
# <a name="upload-data-to-azure-search-using-the-net-sdk"></a>Upload data to Azure Search using the .NET SDK
> [AZURE.SELECTOR]
...
## <a name="i-create-an-instance-of-the-searchindexclient-class"></a>I. Create an instance of the SearchIndexClient class
...
## <a name="iii-construct-your-indexbatch"></a>III. Construct your IndexBatch
...
## <a name="iv-import-data-to-the-index"></a>IV. Import data to the index
...
<a name="HotelClass"></a>
### <a name="how-the-net-sdk-handles-documents"></a>How the .NET SDK handles documents
