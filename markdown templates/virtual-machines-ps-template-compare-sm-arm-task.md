...
# <a name="use-azure-powershell-to-task"></a>Use Azure PowerShell to [task]
...
## <a name="prerequisite-install-a-recent-version-of-azure-powershell"></a>Prerequisite: Install a Recent Version of Azure PowerShell
...
## <a name="command-comparison"></a>Command Comparison
...
## <a name="script-examples"></a>Script Examples
